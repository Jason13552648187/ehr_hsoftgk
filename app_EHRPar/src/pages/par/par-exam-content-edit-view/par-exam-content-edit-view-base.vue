<template>
  <app-layout viewName="parexamcontenteditview" viewTitle="考核内容" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'par-exam-content-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ParExamContentEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ParExamContentEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {ParExamContentService}
     * @memberof ParExamContentEditViewBase
     */
    public appEntityService: ParExamContentService = new ParExamContentService;
	 ...
	 * @memberof ParExamContentEditViewBase
	 */
	public viewtag: string = 'c9e455b34eb6902a1c0a6fffffbf6dfe';
     ...
     */
    public model: any = {
        srfCaption: 'entities.parexamcontent.views.editview.caption',
        srfTitle: 'entities.parexamcontent.views.editview.title',
        srfSubTitle: 'entities.parexamcontent.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof ParExamContentEditView
     */
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'parexamcontent',
            majorPSDEField: 'parexamcontentname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"ParExamContent");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"ParExamContent");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Exit(datas, contextJO,paramJO,  $event, xData,this,"ParExamContent");
    }
...
<style lang='less'>
@import './par-exam-content-edit-view.less';
</style>