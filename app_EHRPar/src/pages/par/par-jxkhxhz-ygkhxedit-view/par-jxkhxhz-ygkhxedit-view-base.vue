<template>
  <app-layout viewName="parjxkhxhzygkhxeditview" viewTitle="员工考核内容及评分汇总" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'par-jxkhxhz-ygkhxedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ParJxkhxhzYGKHXEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ParJxkhxhzYGKHXEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {ParJxkhxhzService}
     * @memberof ParJxkhxhzYGKHXEditViewBase
     */
    public appEntityService: ParJxkhxhzService = new ParJxkhxhzService;
	 ...
	 * @memberof ParJxkhxhzYGKHXEditViewBase
	 */
	public viewtag: string = '94611ef3a4827e95f4bea2199ed9b4a2';
     ...
     */
    public model: any = {
        srfCaption: 'entities.parjxkhxhz.views.ygkhxeditview.caption',
        srfTitle: 'entities.parjxkhxhz.views.ygkhxeditview.title',
        srfSubTitle: 'entities.parjxkhxhz.views.ygkhxeditview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof ParJxkhxhzYGKHXEditView
     */
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'parjxkhxhz',
            majorPSDEField: 'parjxkhxhzname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"ParJxkhxhz");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"ParJxkhxhz");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"ParJxkhxhz");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"ParJxkhxhz");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"ParJxkhxhz");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"ParJxkhxhz");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"ParJxkhxhz");
    }
...
<style lang='less'>
@import './par-jxkhxhz-ygkhxedit-view.less';
</style>