<template>
  <app-layout viewName="parldkhqzeditview" viewTitle="评分权重分配" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'par-ldkhqz-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ParLdkhqzEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ParLdkhqzEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {ParLdkhqzService}
     * @memberof ParLdkhqzEditViewBase
     */
    public appEntityService: ParLdkhqzService = new ParLdkhqzService;
	 ...
	 * @memberof ParLdkhqzEditViewBase
	 */
	public viewtag: string = '663fc0adb5dc1b0c3d92e2bdeb30c163';
     ...
     */
    public model: any = {
        srfCaption: 'entities.parldkhqz.views.editview.caption',
        srfTitle: 'entities.parldkhqz.views.editview.title',
        srfSubTitle: 'entities.parldkhqz.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'parldkhqz',
            majorPSDEField: 'parldkhqzname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"ParLdkhqz");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"ParLdkhqz");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"ParLdkhqz");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"ParLdkhqz");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"ParLdkhqz");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"ParLdkhqz");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"ParLdkhqz");
    }
...
<style lang='less'>
@import './par-ldkhqz-edit-view.less';
</style>