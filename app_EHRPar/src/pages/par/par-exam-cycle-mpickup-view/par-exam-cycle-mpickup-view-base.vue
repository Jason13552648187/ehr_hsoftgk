<template>
  <app-layout viewName="parexamcyclempickupview" viewTitle="考核周期数据多项选择视图" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'dempickupview': true, 'par-exam-cycle-mpickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ParExamCycleMPickupViewBase
 * @extends {MPickupViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ParExamCycleMPickupViewBase extends MPickupViewBase {

    /**
     * 实体服务对象
     *
     * @type {ParExamCycleService}
     * @memberof ParExamCycleMPickupViewBase
     */
	 ...
	 * @memberof ParExamCycleMPickupViewBase
	 */
	public viewtag: string = '9154733e9c78288a33d8342cd81eb5f3';
     ...
     */
    public model: any = {
        srfCaption: 'entities.parexamcycle.views.mpickupview.caption',
        srfTitle: 'entities.parexamcycle.views.mpickupview.title',
        srfSubTitle: 'entities.parexamcycle.views.mpickupview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {any[]}
     * @memberof ParExamCycleMPickupView
     */
        ...
        Object.values(this.containerModel).forEach((model: any) => {
            ...
            if(model.datas.length>0){
                model.datas.forEach((data:any,index:any)=>{
                    Object.assign(data,{srfmajortext: data['parexamcyclename']});
                })
            }
...
<style lang='less'>
@import './par-exam-cycle-mpickup-view.less';
</style>