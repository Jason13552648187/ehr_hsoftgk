<template>
  <app-layout viewName="partzggmpickupview" viewTitle="通知公告数据多项选择视图" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'dempickupview': true, 'par-tzgg-mpickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ParTzggMPickupViewBase
 * @extends {MPickupViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ParTzggMPickupViewBase extends MPickupViewBase {
	 ...
	 * @memberof ParTzggMPickupViewBase
	 */
	public viewtag: string = '48cb9678c112e2bfeceb56c96c8c0de5';
     ...
     */
    public model: any = {
        srfCaption: 'entities.partzgg.views.mpickupview.caption',
        srfTitle: 'entities.partzgg.views.mpickupview.title',
        srfSubTitle: 'entities.partzgg.views.mpickupview.subtitle',
        dataInfo: ''
    }
        ...
        Object.values(this.containerModel).forEach((model: any) => {
            ...
            if(model.datas.length>0){
                model.datas.forEach((data:any,index:any)=>{
                    Object.assign(data,{srfmajortext: data['partzggname']});
                })
            }
...
<style lang='less'>
@import './par-tzgg-mpickup-view.less';
</style>