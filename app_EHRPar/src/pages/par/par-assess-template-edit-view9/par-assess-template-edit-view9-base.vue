 ...
 *
 * @export
 * @class ParAssessTemplateEditView9Base
 * @extends {EditView9Base}
 */
@Component({})
@VueLifeCycleProcessing
export default class ParAssessTemplateEditView9Base extends EditView9Base {

    /**
     * 实体服务对象
     *
     * @type {ParAssessTemplateService}
     * @memberof ParAssessTemplateEditView9Base
     */
	 ...
	 * @memberof ParAssessTemplateEditView9Base
	 */
	public viewtag: string = 'd84eab620a82c604d82070edc298611c';
     ...
     */
    public model: any = {
        srfCaption: 'entities.parassesstemplate.views.editview9.caption',
        srfTitle: 'entities.parassesstemplate.views.editview9.title',
        srfSubTitle: 'entities.parassesstemplate.views.editview9.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof ParAssessTemplateEditView9
     */
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Exit(datas, contextJO,paramJO,  $event, xData,this,"ParAssessTemplate");
    }
...
<style lang='less'>
@import './par-assess-template-edit-view9.less';
</style>