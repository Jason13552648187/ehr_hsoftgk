<template>
  <app-layout viewName="partzggeditview" viewTitle="通知信息" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'par-tzgg-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ParTzggEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ParTzggEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {ParTzggService}
     * @memberof ParTzggEditViewBase
     */
	 ...
	 * @memberof ParTzggEditViewBase
	 */
	public viewtag: string = 'b7f7b92b88ba971f28bbb5aa18145e46';
     ...
     */
    public model: any = {
        srfCaption: 'entities.partzgg.views.editview.caption',
        srfTitle: 'entities.partzgg.views.editview.title',
        srfSubTitle: 'entities.partzgg.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"ParTzgg");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"ParTzgg");
    }
...
<style lang='less'>
@import './par-tzgg-edit-view.less';
</style>