<template>
  <app-layout viewName="parexamcycleeditview" viewTitle="考核周期" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'par-exam-cycle-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ParExamCycleEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ParExamCycleEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {ParExamCycleService}
     * @memberof ParExamCycleEditViewBase
     */
	 ...
	 * @memberof ParExamCycleEditViewBase
	 */
	public viewtag: string = '963f9744f61222f20041022b8b7eba31';
     ...
     */
    public model: any = {
        srfCaption: 'entities.parexamcycle.views.editview.caption',
        srfTitle: 'entities.parexamcycle.views.editview.title',
        srfSubTitle: 'entities.parexamcycle.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"ParExamCycle");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Exit(datas, contextJO,paramJO,  $event, xData,this,"ParExamCycle");
    }
...
<style lang='less'>
@import './par-exam-cycle-edit-view.less';
</style>