<template>
  <app-layout viewName="parjxjgeditview" viewTitle="绩效结果编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'par-jxjg-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ParJxjgEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ParJxjgEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {ParJxjgService}
     * @memberof ParJxjgEditViewBase
     */
	 ...
	 * @memberof ParJxjgEditViewBase
	 */
	public viewtag: string = '05888e4abd44fea4605d6f22c87eb807';
     ...
     */
    public model: any = {
        srfCaption: 'entities.parjxjg.views.editview.caption',
        srfTitle: 'entities.parjxjg.views.editview.title',
        srfSubTitle: 'entities.parjxjg.views.editview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './par-jxjg-edit-view.less';
</style>