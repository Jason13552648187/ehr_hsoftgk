<template>
  <app-layout viewName="parkhfaeditview" viewTitle="考核对象" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'par-khfa-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ParKhfaEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ParKhfaEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {ParKhfaService}
     * @memberof ParKhfaEditViewBase
     */
    public appEntityService: ParKhfaService = new ParKhfaService;
	 ...
	 * @memberof ParKhfaEditViewBase
	 */
	public viewtag: string = 'a0562928c523c5554de86ca7cce6cf14';
     ...
     */
    public model: any = {
        srfCaption: 'entities.parkhfa.views.editview.caption',
        srfTitle: 'entities.parkhfa.views.editview.title',
        srfSubTitle: 'entities.parkhfa.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'parkhfa',
            majorPSDEField: 'parkhfaname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"ParKhfa");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"ParKhfa");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Exit(datas, contextJO,paramJO,  $event, xData,this,"ParKhfa");
    }
...
<style lang='less'>
@import './par-khfa-edit-view.less';
</style>