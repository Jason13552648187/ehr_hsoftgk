<template>
  <app-layout viewName="parjxjgkhdjeditview" viewTitle="绩效考核定级" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'par-jxjg-khdjedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ParJxjgKHDJEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ParJxjgKHDJEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {ParJxjgService}
     * @memberof ParJxjgKHDJEditViewBase
     */
    public appEntityService: ParJxjgService = new ParJxjgService;
	 ...
	 * @memberof ParJxjgKHDJEditViewBase
	 */
	public viewtag: string = 'a97ed731f303a44f10abb4df79b7bfc5';
     ...
     */
    public model: any = {
        srfCaption: 'entities.parjxjg.views.khdjeditview.caption',
        srfTitle: 'entities.parjxjg.views.khdjeditview.title',
        srfSubTitle: 'entities.parjxjg.views.khdjeditview.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'parjxjg',
            majorPSDEField: 'parjxjgname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"ParJxjg");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"ParJxjg");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"ParJxjg");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"ParJxjg");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"ParJxjg");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"ParJxjg");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"ParJxjg");
    }
...
<style lang='less'>
@import './par-jxjg-khdjedit-view.less';
</style>