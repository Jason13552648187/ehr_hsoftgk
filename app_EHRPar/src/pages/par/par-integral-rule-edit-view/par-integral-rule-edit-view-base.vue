<template>
  <app-layout viewName="parintegralruleeditview" viewTitle="积分规则" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'par-integral-rule-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ParIntegralRuleEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ParIntegralRuleEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {ParIntegralRuleService}
     * @memberof ParIntegralRuleEditViewBase
     */
    public appEntityService: ParIntegralRuleService = new ParIntegralRuleService;
	 ...
	 * @memberof ParIntegralRuleEditViewBase
	 */
	public viewtag: string = '02139952c2ac2e90cbc2d5712c5ded50';
     ...
     */
    public model: any = {
        srfCaption: 'entities.parintegralrule.views.editview.caption',
        srfTitle: 'entities.parintegralrule.views.editview.title',
        srfSubTitle: 'entities.parintegralrule.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof ParIntegralRuleEditView
     */
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'parintegralrule',
            majorPSDEField: 'parintegralrulename',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"ParIntegralRule");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"ParIntegralRule");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Exit(datas, contextJO,paramJO,  $event, xData,this,"ParIntegralRule");
    }
...
<style lang='less'>
@import './par-integral-rule-edit-view.less';
</style>