    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('pm')">
                <el-table-column show-overflow-tooltip :prop="'pm'" :label="$t('entities.parjxjg.khpgdj_grid.columns.pm')" :width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.parjxjg.khpgdj_grid.columns.pm')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('yg')">
                <el-table-column show-overflow-tooltip :prop="'yg'" :label="$t('entities.parjxjg.khpgdj_grid.columns.yg')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.parjxjg.khpgdj_grid.columns.yg')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.yg}}</span>
            ...
            <template v-if="getColumnState('nd')">
                <el-table-column show-overflow-tooltip :prop="'nd'" :label="$t('entities.parjxjg.khpgdj_grid.columns.nd')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.parjxjg.khpgdj_grid.columns.nd')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('khlx')">
                <el-table-column show-overflow-tooltip :prop="'khlx'" :label="$t('entities.parjxjg.khpgdj_grid.columns.khlx')" :width="250"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.parjxjg.khpgdj_grid.columns.khlx')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('zz')">
                <el-table-column show-overflow-tooltip :prop="'zz'" :label="$t('entities.parjxjg.khpgdj_grid.columns.zz')" :width="270"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.parjxjg.khpgdj_grid.columns.zz')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.zz}}</span>
            ...
            <template v-if="getColumnState('bm')">
                <el-table-column show-overflow-tooltip :prop="'bm'" :label="$t('entities.parjxjg.khpgdj_grid.columns.bm')" :width="130"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.parjxjg.khpgdj_grid.columns.bm')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.bm}}</span>
            ...
            <template v-if="getColumnState('zf')">
                <el-table-column show-overflow-tooltip :prop="'zf'" :label="$t('entities.parjxjg.khpgdj_grid.columns.zf')" :width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.parjxjg.khpgdj_grid.columns.zf')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                            <app-format-data dataType="FLOAT" precision="0" :data="row.zf"></app-format-data>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('khpgdj')">
                <el-table-column show-overflow-tooltip :prop="'khpgdj'" :label="$t('entities.parjxjg.khpgdj_grid.columns.khpgdj')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.parjxjg.khpgdj_grid.columns.khpgdj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.khpgdj" tag='EhrCodeList0005' codelistType='STATIC' ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
...
import KHPGDJService from './khpgdj-grid-service';
...
export default class KHPGDJBase extends Vue implements ControlInterface {
     ...
     * @memberof KHPGDJBase
     */
    public service: KHPGDJService = new KHPGDJService({ $store: this.$store });
     ...
     * @memberof KHPGDJBase
     */
    public minorSortPSDEF: string = 'pm';
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'pm',
            label: '排名',
            langtag: 'entities.parjxjg.khpgdj_grid.columns.pm',
            show: true,
            util: 'PX'
        },
        {
            name: 'yg',
            label: '员工',
            langtag: 'entities.parjxjg.khpgdj_grid.columns.yg',
            show: true,
            util: 'PX'
        },
        {
            name: 'nd',
            label: '考核年度',
            langtag: 'entities.parjxjg.khpgdj_grid.columns.nd',
            show: true,
            util: 'px'
        },
        {
            name: 'khlx',
            label: '考核对象',
            langtag: 'entities.parjxjg.khpgdj_grid.columns.khlx',
            show: true,
            util: 'PX'
        },
        {
            name: 'zz',
            label: '组织',
            langtag: 'entities.parjxjg.khpgdj_grid.columns.zz',
            show: true,
            util: 'PX'
        },
        {
            name: 'bm',
            label: '部门',
            langtag: 'entities.parjxjg.khpgdj_grid.columns.bm',
            show: true,
            util: 'PX'
        },
        {
            name: 'zf',
            label: '总分',
            langtag: 'entities.parjxjg.khpgdj_grid.columns.zf',
            show: true,
            util: 'PX'
        },
        {
            name: 'khpgdj',
            label: '考核定级',
            langtag: 'entities.parjxjg.khpgdj_grid.columns.khpgdj',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public rules: any = {
        srfkey: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '绩效结果标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '绩效结果标识 值不能为空', trigger: 'blur' },
        ],
    }
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'ParJxjgJXPGDJGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'ParJxjgJXPGDJGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        _datas.forEach((record: any, index: number) => {
            let srfmajortext = record.parjxjgname;
            if (index < 5) {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ parjxjg: _keys }),Object.assign({ parjxjg: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.parjxjg,$event.parjxjg);
        });
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('parjxjg_khpgdj_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('parjxjg_khpgdj_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'ParJxjgJXPGDJGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'ParJxjgJXPGDJGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.parjxjg){
                            Object.assign(this.context,{parjxjg:item.parjxjg});
                        }
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'ParJxjgJXPGDJGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
    ...
    public getRowClassName(args:{row: any,rowIndex: number}){
        let isSelected = this.selections.some((item:any)=>{
            return Object.is(item.parjxjg,args.row.parjxjg);
        });
