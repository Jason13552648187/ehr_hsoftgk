...
<div class='grid' style="height:100%;">
    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('mblx')">
                <el-table-column show-overflow-tooltip :prop="'mblx'" :label="$t('entities.parldndlhmbmx.ndlhmbkhmx_jzszps_grid.columns.mblx')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.parldndlhmbmx.ndlhmbkhmx_jzszps_grid.columns.mblx')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.mblx" tag='EhrCodeList0199' codelistType='STATIC' ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('parldndlhmbmxname')">
                <el-table-column show-overflow-tooltip :prop="'parldndlhmbmxname'" :label="$t('entities.parldndlhmbmx.ndlhmbkhmx_jzszps_grid.columns.parldndlhmbmxname')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.parldndlhmbmx.ndlhmbkhmx_jzszps_grid.columns.parldndlhmbmxname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.parldndlhmbmxname}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('mblhyq')">
                <el-table-column show-overflow-tooltip :prop="'mblhyq'" :label="$t('entities.parldndlhmbmx.ndlhmbkhmx_jzszps_grid.columns.mblhyq')" :width="300"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.parldndlhmbmx.ndlhmbkhmx_jzszps_grid.columns.mblhyq')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.mblhyq}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('fz')">
                <el-table-column show-overflow-tooltip :prop="'fz'" :label="$t('entities.parldndlhmbmx.ndlhmbkhmx_jzszps_grid.columns.fz')" :width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.parldndlhmbmx.ndlhmbkhmx_jzszps_grid.columns.fz')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                            <app-format-data dataType="FLOAT" precision="1" :data="row.fz"></app-format-data>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('khbf')">
                <el-table-column show-overflow-tooltip :prop="'khbf'" :label="$t('entities.parldndlhmbmx.ndlhmbkhmx_jzszps_grid.columns.khbf')" :width="300"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.parldndlhmbmx.ndlhmbkhmx_jzszps_grid.columns.khbf')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.khbf}}</span>
            ...
            <template v-if="getColumnState('wcqk')">
                <el-table-column show-overflow-tooltip :prop="'wcqk'" :label="$t('entities.parldndlhmbmx.ndlhmbkhmx_jzszps_grid.columns.wcqk')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.parldndlhmbmx.ndlhmbkhmx_jzszps_grid.columns.wcqk')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.wcqk}}</span>
            ...
            <template v-if="getColumnState('zpfs')">
                <el-table-column show-overflow-tooltip :prop="'zpfs'" :label="$t('entities.parldndlhmbmx.ndlhmbkhmx_jzszps_grid.columns.zpfs')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.parldndlhmbmx.ndlhmbkhmx_jzszps_grid.columns.zpfs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                            <app-format-data dataType="FLOAT" precision="1" :data="row.zpfs"></app-format-data>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('fgldpf')">
                <el-table-column show-overflow-tooltip :prop="'fgldpf'" :label="$t('entities.parldndlhmbmx.ndlhmbkhmx_jzszps_grid.columns.fgldpf')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.parldndlhmbmx.ndlhmbkhmx_jzszps_grid.columns.fgldpf')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                            <app-format-data dataType="FLOAT" precision="1" :data="row.fgldpf"></app-format-data>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('jzszpsfs')">
                <el-table-column show-overflow-tooltip :prop="'jzszpsfs'" :label="$t('entities.parldndlhmbmx.ndlhmbkhmx_jzszps_grid.columns.jzszpsfs')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.parldndlhmbmx.ndlhmbkhmx_jzszps_grid.columns.jzszpsfs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                            <app-format-data dataType="FLOAT" precision="1" :data="row.jzszpsfs"></app-format-data>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('spzt')">
                <el-table-column show-overflow-tooltip :prop="'spzt'" :label="$t('entities.parldndlhmbmx.ndlhmbkhmx_jzszps_grid.columns.spzt')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.parldndlhmbmx.ndlhmbkhmx_jzszps_grid.columns.spzt')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.spzt" tag='EhrCodeList0209' codelistType='STATIC' ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
...
import NDLHMBKHMX_JZSZPSService from './ndlhmbkhmx-jzszps-grid-service';
...
export default class NDLHMBKHMX_JZSZPSBase extends Vue implements ControlInterface {
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'mblx',
            label: '目标类型',
            langtag: 'entities.parldndlhmbmx.ndlhmbkhmx_jzszps_grid.columns.mblx',
            show: true,
            util: 'PX'
        },
        {
            ...
            label: '量化目标',
            langtag: 'entities.parldndlhmbmx.ndlhmbkhmx_jzszps_grid.columns.parldndlhmbmxname',
            show: true,
            util: 'PX'
        },
        {
            name: 'mblhyq',
            label: '目标量化要求',
            langtag: 'entities.parldndlhmbmx.ndlhmbkhmx_jzszps_grid.columns.mblhyq',
            show: true,
            util: 'PX'
        },
        {
            name: 'fz',
            label: '分值',
            langtag: 'entities.parldndlhmbmx.ndlhmbkhmx_jzszps_grid.columns.fz',
            show: true,
            util: 'PX'
        },
        {
            name: 'khbf',
            label: '考核办法',
            langtag: 'entities.parldndlhmbmx.ndlhmbkhmx_jzszps_grid.columns.khbf',
            show: true,
            util: 'PX'
        },
        {
            name: 'wcqk',
            label: '完成情况',
            langtag: 'entities.parldndlhmbmx.ndlhmbkhmx_jzszps_grid.columns.wcqk',
            show: true,
            util: 'px'
        },
        {
            name: 'zpfs',
            label: '自评分数',
            langtag: 'entities.parldndlhmbmx.ndlhmbkhmx_jzszps_grid.columns.zpfs',
            show: true,
            util: 'px'
        },
        {
            name: 'fgldpf',
            label: '分管领导评分',
            langtag: 'entities.parldndlhmbmx.ndlhmbkhmx_jzszps_grid.columns.fgldpf',
            show: true,
            util: 'px'
        },
        {
            name: 'jzszpsfs',
            label: '集中述职评审分数',
            langtag: 'entities.parldndlhmbmx.ndlhmbkhmx_jzszps_grid.columns.jzszpsfs',
            show: true,
            util: 'PX'
        },
        {
            name: 'spzt',
            label: '审批状态',
            langtag: 'entities.parldndlhmbmx.ndlhmbkhmx_jzszps_grid.columns.spzt',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public rules: any = {
        srfkey: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '量化目标明细标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '量化目标明细标识 值不能为空', trigger: 'blur' },
        ],
    }
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'ParLdndlhmbmxKHGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'ParLdndlhmbmxKHGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        _datas.forEach((record: any, index: number) => {
            let srfmajortext = record.parldndlhmbmxname;
            if (index < 5) {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ parldndlhmbmx: _keys }),Object.assign({ parldndlhmbmx: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
        ...
        const doExport = async (_data:any) => {
            ...
            this.$export.exportExcel().then((excel:any)=>{
                excel.export_json_to_excel({
                  ...
                  data, //具体数据 必填
                  filename: "年度量化目标明细（助理总经理级 ）表", //非必填
                  autoWidth: true, //非必填
                  bookType: "xlsx" //非必填
                });
            }); 
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.parldndlhmbmx,$event.parldndlhmbmx);
        });
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('parldndlhmbmx_ndlhmbkhmx_jzszps_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('parldndlhmbmx_ndlhmbkhmx_jzszps_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'ParLdndlhmbmxKHGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'ParLdndlhmbmxKHGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.parldndlhmbmx){
                            Object.assign(this.context,{parldndlhmbmx:item.parldndlhmbmx});
                        }
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'ParLdndlhmbmxKHGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
    ...
    public getRowClassName(args:{row: any,rowIndex: number}){
        let isSelected = this.selections.some((item:any)=>{
            return Object.is(item.parldndlhmbmx,args.row.parldndlhmbmx);
        });
...
<style lang='less'>
@import './ndlhmbkhmx-jzszps-grid.less';
</style>