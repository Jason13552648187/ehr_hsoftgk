    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('xh')">
                <el-table-column show-overflow-tooltip :prop="'xh'" :label="$t('entities.parjxkhxhz.ygkhx_grid.columns.xh')" :width="80"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.parjxkhxhz.ygkhx_grid.columns.xh')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('khlx')">
                <el-table-column show-overflow-tooltip :prop="'khlx'" :label="$t('entities.parjxkhxhz.ygkhx_grid.columns.khlx')" :width="170"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.parjxkhxhz.ygkhx_grid.columns.khlx')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.khlx" tag='EhrCodeList0015' codelistType='DYNAMIC' renderMode="STR" valueSeparator=";" textSeparator="、" ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('yg')">
                <el-table-column show-overflow-tooltip :prop="'yg'" :label="$t('entities.parjxkhxhz.ygkhx_grid.columns.yg')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.parjxkhxhz.ygkhx_grid.columns.yg')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.yg}}</span>
            ...
            <template v-if="getColumnState('zz')">
                <el-table-column show-overflow-tooltip :prop="'zz'" :label="$t('entities.parjxkhxhz.ygkhx_grid.columns.zz')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.parjxkhxhz.ygkhx_grid.columns.zz')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.zz}}</span>
            ...
            <template v-if="getColumnState('bm')">
                <el-table-column show-overflow-tooltip :prop="'bm'" :label="$t('entities.parjxkhxhz.ygkhx_grid.columns.bm')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.parjxkhxhz.ygkhx_grid.columns.bm')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.bm}}</span>
            ...
            <template v-if="getColumnState('gzjx')">
                <el-table-column show-overflow-tooltip :prop="'gzjx'" :label="$t('entities.parjxkhxhz.ygkhx_grid.columns.gzjx')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.parjxkhxhz.ygkhx_grid.columns.gzjx')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                            <app-format-data dataType="FLOAT" precision="1" :data="row.gzjx"></app-format-data>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('jswmjc')">
                <el-table-column show-overflow-tooltip :prop="'jswmjc'" :label="$t('entities.parjxkhxhz.ygkhx_grid.columns.jswmjc')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.parjxkhxhz.ygkhx_grid.columns.jswmjc')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                            <app-format-data dataType="FLOAT" precision="1" :data="row.jswmjc"></app-format-data>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('ywnlks')">
                <el-table-column show-overflow-tooltip :prop="'ywnlks'" :label="$t('entities.parjxkhxhz.ygkhx_grid.columns.ywnlks')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.parjxkhxhz.ygkhx_grid.columns.ywnlks')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                            <app-format-data dataType="FLOAT" precision="1" :data="row.ywnlks"></app-format-data>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('gznljtd')">
                <el-table-column show-overflow-tooltip :prop="'gznljtd'" :label="$t('entities.parjxkhxhz.ygkhx_grid.columns.gznljtd')" :width="230"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.parjxkhxhz.ygkhx_grid.columns.gznljtd')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                            <app-format-data dataType="FLOAT" precision="1" :data="row.gznljtd"></app-format-data>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('gznljtd_xbn')">
                <el-table-column show-overflow-tooltip :prop="'gznljtd_xbn'" :label="$t('entities.parjxkhxhz.ygkhx_grid.columns.gznljtd_xbn')" :width="230"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.parjxkhxhz.ygkhx_grid.columns.gznljtd_xbn')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                            <app-format-data dataType="FLOAT" precision="1" :data="row.gznljtd_xbn"></app-format-data>
                    </template>
                </el-table-column>
            </template>
...
import YGKHXService from './ygkhx-grid-service';
...
export default class YGKHXBase extends Vue implements ControlInterface {
     ...
     * @memberof YGKHX
     */
    public service: YGKHXService = new YGKHXService({ $store: this.$store });
     ...
     * @memberof YGKHX
     */
    public appEntityService: ParJxkhxhzService = new ParJxkhxhzService({ $store: this.$store });
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'xh',
            label: '排序号',
            langtag: 'entities.parjxkhxhz.ygkhx_grid.columns.xh',
            show: true,
            util: 'PX'
        },
        {
            name: 'khlx',
            label: '考核对象',
            langtag: 'entities.parjxkhxhz.ygkhx_grid.columns.khlx',
            show: true,
            util: 'PX'
        },
        {
            name: 'yg',
            label: '员工',
            langtag: 'entities.parjxkhxhz.ygkhx_grid.columns.yg',
            show: true,
            util: 'PX'
        },
        {
            name: 'zz',
            label: '所属组织',
            langtag: 'entities.parjxkhxhz.ygkhx_grid.columns.zz',
            show: true,
            util: 'PX'
        },
        {
            name: 'bm',
            label: '部门',
            langtag: 'entities.parjxkhxhz.ygkhx_grid.columns.bm',
            show: true,
            util: 'PX'
        },
        {
            name: 'gzjx',
            label: '年度量化目标（工作述职）',
            langtag: 'entities.parjxkhxhz.ygkhx_grid.columns.gzjx',
            show: true,
            util: 'PX'
        },
        {
            name: 'jswmjc',
            label: '月度考核',
            langtag: 'entities.parjxkhxhz.ygkhx_grid.columns.jswmjc',
            show: true,
            util: 'PX'
        },
        {
            name: 'ywnlks',
            label: '工作周报考核',
            langtag: 'entities.parjxkhxhz.ygkhx_grid.columns.ywnlks',
            show: true,
            util: 'PX'
        },
        {
            name: 'gznljtd',
            label: '工作能力及态度评价（上半年）',
            langtag: 'entities.parjxkhxhz.ygkhx_grid.columns.gznljtd',
            show: true,
            util: 'PX'
        },
        {
            name: 'gznljtd_xbn',
            label: '工作能力及态度评价（下半年）',
            langtag: 'entities.parjxkhxhz.ygkhx_grid.columns.gznljtd_xbn',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public rules: any = {
        srfkey: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '绩效考核项得分汇总标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '绩效考核项得分汇总标识 值不能为空', trigger: 'blur' },
        ],
    }
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'ParJxkhxhzYGKHXGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'ParJxkhxhzYGKHXGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        _datas.forEach((record: any, index: number) => {
            let srfmajortext = record.parjxkhxhzname;
            if (index < 5) {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ parjxkhxhz: _keys }),Object.assign({ parjxkhxhz: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.parjxkhxhz,$event.parjxkhxhz);
        });
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('parjxkhxhz_ygkhx_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('parjxkhxhz_ygkhx_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'ParJxkhxhzYGKHXGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'ParJxkhxhzYGKHXGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.parjxkhxhz){
                            Object.assign(this.context,{parjxkhxhz:item.parjxkhxhz});
                        }
    ...
    public getRowClassName(args:{row: any,rowIndex: number}){
        let isSelected = this.selections.some((item:any)=>{
            return Object.is(item.parjxkhxhz,args.row.parjxkhxhz);
        });
