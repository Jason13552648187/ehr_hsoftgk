    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('xh')">
                <el-table-column show-overflow-tooltip :prop="'xh'" :label="$t('entities.parjxkhxhz.main_grid.columns.xh')" :width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.parjxkhxhz.main_grid.columns.xh')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('yg')">
                <el-table-column show-overflow-tooltip :prop="'yg'" :label="$t('entities.parjxkhxhz.main_grid.columns.yg')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.parjxkhxhz.main_grid.columns.yg')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.yg}}</span>
            ...
            <template v-if="getColumnState('zz')">
                <el-table-column show-overflow-tooltip :prop="'zz'" :label="$t('entities.parjxkhxhz.main_grid.columns.zz')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.parjxkhxhz.main_grid.columns.zz')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.zz}}</span>
            ...
            <template v-if="getColumnState('bm')">
                <el-table-column show-overflow-tooltip :prop="'bm'" :label="$t('entities.parjxkhxhz.main_grid.columns.bm')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.parjxkhxhz.main_grid.columns.bm')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.bm}}</span>
            ...
            <template v-if="getColumnState('parassesstemplatename')">
                <el-table-column show-overflow-tooltip :prop="'parassesstemplatename'" :label="$t('entities.parjxkhxhz.main_grid.columns.parassesstemplatename')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.parjxkhxhz.main_grid.columns.parassesstemplatename')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('nd')">
                <el-table-column show-overflow-tooltip :prop="'nd'" :label="$t('entities.parjxkhxhz.main_grid.columns.nd')" :width="130"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.parjxkhxhz.main_grid.columns.nd')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'xh',
            label: '排序',
            langtag: 'entities.parjxkhxhz.main_grid.columns.xh',
            show: true,
            util: 'PX'
        },
        {
            name: 'yg',
            label: '员工',
            langtag: 'entities.parjxkhxhz.main_grid.columns.yg',
            show: true,
            util: 'PX'
        },
        {
            name: 'zz',
            label: '所属组织',
            langtag: 'entities.parjxkhxhz.main_grid.columns.zz',
            show: true,
            util: 'PX'
        },
        {
            name: 'bm',
            label: '部门',
            langtag: 'entities.parjxkhxhz.main_grid.columns.bm',
            show: true,
            util: 'PX'
        },
        {
            ...
            label: '考核模板',
            langtag: 'entities.parjxkhxhz.main_grid.columns.parassesstemplatename',
            show: true,
            util: 'PX'
        },
        {
            name: 'nd',
            label: '年度',
            langtag: 'entities.parjxkhxhz.main_grid.columns.nd',
            show: true,
            util: 'PX'
        },
    ]
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('parjxkhxhz_main_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('parjxkhxhz_main_grid', JSON.stringify(this.allColumns));
    }
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'ParJxkhxhzYGKHXGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
