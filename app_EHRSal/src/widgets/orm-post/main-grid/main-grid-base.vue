    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('xh')">
                <el-table-column show-overflow-tooltip :prop="'xh'" :label="$t('entities.ormpost.main_grid.columns.xh')" :width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.ormpost.main_grid.columns.xh')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('ormpostname')">
                <el-table-column show-overflow-tooltip :prop="'ormpostname'" :label="$t('entities.ormpost.main_grid.columns.ormpostname')" :width="240"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.ormpost.main_grid.columns.ormpostname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('gwfl')">
                <el-table-column show-overflow-tooltip :prop="'gwfl'" :label="$t('entities.ormpost.main_grid.columns.gwfl')" :width="150"  :align="'left'" :sortable="'custom'">
                    ...
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.gwfl" tag='EhrCodeList0073' codelistType='STATIC' ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('nx')">
                <el-table-column show-overflow-tooltip :prop="'nx'" :label="$t('entities.ormpost.main_grid.columns.nx')" :width="140"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.ormpost.main_grid.columns.nx')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
                                <app-span name='nx' editorType="TEXTBOX" :value="row.nx"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('bxjlnx')">
                <el-table-column show-overflow-tooltip :prop="'bxjlnx'" :label="$t('entities.ormpost.main_grid.columns.bxjlnx')" :width="140"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.ormpost.main_grid.columns.bxjlnx')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
                                <app-span name='bxjlnx' editorType="TEXTBOX" :value="row.bxjlnx"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('isconfidential')">
                <el-table-column show-overflow-tooltip :prop="'isconfidential'" :label="$t('entities.ormpost.main_grid.columns.isconfidential')" :width="130"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.ormpost.main_grid.columns.isconfidential')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('postnature')">
                <el-table-column show-overflow-tooltip :prop="'postnature'" :label="$t('entities.ormpost.main_grid.columns.postnature')" :width="130"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.ormpost.main_grid.columns.postnature')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('iskeypostion')">
                <el-table-column show-overflow-tooltip :prop="'iskeypostion'" :label="$t('entities.ormpost.main_grid.columns.iskeypostion')" :width="140"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.ormpost.main_grid.columns.iskeypostion')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.iskeypostion" tag='EhrCodeList0097' codelistType='STATIC' ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('startstopsign')">
                <el-table-column show-overflow-tooltip :prop="'startstopsign'" :label="$t('entities.ormpost.main_grid.columns.startstopsign')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.ormpost.main_grid.columns.startstopsign')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.startstopsign" tag='EhrCodeList0086' codelistType='STATIC' ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof MainBase
     */
    public minorSortPSDEF: string = 'xh';
    ...
    */
    ...
    public allColumns: any[] = [
        ...
        },
        {
            name: 'nx',
            label: '建议交流年限',
            langtag: 'entities.ormpost.main_grid.columns.nx',
            show: true,
            util: 'PX'
        },
        {
            name: 'bxjlnx',
            label: '必须交流年限',
            langtag: 'entities.ormpost.main_grid.columns.bxjlnx',
            show: true,
            util: 'PX'
        },
        {
            name: 'isconfidential',
            label: '是否保密岗',
            langtag: 'entities.ormpost.main_grid.columns.isconfidential',
            show: true,
            util: 'PX'
        },
        {
            name: 'postnature',
            label: '岗位性质',
            langtag: 'entities.ormpost.main_grid.columns.postnature',
            show: true,
            util: 'PX'
        },
        {
            name: 'iskeypostion',
            label: '是否关键岗位',
            langtag: 'entities.ormpost.main_grid.columns.iskeypostion',
            show: true,
            util: 'PX'
        },
        {
            name: 'startstopsign',
            label: '启用标识',
            langtag: 'entities.ormpost.main_grid.columns.startstopsign',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public getGridRowModel(){
        return {
          startstopsign: new FormItemModel(),
          xh: new FormItemModel(),
          iskeypostion: new FormItemModel(),
    ...
    public rules: any = {
        startstopsign: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '启用标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '启用标识 值不能为空', trigger: 'blur' },
        ],
        xh: [
        ...
        iskeypostion: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '是否关键岗位 值不能为空', trigger: 'change' },
        ...
        gwfl: [
            ...
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '岗位分类 值不能为空', trigger: 'blur' },
        ],
        bxjlnx: [
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'OrmPostPickupGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'OrmPostPickupGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        _datas.forEach((record: any, index: number) => {
            let srfmajortext = record.ormpostname;
            if (index < 5) {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ ormpost: _keys }),Object.assign({ ormpost: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.ormpost,$event.ormpost);
        });
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('ormpost_main_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('ormpost_main_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'OrmPostPickupGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'OrmPostPickupGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.ormpost){
                            Object.assign(this.context,{ormpost:item.ormpost});
                        }
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'OrmPostPickupGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
    ...
    public getRowClassName(args:{row: any,rowIndex: number}){
        let isSelected = this.selections.some((item:any)=>{
            return Object.is(item.ormpost,args.row.ormpost);
        });
    ...
    public createDefault(row: any){                    
        if (row.hasOwnProperty('startstopsign')) {
            row['startstopsign'] = '1';
        }
