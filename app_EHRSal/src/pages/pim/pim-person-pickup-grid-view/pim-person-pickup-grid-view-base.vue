...
export default class PimPersonPickupGridViewBase extends PickupViewBase {
	 ...
	 * @memberof PimPersonPickupGridViewBase
	 */
	public viewtag: string = 'd44ef037d312d50fd58de9dec03f4df7';
...
<style lang='less'>
@import './pim-person-pickup-grid-view.less';
</style>