<template>
  <app-layout viewName="salstdzceditview" viewTitle="职称类别标准编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'sal-stdzc-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class SalStdzcEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalStdzcEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalStdzcService}
     * @memberof SalStdzcEditViewBase
     */
    public appEntityService: SalStdzcService = new SalStdzcService;
	 ...
	 * @memberof SalStdzcEditViewBase
	 */
	public viewtag: string = '98d4615a066ecb708dc968b8dc6fdbec';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salstdzc.views.editview.caption',
        srfTitle: 'entities.salstdzc.views.editview.title',
        srfSubTitle: 'entities.salstdzc.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'salstdzc',
            majorPSDEField: 'salstdzcname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"SalStdzc");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"SalStdzc");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SalStdzc");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SalStdzc");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"SalStdzc");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"SalStdzc");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"SalStdzc");
    }
...
<style lang='less'>
@import './sal-stdzc-edit-view.less';
</style>