<template>
  <app-layout viewName="salsalarydetaileditview" viewTitle="员工薪酬明细编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'sal-salary-detail-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class SalSalaryDetailEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalSalaryDetailEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalSalaryDetailService}
     * @memberof SalSalaryDetailEditViewBase
     */
    public appEntityService: SalSalaryDetailService = new SalSalaryDetailService;
	 ...
	 * @memberof SalSalaryDetailEditViewBase
	 */
	public viewtag: string = '03b0dabf4226d8cfd5f1debe7543a91e';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salsalarydetail.views.editview.caption',
        srfTitle: 'entities.salsalarydetail.views.editview.title',
        srfSubTitle: 'entities.salsalarydetail.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof SalSalaryDetailEditView
     */
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'salsalarydetail',
            majorPSDEField: 'salsalarydetailname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"SalSalaryDetail");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"SalSalaryDetail");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SalSalaryDetail");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SalSalaryDetail");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"SalSalaryDetail");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"SalSalaryDetail");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"SalSalaryDetail");
    }
...
<style lang='less'>
@import './sal-salary-detail-edit-view.less';
</style>