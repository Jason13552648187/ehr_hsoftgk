<template>
  <app-layout viewName="salstdzyzgeditview" viewTitle="执业资格津贴标准编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'sal-stdzyzg-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class SalStdzyzgEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalStdzyzgEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalStdzyzgService}
     * @memberof SalStdzyzgEditViewBase
     */
    public appEntityService: SalStdzyzgService = new SalStdzyzgService;
	 ...
	 * @memberof SalStdzyzgEditViewBase
	 */
	public viewtag: string = '51c361a6355fa02f0c659e4616fc63f9';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salstdzyzg.views.editview.caption',
        srfTitle: 'entities.salstdzyzg.views.editview.title',
        srfSubTitle: 'entities.salstdzyzg.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'salstdzyzg',
            majorPSDEField: 'salstdzyzgname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"SalStdzyzg");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"SalStdzyzg");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SalStdzyzg");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SalStdzyzg");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"SalStdzyzg");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"SalStdzyzg");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"SalStdzyzg");
    }
...
<style lang='less'>
@import './sal-stdzyzg-edit-view.less';
</style>