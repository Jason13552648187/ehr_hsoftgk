<template>
  <app-layout viewName="salschemeeditview" viewTitle="薪酬方案编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'sal-scheme-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class SalSchemeEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalSchemeEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalSchemeService}
     * @memberof SalSchemeEditViewBase
     */
    public appEntityService: SalSchemeService = new SalSchemeService;
	 ...
	 * @memberof SalSchemeEditViewBase
	 */
	public viewtag: string = '817ea8d9a018ecf1d3caad347cf1e09f';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salscheme.views.editview.caption',
        srfTitle: 'entities.salscheme.views.editview.title',
        srfSubTitle: 'entities.salscheme.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'salscheme',
            majorPSDEField: 'salschemename',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"SalScheme");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"SalScheme");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SalScheme");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SalScheme");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"SalScheme");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"SalScheme");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"SalScheme");
    }
...
<style lang='less'>
@import './sal-scheme-edit-view.less';
</style>