<template>
  <app-layout viewName="salstdzxeditview" viewTitle="专项津贴标准编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'sal-stdzx-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class SalStdzxEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalStdzxEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalStdzxService}
     * @memberof SalStdzxEditViewBase
     */
    public appEntityService: SalStdzxService = new SalStdzxService;
	 ...
	 * @memberof SalStdzxEditViewBase
	 */
	public viewtag: string = '17bf2d24b6ce28ffc40ec1650e067899';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salstdzx.views.editview.caption',
        srfTitle: 'entities.salstdzx.views.editview.title',
        srfSubTitle: 'entities.salstdzx.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'salstdzx',
            majorPSDEField: 'salstdzxname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"SalStdzx");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"SalStdzx");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SalStdzx");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SalStdzx");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"SalStdzx");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"SalStdzx");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"SalStdzx");
    }
...
<style lang='less'>
@import './sal-stdzx-edit-view.less';
</style>