<template>
  <app-layout viewName="salitemeditview" viewTitle="薪酬要素项编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'sal-item-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class SalItemEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalItemEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalItemService}
     * @memberof SalItemEditViewBase
     */
	 ...
	 * @memberof SalItemEditViewBase
	 */
	public viewtag: string = 'f8c313ecc86037a3c52c2d5322717e43';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salitem.views.editview.caption',
        srfTitle: 'entities.salitem.views.editview.title',
        srfSubTitle: 'entities.salitem.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"SalItem");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"SalItem");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SalItem");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SalItem");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"SalItem");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"SalItem");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"SalItem");
    }
...
<style lang='less'>
@import './sal-item-edit-view.less';
</style>