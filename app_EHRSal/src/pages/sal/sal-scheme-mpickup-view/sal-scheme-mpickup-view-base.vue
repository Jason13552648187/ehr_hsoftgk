<template>
  <app-layout viewName="salschemempickupview" viewTitle="薪酬方案数据多项选择视图" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'dempickupview': true, 'sal-scheme-mpickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class SalSchemeMPickupViewBase
 * @extends {MPickupViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalSchemeMPickupViewBase extends MPickupViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalSchemeService}
     * @memberof SalSchemeMPickupViewBase
     */
	 ...
	 * @memberof SalSchemeMPickupViewBase
	 */
	public viewtag: string = 'a63122cb1dbda97282ba0741f9859ef4';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salscheme.views.mpickupview.caption',
        srfTitle: 'entities.salscheme.views.mpickupview.title',
        srfSubTitle: 'entities.salscheme.views.mpickupview.subtitle',
        dataInfo: ''
    }
        ...
        Object.values(this.containerModel).forEach((model: any) => {
            ...
            if(model.datas.length>0){
                model.datas.forEach((data:any,index:any)=>{
                    Object.assign(data,{srfmajortext: data['salschemename']});
                })
            }
...
<style lang='less'>
@import './sal-scheme-mpickup-view.less';
</style>