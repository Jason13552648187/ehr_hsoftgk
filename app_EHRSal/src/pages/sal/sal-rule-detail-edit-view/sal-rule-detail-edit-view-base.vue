<template>
  <app-layout viewName="salruledetaileditview" viewTitle="薪酬规则明细编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'sal-rule-detail-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class SalRuleDetailEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalRuleDetailEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalRuleDetailService}
     * @memberof SalRuleDetailEditViewBase
     */
    public appEntityService: SalRuleDetailService = new SalRuleDetailService;
	 ...
	 * @memberof SalRuleDetailEditViewBase
	 */
	public viewtag: string = '3a0b5636f1cb242c9fac8211b31f9ddb';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salruledetail.views.editview.caption',
        srfTitle: 'entities.salruledetail.views.editview.title',
        srfSubTitle: 'entities.salruledetail.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof SalRuleDetailEditView
     */
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'salruledetail',
            majorPSDEField: 'salruledetailname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"SalRuleDetail");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"SalRuleDetail");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SalRuleDetail");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SalRuleDetail");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"SalRuleDetail");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"SalRuleDetail");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"SalRuleDetail");
    }
...
<style lang='less'>
@import './sal-rule-detail-edit-view.less';
</style>