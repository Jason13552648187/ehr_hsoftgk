<template>
  <app-layout viewName="salplaneditview" viewTitle="薪酬计算计划编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'sal-plan-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class SalPlanEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalPlanEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalPlanService}
     * @memberof SalPlanEditViewBase
     */
    public appEntityService: SalPlanService = new SalPlanService;
	 ...
	 * @memberof SalPlanEditViewBase
	 */
	public viewtag: string = 'd609da2973320af9f65ea17bd06be515';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salplan.views.editview.caption',
        srfTitle: 'entities.salplan.views.editview.title',
        srfSubTitle: 'entities.salplan.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'salplan',
            majorPSDEField: 'salplanname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"SalPlan");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"SalPlan");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SalPlan");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SalPlan");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"SalPlan");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"SalPlan");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"SalPlan");
    }
...
<style lang='less'>
@import './sal-plan-edit-view.less';
</style>