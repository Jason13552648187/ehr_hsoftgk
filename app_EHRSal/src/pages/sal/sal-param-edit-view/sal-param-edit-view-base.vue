<template>
  <app-layout viewName="salparameditview" viewTitle="薪酬计算指标编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'sal-param-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class SalParamEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalParamEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalParamService}
     * @memberof SalParamEditViewBase
     */
    public appEntityService: SalParamService = new SalParamService;
	 ...
	 * @memberof SalParamEditViewBase
	 */
	public viewtag: string = '42956c109010f0879a41dd3266e279a0';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salparam.views.editview.caption',
        srfTitle: 'entities.salparam.views.editview.title',
        srfSubTitle: 'entities.salparam.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'salparam',
            majorPSDEField: 'salparamname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"SalParam");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"SalParam");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SalParam");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SalParam");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"SalParam");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"SalParam");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"SalParam");
    }
...
<style lang='less'>
@import './sal-param-edit-view.less';
</style>