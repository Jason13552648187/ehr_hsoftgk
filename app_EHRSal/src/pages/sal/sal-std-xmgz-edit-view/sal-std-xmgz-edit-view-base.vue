<template>
  <app-layout viewName="salstdxmgzeditview" viewTitle="项目工资标准编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'sal-std-xmgz-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class SalStdXmgzEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalStdXmgzEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalStdXmgzService}
     * @memberof SalStdXmgzEditViewBase
     */
    public appEntityService: SalStdXmgzService = new SalStdXmgzService;
	 ...
	 * @memberof SalStdXmgzEditViewBase
	 */
	public viewtag: string = '37c011e01d93d713ab87c482aa2908e8';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salstdxmgz.views.editview.caption',
        srfTitle: 'entities.salstdxmgz.views.editview.title',
        srfSubTitle: 'entities.salstdxmgz.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'salstdxmgz',
            majorPSDEField: 'salstdxmgzname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"SalStdXmgz");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"SalStdXmgz");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SalStdXmgz");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SalStdXmgz");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"SalStdXmgz");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"SalStdXmgz");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"SalStdXmgz");
    }
...
<style lang='less'>
@import './sal-std-xmgz-edit-view.less';
</style>