<template>
  <app-layout viewName="salsalaryeditview" viewTitle="员工薪酬编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'sal-salary-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class SalSalaryEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalSalaryEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalSalaryService}
     * @memberof SalSalaryEditViewBase
     */
    public appEntityService: SalSalaryService = new SalSalaryService;
	 ...
	 * @memberof SalSalaryEditViewBase
	 */
	public viewtag: string = '8550c745e3b2fe38208ab9a48ac7ab97';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salsalary.views.editview.caption',
        srfTitle: 'entities.salsalary.views.editview.title',
        srfSubTitle: 'entities.salsalary.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'salsalary',
            majorPSDEField: 'salsalaryname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"SalSalary");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"SalSalary");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SalSalary");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SalSalary");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"SalSalary");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"SalSalary");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"SalSalary");
    }
...
<style lang='less'>
@import './sal-salary-edit-view.less';
</style>