<template>
  <app-layout viewName="salpersonstdeditview" viewTitle="员工薪酬标准编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'sal-person-std-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class SalPersonStdEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalPersonStdEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalPersonStdService}
     * @memberof SalPersonStdEditViewBase
     */
    public appEntityService: SalPersonStdService = new SalPersonStdService;
	 ...
	 * @memberof SalPersonStdEditViewBase
	 */
	public viewtag: string = 'cbdbf28aca33510bd1847738a9a58649';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salpersonstd.views.editview.caption',
        srfTitle: 'entities.salpersonstd.views.editview.title',
        srfSubTitle: 'entities.salpersonstd.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'salpersonstd',
            majorPSDEField: 'salpersonstdname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"SalPersonStd");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"SalPersonStd");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SalPersonStd");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SalPersonStd");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"SalPersonStd");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"SalPersonStd");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"SalPersonStd");
    }
...
<style lang='less'>
@import './sal-person-std-edit-view.less';
</style>