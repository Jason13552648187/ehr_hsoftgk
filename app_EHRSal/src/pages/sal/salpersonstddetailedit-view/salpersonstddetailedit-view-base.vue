<template>
  <app-layout viewName="salpersonstddetaileditview" viewTitle="员工薪酬标准明细编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'salpersonstddetailedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class SALPERSONSTDDETAILEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SALPERSONSTDDETAILEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {SALPERSONSTDDETAILService}
     * @memberof SALPERSONSTDDETAILEditViewBase
     */
    public appEntityService: SALPERSONSTDDETAILService = new SALPERSONSTDDETAILService;
	 ...
	 * @memberof SALPERSONSTDDETAILEditViewBase
	 */
	public viewtag: string = 'aeba780ecae8173357248fd20ba7ad9b';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salpersonstddetail.views.editview.caption',
        srfTitle: 'entities.salpersonstddetail.views.editview.title',
        srfSubTitle: 'entities.salpersonstddetail.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof SALPERSONSTDDETAILEditView
     */
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'salpersonstddetail',
            majorPSDEField: 'salpersonstddetailname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"SALPERSONSTDDETAIL");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"SALPERSONSTDDETAIL");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SALPERSONSTDDETAIL");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SALPERSONSTDDETAIL");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"SALPERSONSTDDETAIL");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"SALPERSONSTDDETAIL");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"SALPERSONSTDDETAIL");
    }
...
<style lang='less'>
@import './salpersonstddetailedit-view.less';
</style>