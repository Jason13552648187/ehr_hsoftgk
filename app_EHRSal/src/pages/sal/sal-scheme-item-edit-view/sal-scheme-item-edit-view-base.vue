<template>
  <app-layout viewName="salschemeitemeditview" viewTitle="方案要素项编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'sal-scheme-item-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class SalSchemeItemEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalSchemeItemEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalSchemeItemService}
     * @memberof SalSchemeItemEditViewBase
     */
    public appEntityService: SalSchemeItemService = new SalSchemeItemService;
	 ...
	 * @memberof SalSchemeItemEditViewBase
	 */
	public viewtag: string = 'df88a72f2eabeebc4e7f05de730938f2';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salschemeitem.views.editview.caption',
        srfTitle: 'entities.salschemeitem.views.editview.title',
        srfSubTitle: 'entities.salschemeitem.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof SalSchemeItemEditView
     */
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"SalSchemeItem");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"SalSchemeItem");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SalSchemeItem");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SalSchemeItem");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"SalSchemeItem");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"SalSchemeItem");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"SalSchemeItem");
    }
...
<style lang='less'>
@import './sal-scheme-item-edit-view.less';
</style>