<template>
  <app-layout viewName="salsourceeditview" viewTitle="薪酬计算源编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'sal-source-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class SalSourceEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalSourceEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalSourceService}
     * @memberof SalSourceEditViewBase
     */
    public appEntityService: SalSourceService = new SalSourceService;
	 ...
	 * @memberof SalSourceEditViewBase
	 */
	public viewtag: string = 'a0bfdd5660561dd0f43d46568a486269';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salsource.views.editview.caption',
        srfTitle: 'entities.salsource.views.editview.title',
        srfSubTitle: 'entities.salsource.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'salsource',
            majorPSDEField: 'salsourcename',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"SalSource");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"SalSource");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SalSource");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SalSource");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"SalSource");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"SalSource");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"SalSource");
    }
...
<style lang='less'>
@import './sal-source-edit-view.less';
</style>