<template>
  <app-layout viewName="saltypeeditview" viewTitle="薪酬类型编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'sal-type-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class SalTypeEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalTypeEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalTypeService}
     * @memberof SalTypeEditViewBase
     */
    public appEntityService: SalTypeService = new SalTypeService;
	 ...
	 * @memberof SalTypeEditViewBase
	 */
	public viewtag: string = '324016f50d34fa67d0292f68c636b19b';
     ...
     */
    public model: any = {
        srfCaption: 'entities.saltype.views.editview.caption',
        srfTitle: 'entities.saltype.views.editview.title',
        srfSubTitle: 'entities.saltype.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'saltype',
            majorPSDEField: 'saltypename',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"SalType");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"SalType");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SalType");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SalType");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"SalType");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"SalType");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"SalType");
    }
...
<style lang='less'>
@import './sal-type-edit-view.less';
</style>