<template>
  <app-layout viewName="salruleeditview" viewTitle="薪酬规则编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'sal-rule-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class SalRuleEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalRuleEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalRuleService}
     * @memberof SalRuleEditViewBase
     */
    public appEntityService: SalRuleService = new SalRuleService;
	 ...
	 * @memberof SalRuleEditViewBase
	 */
	public viewtag: string = '2f49a6f63db41f57072f028be1c29756';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salrule.views.editview.caption',
        srfTitle: 'entities.salrule.views.editview.title',
        srfSubTitle: 'entities.salrule.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'salrule',
            majorPSDEField: 'salrulename',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"SalRule");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"SalRule");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SalRule");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SalRule");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"SalRule");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"SalRule");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"SalRule");
    }
...
<style lang='less'>
@import './sal-rule-edit-view.less';
</style>