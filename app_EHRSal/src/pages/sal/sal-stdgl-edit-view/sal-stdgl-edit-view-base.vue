<template>
  <app-layout viewName="salstdgleditview" viewTitle="工龄工资标准编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'sal-stdgl-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class SalStdglEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SalStdglEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {SalStdglService}
     * @memberof SalStdglEditViewBase
     */
    public appEntityService: SalStdglService = new SalStdglService;
	 ...
	 * @memberof SalStdglEditViewBase
	 */
	public viewtag: string = '413a44b0e0559d300b5cc17d970f9978';
     ...
     */
    public model: any = {
        srfCaption: 'entities.salstdgl.views.editview.caption',
        srfTitle: 'entities.salstdgl.views.editview.title',
        srfSubTitle: 'entities.salstdgl.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'salstdgl',
            majorPSDEField: 'salstdglname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"SalStdgl");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"SalStdgl");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SalStdgl");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SalStdgl");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"SalStdgl");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"SalStdgl");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"SalStdgl");
    }
...
<style lang='less'>
@import './sal-stdgl-edit-view.less';
</style>