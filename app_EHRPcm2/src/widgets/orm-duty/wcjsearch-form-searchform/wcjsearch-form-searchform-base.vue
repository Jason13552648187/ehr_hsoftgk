    ...
    <i-col span="20" class="form-content">
      <row>
          ...
          <i-col v-show="detailsModel.n_fglx_like.visible" :style="{}"  :sm="{ span: 6, offset: 0 }" :md="{ span: 6, offset: 0 }" :lg="{ span: 6, offset: 0 }" :xl="{ span: 6, offset: 0 }">
              <app-form-item name='n_fglx_like' :itemRules="this.rules.n_fglx_like" class='' :caption="$t('entities.ormduty.wcjsearchform_searchform.details.n_fglx_like')" uiStyle="DEFAULT" :labelWidth="100" :isShowCaption="true" :error="detailsModel.n_fglx_like.error" :isEmptyCaption="false" labelPos="RIGHT"> 
...
export default class WCJSearchFormBase extends Vue implements ControlInterface {
...
<style lang='less'>
@import './wcjsearch-form-searchform.less';
</style>