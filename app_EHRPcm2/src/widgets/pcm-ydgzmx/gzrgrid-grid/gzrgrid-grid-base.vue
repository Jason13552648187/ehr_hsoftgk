    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('ygbh')">
                <el-table-column show-overflow-tooltip :prop="'ygbh'" :label="$t('entities.pcmydgzmx.gzrgrid_grid.columns.ygbh')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydgzmx.gzrgrid_grid.columns.ygbh')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('pimpersonname')">
                <el-table-column show-overflow-tooltip :prop="'pimpersonname'" :label="$t('entities.pcmydgzmx.gzrgrid_grid.columns.pimpersonname')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydgzmx.gzrgrid_grid.columns.pimpersonname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('zz')">
                <el-table-column show-overflow-tooltip :prop="'zz'" :label="$t('entities.pcmydgzmx.gzrgrid_grid.columns.zz')" :width="280"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydgzmx.gzrgrid_grid.columns.zz')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.zz}}</span>
            ...
            <template v-if="getColumnState('bm')">
                <el-table-column show-overflow-tooltip :prop="'bm'" :label="$t('entities.pcmydgzmx.gzrgrid_grid.columns.bm')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydgzmx.gzrgrid_grid.columns.bm')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.bm}}</span>
            ...
            <template v-if="getColumnState('yzw')">
                <el-table-column show-overflow-tooltip :prop="'yzw'" :label="$t('entities.pcmydgzmx.gzrgrid_grid.columns.yzw')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydgzmx.gzrgrid_grid.columns.yzw')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('ygw')">
                <el-table-column show-overflow-tooltip :prop="'ygw'" :label="$t('entities.pcmydgzmx.gzrgrid_grid.columns.ygw')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydgzmx.gzrgrid_grid.columns.ygw')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('wbzz')">
                <el-table-column show-overflow-tooltip :prop="'wbzz'" :label="$t('entities.pcmydgzmx.gzrgrid_grid.columns.wbzz')" :width="280"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydgzmx.gzrgrid_grid.columns.wbzz')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.wbzz}}</span>
            ...
            <template v-if="getColumnState('wwzzid')">
                <el-table-column show-overflow-tooltip :prop="'wwzzid'" :label="$t('entities.pcmydgzmx.gzrgrid_grid.columns.wwzzid')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydgzmx.gzrgrid_grid.columns.wwzzid')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('wbbm')">
                <el-table-column show-overflow-tooltip :prop="'wbbm'" :label="$t('entities.pcmydgzmx.gzrgrid_grid.columns.wbbm')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydgzmx.gzrgrid_grid.columns.wbbm')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.wbbm}}</span>
            ...
            <template v-if="getColumnState('wbzw')">
                <el-table-column show-overflow-tooltip :prop="'wbzw'" :label="$t('entities.pcmydgzmx.gzrgrid_grid.columns.wbzw')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydgzmx.gzrgrid_grid.columns.wbzw')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.wbzw}}</span>
            ...
            <template v-if="getColumnState('wbgw')">
                <el-table-column show-overflow-tooltip :prop="'wbgw'" :label="$t('entities.pcmydgzmx.gzrgrid_grid.columns.wbgw')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydgzmx.gzrgrid_grid.columns.wbgw')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.wbgw}}</span>
            ...
            <template v-if="getColumnState('ksrq')">
                <el-table-column show-overflow-tooltip :prop="'ksrq'" :label="$t('entities.pcmydgzmx.gzrgrid_grid.columns.ksrq')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydgzmx.gzrgrid_grid.columns.ksrq')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('jsrq')">
                <el-table-column show-overflow-tooltip :prop="'jsrq'" :label="$t('entities.pcmydgzmx.gzrgrid_grid.columns.jsrq')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydgzmx.gzrgrid_grid.columns.jsrq')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
...
import GZRGridService from './gzrgrid-grid-service';
...
export default class GZRGridBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof GZRGridBase
     */
     ...
     * @memberof GZRGridBase
     */
    public service: GZRGridService = new GZRGridService({ $store: this.$store });
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'ygbh',
            label: '员工编号',
            langtag: 'entities.pcmydgzmx.gzrgrid_grid.columns.ygbh',
            show: true,
            util: 'px'
        },
        {
            name: 'pimpersonname',
            label: '员工姓名',
            langtag: 'entities.pcmydgzmx.gzrgrid_grid.columns.pimpersonname',
            show: true,
            util: 'PX'
        },
        {
            name: 'zz',
            label: '挂职进组织',
            langtag: 'entities.pcmydgzmx.gzrgrid_grid.columns.zz',
            show: true,
            util: 'PX'
        },
        {
            name: 'bm',
            label: '挂职进部门',
            langtag: 'entities.pcmydgzmx.gzrgrid_grid.columns.bm',
            show: true,
            util: 'PX'
        },
        {
            name: 'yzw',
            label: '挂职进职务',
            langtag: 'entities.pcmydgzmx.gzrgrid_grid.columns.yzw',
            show: true,
            util: 'PX'
        },
        {
            name: 'ygw',
            label: '挂职进岗位',
            langtag: 'entities.pcmydgzmx.gzrgrid_grid.columns.ygw',
            show: true,
            util: 'PX'
        },
        {
            name: 'wbzz',
            label: '外部组织',
            langtag: 'entities.pcmydgzmx.gzrgrid_grid.columns.wbzz',
            show: true,
            util: 'PX'
        },
        {
            name: 'wwzzid',
            label: '组织机构代码',
            langtag: 'entities.pcmydgzmx.gzrgrid_grid.columns.wwzzid',
            show: true,
            util: 'PX'
        },
        {
            name: 'wbbm',
            label: '外部部门',
            langtag: 'entities.pcmydgzmx.gzrgrid_grid.columns.wbbm',
            show: true,
            util: 'PX'
        },
        {
            name: 'wbzw',
            label: '外部职务',
            langtag: 'entities.pcmydgzmx.gzrgrid_grid.columns.wbzw',
            show: true,
            util: 'PX'
        },
        {
            name: 'wbgw',
            label: '外部岗位',
            langtag: 'entities.pcmydgzmx.gzrgrid_grid.columns.wbgw',
            show: true,
            util: 'PX'
        },
        {
            name: 'ksrq',
            label: '挂职开始日期',
            langtag: 'entities.pcmydgzmx.gzrgrid_grid.columns.ksrq',
            show: true,
            util: 'px'
        },
        {
            name: 'jsrq',
            label: '挂职结束日期',
            langtag: 'entities.pcmydgzmx.gzrgrid_grid.columns.jsrq',
            show: true,
            util: 'px'
        },
    ]
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PcmYdgzmxGZRLSJLGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PcmYdgzmxGZRLSJLGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('pcmydgzmx_gzrgrid_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('pcmydgzmx_gzrgrid_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PcmYdgzmxGZRLSJLGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PcmYdgzmxGZRLSJLGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.pcmydgzmx){
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PcmYdgzmxGZRLSJLGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
