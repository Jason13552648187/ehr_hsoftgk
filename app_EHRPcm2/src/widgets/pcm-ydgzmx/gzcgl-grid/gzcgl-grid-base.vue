    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('cz')">
                <el-table-column show-overflow-tooltip :prop="'cz'" :label="$t('entities.pcmydgzmx.gzcgl_grid.columns.cz')" :width="100"  :align="'center'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydgzmx.gzcgl_grid.columns.cz')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('ygbh')">
                <el-table-column show-overflow-tooltip :prop="'ygbh'" :label="$t('entities.pcmydgzmx.gzcgl_grid.columns.ygbh')" :width="130"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydgzmx.gzcgl_grid.columns.ygbh')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.ygbh}}</span>
            ...
            <template v-if="getColumnState('pimpersonname')">
                <el-table-column show-overflow-tooltip :prop="'pimpersonname'" :label="$t('entities.pcmydgzmx.gzcgl_grid.columns.pimpersonname')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydgzmx.gzcgl_grid.columns.pimpersonname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('zzdzs')">
                <el-table-column show-overflow-tooltip :prop="'zzdzs'" :label="$t('entities.pcmydgzmx.gzcgl_grid.columns.zzdzs')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydgzmx.gzcgl_grid.columns.zzdzs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.zzdzs}}</span>
            ...
            <template v-if="getColumnState('shortname')">
                <el-table-column show-overflow-tooltip :prop="'shortname'" :label="$t('entities.pcmydgzmx.gzcgl_grid.columns.shortname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydgzmx.gzcgl_grid.columns.shortname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('yzw')">
                <el-table-column show-overflow-tooltip :prop="'yzw'" :label="$t('entities.pcmydgzmx.gzcgl_grid.columns.yzw')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydgzmx.gzcgl_grid.columns.yzw')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('ygw')">
                <el-table-column show-overflow-tooltip :prop="'ygw'" :label="$t('entities.pcmydgzmx.gzcgl_grid.columns.ygw')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydgzmx.gzcgl_grid.columns.ygw')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('wbzz')">
                <el-table-column show-overflow-tooltip :prop="'wbzz'" :label="$t('entities.pcmydgzmx.gzcgl_grid.columns.wbzz')" :width="250"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydgzmx.gzcgl_grid.columns.wbzz')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('wbbm')">
                <el-table-column show-overflow-tooltip :prop="'wbbm'" :label="$t('entities.pcmydgzmx.gzcgl_grid.columns.wbbm')" :width="130"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydgzmx.gzcgl_grid.columns.wbbm')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
            ...
            <template v-if="getColumnState('ksrq')">
                <el-table-column show-overflow-tooltip :prop="'ksrq'" :label="$t('entities.pcmydgzmx.gzcgl_grid.columns.ksrq')" :width="140"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydgzmx.gzcgl_grid.columns.ksrq')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
            ...
            <template v-if="getColumnState('jsrq')">
                <el-table-column show-overflow-tooltip :prop="'jsrq'" :label="$t('entities.pcmydgzmx.gzcgl_grid.columns.jsrq')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydgzmx.gzcgl_grid.columns.jsrq')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
            ...
            <template v-if="getColumnState('syyf')">
                <el-table-column show-overflow-tooltip :prop="'syyf'" :label="$t('entities.pcmydgzmx.gzcgl_grid.columns.syyf')" :width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydgzmx.gzcgl_grid.columns.syyf')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.syyf}}</span>
            ...
            <template v-if="getColumnState('checkstatus')">
                <el-table-column show-overflow-tooltip :prop="'checkstatus'" :label="$t('entities.pcmydgzmx.gzcgl_grid.columns.checkstatus')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydgzmx.gzcgl_grid.columns.checkstatus')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
...
import GZCGLService from './gzcgl-grid-service';
...
export default class GZCGLBase extends Vue implements ControlInterface {
     ...
     * @memberof GZCGLBase
     */
    public service: GZCGLService = new GZCGLService({ $store: this.$store });
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'cz',
            label: '操作',
            langtag: 'entities.pcmydgzmx.gzcgl_grid.columns.cz',
            show: true,
            util: 'PX'
        },
        {
            name: 'ygbh',
            label: '员工编号',
            langtag: 'entities.pcmydgzmx.gzcgl_grid.columns.ygbh',
            show: true,
            util: 'PX'
        },
        {
            name: 'pimpersonname',
            label: '员工姓名',
            langtag: 'entities.pcmydgzmx.gzcgl_grid.columns.pimpersonname',
            show: true,
            util: 'PX'
        },
        {
            name: 'zzdzs',
            label: '所属组织',
            langtag: 'entities.pcmydgzmx.gzcgl_grid.columns.zzdzs',
            show: true,
            util: 'px'
        },
        {
            name: 'shortname',
            label: '所属部门',
            langtag: 'entities.pcmydgzmx.gzcgl_grid.columns.shortname',
            show: true,
            util: 'px'
        },
        {
            name: 'yzw',
            label: '所属职务',
            langtag: 'entities.pcmydgzmx.gzcgl_grid.columns.yzw',
            show: true,
            util: 'PX'
        },
        {
            name: 'ygw',
            label: '所属岗位',
            langtag: 'entities.pcmydgzmx.gzcgl_grid.columns.ygw',
            show: true,
            util: 'PX'
        },
        {
            name: 'wbzz',
            label: '挂职出组织',
            langtag: 'entities.pcmydgzmx.gzcgl_grid.columns.wbzz',
            show: true,
            util: 'PX'
        },
        {
            name: 'wbbm',
            label: '挂职出部门',
            langtag: 'entities.pcmydgzmx.gzcgl_grid.columns.wbbm',
            show: true,
            util: 'PX'
        },
        {
            name: 'ksrq',
            label: '挂职开始日期',
            langtag: 'entities.pcmydgzmx.gzcgl_grid.columns.ksrq',
            show: true,
            util: 'PX'
        },
        {
            name: 'jsrq',
            label: '挂职结束日期',
            langtag: 'entities.pcmydgzmx.gzcgl_grid.columns.jsrq',
            show: true,
            util: 'PX'
        },
        {
            name: 'syyf',
            label: '剩余月份',
            langtag: 'entities.pcmydgzmx.gzcgl_grid.columns.syyf',
            show: true,
            util: 'PX'
        },
        {
            name: 'checkstatus',
            label: '审核状态',
            langtag: 'entities.pcmydgzmx.gzcgl_grid.columns.checkstatus',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public rules: any = {
        wbbm: [
             { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '挂职出部门 值不能为空', trigger: 'change' },
            { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '挂职出部门 值不能为空', trigger: 'blur' },
        ],
        wbgw: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '挂职出岗位 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '挂职出岗位 值不能为空', trigger: 'blur' },
        ],
        wbzw: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '挂职出职务 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '挂职出职务 值不能为空', trigger: 'blur' },
        ],
        wwzzid: [
        ...
        wbzz: [
             { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '挂职出组织 值不能为空', trigger: 'change' },
            { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '挂职出组织 值不能为空', trigger: 'blur' },
        ],
        jsrq: [
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PcmYdgzmxGZCGLGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PcmYdgzmxGZCGLGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('pcmydgzmx_gzcgl_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('pcmydgzmx_gzcgl_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PcmYdgzmxGZCGLGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PcmYdgzmxGZCGLGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.pcmydgzmx){
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PcmYdgzmxGZCGLGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
