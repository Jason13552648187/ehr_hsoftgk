    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('ygbh')">
                <el-table-column show-overflow-tooltip :prop="'ygbh'" :label="$t('entities.pcmydlzmx.main_grid.columns.ygbh')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydlzmx.main_grid.columns.ygbh')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('pimpersonname')">
                <el-table-column show-overflow-tooltip :prop="'pimpersonname'" :label="$t('entities.pcmydlzmx.main_grid.columns.pimpersonname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydlzmx.main_grid.columns.pimpersonname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('zz')">
                <el-table-column show-overflow-tooltip :prop="'zz'" :label="$t('entities.pcmydlzmx.main_grid.columns.zz')" :width="280"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydlzmx.main_grid.columns.zz')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.zz}}</span>
            ...
            <template v-if="getColumnState('bm')">
                <el-table-column show-overflow-tooltip :prop="'bm'" :label="$t('entities.pcmydlzmx.main_grid.columns.bm')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydlzmx.main_grid.columns.bm')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.bm}}</span>
            ...
            <template v-if="getColumnState('ygw')">
                <el-table-column show-overflow-tooltip :prop="'ygw'" :label="$t('entities.pcmydlzmx.main_grid.columns.ygw')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydlzmx.main_grid.columns.ygw')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('yzw')">
                <el-table-column show-overflow-tooltip :prop="'yzw'" :label="$t('entities.pcmydlzmx.main_grid.columns.yzw')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydlzmx.main_grid.columns.yzw')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('lxdh')">
                <el-table-column show-overflow-tooltip :prop="'lxdh'" :label="$t('entities.pcmydlzmx.main_grid.columns.lxdh')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydlzmx.main_grid.columns.lxdh')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.lxdh}}</span>
            ...
            <template v-if="getColumnState('sxrq')">
                <el-table-column show-overflow-tooltip :prop="'sxrq'" :label="$t('entities.pcmydlzmx.main_grid.columns.sxrq')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydlzmx.main_grid.columns.sxrq')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.sxrq}}</span>
            ...
            <template v-if="getColumnState('yytype')">
                <el-table-column show-overflow-tooltip :prop="'yytype'" :label="$t('entities.pcmydlzmx.main_grid.columns.yytype')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydlzmx.main_grid.columns.yytype')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('lzqx')">
                <el-table-column show-overflow-tooltip :prop="'lzqx'" :label="$t('entities.pcmydlzmx.main_grid.columns.lzqx')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydlzmx.main_grid.columns.lzqx')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.lzqx}}</span>
            ...
            <template v-if="getColumnState('sfhmd')">
                <el-table-column show-overflow-tooltip :prop="'sfhmd'" :label="$t('entities.pcmydlzmx.main_grid.columns.sfhmd')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydlzmx.main_grid.columns.sfhmd')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'ygbh',
            label: '员工编号',
            langtag: 'entities.pcmydlzmx.main_grid.columns.ygbh',
            show: true,
            util: 'px'
        },
        {
            name: 'pimpersonname',
            label: '员工姓名',
            langtag: 'entities.pcmydlzmx.main_grid.columns.pimpersonname',
            show: true,
            util: 'px'
        },
        {
            name: 'zz',
            label: '所属组织',
            langtag: 'entities.pcmydlzmx.main_grid.columns.zz',
            show: true,
            util: 'PX'
        },
        {
            name: 'bm',
            label: '所属部门',
            langtag: 'entities.pcmydlzmx.main_grid.columns.bm',
            show: true,
            util: 'px'
        },
        {
            name: 'ygw',
            label: '所属岗位',
            langtag: 'entities.pcmydlzmx.main_grid.columns.ygw',
            show: true,
            util: 'px'
        },
        {
            name: 'yzw',
            label: '所属职务',
            langtag: 'entities.pcmydlzmx.main_grid.columns.yzw',
            show: true,
            util: 'px'
        },
        {
            name: 'lxdh',
            label: '联系电话',
            langtag: 'entities.pcmydlzmx.main_grid.columns.lxdh',
            show: true,
            util: 'px'
        },
        {
            name: 'sxrq',
            label: '离职日期',
            langtag: 'entities.pcmydlzmx.main_grid.columns.sxrq',
            show: true,
            util: 'px'
        },
        {
            name: 'yytype',
            label: '离职理由',
            langtag: 'entities.pcmydlzmx.main_grid.columns.yytype',
            show: true,
            util: 'px'
        },
        {
            name: 'lzqx',
            label: '离职去向',
            langtag: 'entities.pcmydlzmx.main_grid.columns.lzqx',
            show: true,
            util: 'px'
        },
        {
            name: 'sfhmd',
            label: '是否加入黑名单',
            langtag: 'entities.pcmydlzmx.main_grid.columns.sfhmd',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PcmYdlzmxLSJLGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PcmYdlzmxLSJLGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('pcmydlzmx_main_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('pcmydlzmx_main_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PcmYdlzmxLSJLGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PcmYdlzmxLSJLGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.pcmydlzmx){
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PcmYdlzmxLSJLGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
