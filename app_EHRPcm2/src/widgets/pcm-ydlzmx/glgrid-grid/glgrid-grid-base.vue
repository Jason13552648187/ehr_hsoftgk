    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('uagridcolumn1')">
                <el-table-column :column-key="'uagridcolumn1'" :label="$t('entities.pcmydlzmx.glgrid_grid.columns.uagridcolumn1')" :width="150"  :align="'center'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydlzmx.glgrid_grid.columns.uagridcolumn1')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('ygbh')">
                <el-table-column show-overflow-tooltip :prop="'ygbh'" :label="$t('entities.pcmydlzmx.glgrid_grid.columns.ygbh')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydlzmx.glgrid_grid.columns.ygbh')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('pimpersonname')">
                <el-table-column show-overflow-tooltip :prop="'pimpersonname'" :label="$t('entities.pcmydlzmx.glgrid_grid.columns.pimpersonname')" :width="130"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydlzmx.glgrid_grid.columns.pimpersonname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('zzdzs')">
                <el-table-column show-overflow-tooltip :prop="'zzdzs'" :label="$t('entities.pcmydlzmx.glgrid_grid.columns.zzdzs')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydlzmx.glgrid_grid.columns.zzdzs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.zzdzs}}</span>
            ...
            <template v-if="getColumnState('shortname')">
                <el-table-column show-overflow-tooltip :prop="'shortname'" :label="$t('entities.pcmydlzmx.glgrid_grid.columns.shortname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydlzmx.glgrid_grid.columns.shortname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('ygw')">
                <el-table-column show-overflow-tooltip :prop="'ygw'" :label="$t('entities.pcmydlzmx.glgrid_grid.columns.ygw')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydlzmx.glgrid_grid.columns.ygw')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('yzw')">
                <el-table-column show-overflow-tooltip :prop="'yzw'" :label="$t('entities.pcmydlzmx.glgrid_grid.columns.yzw')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydlzmx.glgrid_grid.columns.yzw')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('lxdh')">
                <el-table-column show-overflow-tooltip :prop="'lxdh'" :label="$t('entities.pcmydlzmx.glgrid_grid.columns.lxdh')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydlzmx.glgrid_grid.columns.lxdh')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.lxdh}}</span>
            ...
            <template v-if="getColumnState('sxrq')">
                <el-table-column show-overflow-tooltip :prop="'sxrq'" :label="$t('entities.pcmydlzmx.glgrid_grid.columns.sxrq')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydlzmx.glgrid_grid.columns.sxrq')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('yytype')">
                <el-table-column show-overflow-tooltip :prop="'yytype'" :label="$t('entities.pcmydlzmx.glgrid_grid.columns.yytype')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydlzmx.glgrid_grid.columns.yytype')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.yytype" tag='EhrCodeList0217' codelistType='DYNAMIC' ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('lzqx')">
                <el-table-column show-overflow-tooltip :prop="'lzqx'" :label="$t('entities.pcmydlzmx.glgrid_grid.columns.lzqx')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydlzmx.glgrid_grid.columns.lzqx')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
                                <app-span name='lzqx' editorType="TEXTBOX" :value="row.lzqx"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('sfhmd')">
                <el-table-column show-overflow-tooltip :prop="'sfhmd'" :label="$t('entities.pcmydlzmx.glgrid_grid.columns.sfhmd')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydlzmx.glgrid_grid.columns.sfhmd')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
...
import PcmYdlzmxUIService from '@/uiservice/pcm-ydlzmx/pcm-ydlzmx-ui-service';
...
export default class GLGridBase extends Vue implements ControlInterface {
     ...
     * @memberof 
     */
    public grid_uagridcolumn1_u3e29056_click(params: any = {}, tag?: any, $event?: any) {
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        // _this 指向容器对象
        ...
        // 界面行为
        const curUIService:PcmYdlzmxUIService  = new PcmYdlzmxUIService();
        curUIService.PcmYdlzmx_FinishLZ(datas,contextJO, paramJO,  $event, xData,this,"PcmYdlzmx");
    }
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'uagridcolumn1',
            label: '操作',
            langtag: 'entities.pcmydlzmx.glgrid_grid.columns.uagridcolumn1',
            show: true,
            util: 'PX'
        },
        {
            name: 'ygbh',
            label: '员工编号',
            langtag: 'entities.pcmydlzmx.glgrid_grid.columns.ygbh',
            show: true,
            util: 'px'
        },
        {
            name: 'pimpersonname',
            label: '员工姓名',
            langtag: 'entities.pcmydlzmx.glgrid_grid.columns.pimpersonname',
            show: true,
            util: 'px'
        },
        {
            name: 'zzdzs',
            label: '所属组织',
            langtag: 'entities.pcmydlzmx.glgrid_grid.columns.zzdzs',
            show: true,
            util: 'px'
        },
        {
            name: 'shortname',
            label: '所属部门',
            langtag: 'entities.pcmydlzmx.glgrid_grid.columns.shortname',
            show: true,
            util: 'px'
        },
        {
            name: 'ygw',
            label: '所属岗位',
            langtag: 'entities.pcmydlzmx.glgrid_grid.columns.ygw',
            show: true,
            util: 'px'
        },
        {
            name: 'yzw',
            label: '所属职务',
            langtag: 'entities.pcmydlzmx.glgrid_grid.columns.yzw',
            show: true,
            util: 'px'
        },
        {
            name: 'lxdh',
            label: '联系电话',
            langtag: 'entities.pcmydlzmx.glgrid_grid.columns.lxdh',
            show: true,
            util: 'px'
        },
        {
            name: 'sxrq',
            label: '离职日期',
            langtag: 'entities.pcmydlzmx.glgrid_grid.columns.sxrq',
            show: true,
            util: 'PX'
        },
        {
            name: 'yytype',
            label: '离职理由',
            langtag: 'entities.pcmydlzmx.glgrid_grid.columns.yytype',
            show: true,
            util: 'PX'
        },
        {
            name: 'lzqx',
            label: '离职去向',
            langtag: 'entities.pcmydlzmx.glgrid_grid.columns.lzqx',
            show: true,
            util: 'PX'
        },
        {
            name: 'sfhmd',
            label: '是否加入黑名单',
            langtag: 'entities.pcmydlzmx.glgrid_grid.columns.sfhmd',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public getGridRowModel(){
        return {
          ...
          yytype: new FormItemModel(),
          srfkey: new FormItemModel(),
          lzqx: new FormItemModel(),
    ...
    public rules: any = {
        sfhmd: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '是否加入黑名单 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '是否加入黑名单 值不能为空', trigger: 'blur' },
        ],
        yytype: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '离职理由 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '离职理由 值不能为空', trigger: 'blur' },
        ],
        srfkey: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '异动离职明细标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '异动离职明细标识 值不能为空', trigger: 'blur' },
        ],
        lzqx: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '离职去向 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '离职去向 值不能为空', trigger: 'blur' },
        ],
        sxrq: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '离职日期 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '离职日期 值不能为空', trigger: 'blur' },
        ],
    }
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PcmYdlzmxGLGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PcmYdlzmxGLGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        _datas.forEach((record: any, index: number) => {
            let srfmajortext = record.pcmydlzmxname;
            if (index < 5) {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pcmydlzmx: _keys }),Object.assign({ pcmydlzmx: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.pcmydlzmx,$event.pcmydlzmx);
        });
	...
	public uiAction(row: any, tag: any, $event: any) {
        ...
        if(Object.is('FinishLZ', tag)) {
            this.grid_uagridcolumn1_u3e29056_click(row, tag, $event);
        }
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PcmYdlzmxGLGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PcmYdlzmxGLGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.pcmydlzmx){
                            Object.assign(this.context,{pcmydlzmx:item.pcmydlzmx});
                        }
    ...
    public getRowClassName(args:{row: any,rowIndex: number}){
        let isSelected = this.selections.some((item:any)=>{
            return Object.is(item.pcmydlzmx,args.row.pcmydlzmx);
        });
