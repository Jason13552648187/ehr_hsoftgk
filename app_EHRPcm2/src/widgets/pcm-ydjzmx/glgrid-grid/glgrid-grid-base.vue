    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('uagridcolumn1')">
                <el-table-column :column-key="'uagridcolumn1'" :label="$t('entities.pcmydjzmx.glgrid_grid.columns.uagridcolumn1')" :width="150"  :align="'center'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                          <i class='create'></i>
                        {{$t('entities.pcmydjzmx.glgrid_grid.columns.uagridcolumn1')}}
                      </span>
                    </template>
                    <template slot-scope="scope">
                        <div style="text-align: center;">
                            <a @click="uiAction(scope.row, 'RYHG', $event)">
                              <i class=''></i>
                              {{$t('entities.pcmydjzmx.glgrid_grid.uiactions.ryhg')}}
                            </a>
                        </div>
                    </template>
                </el-table-column>
            ...
            <template v-if="getColumnState('ygbh')">
                <el-table-column show-overflow-tooltip :prop="'ygbh'" :label="$t('entities.pcmydjzmx.glgrid_grid.columns.ygbh')" :width="130"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydjzmx.glgrid_grid.columns.ygbh')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('pimpersonname')">
                <el-table-column show-overflow-tooltip :prop="'pimpersonname'" :label="$t('entities.pcmydjzmx.glgrid_grid.columns.pimpersonname')" :width="130"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydjzmx.glgrid_grid.columns.pimpersonname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('zzdzs')">
                <el-table-column show-overflow-tooltip :prop="'zzdzs'" :label="$t('entities.pcmydjzmx.glgrid_grid.columns.zzdzs')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydjzmx.glgrid_grid.columns.zzdzs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.zzdzs}}</span>
            ...
            <template v-if="getColumnState('shortname')">
                <el-table-column show-overflow-tooltip :prop="'shortname'" :label="$t('entities.pcmydjzmx.glgrid_grid.columns.shortname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydjzmx.glgrid_grid.columns.shortname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('jzzzdzs')">
                <el-table-column show-overflow-tooltip :prop="'jzzzdzs'" :label="$t('entities.pcmydjzmx.glgrid_grid.columns.jzzzdzs')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydjzmx.glgrid_grid.columns.jzzzdzs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.jzzzdzs}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('jzshortname')">
                <el-table-column show-overflow-tooltip :prop="'jzshortname'" :label="$t('entities.pcmydjzmx.glgrid_grid.columns.jzshortname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydjzmx.glgrid_grid.columns.jzshortname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.jzshortname}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('ksrq')">
                <el-table-column show-overflow-tooltip :prop="'ksrq'" :label="$t('entities.pcmydjzmx.glgrid_grid.columns.ksrq')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydjzmx.glgrid_grid.columns.ksrq')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('jsrq')">
                <el-table-column show-overflow-tooltip :prop="'jsrq'" :label="$t('entities.pcmydjzmx.glgrid_grid.columns.jsrq')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydjzmx.glgrid_grid.columns.jsrq')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('checkstatus')">
                <el-table-column show-overflow-tooltip :prop="'checkstatus'" :label="$t('entities.pcmydjzmx.glgrid_grid.columns.checkstatus')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmydjzmx.glgrid_grid.columns.checkstatus')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
...
export default class GLGridBase extends Vue implements ControlInterface {
     ...
     * @memberof GLGridBase
     */
    public appEntityService: PcmYdjzmxService = new PcmYdjzmxService({ $store: this.$store });
     ...
     * @memberof 
     */
    public grid_uagridcolumn1_u978abd3_click(params: any = {}, tag?: any, $event?: any) {
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        // _this 指向容器对象
        ...
        curUIService.PcmYdjzmx_RYHG(datas,contextJO, paramJO,  $event, xData,this,"PcmYdjzmx");
    }
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'uagridcolumn1',
            label: '操作',
            langtag: 'entities.pcmydjzmx.glgrid_grid.columns.uagridcolumn1',
            show: true,
            util: 'PX'
        },
        {
            name: 'ygbh',
            label: '员工编号',
            langtag: 'entities.pcmydjzmx.glgrid_grid.columns.ygbh',
            show: true,
            util: 'PX'
        },
        {
            name: 'pimpersonname',
            label: '员工姓名',
            langtag: 'entities.pcmydjzmx.glgrid_grid.columns.pimpersonname',
            show: true,
            util: 'PX'
        },
        {
            name: 'zzdzs',
            label: '所属组织',
            langtag: 'entities.pcmydjzmx.glgrid_grid.columns.zzdzs',
            show: true,
            util: 'px'
        },
        {
            name: 'shortname',
            label: '所属部门',
            langtag: 'entities.pcmydjzmx.glgrid_grid.columns.shortname',
            show: true,
            util: 'px'
        },
        {
            name: 'jzzzdzs',
            label: '兼职组织',
            langtag: 'entities.pcmydjzmx.glgrid_grid.columns.jzzzdzs',
            show: true,
            util: 'px'
        },
        {
            name: 'jzshortname',
            label: '兼职部门',
            langtag: 'entities.pcmydjzmx.glgrid_grid.columns.jzshortname',
            show: true,
            util: 'px'
        },
        {
            name: 'ksrq',
            label: '兼职开始日期',
            langtag: 'entities.pcmydjzmx.glgrid_grid.columns.ksrq',
            show: true,
            util: 'PX'
        },
        {
            name: 'jsrq',
            label: '兼职结束日期',
            langtag: 'entities.pcmydjzmx.glgrid_grid.columns.jsrq',
            show: true,
            util: 'PX'
        },
        {
            name: 'checkstatus',
            label: '审核状态',
            langtag: 'entities.pcmydjzmx.glgrid_grid.columns.checkstatus',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public rules: any = {
        ...
        ormpostname: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '兼职岗位 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '兼职岗位 值不能为空', trigger: 'blur' },
        ],
        jsrq: [
             { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '兼职结束日期 值不能为空', trigger: 'change' },
            { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '兼职结束日期 值不能为空', trigger: 'blur' },
        ],
        srfkey: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '异动兼职明细标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '异动兼职明细标识 值不能为空', trigger: 'blur' },
        ],
        ormdutyname: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '兼职职务 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '兼职职务 值不能为空', trigger: 'blur' },
        ],
        ksrq: [
             { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '兼职开始日期 值不能为空', trigger: 'change' },
            { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '兼职开始日期 值不能为空', trigger: 'blur' },
        ],
    }
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PcmYdjzmxGLGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PcmYdjzmxGLGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        _datas.forEach((record: any, index: number) => {
            let srfmajortext = record.pcmydjzmxname;
            if (index < 5) {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pcmydjzmx: _keys }),Object.assign({ pcmydjzmx: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.pcmydjzmx,$event.pcmydjzmx);
        });
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('pcmydjzmx_glgrid_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('pcmydjzmx_glgrid_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PcmYdjzmxGLGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PcmYdjzmxGLGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.pcmydjzmx){
                            Object.assign(this.context,{pcmydjzmx:item.pcmydjzmx});
                        }
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PcmYdjzmxGLGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
