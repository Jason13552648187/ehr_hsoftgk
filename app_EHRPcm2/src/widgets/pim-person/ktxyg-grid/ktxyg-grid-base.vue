    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('ygbh')">
                <el-table-column show-overflow-tooltip :prop="'ygbh'" :label="$t('entities.pimperson.ktxyg_grid.columns.ygbh')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimperson.ktxyg_grid.columns.ygbh')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('pimpersonname')">
                <el-table-column show-overflow-tooltip :prop="'pimpersonname'" :label="$t('entities.pimperson.ktxyg_grid.columns.pimpersonname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimperson.ktxyg_grid.columns.pimpersonname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('nj')">
                <el-table-column show-overflow-tooltip :prop="'nj'" :label="$t('entities.pimperson.ktxyg_grid.columns.nj')" :width="95"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimperson.ktxyg_grid.columns.nj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.nj}}</span>
            ...
            <template v-if="getColumnState('zzdzs')">
                <el-table-column show-overflow-tooltip :prop="'zzdzs'" :label="$t('entities.pimperson.ktxyg_grid.columns.zzdzs')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimperson.ktxyg_grid.columns.zzdzs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.zzdzs}}</span>
            ...
            <template v-if="getColumnState('ormorgsectorname')">
                <el-table-column show-overflow-tooltip :prop="'ormorgsectorname'" :label="$t('entities.pimperson.ktxyg_grid.columns.ormorgsectorname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimperson.ktxyg_grid.columns.ormorgsectorname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('zw')">
                <el-table-column show-overflow-tooltip :prop="'zw'" :label="$t('entities.pimperson.ktxyg_grid.columns.zw')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimperson.ktxyg_grid.columns.zw')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('gw')">
                <el-table-column show-overflow-tooltip :prop="'gw'" :label="$t('entities.pimperson.ktxyg_grid.columns.gw')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimperson.ktxyg_grid.columns.gw')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('lxdh')">
                <el-table-column show-overflow-tooltip :prop="'lxdh'" :label="$t('entities.pimperson.ktxyg_grid.columns.lxdh')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimperson.ktxyg_grid.columns.lxdh')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.lxdh}}</span>
            ...
            <template v-if="getColumnState('postaladdress')">
                <el-table-column show-overflow-tooltip :prop="'postaladdress'" :label="$t('entities.pimperson.ktxyg_grid.columns.postaladdress')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimperson.ktxyg_grid.columns.postaladdress')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('sjtxrq')">
                <el-table-column show-overflow-tooltip :prop="'sjtxrq'" :label="$t('entities.pimperson.ktxyg_grid.columns.sjtxrq')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimperson.ktxyg_grid.columns.sjtxrq')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('retiplace')">
                <el-table-column show-overflow-tooltip :prop="'retiplace'" :label="$t('entities.pimperson.ktxyg_grid.columns.retiplace')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimperson.ktxyg_grid.columns.retiplace')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('txnx')">
                <el-table-column show-overflow-tooltip :prop="'txnx'" :label="$t('entities.pimperson.ktxyg_grid.columns.txnx')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimperson.ktxyg_grid.columns.txnx')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.txnx}}</span>
...
export default class KTXYGBase extends Vue implements ControlInterface {
     ...
     * @memberof KTXYGBase
     */
    public service: KTXYGService = new KTXYGService({ $store: this.$store });
    ...
    */
    ...
    public allColumns: any[] = [
        ...
        },
        {
            name: 'ygbh',
            label: '员工编号',
            langtag: 'entities.pimperson.ktxyg_grid.columns.ygbh',
            show: true,
            util: 'px'
        },
        {
            name: 'pimpersonname',
            label: '员工姓名',
            langtag: 'entities.pimperson.ktxyg_grid.columns.pimpersonname',
            show: true,
            util: 'px'
        },
        {
            name: 'nj',
            label: '年龄',
            langtag: 'entities.pimperson.ktxyg_grid.columns.nj',
            show: true,
            util: 'PX'
        },
        {
            name: 'zzdzs',
            label: '组织',
            langtag: 'entities.pimperson.ktxyg_grid.columns.zzdzs',
            show: true,
            util: 'px'
        },
        {
            ...
            label: '部门',
            langtag: 'entities.pimperson.ktxyg_grid.columns.ormorgsectorname',
            show: true,
            util: 'px'
        },
        {
            name: 'zw',
            label: '职务',
            langtag: 'entities.pimperson.ktxyg_grid.columns.zw',
            show: true,
            util: 'px'
        },
        {
            name: 'gw',
            label: '岗位',
            langtag: 'entities.pimperson.ktxyg_grid.columns.gw',
            show: true,
            util: 'px'
        },
        {
            name: 'lxdh',
            label: '手机号码',
            langtag: 'entities.pimperson.ktxyg_grid.columns.lxdh',
            show: true,
            util: 'px'
        },
        {
            name: 'postaladdress',
            label: '通讯地址',
            langtag: 'entities.pimperson.ktxyg_grid.columns.postaladdress',
            show: true,
            util: 'px'
        },
        {
            name: 'sjtxrq',
            label: '拟退休日期',
            langtag: 'entities.pimperson.ktxyg_grid.columns.sjtxrq',
            show: true,
            util: 'PX'
        },
        {
            name: 'retiplace',
            label: '退休地',
            langtag: 'entities.pimperson.ktxyg_grid.columns.retiplace',
            show: true,
            util: 'PX'
        },
        {
            name: 'txnx',
            label: '退休到期(月)',
            langtag: 'entities.pimperson.ktxyg_grid.columns.txnx',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public getGridRowModel(){
        return {
          sjtxrq: new FormItemModel(),
          retiplace: new FormItemModel(),
    ...
    public rules: any = {
        sjtxrq: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '拟退休日期 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '拟退休日期 值不能为空', trigger: 'blur' },
        ],
        retiplace: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '退休地 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '退休地 值不能为空', trigger: 'blur' },
        ],
        srfkey: [
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PimPersonTXGLGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PimPersonTXGLGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.pimperson,$event.pimperson);
        });
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('pimperson_ktxyg_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('pimperson_ktxyg_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PimPersonTXGLGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PimPersonTXGLGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.pimperson){
