    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('pimdistirbutionname')">
                <el-table-column show-overflow-tooltip :prop="'pimdistirbutionname'" :label="$t('entities.pcmddsqdmx.lgsqmx_grid.columns.pimdistirbutionname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmddsqdmx.lgsqmx_grid.columns.pimdistirbutionname')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('ormorgname')">
                <el-table-column show-overflow-tooltip :prop="'ormorgname'" :label="$t('entities.pcmddsqdmx.lgsqmx_grid.columns.ormorgname')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmddsqdmx.lgsqmx_grid.columns.ormorgname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('ormorgsectorname')">
                <el-table-column show-overflow-tooltip :prop="'ormorgsectorname'" :label="$t('entities.pcmddsqdmx.lgsqmx_grid.columns.ormorgsectorname')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmddsqdmx.lgsqmx_grid.columns.ormorgsectorname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('ormygw')">
                <el-table-column show-overflow-tooltip :prop="'ormygw'" :label="$t('entities.pcmddsqdmx.lgsqmx_grid.columns.ormygw')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmddsqdmx.lgsqmx_grid.columns.ormygw')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('orgname')">
                <el-table-column show-overflow-tooltip :prop="'orgname'" :label="$t('entities.pcmddsqdmx.lgsqmx_grid.columns.orgname')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmddsqdmx.lgsqmx_grid.columns.orgname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('orgsectorname')">
                <el-table-column show-overflow-tooltip :prop="'orgsectorname'" :label="$t('entities.pcmddsqdmx.lgsqmx_grid.columns.orgsectorname')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmddsqdmx.lgsqmx_grid.columns.orgsectorname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('ormpostname')">
                <el-table-column show-overflow-tooltip :prop="'ormpostname'" :label="$t('entities.pcmddsqdmx.lgsqmx_grid.columns.ormpostname')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmddsqdmx.lgsqmx_grid.columns.ormpostname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('sxrq')">
                <el-table-column show-overflow-tooltip :prop="'sxrq'" :label="$t('entities.pcmddsqdmx.lgsqmx_grid.columns.sxrq')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmddsqdmx.lgsqmx_grid.columns.sxrq')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
...
import LGSQMXService from './lgsqmx-grid-service';
...
export default class LGSQMXBase extends Vue implements ControlInterface {
     ...
     * @memberof LGSQMXBase
     */
    public service: LGSQMXService = new LGSQMXService({ $store: this.$store });
    ...
    */
    ...
    public allColumns: any[] = [
        {
            ...
            label: '分配选择',
            langtag: 'entities.pcmddsqdmx.lgsqmx_grid.columns.pimdistirbutionname',
            show: true,
            util: 'PX'
        },
        {
            name: 'ormorgname',
            label: '原组织',
            langtag: 'entities.pcmddsqdmx.lgsqmx_grid.columns.ormorgname',
            show: true,
            util: 'PX'
        },
        {
            ...
            label: '原部门/项目',
            langtag: 'entities.pcmddsqdmx.lgsqmx_grid.columns.ormorgsectorname',
            show: true,
            util: 'PX'
        },
        {
            name: 'ormygw',
            label: '原岗位',
            langtag: 'entities.pcmddsqdmx.lgsqmx_grid.columns.ormygw',
            show: true,
            util: 'PX'
        },
        {
            name: 'orgname',
            label: '新组织',
            langtag: 'entities.pcmddsqdmx.lgsqmx_grid.columns.orgname',
            show: true,
            util: 'PX'
        },
        {
            name: 'orgsectorname',
            label: '新部门',
            langtag: 'entities.pcmddsqdmx.lgsqmx_grid.columns.orgsectorname',
            show: true,
            util: 'PX'
        },
        {
            name: 'ormpostname',
            label: '新岗位',
            langtag: 'entities.pcmddsqdmx.lgsqmx_grid.columns.ormpostname',
            show: true,
            util: 'PX'
        },
        {
            name: 'sxrq',
            label: '生效日期',
            langtag: 'entities.pcmddsqdmx.lgsqmx_grid.columns.sxrq',
            show: true,
            util: 'px'
        },
    ]
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PcmDdsqdmxLGSQMXGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PcmDdsqdmxLGSQMXGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('pcmddsqdmx_lgsqmx_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('pcmddsqdmx_lgsqmx_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PcmDdsqdmxLGSQMXGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PcmDdsqdmxLGSQMXGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.pcmddsqdmx){
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PcmDdsqdmxLGSQMXGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
