    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('createdate')">
                <el-table-column show-overflow-tooltip :prop="'createdate'" :label="$t('entities.pcmddsqdmx.jzsqmxgr_grid.columns.createdate')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmddsqdmx.jzsqmxgr_grid.columns.createdate')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('ormorgname')">
                <el-table-column show-overflow-tooltip :prop="'ormorgname'" :label="$t('entities.pcmddsqdmx.jzsqmxgr_grid.columns.ormorgname')" :width="300"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmddsqdmx.jzsqmxgr_grid.columns.ormorgname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('ormorgsectorname')">
                <el-table-column show-overflow-tooltip :prop="'ormorgsectorname'" :label="$t('entities.pcmddsqdmx.jzsqmxgr_grid.columns.ormorgsectorname')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmddsqdmx.jzsqmxgr_grid.columns.ormorgsectorname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('ormyzw')">
                <el-table-column show-overflow-tooltip :prop="'ormyzw'" :label="$t('entities.pcmddsqdmx.jzsqmxgr_grid.columns.ormyzw')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmddsqdmx.jzsqmxgr_grid.columns.ormyzw')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('ormygw')">
                <el-table-column show-overflow-tooltip :prop="'ormygw'" :label="$t('entities.pcmddsqdmx.jzsqmxgr_grid.columns.ormygw')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmddsqdmx.jzsqmxgr_grid.columns.ormygw')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('orgname')">
                <el-table-column show-overflow-tooltip :prop="'orgname'" :label="$t('entities.pcmddsqdmx.jzsqmxgr_grid.columns.orgname')" :width="300"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmddsqdmx.jzsqmxgr_grid.columns.orgname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('orgsectorname')">
                <el-table-column show-overflow-tooltip :prop="'orgsectorname'" :label="$t('entities.pcmddsqdmx.jzsqmxgr_grid.columns.orgsectorname')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmddsqdmx.jzsqmxgr_grid.columns.orgsectorname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('ormdutyname1')">
                <el-table-column show-overflow-tooltip :prop="'ormdutyname1'" :label="$t('entities.pcmddsqdmx.jzsqmxgr_grid.columns.ormdutyname1')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmddsqdmx.jzsqmxgr_grid.columns.ormdutyname1')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.ormdutyname1}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('ormpostname')">
                <el-table-column show-overflow-tooltip :prop="'ormpostname'" :label="$t('entities.pcmddsqdmx.jzsqmxgr_grid.columns.ormpostname')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmddsqdmx.jzsqmxgr_grid.columns.ormpostname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('sxrq')">
                <el-table-column show-overflow-tooltip :prop="'sxrq'" :label="$t('entities.pcmddsqdmx.jzsqmxgr_grid.columns.sxrq')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmddsqdmx.jzsqmxgr_grid.columns.sxrq')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('finishdd')">
                <el-table-column show-overflow-tooltip :prop="'finishdd'" :label="$t('entities.pcmddsqdmx.jzsqmxgr_grid.columns.finishdd')" :width="50"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmddsqdmx.jzsqmxgr_grid.columns.finishdd')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('checkstatus')">
                <el-table-column show-overflow-tooltip :prop="'checkstatus'" :label="$t('entities.pcmddsqdmx.jzsqmxgr_grid.columns.checkstatus')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmddsqdmx.jzsqmxgr_grid.columns.checkstatus')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
...
import JZSQMXGRService from './jzsqmxgr-grid-service';
...
export default class JZSQMXGRBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof JZSQMXGRBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {JZSQMXGRService}
     * @memberof JZSQMXGRBase
     */
    public service: JZSQMXGRService = new JZSQMXGRService({ $store: this.$store });
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'createdate',
            label: '申请时间',
            langtag: 'entities.pcmddsqdmx.jzsqmxgr_grid.columns.createdate',
            show: true,
            util: 'PX'
        },
        {
            name: 'ormorgname',
            label: '所属组织',
            langtag: 'entities.pcmddsqdmx.jzsqmxgr_grid.columns.ormorgname',
            show: true,
            util: 'PX'
        },
        {
            ...
            label: '所属部门',
            langtag: 'entities.pcmddsqdmx.jzsqmxgr_grid.columns.ormorgsectorname',
            show: true,
            util: 'PX'
        },
        {
            name: 'ormyzw',
            label: '任职职务',
            langtag: 'entities.pcmddsqdmx.jzsqmxgr_grid.columns.ormyzw',
            show: true,
            util: 'PX'
        },
        {
            name: 'ormygw',
            label: '任职岗位',
            langtag: 'entities.pcmddsqdmx.jzsqmxgr_grid.columns.ormygw',
            show: true,
            util: 'PX'
        },
        {
            name: 'orgname',
            label: '兼职组织',
            langtag: 'entities.pcmddsqdmx.jzsqmxgr_grid.columns.orgname',
            show: true,
            util: 'PX'
        },
        {
            name: 'orgsectorname',
            label: '兼职部门',
            langtag: 'entities.pcmddsqdmx.jzsqmxgr_grid.columns.orgsectorname',
            show: true,
            util: 'PX'
        },
        {
            name: 'ormdutyname1',
            label: '兼职职务',
            langtag: 'entities.pcmddsqdmx.jzsqmxgr_grid.columns.ormdutyname1',
            show: true,
            util: 'PX'
        },
        {
            name: 'ormpostname',
            label: '兼职岗位',
            langtag: 'entities.pcmddsqdmx.jzsqmxgr_grid.columns.ormpostname',
            show: true,
            util: 'PX'
        },
        {
            name: 'sxrq',
            label: '生效日期',
            langtag: 'entities.pcmddsqdmx.jzsqmxgr_grid.columns.sxrq',
            show: true,
            util: 'px'
        },
        {
            name: 'finishdd',
            label: '是否审核',
            langtag: 'entities.pcmddsqdmx.jzsqmxgr_grid.columns.finishdd',
            show: true,
            util: 'PX'
        },
        {
            name: 'checkstatus',
            label: '审核状态',
            langtag: 'entities.pcmddsqdmx.jzsqmxgr_grid.columns.checkstatus',
            show: true,
            util: 'px'
        },
    ]
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PcmDdsqdmxJZSQGRGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PcmDdsqdmxJZSQGRGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('pcmddsqdmx_jzsqmxgr_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('pcmddsqdmx_jzsqmxgr_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PcmDdsqdmxJZSQGRGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PcmDdsqdmxJZSQGRGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.pcmddsqdmx){
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PcmDdsqdmxJZSQGRGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
