    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('ygbh')">
                <el-table-column show-overflow-tooltip :prop="'ygbh'" :label="$t('entities.pcmddsqdmx.jdsqmx_grid.columns.ygbh')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmddsqdmx.jdsqmx_grid.columns.ygbh')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('pimdistirbutionname')">
                <el-table-column show-overflow-tooltip :prop="'pimdistirbutionname'" :label="$t('entities.pcmddsqdmx.jdsqmx_grid.columns.pimdistirbutionname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmddsqdmx.jdsqmx_grid.columns.pimdistirbutionname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('ormorgname')">
                <el-table-column show-overflow-tooltip :prop="'ormorgname'" :label="$t('entities.pcmddsqdmx.jdsqmx_grid.columns.ormorgname')" :width="300"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmddsqdmx.jdsqmx_grid.columns.ormorgname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('ormorgsectorname')">
                <el-table-column show-overflow-tooltip :prop="'ormorgsectorname'" :label="$t('entities.pcmddsqdmx.jdsqmx_grid.columns.ormorgsectorname')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmddsqdmx.jdsqmx_grid.columns.ormorgsectorname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('ormygw')">
                <el-table-column show-overflow-tooltip :prop="'ormygw'" :label="$t('entities.pcmddsqdmx.jdsqmx_grid.columns.ormygw')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmddsqdmx.jdsqmx_grid.columns.ormygw')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('ormyzw')">
                <el-table-column show-overflow-tooltip :prop="'ormyzw'" :label="$t('entities.pcmddsqdmx.jdsqmx_grid.columns.ormyzw')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmddsqdmx.jdsqmx_grid.columns.ormyzw')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('orgname')">
                <el-table-column show-overflow-tooltip :prop="'orgname'" :label="$t('entities.pcmddsqdmx.jdsqmx_grid.columns.orgname')" :width="300"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmddsqdmx.jdsqmx_grid.columns.orgname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('orgsectorname')">
                <el-table-column show-overflow-tooltip :prop="'orgsectorname'" :label="$t('entities.pcmddsqdmx.jdsqmx_grid.columns.orgsectorname')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmddsqdmx.jdsqmx_grid.columns.orgsectorname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('ormpostname')">
                <el-table-column show-overflow-tooltip :prop="'ormpostname'" :label="$t('entities.pcmddsqdmx.jdsqmx_grid.columns.ormpostname')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmddsqdmx.jdsqmx_grid.columns.ormpostname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('ormdutyname')">
                <el-table-column show-overflow-tooltip :prop="'ormdutyname'" :label="$t('entities.pcmddsqdmx.jdsqmx_grid.columns.ormdutyname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmddsqdmx.jdsqmx_grid.columns.ormdutyname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('jdkssj')">
                <el-table-column show-overflow-tooltip :prop="'jdkssj'" :label="$t('entities.pcmddsqdmx.jdsqmx_grid.columns.jdkssj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmddsqdmx.jdsqmx_grid.columns.jdkssj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('jdjssj')">
                <el-table-column show-overflow-tooltip :prop="'jdjssj'" :label="$t('entities.pcmddsqdmx.jdsqmx_grid.columns.jdjssj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmddsqdmx.jdsqmx_grid.columns.jdjssj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('checkstatus')">
                <el-table-column show-overflow-tooltip :prop="'checkstatus'" :label="$t('entities.pcmddsqdmx.jdsqmx_grid.columns.checkstatus')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmddsqdmx.jdsqmx_grid.columns.checkstatus')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
...
export default class JDSQMXBase extends Vue implements ControlInterface {
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'ygbh',
            label: '员工编号',
            langtag: 'entities.pcmddsqdmx.jdsqmx_grid.columns.ygbh',
            show: true,
            util: 'px'
        },
        {
            ...
            label: '员工姓名',
            langtag: 'entities.pcmddsqdmx.jdsqmx_grid.columns.pimdistirbutionname',
            show: true,
            util: 'PX'
        },
        {
            name: 'ormorgname',
            label: '所属组织',
            langtag: 'entities.pcmddsqdmx.jdsqmx_grid.columns.ormorgname',
            show: true,
            util: 'PX'
        },
        {
            ...
            label: '所属部门',
            langtag: 'entities.pcmddsqdmx.jdsqmx_grid.columns.ormorgsectorname',
            show: true,
            util: 'PX'
        },
        {
            name: 'ormygw',
            label: '所属岗位',
            langtag: 'entities.pcmddsqdmx.jdsqmx_grid.columns.ormygw',
            show: true,
            util: 'PX'
        },
        {
            name: 'ormyzw',
            label: '所属职务',
            langtag: 'entities.pcmddsqdmx.jdsqmx_grid.columns.ormyzw',
            show: true,
            util: 'PX'
        },
        {
            name: 'orgname',
            label: '借调组织',
            langtag: 'entities.pcmddsqdmx.jdsqmx_grid.columns.orgname',
            show: true,
            util: 'PX'
        },
        {
            name: 'orgsectorname',
            label: '借调部门',
            langtag: 'entities.pcmddsqdmx.jdsqmx_grid.columns.orgsectorname',
            show: true,
            util: 'PX'
        },
        {
            name: 'ormpostname',
            label: '借调岗位',
            langtag: 'entities.pcmddsqdmx.jdsqmx_grid.columns.ormpostname',
            show: true,
            util: 'PX'
        },
        {
            name: 'ormdutyname',
            label: '借调职务',
            langtag: 'entities.pcmddsqdmx.jdsqmx_grid.columns.ormdutyname',
            show: true,
            util: 'PX'
        },
        {
            name: 'jdkssj',
            label: '借调开始时间',
            langtag: 'entities.pcmddsqdmx.jdsqmx_grid.columns.jdkssj',
            show: true,
            util: 'px'
        },
        {
            name: 'jdjssj',
            label: '借调结束时间',
            langtag: 'entities.pcmddsqdmx.jdsqmx_grid.columns.jdjssj',
            show: true,
            util: 'px'
        },
        {
            name: 'checkstatus',
            label: '审核状态',
            langtag: 'entities.pcmddsqdmx.jdsqmx_grid.columns.checkstatus',
            show: true,
            util: 'px'
        },
    ]
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PcmDdsqdmxJDSQWSHGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PcmDdsqdmxJDSQWSHGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PcmDdsqdmxJDSQWSHGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PcmDdsqdmxJDSQWSHGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.pcmddsqdmx){
