    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('uagridcolumn1')">
                <el-table-column :column-key="'uagridcolumn1'" :label="$t('entities.pcmxygzzjlmx.main_grid.columns.uagridcolumn1')" :width="150"  :align="'center'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmxygzzjlmx.main_grid.columns.uagridcolumn1')}}
                      </span>
                    </template>
                    <template slot-scope="scope">
                        <div style="text-align: center;">
                            <a @click="uiAction(scope.row, 'CheckDetail', $event)">
                              <i class=''></i>
                              {{$t('entities.pcmxygzzjlmx.main_grid.uiactions.checkdetail')}}
                            </a>
                            <divider type='vertical'></divider>
                            <a @click="uiAction(scope.row, 'Remove', $event)">
                              <i class='fa fa-remove'></i>
                              {{$t('entities.pcmxygzzjlmx.main_grid.uiactions.remove')}}
                            </a>
                        </div>
                    </template>
                </el-table-column>
            ...
            <template v-if="getColumnState('ygbh')">
                <el-table-column show-overflow-tooltip :prop="'ygbh'" :label="$t('entities.pcmxygzzjlmx.main_grid.columns.ygbh')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmxygzzjlmx.main_grid.columns.ygbh')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('zz')">
                <el-table-column show-overflow-tooltip :prop="'zz'" :label="$t('entities.pcmxygzzjlmx.main_grid.columns.zz')" :width="170"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
            ...
            <template v-if="getColumnState('bm')">
                <el-table-column show-overflow-tooltip :prop="'bm'" :label="$t('entities.pcmxygzzjlmx.main_grid.columns.bm')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmxygzzjlmx.main_grid.columns.bm')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.bm}}</span>
            ...
            <template v-if="getColumnState('rzqd')">
                <el-table-column show-overflow-tooltip :prop="'rzqd'" :label="$t('entities.pcmxygzzjlmx.main_grid.columns.rzqd')" :width="130"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmxygzzjlmx.main_grid.columns.rzqd')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('duration')">
                <el-table-column show-overflow-tooltip :prop="'duration'" :label="$t('entities.pcmxygzzjlmx.main_grid.columns.duration')" :width="180"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmxygzzjlmx.main_grid.columns.duration')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('zzgw')">
                <el-table-column show-overflow-tooltip :prop="'zzgw'" :label="$t('entities.pcmxygzzjlmx.main_grid.columns.zzgw')" :width="130"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmxygzzjlmx.main_grid.columns.zzgw')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.zzgw" tag='EhrCodeList0050' codelistType='DYNAMIC' renderMode="STR" valueSeparator=";" textSeparator="、" ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('zzsj')">
                <el-table-column show-overflow-tooltip :prop="'zzsj'" :label="$t('entities.pcmxygzzjlmx.main_grid.columns.zzsj')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmxygzzjlmx.main_grid.columns.zzsj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <app-format-data format="YYYY-MM-DD" :data="row.zzsj"></app-format-data>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('jssj')">
                <el-table-column show-overflow-tooltip :prop="'jssj'" :label="$t('entities.pcmxygzzjlmx.main_grid.columns.jssj')" :width="180"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmxygzzjlmx.main_grid.columns.jssj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.jssj}}</span>
            ...
            <template v-if="getColumnState('fs')">
                <el-table-column show-overflow-tooltip :prop="'fs'" :label="$t('entities.pcmxygzzjlmx.main_grid.columns.fs')" :width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmxygzzjlmx.main_grid.columns.fs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.fs}}</span>
...
import PcmXygzzjlmxService from '@/service/pcm-xygzzjlmx/pcm-xygzzjlmx-service';
import MainService from './main-grid-service';

import PcmXygzzjlmxUIService from '@/uiservice/pcm-xygzzjlmx/pcm-xygzzjlmx-ui-service';
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * 实体服务对象
     *
     * @type {PcmXygzzjlmxService}
     * @memberof MainBase
     */
    public appEntityService: PcmXygzzjlmxService = new PcmXygzzjlmxService({ $store: this.$store });
     ...
     * @memberof 
     */
    public grid_uagridcolumn1_u80e0583_click(params: any = {}, tag?: any, $event?: any) {
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        // _this 指向容器对象
        ...
        // 界面行为
        const curUIService:PcmXygzzjlmxUIService  = new PcmXygzzjlmxUIService();
        curUIService.PcmXygzzjlmx_CheckDetail(datas,contextJO, paramJO,  $event, xData,this,"PcmXygzzjlmx");
    }
     ...
     * @memberof 
     */
    public grid_uagridcolumn1_u86bc187_click(params: any = {}, tag?: any, $event?: any) {
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        // _this 指向容器对象
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"PcmXygzzjlmx");
    }
     ...
     * @memberof PcmXygzzjlmxZZSQLSJMGridViewBase
     */
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'uagridcolumn1',
            label: '操作',
            langtag: 'entities.pcmxygzzjlmx.main_grid.columns.uagridcolumn1',
            show: true,
            util: 'PX'
        },
        {
        ...
        },
        {
            name: 'zz',
            label: '组织',
            langtag: 'entities.pcmxygzzjlmx.main_grid.columns.zz',
            show: true,
            util: 'PX'
        },
        {
            name: 'bm',
            label: '部门',
            langtag: 'entities.pcmxygzzjlmx.main_grid.columns.bm',
            show: true,
            util: 'PX'
        },
        {
            name: 'rzqd',
            label: '入职渠道',
            langtag: 'entities.pcmxygzzjlmx.main_grid.columns.rzqd',
            show: true,
            util: 'px'
        },
        {
            name: 'duration',
            label: '试用期限（月）',
            langtag: 'entities.pcmxygzzjlmx.main_grid.columns.duration',
            show: true,
            util: 'PX'
        },
        {
            name: 'zzgw',
            label: '转正岗位',
            langtag: 'entities.pcmxygzzjlmx.main_grid.columns.zzgw',
            show: true,
            util: 'px'
        },
        {
        ...
        },
        {
            name: 'jssj',
            label: '试用期到期时间',
            langtag: 'entities.pcmxygzzjlmx.main_grid.columns.jssj',
            show: true,
            util: 'PX'
        },
        {
            name: 'fs',
            label: '分数',
            langtag: 'entities.pcmxygzzjlmx.main_grid.columns.fs',
            show: true,
            util: 'px'
        },
        {
    ...
    public rules: any = {
        srfkey: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '试用期员工转正结果引用明细标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '试用期员工转正结果引用明细标识 值不能为空', trigger: 'blur' },
        ],
    }
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PcmXygzzjlmxZZSQLSJMGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PcmXygzzjlmxZZSQLSJMGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        _datas.forEach((record: any, index: number) => {
            let srfmajortext = record.pcmxygzzjlmxname;
            if (index < 5) {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pcmxygzzjlmx: _keys }),Object.assign({ pcmxygzzjlmx: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.pcmxygzzjlmx,$event.pcmxygzzjlmx);
        });
	...
	public uiAction(row: any, tag: any, $event: any) {
        ...
        if(Object.is('CheckDetail', tag)) {
            this.grid_uagridcolumn1_u80e0583_click(row, tag, $event);
        }
        if(Object.is('Remove', tag)) {
            this.grid_uagridcolumn1_u86bc187_click(row, tag, $event);
        }
    }
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('pcmxygzzjlmx_main_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('pcmxygzzjlmx_main_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PcmXygzzjlmxZZSQLSJMGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PcmXygzzjlmxZZSQLSJMGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.pcmxygzzjlmx){
                            Object.assign(this.context,{pcmxygzzjlmx:item.pcmxygzzjlmx});
                        }
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PcmXygzzjlmxZZSQLSJMGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
    ...
    public getRowClassName(args:{row: any,rowIndex: number}){
        let isSelected = this.selections.some((item:any)=>{
            return Object.is(item.pcmxygzzjlmx,args.row.pcmxygzzjlmx);
        });
