    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('ygbh')">
                <el-table-column show-overflow-tooltip :prop="'ygbh'" :label="$t('entities.pimdistirbution.ddfpxx_c_grid.columns.ygbh')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.ddfpxx_c_grid.columns.ygbh')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('pimpersonname')">
                <el-table-column show-overflow-tooltip :prop="'pimpersonname'" :label="$t('entities.pimdistirbution.ddfpxx_c_grid.columns.pimpersonname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.ddfpxx_c_grid.columns.pimpersonname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('ormorgname')">
                <el-table-column show-overflow-tooltip :prop="'ormorgname'" :label="$t('entities.pimdistirbution.ddfpxx_c_grid.columns.ormorgname')" :width="250"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.ddfpxx_c_grid.columns.ormorgname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('ormorgsectorname')">
                <el-table-column show-overflow-tooltip :prop="'ormorgsectorname'" :label="$t('entities.pimdistirbution.ddfpxx_c_grid.columns.ormorgsectorname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.ddfpxx_c_grid.columns.ormorgsectorname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('rank')">
                <el-table-column show-overflow-tooltip :prop="'rank'" :label="$t('entities.pimdistirbution.ddfpxx_c_grid.columns.rank')" :width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.ddfpxx_c_grid.columns.rank')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.rank" tag='EhrCodeList0025' codelistType='DYNAMIC' renderMode="STR" valueSeparator=";" textSeparator="、" ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('ormdutyname')">
                <el-table-column show-overflow-tooltip :prop="'ormdutyname'" :label="$t('entities.pimdistirbution.ddfpxx_c_grid.columns.ormdutyname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.ddfpxx_c_grid.columns.ormdutyname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('ormpostname')">
                <el-table-column show-overflow-tooltip :prop="'ormpostname'" :label="$t('entities.pimdistirbution.ddfpxx_c_grid.columns.ormpostname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.ddfpxx_c_grid.columns.ormpostname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('rzkssj')">
                <el-table-column show-overflow-tooltip :prop="'rzkssj'" :label="$t('entities.pimdistirbution.ddfpxx_c_grid.columns.rzkssj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.ddfpxx_c_grid.columns.rzkssj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('rzjssj')">
                <el-table-column show-overflow-tooltip :prop="'rzjssj'" :label="$t('entities.pimdistirbution.ddfpxx_c_grid.columns.rzjssj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.ddfpxx_c_grid.columns.rzjssj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
...
import DDFPXX_CService from './ddfpxx-c-grid-service';
...
export default class DDFPXX_CBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof DDFPXX_CBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {DDFPXX_CService}
     * @memberof DDFPXX_CBase
     */
    public service: DDFPXX_CService = new DDFPXX_CService({ $store: this.$store });
     ...
     * @memberof DDFPXX_CBase
     */
    public minorSortPSDEF: string = 'pimpersonname';
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'ygbh',
            label: '员工编号',
            langtag: 'entities.pimdistirbution.ddfpxx_c_grid.columns.ygbh',
            show: true,
            util: 'px'
        },
        {
            name: 'pimpersonname',
            label: '员工姓名',
            langtag: 'entities.pimdistirbution.ddfpxx_c_grid.columns.pimpersonname',
            show: true,
            util: 'px'
        },
        {
            name: 'ormorgname',
            label: '组织',
            langtag: 'entities.pimdistirbution.ddfpxx_c_grid.columns.ormorgname',
            show: true,
            util: 'PX'
        },
        {
            ...
            label: '部门',
            langtag: 'entities.pimdistirbution.ddfpxx_c_grid.columns.ormorgsectorname',
            show: true,
            util: 'PX'
        },
        {
            name: 'rank',
            label: '职级',
            langtag: 'entities.pimdistirbution.ddfpxx_c_grid.columns.rank',
            show: true,
            util: 'PX'
        },
        {
            name: 'ormdutyname',
            label: '职务',
            langtag: 'entities.pimdistirbution.ddfpxx_c_grid.columns.ormdutyname',
            show: true,
            util: 'PX'
        },
        {
            name: 'ormpostname',
            label: '岗位',
            langtag: 'entities.pimdistirbution.ddfpxx_c_grid.columns.ormpostname',
            show: true,
            util: 'PX'
        },
        {
            name: 'rzkssj',
            label: '任职开始时间',
            langtag: 'entities.pimdistirbution.ddfpxx_c_grid.columns.rzkssj',
            show: true,
            util: 'px'
        },
        {
            name: 'rzjssj',
            label: '任职结束时间',
            langtag: 'entities.pimdistirbution.ddfpxx_c_grid.columns.rzjssj',
            show: true,
            util: 'px'
        },
    ]
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PimDistirbutionGBDDMgrGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PimDistirbutionGBDDMgrGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('pimdistirbution_ddfpxx_c_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('pimdistirbution_ddfpxx_c_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PimDistirbutionGBDDMgrGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PimDistirbutionGBDDMgrGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PimDistirbutionGBDDMgrGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
