    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('ygbh')">
                <el-table-column show-overflow-tooltip :prop="'ygbh'" :label="$t('entities.pimdistirbution.maturityduegrid_grid.columns.ygbh')" :width="130"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.maturityduegrid_grid.columns.ygbh')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('pimpersonname')">
                <el-table-column show-overflow-tooltip :prop="'pimpersonname'" :label="$t('entities.pimdistirbution.maturityduegrid_grid.columns.pimpersonname')" :width="130"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.maturityduegrid_grid.columns.pimpersonname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('yzzzzdzs')">
                <el-table-column show-overflow-tooltip :prop="'yzzzzdzs'" :label="$t('entities.pimdistirbution.maturityduegrid_grid.columns.yzzzzdzs')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.maturityduegrid_grid.columns.yzzzzdzs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('ybmshortname')">
                <el-table-column show-overflow-tooltip :prop="'ybmshortname'" :label="$t('entities.pimdistirbution.maturityduegrid_grid.columns.ybmshortname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.maturityduegrid_grid.columns.ybmshortname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('yzw')">
                <el-table-column show-overflow-tooltip :prop="'yzw'" :label="$t('entities.pimdistirbution.maturityduegrid_grid.columns.yzw')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.maturityduegrid_grid.columns.yzw')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('ygw')">
                <el-table-column show-overflow-tooltip :prop="'ygw'" :label="$t('entities.pimdistirbution.maturityduegrid_grid.columns.ygw')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.maturityduegrid_grid.columns.ygw')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('zzdzs')">
                <el-table-column show-overflow-tooltip :prop="'zzdzs'" :label="$t('entities.pimdistirbution.maturityduegrid_grid.columns.zzdzs')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.maturityduegrid_grid.columns.zzdzs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.zzdzs}}</span>
            ...
            <template v-if="getColumnState('shortname')">
                <el-table-column show-overflow-tooltip :prop="'shortname'" :label="$t('entities.pimdistirbution.maturityduegrid_grid.columns.shortname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.maturityduegrid_grid.columns.shortname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('ormdutyname')">
                <el-table-column show-overflow-tooltip :prop="'ormdutyname'" :label="$t('entities.pimdistirbution.maturityduegrid_grid.columns.ormdutyname')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.maturityduegrid_grid.columns.ormdutyname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('ormpostname')">
                <el-table-column show-overflow-tooltip :prop="'ormpostname'" :label="$t('entities.pimdistirbution.maturityduegrid_grid.columns.ormpostname')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.maturityduegrid_grid.columns.ormpostname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('rzkssj')">
                <el-table-column show-overflow-tooltip :prop="'rzkssj'" :label="$t('entities.pimdistirbution.maturityduegrid_grid.columns.rzkssj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.maturityduegrid_grid.columns.rzkssj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('rzjssj')">
                <el-table-column show-overflow-tooltip :prop="'rzjssj'" :label="$t('entities.pimdistirbution.maturityduegrid_grid.columns.rzjssj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.maturityduegrid_grid.columns.rzjssj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
...
import MaturityDueGridService from './maturity-due-grid-grid-service';
...
export default class MaturityDueGridBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof MaturityDueGridBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {MaturityDueGridService}
     * @memberof MaturityDueGridBase
     */
    public service: MaturityDueGridService = new MaturityDueGridService({ $store: this.$store });
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'ygbh',
            label: '员工编号',
            langtag: 'entities.pimdistirbution.maturityduegrid_grid.columns.ygbh',
            show: true,
            util: 'PX'
        },
        {
            name: 'pimpersonname',
            label: '员工姓名',
            langtag: 'entities.pimdistirbution.maturityduegrid_grid.columns.pimpersonname',
            show: true,
            util: 'PX'
        },
        {
            name: 'yzzzzdzs',
            label: '原组织',
            langtag: 'entities.pimdistirbution.maturityduegrid_grid.columns.yzzzzdzs',
            show: true,
            util: 'px'
        },
        {
            name: 'ybmshortname',
            label: '原部门',
            langtag: 'entities.pimdistirbution.maturityduegrid_grid.columns.ybmshortname',
            show: true,
            util: 'px'
        },
        {
            name: 'yzw',
            label: '原职务',
            langtag: 'entities.pimdistirbution.maturityduegrid_grid.columns.yzw',
            show: true,
            util: 'PX'
        },
        {
            name: 'ygw',
            label: '原岗位',
            langtag: 'entities.pimdistirbution.maturityduegrid_grid.columns.ygw',
            show: true,
            util: 'PX'
        },
        {
            name: 'zzdzs',
            label: '新组织',
            langtag: 'entities.pimdistirbution.maturityduegrid_grid.columns.zzdzs',
            show: true,
            util: 'PX'
        },
        {
            name: 'shortname',
            label: '新部门',
            langtag: 'entities.pimdistirbution.maturityduegrid_grid.columns.shortname',
            show: true,
            util: 'PX'
        },
        {
            name: 'ormdutyname',
            label: '新职务',
            langtag: 'entities.pimdistirbution.maturityduegrid_grid.columns.ormdutyname',
            show: true,
            util: 'PX'
        },
        {
            name: 'ormpostname',
            label: '新岗位',
            langtag: 'entities.pimdistirbution.maturityduegrid_grid.columns.ormpostname',
            show: true,
            util: 'PX'
        },
        {
            name: 'rzkssj',
            label: '借调开始时间',
            langtag: 'entities.pimdistirbution.maturityduegrid_grid.columns.rzkssj',
            show: true,
            util: 'PX'
        },
        {
            name: 'rzjssj',
            label: '借调结束时间',
            langtag: 'entities.pimdistirbution.maturityduegrid_grid.columns.rzjssj',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public rules: any = {
        ...
        rzkssj: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '借调开始时间 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '借调开始时间 值不能为空', trigger: 'blur' },
        ],
        ormpostname: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '新岗位 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '新岗位 值不能为空', trigger: 'blur' },
        ],
        rzjssj: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '借调结束时间 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '借调结束时间 值不能为空', trigger: 'blur' },
        ],
        srfkey: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '分配信息标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '分配信息标识 值不能为空', trigger: 'blur' },
        ],
        ormdutyname: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '新职务 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '新职务 值不能为空', trigger: 'blur' },
        ],
    }
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PimDistirbutionJDDQGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PimDistirbutionJDDQGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pimdistirbution: _keys }),Object.assign({ pimdistirbution: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.pimdistirbution,$event.pimdistirbution);
        });
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('pimdistirbution_maturityduegrid_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('pimdistirbution_maturityduegrid_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PimDistirbutionJDDQGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PimDistirbutionJDDQGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.pimdistirbution){
                            Object.assign(this.context,{pimdistirbution:item.pimdistirbution});
                        }
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PimDistirbutionJDDQGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
...
<style lang='less'>
@import './maturity-due-grid-grid.less';
</style>