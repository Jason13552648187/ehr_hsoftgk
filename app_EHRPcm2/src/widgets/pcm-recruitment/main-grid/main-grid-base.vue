...
<div class='grid' style="height:100%;">
    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('pcmrecruitmentname')">
                <el-table-column show-overflow-tooltip :prop="'pcmrecruitmentname'" :label="$t('entities.pcmrecruitment.main_grid.columns.pcmrecruitmentname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmrecruitment.main_grid.columns.pcmrecruitmentname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.pcmrecruitmentname}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('recruitmenttype')">
                <el-table-column show-overflow-tooltip :prop="'recruitmenttype'" :label="$t('entities.pcmrecruitment.main_grid.columns.recruitmenttype')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmrecruitment.main_grid.columns.recruitmenttype')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.recruitmenttype" tag='EhrCodeList0197' codelistType='STATIC' ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('sfzpwc')">
                <el-table-column show-overflow-tooltip :prop="'sfzpwc'" :label="$t('entities.pcmrecruitment.main_grid.columns.sfzpwc')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmrecruitment.main_grid.columns.sfzpwc')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.sfzpwc" tag='EhrCodeList0401' codelistType='STATIC' renderMode="STR" valueSeparator=";" textSeparator="、" ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('ormorgname')">
                <el-table-column show-overflow-tooltip :prop="'ormorgname'" :label="$t('entities.pcmrecruitment.main_grid.columns.ormorgname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmrecruitment.main_grid.columns.ormorgname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('ormorgsectorname')">
                <el-table-column show-overflow-tooltip :prop="'ormorgsectorname'" :label="$t('entities.pcmrecruitment.main_grid.columns.ormorgsectorname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmrecruitment.main_grid.columns.ormorgsectorname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('ormdutyname')">
                <el-table-column show-overflow-tooltip :prop="'ormdutyname'" :label="$t('entities.pcmrecruitment.main_grid.columns.ormdutyname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmrecruitment.main_grid.columns.ormdutyname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('ormpostname')">
                <el-table-column show-overflow-tooltip :prop="'ormpostname'" :label="$t('entities.pcmrecruitment.main_grid.columns.ormpostname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmrecruitment.main_grid.columns.ormpostname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('yjzprs')">
                <el-table-column show-overflow-tooltip :prop="'yjzprs'" :label="$t('entities.pcmrecruitment.main_grid.columns.yjzprs')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmrecruitment.main_grid.columns.yjzprs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.yjzprs}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('sjzprs')">
                <el-table-column show-overflow-tooltip :prop="'sjzprs'" :label="$t('entities.pcmrecruitment.main_grid.columns.sjzprs')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmrecruitment.main_grid.columns.sjzprs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.sjzprs}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('updateman')">
                <el-table-column show-overflow-tooltip :prop="'updateman'" :label="$t('entities.pcmrecruitment.main_grid.columns.updateman')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmrecruitment.main_grid.columns.updateman')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('updatedate')">
                <el-table-column show-overflow-tooltip :prop="'updatedate'" :label="$t('entities.pcmrecruitment.main_grid.columns.updatedate')" :width="170"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmrecruitment.main_grid.columns.updatedate')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof MainBase
     */
    public appEntityService: PcmRecruitmentService = new PcmRecruitmentService({ $store: this.$store });
    ...
    */
    ...
    public allColumns: any[] = [
        {
            ...
            label: '内部招聘信息名称',
            langtag: 'entities.pcmrecruitment.main_grid.columns.pcmrecruitmentname',
            show: true,
            util: 'PX'
        },
        {
            ...
            label: '招聘类型',
            langtag: 'entities.pcmrecruitment.main_grid.columns.recruitmenttype',
            show: true,
            util: 'px'
        },
        {
            name: 'sfzpwc',
            label: '是否招聘完成',
            langtag: 'entities.pcmrecruitment.main_grid.columns.sfzpwc',
            show: true,
            util: 'px'
        },
        {
            name: 'ormorgname',
            label: '组织名称',
            langtag: 'entities.pcmrecruitment.main_grid.columns.ormorgname',
            show: true,
            util: 'px'
        },
        {
            ...
            label: '部门名称',
            langtag: 'entities.pcmrecruitment.main_grid.columns.ormorgsectorname',
            show: true,
            util: 'px'
        },
        {
            name: 'ormdutyname',
            label: '职务',
            langtag: 'entities.pcmrecruitment.main_grid.columns.ormdutyname',
            show: true,
            util: 'px'
        },
        {
            name: 'ormpostname',
            label: '岗位',
            langtag: 'entities.pcmrecruitment.main_grid.columns.ormpostname',
            show: true,
            util: 'px'
        },
        {
            name: 'yjzprs',
            label: '预计招聘人数',
            langtag: 'entities.pcmrecruitment.main_grid.columns.yjzprs',
            show: true,
            util: 'px'
        },
        {
            name: 'sjzprs',
            label: '实际招聘人数',
            langtag: 'entities.pcmrecruitment.main_grid.columns.sjzprs',
            show: true,
            util: 'px'
        },
        {
            name: 'updateman',
            label: '更新人',
            langtag: 'entities.pcmrecruitment.main_grid.columns.updateman',
            show: true,
            util: 'PX'
        },
        {
            name: 'updatedate',
            label: '更新时间',
            langtag: 'entities.pcmrecruitment.main_grid.columns.updatedate',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public rules: any = {
        srfkey: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '内部招聘信息标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '内部招聘信息标识 值不能为空', trigger: 'blur' },
        ],
    }
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PcmRecruitmentPickupGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PcmRecruitmentPickupGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        _datas.forEach((record: any, index: number) => {
            let srfmajortext = record.pcmrecruitmentname;
            if (index < 5) {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pcmrecruitment: _keys }),Object.assign({ pcmrecruitment: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.pcmrecruitment,$event.pcmrecruitment);
        });
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('pcmrecruitment_main_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('pcmrecruitment_main_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PcmRecruitmentPickupGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PcmRecruitmentPickupGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.pcmrecruitment){
                            Object.assign(this.context,{pcmrecruitment:item.pcmrecruitment});
                        }
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PcmRecruitmentPickupGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
    ...
    public getRowClassName(args:{row: any,rowIndex: number}){
        let isSelected = this.selections.some((item:any)=>{
            return Object.is(item.pcmrecruitment,args.row.pcmrecruitment);
        });
