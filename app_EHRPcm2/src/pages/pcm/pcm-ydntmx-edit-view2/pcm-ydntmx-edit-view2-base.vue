<template>
  <app-layout viewName="pcmydntmxeditview2" viewTitle="异动内退明细编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview2': true, 'pcm-ydntmx-edit-view2': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdntmxEditView2Base
 * @extends {EditView2Base}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdntmxEditView2Base extends EditView2Base {
	 ...
	 * @memberof PcmYdntmxEditView2Base
	 */
	public viewtag: string = 'a93b6b6efe8a9ccf0a6f5a46cdbbc5a5';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydntmx.views.editview2.caption',
        srfTitle: 'entities.pcmydntmx.views.editview2.title',
        srfSubTitle: 'entities.pcmydntmx.views.editview2.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pcm-ydntmx-edit-view2.less';
</style>