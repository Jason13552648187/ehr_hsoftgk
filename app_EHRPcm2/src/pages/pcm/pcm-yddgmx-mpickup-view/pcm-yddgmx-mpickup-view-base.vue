<template>
  <app-layout viewName="pcmyddgmxmpickupview" viewTitle="异动待岗明细数据多项选择视图" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'dempickupview': true, 'pcm-yddgmx-mpickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYddgmxMPickupViewBase
 * @extends {MPickupViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYddgmxMPickupViewBase extends MPickupViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYddgmxService}
     * @memberof PcmYddgmxMPickupViewBase
     */
	 ...
	 * @memberof PcmYddgmxMPickupViewBase
	 */
	public viewtag: string = 'e58b0632b9beb66d7b86e34d2794cda7';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmyddgmx.views.mpickupview.caption',
        srfTitle: 'entities.pcmyddgmx.views.mpickupview.title',
        srfSubTitle: 'entities.pcmyddgmx.views.mpickupview.subtitle',
        dataInfo: ''
    }
        ...
        Object.values(this.containerModel).forEach((model: any) => {
            ...
            if(model.datas.length>0){
                model.datas.forEach((data:any,index:any)=>{
                    Object.assign(data,{srfmajortext: data['pcmyddgmxname']});
                })
            }
...
<style lang='less'>
@import './pcm-yddgmx-mpickup-view.less';
</style>