<template>
  <app-layout viewName="pimpersontxqreditview" viewTitle="请确认/修改退休信息" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pim-person-txqredit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PimPersonTXQREditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PimPersonTXQREditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimPersonService}
     * @memberof PimPersonTXQREditViewBase
     */
	 ...
	 * @memberof PimPersonTXQREditViewBase
	 */
	public viewtag: string = '8a956c3690e308b4a8cf365a643bd6c1';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimperson.views.txqreditview.caption',
        srfTitle: 'entities.pimperson.views.txqreditview.title',
        srfSubTitle: 'entities.pimperson.views.txqreditview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PimPersonTXQREditView
     */
...
<style lang='less'>
@import './pim-person-txqredit-view.less';
</style>