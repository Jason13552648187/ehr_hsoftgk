...
export default class PcmXygzzjlmxEditView9Base extends EditView9Base {

    /**
     * 实体服务对象
     *
     * @type {PcmXygzzjlmxService}
     * @memberof PcmXygzzjlmxEditView9Base
     */
	 ...
	 * @memberof PcmXygzzjlmxEditView9Base
	 */
	public viewtag: string = 'a9827f5ee0e883f0c48c5a5f2d89b124';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmxygzzjlmx.views.editview9.caption',
        srfTitle: 'entities.pcmxygzzjlmx.views.editview9.title',
        srfSubTitle: 'entities.pcmxygzzjlmx.views.editview9.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PcmXygzzjlmxEditView9
     */
...
<style lang='less'>
@import './pcm-xygzzjlmx-edit-view9.less';
</style>