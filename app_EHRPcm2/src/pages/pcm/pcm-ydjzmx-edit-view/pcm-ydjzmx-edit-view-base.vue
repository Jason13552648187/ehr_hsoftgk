<template>
  <app-layout viewName="pcmydjzmxeditview" viewTitle="异动兼职明细编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcm-ydjzmx-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdjzmxEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdjzmxEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdjzmxService}
     * @memberof PcmYdjzmxEditViewBase
     */
	 ...
	 * @memberof PcmYdjzmxEditViewBase
	 */
	public viewtag: string = 'e3d460cef63d656feba9ecc50731a3f3';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydjzmx.views.editview.caption',
        srfTitle: 'entities.pcmydjzmx.views.editview.title',
        srfSubTitle: 'entities.pcmydjzmx.views.editview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pcm-ydjzmx-edit-view.less';
</style>