<template>
  <app-layout viewName="pcmddsqdmxddeditview" viewTitle="调动" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcm-ddsqdmx-ddedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmDdsqdmxDDEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmDdsqdmxDDEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmDdsqdmxService}
     * @memberof PcmDdsqdmxDDEditViewBase
     */
	 ...
	 * @memberof PcmDdsqdmxDDEditViewBase
	 */
	public viewtag: string = '4a99687a15282a2616a626be57be52af';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmddsqdmx.views.ddeditview.caption',
        srfTitle: 'entities.pcmddsqdmx.views.ddeditview.title',
        srfSubTitle: 'entities.pcmddsqdmx.views.ddeditview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pcm-ddsqdmx-ddedit-view.less';
</style>