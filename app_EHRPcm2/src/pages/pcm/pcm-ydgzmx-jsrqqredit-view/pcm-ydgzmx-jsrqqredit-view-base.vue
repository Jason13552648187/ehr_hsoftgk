<template>
  <app-layout viewName="pcmydgzmxjsrqqreditview" viewTitle="请确认/修改挂职结束时间" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcm-ydgzmx-jsrqqredit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdgzmxJSRQQREditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdgzmxJSRQQREditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdgzmxService}
     * @memberof PcmYdgzmxJSRQQREditViewBase
     */
	 ...
	 * @memberof PcmYdgzmxJSRQQREditViewBase
	 */
	public viewtag: string = '29f9fa27438ea356ca1cc1bd5e052530';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydgzmx.views.jsrqqreditview.caption',
        srfTitle: 'entities.pcmydgzmx.views.jsrqqreditview.title',
        srfSubTitle: 'entities.pcmydgzmx.views.jsrqqreditview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PcmYdgzmxJSRQQREditView
     */
...
<style lang='less'>
@import './pcm-ydgzmx-jsrqqredit-view.less';
</style>