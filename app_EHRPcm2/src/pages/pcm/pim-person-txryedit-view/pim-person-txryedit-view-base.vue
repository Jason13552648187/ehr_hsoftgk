<template>
  <app-layout viewName="pimpersontxryeditview" viewTitle="退休人员信息" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pim-person-txryedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PimPersonTXRYEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PimPersonTXRYEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimPersonService}
     * @memberof PimPersonTXRYEditViewBase
     */
	 ...
	 * @memberof PimPersonTXRYEditViewBase
	 */
	public viewtag: string = '88de65d118d034ec62514ec9cc229438';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimperson.views.txryeditview.caption',
        srfTitle: 'entities.pimperson.views.txryeditview.title',
        srfSubTitle: 'entities.pimperson.views.txryeditview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PimPersonTXRYEditView
     */
...
<style lang='less'>
@import './pim-person-txryedit-view.less';
</style>