<template>
  <app-layout viewName="pcmddsqdmxgrzzsqjzeditview" viewTitle="兼职申请编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcm-ddsqdmx-grzzsqjzedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmDdsqdmxGRZZSQJZEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmDdsqdmxGRZZSQJZEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmDdsqdmxService}
     * @memberof PcmDdsqdmxGRZZSQJZEditViewBase
     */
	 ...
	 * @memberof PcmDdsqdmxGRZZSQJZEditViewBase
	 */
	public viewtag: string = '5bb09d8d12dee4d5301dcc64078b0dcb';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmddsqdmx.views.grzzsqjzeditview.caption',
        srfTitle: 'entities.pcmddsqdmx.views.grzzsqjzeditview.title',
        srfSubTitle: 'entities.pcmddsqdmx.views.grzzsqjzeditview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PcmDdsqdmxGRZZSQJZEditView
     */
...
<style lang='less'>
@import './pcm-ddsqdmx-grzzsqjzedit-view.less';
</style>