<template>
  <app-layout viewName="pcmydjdmxmpickupview" viewTitle="异动借调明细数据多项选择视图" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'dempickupview': true, 'pcm-ydjdmx-mpickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdjdmxMPickupViewBase
 * @extends {MPickupViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdjdmxMPickupViewBase extends MPickupViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdjdmxService}
     * @memberof PcmYdjdmxMPickupViewBase
     */
	 ...
	 * @memberof PcmYdjdmxMPickupViewBase
	 */
	public viewtag: string = '569e19acb133248dc84d29ed504ccacc';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydjdmx.views.mpickupview.caption',
        srfTitle: 'entities.pcmydjdmx.views.mpickupview.title',
        srfSubTitle: 'entities.pcmydjdmx.views.mpickupview.subtitle',
        dataInfo: ''
    }
        ...
        Object.values(this.containerModel).forEach((model: any) => {
            ...
            if(model.datas.length>0){
                model.datas.forEach((data:any,index:any)=>{
                    Object.assign(data,{srfmajortext: data['pcmydjdmxname']});
                })
            }
...
<style lang='less'>
@import './pcm-ydjdmx-mpickup-view.less';
</style>