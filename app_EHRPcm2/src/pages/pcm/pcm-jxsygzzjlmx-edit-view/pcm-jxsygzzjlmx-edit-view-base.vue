<template>
  <app-layout viewName="pcmjxsygzzjlmxeditview" viewTitle="见习生员工转正记录引用明细编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcm-jxsygzzjlmx-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmJxsygzzjlmxEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmJxsygzzjlmxEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmJxsygzzjlmxService}
     * @memberof PcmJxsygzzjlmxEditViewBase
     */
    public appEntityService: PcmJxsygzzjlmxService = new PcmJxsygzzjlmxService;
	 ...
	 * @memberof PcmJxsygzzjlmxEditViewBase
	 */
	public viewtag: string = '75b62ccd6984832138d637517d537ad4';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmjxsygzzjlmx.views.editview.caption',
        srfTitle: 'entities.pcmjxsygzzjlmx.views.editview.title',
        srfSubTitle: 'entities.pcmjxsygzzjlmx.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PcmJxsygzzjlmxEditView
     */
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'pcmjxsygzzjlmx',
            majorPSDEField: 'pcmjxsygzzjlmxname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"PcmJxsygzzjlmx");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"PcmJxsygzzjlmx");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PcmJxsygzzjlmx");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PcmJxsygzzjlmx");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"PcmJxsygzzjlmx");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"PcmJxsygzzjlmx");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"PcmJxsygzzjlmx");
    }
...
<style lang='less'>
@import './pcm-jxsygzzjlmx-edit-view.less';
</style>