<template>
  <app-layout viewName="pcmydjdmxjdjsqreditview" viewTitle="请确认/修改借调结束时间" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcm-ydjdmx-jdjsqredit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdjdmxJDJSQREditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdjdmxJDJSQREditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdjdmxService}
     * @memberof PcmYdjdmxJDJSQREditViewBase
     */
	 ...
	 * @memberof PcmYdjdmxJDJSQREditViewBase
	 */
	public viewtag: string = '1bf4b1a851c85bdb86dced19899be308';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydjdmx.views.jdjsqreditview.caption',
        srfTitle: 'entities.pcmydjdmx.views.jdjsqreditview.title',
        srfSubTitle: 'entities.pcmydjdmx.views.jdjsqreditview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PcmYdjdmxJDJSQREditView
     */
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Exit(datas, contextJO,paramJO,  $event, xData,this,"PcmYdjdmx");
    }
...
<style lang='less'>
@import './pcm-ydjdmx-jdjsqredit-view.less';
</style>