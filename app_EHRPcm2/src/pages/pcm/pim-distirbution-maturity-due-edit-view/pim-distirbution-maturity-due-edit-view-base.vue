<template>
  <app-layout viewName="pimdistirbutionmaturitydueeditview" viewTitle="借调到期编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pim-distirbution-maturity-due-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PimDistirbutionMaturityDueEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PimDistirbutionMaturityDueEditViewBase extends EditViewBase {
	 ...
	 * @memberof PimDistirbutionMaturityDueEditViewBase
	 */
	public viewtag: string = '4880095fa928f20096fe9fce0692351f';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimdistirbution.views.maturitydueeditview.caption',
        srfTitle: 'entities.pimdistirbution.views.maturitydueeditview.title',
        srfSubTitle: 'entities.pimdistirbution.views.maturitydueeditview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PimDistirbutionMaturityDueEditView
     */
...
<style lang='less'>
@import './pim-distirbution-maturity-due-edit-view.less';
</style>