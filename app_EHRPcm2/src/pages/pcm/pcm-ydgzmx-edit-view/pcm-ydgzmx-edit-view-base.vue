<template>
  <app-layout viewName="pcmydgzmxeditview" viewTitle="异动挂职明细编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcm-ydgzmx-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdgzmxEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdgzmxEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdgzmxService}
     * @memberof PcmYdgzmxEditViewBase
     */
	 ...
	 * @memberof PcmYdgzmxEditViewBase
	 */
	public viewtag: string = 'c25d65e47b4897084226ea56e60dfde2';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydgzmx.views.editview.caption',
        srfTitle: 'entities.pcmydgzmx.views.editview.title',
        srfSubTitle: 'entities.pcmydgzmx.views.editview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pcm-ydgzmx-edit-view.less';
</style>