<template>
  <app-layout viewName="pcmydlzmxeditview2" viewTitle="异动离职明细编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview2': true, 'pcm-ydlzmx-edit-view2': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdlzmxEditView2Base
 * @extends {EditView2Base}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdlzmxEditView2Base extends EditView2Base {

    /**
     * 实体服务对象
     *
     * @type {PcmYdlzmxService}
     * @memberof PcmYdlzmxEditView2Base
     */
	 ...
	 * @memberof PcmYdlzmxEditView2Base
	 */
	public viewtag: string = 'e2f17dc1b362d356d85b44c45a0601ee';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydlzmx.views.editview2.caption',
        srfTitle: 'entities.pcmydlzmx.views.editview2.title',
        srfSubTitle: 'entities.pcmydlzmx.views.editview2.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'pcmydlzmx',
            majorPSDEField: 'pcmydlzmxname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"PcmYdlzmx");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"PcmYdlzmx");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PcmYdlzmx");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PcmYdlzmx");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"PcmYdlzmx");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"PcmYdlzmx");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"PcmYdlzmx");
    }
...
<style lang='less'>
@import './pcm-ydlzmx-edit-view2.less';
</style>