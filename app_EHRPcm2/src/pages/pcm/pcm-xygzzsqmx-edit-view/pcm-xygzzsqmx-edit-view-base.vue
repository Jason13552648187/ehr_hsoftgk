<template>
  <app-layout viewName="pcmxygzzsqmxeditview" viewTitle="试用期员工转正申请明细编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcm-xygzzsqmx-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmXygzzsqmxEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmXygzzsqmxEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmXygzzsqmxService}
     * @memberof PcmXygzzsqmxEditViewBase
     */
    public appEntityService: PcmXygzzsqmxService = new PcmXygzzsqmxService;
	 ...
	 * @memberof PcmXygzzsqmxEditViewBase
	 */
	public viewtag: string = '61e224a44cc2b1ca41013b5b85d177a3';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmxygzzsqmx.views.editview.caption',
        srfTitle: 'entities.pcmxygzzsqmx.views.editview.title',
        srfSubTitle: 'entities.pcmxygzzsqmx.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'pcmxygzzsqmx',
            majorPSDEField: 'pcmxygzzsqmxname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"PcmXygzzsqmx");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"PcmXygzzsqmx");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PcmXygzzsqmx");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PcmXygzzsqmx");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"PcmXygzzsqmx");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"PcmXygzzsqmx");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"PcmXygzzsqmx");
    }
...
<style lang='less'>
@import './pcm-xygzzsqmx-edit-view.less';
</style>