<template>
  <app-layout viewName="pcmydjpmxxzeditview" viewTitle="新增解聘" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcm-ydjpmx-xzedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdjpmxXZEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdjpmxXZEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdjpmxService}
     * @memberof PcmYdjpmxXZEditViewBase
     */
	 ...
	 * @memberof PcmYdjpmxXZEditViewBase
	 */
	public viewtag: string = '880708a2c62910269eb8ae33afdf5e4b';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydjpmx.views.xzeditview.caption',
        srfTitle: 'entities.pcmydjpmx.views.xzeditview.title',
        srfSubTitle: 'entities.pcmydjpmx.views.xzeditview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_deuiaction2_saveandexit_click(params: any = {}, tag?: any, $event?: any) {
        ...
        curUIService.PcmYdjpmx_SaveAndExit(datas,contextJO, paramJO,  $event, xData,this,"PcmYdjpmx");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Exit(datas, contextJO,paramJO,  $event, xData,this,"PcmYdjpmx");
    }
...
<style lang='less'>
@import './pcm-ydjpmx-xzedit-view.less';
</style>