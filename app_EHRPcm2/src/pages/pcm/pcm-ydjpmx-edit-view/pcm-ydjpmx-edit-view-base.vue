<template>
  <app-layout viewName="pcmydjpmxeditview" viewTitle="异动解聘明细" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcm-ydjpmx-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdjpmxEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdjpmxEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdjpmxService}
     * @memberof PcmYdjpmxEditViewBase
     */
	 ...
	 * @memberof PcmYdjpmxEditViewBase
	 */
	public viewtag: string = '1296e9fa7cfba6b54cd535ecacbe09fd';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydjpmx.views.editview.caption',
        srfTitle: 'entities.pcmydjpmx.views.editview.title',
        srfSubTitle: 'entities.pcmydjpmx.views.editview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pcm-ydjpmx-edit-view.less';
</style>