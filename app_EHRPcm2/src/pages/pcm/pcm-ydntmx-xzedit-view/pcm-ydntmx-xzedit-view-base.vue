<template>
  <app-layout viewName="pcmydntmxxzeditview" viewTitle="新增内退" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcm-ydntmx-xzedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdntmxXZEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdntmxXZEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdntmxService}
     * @memberof PcmYdntmxXZEditViewBase
     */
	 ...
	 * @memberof PcmYdntmxXZEditViewBase
	 */
	public viewtag: string = '994b7724ecfb0f0e9a157db2b34affd1';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydntmx.views.xzeditview.caption',
        srfTitle: 'entities.pcmydntmx.views.xzeditview.title',
        srfSubTitle: 'entities.pcmydntmx.views.xzeditview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pcm-ydntmx-xzedit-view.less';
</style>