<template>
  <app-layout viewName="pcmydlzmxxzeditview" viewTitle="新增离职" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcm-ydlzmx-xzedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdlzmxXZEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdlzmxXZEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdlzmxService}
     * @memberof PcmYdlzmxXZEditViewBase
     */
	 ...
	 * @memberof PcmYdlzmxXZEditViewBase
	 */
	public viewtag: string = '09ed0f4be9f3ab5b9eb28cd9323a7692';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydlzmx.views.xzeditview.caption',
        srfTitle: 'entities.pcmydlzmx.views.xzeditview.title',
        srfSubTitle: 'entities.pcmydlzmx.views.xzeditview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Exit(datas, contextJO,paramJO,  $event, xData,this,"PcmYdlzmx");
    }
...
<style lang='less'>
@import './pcm-ydlzmx-xzedit-view.less';
</style>