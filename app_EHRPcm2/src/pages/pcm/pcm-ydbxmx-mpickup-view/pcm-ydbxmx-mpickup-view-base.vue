<template>
  <app-layout viewName="pcmydbxmxmpickupview" viewTitle="异动病休明细数据多项选择视图" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'dempickupview': true, 'pcm-ydbxmx-mpickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdbxmxMPickupViewBase
 * @extends {MPickupViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdbxmxMPickupViewBase extends MPickupViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdbxmxService}
     * @memberof PcmYdbxmxMPickupViewBase
     */
	 ...
	 * @memberof PcmYdbxmxMPickupViewBase
	 */
	public viewtag: string = '06d6fbd825358a4d7de7d8760a02e12c';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydbxmx.views.mpickupview.caption',
        srfTitle: 'entities.pcmydbxmx.views.mpickupview.title',
        srfSubTitle: 'entities.pcmydbxmx.views.mpickupview.subtitle',
        dataInfo: ''
    }
        ...
        Object.values(this.containerModel).forEach((model: any) => {
            ...
            if(model.datas.length>0){
                model.datas.forEach((data:any,index:any)=>{
                    Object.assign(data,{srfmajortext: data['pcmydbxmxname']});
                })
            }
...
<style lang='less'>
@import './pcm-ydbxmx-mpickup-view.less';
</style>