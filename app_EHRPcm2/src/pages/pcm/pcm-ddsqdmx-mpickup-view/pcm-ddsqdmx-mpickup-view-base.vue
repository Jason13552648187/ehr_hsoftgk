<template>
  <app-layout viewName="pcmddsqdmxmpickupview" viewTitle="调动申请单明细数据多项选择视图" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'dempickupview': true, 'pcm-ddsqdmx-mpickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmDdsqdmxMPickupViewBase
 * @extends {MPickupViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmDdsqdmxMPickupViewBase extends MPickupViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmDdsqdmxService}
     * @memberof PcmDdsqdmxMPickupViewBase
     */
	 ...
	 * @memberof PcmDdsqdmxMPickupViewBase
	 */
	public viewtag: string = '467f25c7822b1b29608934028376cd9c';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmddsqdmx.views.mpickupview.caption',
        srfTitle: 'entities.pcmddsqdmx.views.mpickupview.title',
        srfSubTitle: 'entities.pcmddsqdmx.views.mpickupview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {any[]}
     * @memberof PcmDdsqdmxMPickupView
     */
        ...
        Object.values(this.containerModel).forEach((model: any) => {
            ...
            if(model.datas.length>0){
                model.datas.forEach((data:any,index:any)=>{
                    Object.assign(data,{srfmajortext: data['pcmddsqdmxname']});
                })
            }
...
<style lang='less'>
@import './pcm-ddsqdmx-mpickup-view.less';
</style>