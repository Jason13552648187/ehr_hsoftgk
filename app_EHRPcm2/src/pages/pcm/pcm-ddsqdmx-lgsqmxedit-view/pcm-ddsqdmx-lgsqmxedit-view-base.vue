<template>
  <app-layout viewName="pcmddsqdmxlgsqmxeditview" viewTitle="轮岗申请明细" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcm-ddsqdmx-lgsqmxedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmDdsqdmxLGSQMXEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmDdsqdmxLGSQMXEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmDdsqdmxService}
     * @memberof PcmDdsqdmxLGSQMXEditViewBase
     */
	 ...
	 * @memberof PcmDdsqdmxLGSQMXEditViewBase
	 */
	public viewtag: string = 'df0b54408a34dc0a8c7c3c9ee9310e7c';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmddsqdmx.views.lgsqmxeditview.caption',
        srfTitle: 'entities.pcmddsqdmx.views.lgsqmxeditview.title',
        srfSubTitle: 'entities.pcmddsqdmx.views.lgsqmxeditview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PcmDdsqdmxLGSQMXEditView
     */
...
<style lang='less'>
@import './pcm-ddsqdmx-lgsqmxedit-view.less';
</style>