<template>
  <app-layout viewName="pcmydgzmxtype_gzjeditview3" viewTitle="异动挂职明细编辑视图(挂职进)" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview3': true, 'pcm-ydgzmx-type-gzjedit-view3': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdgzmxType_GZJEditView3Base
 * @extends {EditView3Base}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdgzmxType_GZJEditView3Base extends EditView3Base {
	 ...
	 * @memberof PcmYdgzmxType_GZJEditView3Base
	 */
	public viewtag: string = '67d8ae75186cb57f396b4f0ac4f89abe';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydgzmx.views.type_gzjeditview3.caption',
        srfTitle: 'entities.pcmydgzmx.views.type_gzjeditview3.title',
        srfSubTitle: 'entities.pcmydgzmx.views.type_gzjeditview3.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PcmYdgzmxType_GZJEditView3
     */
...
<style lang='less'>
@import './pcm-ydgzmx-type-gzjedit-view3.less';
</style>