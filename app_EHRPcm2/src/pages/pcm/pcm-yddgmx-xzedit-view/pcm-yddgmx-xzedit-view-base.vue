<template>
  <app-layout viewName="pcmyddgmxxzeditview" viewTitle="新增待岗" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcm-yddgmx-xzedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYddgmxXZEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYddgmxXZEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYddgmxService}
     * @memberof PcmYddgmxXZEditViewBase
     */
	 ...
	 * @memberof PcmYddgmxXZEditViewBase
	 */
	public viewtag: string = 'f8e8d3d1a30cdb1de8e896725f4722e4';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmyddgmx.views.xzeditview.caption',
        srfTitle: 'entities.pcmyddgmx.views.xzeditview.title',
        srfSubTitle: 'entities.pcmyddgmx.views.xzeditview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pcm-yddgmx-xzedit-view.less';
</style>