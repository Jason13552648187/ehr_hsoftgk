<template>
  <app-layout viewName="pcmydgzmxeditview2" viewTitle="异动挂职明细编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview2': true, 'pcm-ydgzmx-edit-view2': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdgzmxEditView2Base
 * @extends {EditView2Base}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdgzmxEditView2Base extends EditView2Base {

    /**
     * 实体服务对象
     *
     * @type {PcmYdgzmxService}
     * @memberof PcmYdgzmxEditView2Base
     */
	 ...
	 * @memberof PcmYdgzmxEditView2Base
	 */
	public viewtag: string = '501e0ad8df3edbe849662fb78bd008ea';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydgzmx.views.editview2.caption',
        srfTitle: 'entities.pcmydgzmx.views.editview2.title',
        srfSubTitle: 'entities.pcmydgzmx.views.editview2.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"PcmYdgzmx");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PcmYdgzmx");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"PcmYdgzmx");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"PcmYdgzmx");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"PcmYdgzmx");
    }
...
<style lang='less'>
@import './pcm-ydgzmx-edit-view2.less';
</style>