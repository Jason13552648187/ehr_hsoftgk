<template>
  <app-layout viewName="pcmddsqdmxgrzzsqddeditview" viewTitle="调动申请编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcm-ddsqdmx-grzzsqddedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmDdsqdmxGRZZSQDDEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmDdsqdmxGRZZSQDDEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmDdsqdmxService}
     * @memberof PcmDdsqdmxGRZZSQDDEditViewBase
     */
	 ...
	 * @memberof PcmDdsqdmxGRZZSQDDEditViewBase
	 */
	public viewtag: string = '89d7da6963978b8a7f0c23f62cc194d3';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmddsqdmx.views.grzzsqddeditview.caption',
        srfTitle: 'entities.pcmddsqdmx.views.grzzsqddeditview.title',
        srfSubTitle: 'entities.pcmddsqdmx.views.grzzsqddeditview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PcmDdsqdmxGRZZSQDDEditView
     */
...
<style lang='less'>
@import './pcm-ddsqdmx-grzzsqddedit-view.less';
</style>