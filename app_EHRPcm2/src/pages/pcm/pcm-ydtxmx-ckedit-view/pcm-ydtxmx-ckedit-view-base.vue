<template>
  <app-layout viewName="pcmydtxmxckeditview" viewTitle="异动退休明细" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcm-ydtxmx-ckedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdtxmxCKEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdtxmxCKEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdtxmxService}
     * @memberof PcmYdtxmxCKEditViewBase
     */
	 ...
	 * @memberof PcmYdtxmxCKEditViewBase
	 */
	public viewtag: string = 'c1f28d055aab3e2ca57dbb55834f287f';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydtxmx.views.ckeditview.caption',
        srfTitle: 'entities.pcmydtxmx.views.ckeditview.title',
        srfSubTitle: 'entities.pcmydtxmx.views.ckeditview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"PcmYdtxmx");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"PcmYdtxmx");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PcmYdtxmx");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PcmYdtxmx");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"PcmYdtxmx");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"PcmYdtxmx");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"PcmYdtxmx");
    }
...
<style lang='less'>
@import './pcm-ydtxmx-ckedit-view.less';
</style>