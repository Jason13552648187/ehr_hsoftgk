<template>
  <app-layout viewName="pcmddsqdmxjzsqmxeditview" viewTitle="兼职申请明细" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcm-ddsqdmx-jzsqmxedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmDdsqdmxJZSQMXEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmDdsqdmxJZSQMXEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmDdsqdmxService}
     * @memberof PcmDdsqdmxJZSQMXEditViewBase
     */
	 ...
	 * @memberof PcmDdsqdmxJZSQMXEditViewBase
	 */
	public viewtag: string = '844f674b829f7675d4c632eeae5de71f';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmddsqdmx.views.jzsqmxeditview.caption',
        srfTitle: 'entities.pcmddsqdmx.views.jzsqmxeditview.title',
        srfSubTitle: 'entities.pcmddsqdmx.views.jzsqmxeditview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PcmDdsqdmxJZSQMXEditView
     */
...
<style lang='less'>
@import './pcm-ddsqdmx-jzsqmxedit-view.less';
</style>