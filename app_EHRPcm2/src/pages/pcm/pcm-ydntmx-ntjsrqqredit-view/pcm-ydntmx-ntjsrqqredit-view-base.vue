<template>
  <app-layout viewName="pcmydntmxntjsrqqreditview" viewTitle="请确认/修改内退结束日期" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcm-ydntmx-ntjsrqqredit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdntmxNTJSRQQREditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdntmxNTJSRQQREditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdntmxService}
     * @memberof PcmYdntmxNTJSRQQREditViewBase
     */
	 ...
	 * @memberof PcmYdntmxNTJSRQQREditViewBase
	 */
	public viewtag: string = 'efb790310f26eb833d6115de419d039b';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydntmx.views.ntjsrqqreditview.caption',
        srfTitle: 'entities.pcmydntmx.views.ntjsrqqreditview.title',
        srfSubTitle: 'entities.pcmydntmx.views.ntjsrqqreditview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PcmYdntmxNTJSRQQREditView
     */
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Exit(datas, contextJO,paramJO,  $event, xData,this,"PcmYdntmx");
    }
...
<style lang='less'>
@import './pcm-ydntmx-ntjsrqqredit-view.less';
</style>