<template>
  <app-layout viewName="pcmydgzmxmpickupview" viewTitle="异动挂职明细数据多项选择视图" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'dempickupview': true, 'pcm-ydgzmx-mpickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdgzmxMPickupViewBase
 * @extends {MPickupViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdgzmxMPickupViewBase extends MPickupViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdgzmxService}
     * @memberof PcmYdgzmxMPickupViewBase
     */
	 ...
	 * @memberof PcmYdgzmxMPickupViewBase
	 */
	public viewtag: string = '114f6647f6f6cf489145008536c1bd93';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydgzmx.views.mpickupview.caption',
        srfTitle: 'entities.pcmydgzmx.views.mpickupview.title',
        srfSubTitle: 'entities.pcmydgzmx.views.mpickupview.subtitle',
        dataInfo: ''
    }
        ...
        Object.values(this.containerModel).forEach((model: any) => {
            ...
            if(model.datas.length>0){
                model.datas.forEach((data:any,index:any)=>{
                    Object.assign(data,{srfmajortext: data['pcmydgzmxname']});
                })
            }
...
<style lang='less'>
@import './pcm-ydgzmx-mpickup-view.less';
</style>