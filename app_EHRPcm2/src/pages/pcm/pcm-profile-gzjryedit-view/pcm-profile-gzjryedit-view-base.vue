<template>
  <app-layout viewName="pcmprofilegzjryeditview" viewTitle="挂职进人员信息" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcm-profile-gzjryedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmProfileGZJRYEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmProfileGZJRYEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmProfileService}
     * @memberof PcmProfileGZJRYEditViewBase
     */
	 ...
	 * @memberof PcmProfileGZJRYEditViewBase
	 */
	public viewtag: string = 'e8a71f2daabc7af8748d5c702989e250';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmprofile.views.gzjryeditview.caption',
        srfTitle: 'entities.pcmprofile.views.gzjryeditview.title',
        srfSubTitle: 'entities.pcmprofile.views.gzjryeditview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PcmProfileGZJRYEditView
     */
...
<style lang='less'>
@import './pcm-profile-gzjryedit-view.less';
</style>