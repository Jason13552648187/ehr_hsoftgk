<template>
  <app-layout viewName="ormorgmpickupview" viewTitle="组织管理数据多项选择视图" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'dempickupview': true, 'orm-org-mpickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class OrmOrgMPickupViewBase
 * @extends {MPickupViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class OrmOrgMPickupViewBase extends MPickupViewBase {

    /**
     * 实体服务对象
     *
     * @type {OrmOrgService}
     * @memberof OrmOrgMPickupViewBase
     */
	 ...
	 * @memberof OrmOrgMPickupViewBase
	 */
	public viewtag: string = 'd11e0e5a43b51d8f4d5d8dfc9bcb3128';
     ...
     */
    public model: any = {
        srfCaption: 'entities.ormorg.views.mpickupview.caption',
        srfTitle: 'entities.ormorg.views.mpickupview.title',
        srfSubTitle: 'entities.ormorg.views.mpickupview.subtitle',
        dataInfo: ''
    }
        ...
        Object.values(this.containerModel).forEach((model: any) => {
            ...
            if(model.datas.length>0){
                model.datas.forEach((data:any,index:any)=>{
                    Object.assign(data,{srfmajortext: data['orgname']});
                })
            }
...
<style lang='less'>
@import './orm-org-mpickup-view.less';
</style>