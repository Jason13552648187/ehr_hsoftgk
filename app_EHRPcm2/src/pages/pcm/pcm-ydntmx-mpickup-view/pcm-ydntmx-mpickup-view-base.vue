<template>
  <app-layout viewName="pcmydntmxmpickupview" viewTitle="异动内退明细数据多项选择视图" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'dempickupview': true, 'pcm-ydntmx-mpickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdntmxMPickupViewBase
 * @extends {MPickupViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdntmxMPickupViewBase extends MPickupViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdntmxService}
     * @memberof PcmYdntmxMPickupViewBase
     */
	 ...
	 * @memberof PcmYdntmxMPickupViewBase
	 */
	public viewtag: string = '2a7a45545c5bce78b7ec22fa6f88b58f';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydntmx.views.mpickupview.caption',
        srfTitle: 'entities.pcmydntmx.views.mpickupview.title',
        srfSubTitle: 'entities.pcmydntmx.views.mpickupview.subtitle',
        dataInfo: ''
    }
        ...
        Object.values(this.containerModel).forEach((model: any) => {
            ...
            if(model.datas.length>0){
                model.datas.forEach((data:any,index:any)=>{
                    Object.assign(data,{srfmajortext: data['pcmydntmxname']});
                })
            }
...
<style lang='less'>
@import './pcm-ydntmx-mpickup-view.less';
</style>