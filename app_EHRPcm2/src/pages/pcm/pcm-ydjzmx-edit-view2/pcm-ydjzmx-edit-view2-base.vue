<template>
  <app-layout viewName="pcmydjzmxeditview2" viewTitle="异动兼职明细编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview2': true, 'pcm-ydjzmx-edit-view2': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdjzmxEditView2Base
 * @extends {EditView2Base}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdjzmxEditView2Base extends EditView2Base {

    /**
     * 实体服务对象
     *
     * @type {PcmYdjzmxService}
     * @memberof PcmYdjzmxEditView2Base
     */
	 ...
	 * @memberof PcmYdjzmxEditView2Base
	 */
	public viewtag: string = '5936e54be5c3035ff2b7ad35151f2ac5';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydjzmx.views.editview2.caption',
        srfTitle: 'entities.pcmydjzmx.views.editview2.title',
        srfSubTitle: 'entities.pcmydjzmx.views.editview2.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pcm-ydjzmx-edit-view2.less';
</style>