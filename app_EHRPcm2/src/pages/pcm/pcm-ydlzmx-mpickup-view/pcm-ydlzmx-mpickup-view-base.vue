<template>
  <app-layout viewName="pcmydlzmxmpickupview" viewTitle="异动离职明细数据多项选择视图" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'dempickupview': true, 'pcm-ydlzmx-mpickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdlzmxMPickupViewBase
 * @extends {MPickupViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdlzmxMPickupViewBase extends MPickupViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdlzmxService}
     * @memberof PcmYdlzmxMPickupViewBase
     */
	 ...
	 * @memberof PcmYdlzmxMPickupViewBase
	 */
	public viewtag: string = '689be5480c691efb3adb56994107220e';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydlzmx.views.mpickupview.caption',
        srfTitle: 'entities.pcmydlzmx.views.mpickupview.title',
        srfSubTitle: 'entities.pcmydlzmx.views.mpickupview.subtitle',
        dataInfo: ''
    }
        ...
        Object.values(this.containerModel).forEach((model: any) => {
            ...
            if(model.datas.length>0){
                model.datas.forEach((data:any,index:any)=>{
                    Object.assign(data,{srfmajortext: data['pcmydlzmxname']});
                })
            }
...
<style lang='less'>
@import './pcm-ydlzmx-mpickup-view.less';
</style>