<template>
  <app-layout viewName="pcmddsqdmxzwbdsqmxeditview" viewTitle="职务变动申请明细" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcm-ddsqdmx-zwbdsqmxedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmDdsqdmxZWBDSQMXEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmDdsqdmxZWBDSQMXEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmDdsqdmxService}
     * @memberof PcmDdsqdmxZWBDSQMXEditViewBase
     */
	 ...
	 * @memberof PcmDdsqdmxZWBDSQMXEditViewBase
	 */
	public viewtag: string = 'ab3abeb657826f0ca3d6bc5975e6abfe';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmddsqdmx.views.zwbdsqmxeditview.caption',
        srfTitle: 'entities.pcmddsqdmx.views.zwbdsqmxeditview.title',
        srfSubTitle: 'entities.pcmddsqdmx.views.zwbdsqmxeditview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PcmDdsqdmxZWBDSQMXEditView
     */
...
<style lang='less'>
@import './pcm-ddsqdmx-zwbdsqmxedit-view.less';
</style>