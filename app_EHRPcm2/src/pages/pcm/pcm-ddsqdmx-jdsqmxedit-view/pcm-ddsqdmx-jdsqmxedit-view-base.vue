<template>
  <app-layout viewName="pcmddsqdmxjdsqmxeditview" viewTitle="借调申请明细" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcm-ddsqdmx-jdsqmxedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmDdsqdmxJDSQMXEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmDdsqdmxJDSQMXEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmDdsqdmxService}
     * @memberof PcmDdsqdmxJDSQMXEditViewBase
     */
	 ...
	 * @memberof PcmDdsqdmxJDSQMXEditViewBase
	 */
	public viewtag: string = '354427f0670d912b99b3f05d347f6ef4';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmddsqdmx.views.jdsqmxeditview.caption',
        srfTitle: 'entities.pcmddsqdmx.views.jdsqmxeditview.title',
        srfSubTitle: 'entities.pcmddsqdmx.views.jdsqmxeditview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PcmDdsqdmxJDSQMXEditView
     */
...
<style lang='less'>
@import './pcm-ddsqdmx-jdsqmxedit-view.less';
</style>