<template>
  <app-layout viewName="pcmyddgmxckeditview" viewTitle="异动病休明细" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcm-yddgmx-ckedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYddgmxCKEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYddgmxCKEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYddgmxService}
     * @memberof PcmYddgmxCKEditViewBase
     */
	 ...
	 * @memberof PcmYddgmxCKEditViewBase
	 */
	public viewtag: string = 'da71cb260f0c8913bc32c357a3e352aa';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmyddgmx.views.ckeditview.caption',
        srfTitle: 'entities.pcmyddgmx.views.ckeditview.title',
        srfSubTitle: 'entities.pcmyddgmx.views.ckeditview.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'pcmyddgmx',
            majorPSDEField: 'pcmyddgmxname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"PcmYddgmx");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"PcmYddgmx");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PcmYddgmx");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PcmYddgmx");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"PcmYddgmx");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"PcmYddgmx");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"PcmYddgmx");
    }
...
<style lang='less'>
@import './pcm-yddgmx-ckedit-view.less';
</style>