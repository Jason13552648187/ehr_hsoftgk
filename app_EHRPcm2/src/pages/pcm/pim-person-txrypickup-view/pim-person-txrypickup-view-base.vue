<template>
  <app-layout viewName="pimpersontxrypickupview" viewTitle="选择退休人员" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'depickupview': true, 'pim-person-txrypickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
export default class PimPersonTXRYPickupViewBase extends PickupViewBase {
	 ...
	 * @memberof PimPersonTXRYPickupViewBase
	 */
	public viewtag: string = '3c851dd1278ecb803285317cc469bf9c';
...
<style lang='less'>
@import './pim-person-txrypickup-view.less';
</style>