<template>
  <app-layout viewName="pcmydbxmxeditview2" viewTitle="异动病休明细编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview2': true, 'pcm-ydbxmx-edit-view2': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdbxmxEditView2Base
 * @extends {EditView2Base}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdbxmxEditView2Base extends EditView2Base {

    /**
     * 实体服务对象
     *
     * @type {PcmYdbxmxService}
     * @memberof PcmYdbxmxEditView2Base
     */
	 ...
	 * @memberof PcmYdbxmxEditView2Base
	 */
	public viewtag: string = 'f608f6b589e199609bf5405fb457d2c6';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydbxmx.views.editview2.caption',
        srfTitle: 'entities.pcmydbxmx.views.editview2.title',
        srfSubTitle: 'entities.pcmydbxmx.views.editview2.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'pcmydbxmx',
            majorPSDEField: 'pcmydbxmxname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"PcmYdbxmx");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"PcmYdbxmx");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PcmYdbxmx");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PcmYdbxmx");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"PcmYdbxmx");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"PcmYdbxmx");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"PcmYdbxmx");
    }
...
<style lang='less'>
@import './pcm-ydbxmx-edit-view2.less';
</style>