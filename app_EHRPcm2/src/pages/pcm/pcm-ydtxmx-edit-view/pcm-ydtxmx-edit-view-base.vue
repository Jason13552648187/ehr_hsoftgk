<template>
  <app-layout viewName="pcmydtxmxeditview" viewTitle="异动病休明细编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcm-ydtxmx-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdtxmxEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdtxmxEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdtxmxService}
     * @memberof PcmYdtxmxEditViewBase
     */
	 ...
	 * @memberof PcmYdtxmxEditViewBase
	 */
	public viewtag: string = '3d87bcde5c7e4c28503705f9ec026b0f';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydtxmx.views.editview.caption',
        srfTitle: 'entities.pcmydtxmx.views.editview.title',
        srfSubTitle: 'entities.pcmydtxmx.views.editview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pcm-ydtxmx-edit-view.less';
</style>