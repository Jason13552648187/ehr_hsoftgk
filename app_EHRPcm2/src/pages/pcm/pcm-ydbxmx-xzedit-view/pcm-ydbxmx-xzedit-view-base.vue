<template>
  <app-layout viewName="pcmydbxmxxzeditview" viewTitle="新增病休" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcm-ydbxmx-xzedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdbxmxXZEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdbxmxXZEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdbxmxService}
     * @memberof PcmYdbxmxXZEditViewBase
     */
	 ...
	 * @memberof PcmYdbxmxXZEditViewBase
	 */
	public viewtag: string = 'dd733da3c7297bc660f8119607576f4d';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydbxmx.views.xzeditview.caption',
        srfTitle: 'entities.pcmydbxmx.views.xzeditview.title',
        srfSubTitle: 'entities.pcmydbxmx.views.xzeditview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pcm-ydbxmx-xzedit-view.less';
</style>