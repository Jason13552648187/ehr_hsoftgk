...
export default class PcmYdjdmxEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdjdmxService}
     * @memberof PcmYdjdmxEditViewBase
     */
	 ...
	 * @memberof PcmYdjdmxEditViewBase
	 */
	public viewtag: string = 'a9a72f00f6bb8d29263406b4d2ca4354';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydjdmx.views.editview.caption',
        srfTitle: 'entities.pcmydjdmx.views.editview.title',
        srfSubTitle: 'entities.pcmydjdmx.views.editview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pcm-ydjdmx-edit-view.less';
</style>