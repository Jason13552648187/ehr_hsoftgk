<template>
  <app-layout viewName="pimdistirbutionpickupview" viewTitle="分配信息数据选择视图" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'depickupview': true, 'pim-distirbution-pickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PimDistirbutionPickupViewBase
 * @extends {PickupViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PimDistirbutionPickupViewBase extends PickupViewBase {
	 ...
	 * @memberof PimDistirbutionPickupViewBase
	 */
	public viewtag: string = 'c8742acfe50656da3fdd23bdb49b8432';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimdistirbution.views.pickupview.caption',
        srfTitle: 'entities.pimdistirbution.views.pickupview.title',
        srfSubTitle: 'entities.pimdistirbution.views.pickupview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pim-distirbution-pickup-view.less';
</style>