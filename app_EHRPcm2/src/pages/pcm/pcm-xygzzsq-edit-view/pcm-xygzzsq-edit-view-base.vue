<template>
  <app-layout viewName="pcmxygzzsqeditview" viewTitle="试用期员工转正申请编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcm-xygzzsq-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmXygzzsqEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmXygzzsqEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmXygzzsqService}
     * @memberof PcmXygzzsqEditViewBase
     */
	 ...
	 * @memberof PcmXygzzsqEditViewBase
	 */
	public viewtag: string = 'ccdc9bfae5d1ca066e16c5b5e674f7b2';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmxygzzsq.views.editview.caption',
        srfTitle: 'entities.pcmxygzzsq.views.editview.title',
        srfSubTitle: 'entities.pcmxygzzsq.views.editview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pcm-xygzzsq-edit-view.less';
</style>