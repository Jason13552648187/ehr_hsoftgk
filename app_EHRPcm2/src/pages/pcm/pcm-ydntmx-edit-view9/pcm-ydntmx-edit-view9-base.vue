<template>
  <app-layout viewName="pcmydntmxeditview9" viewTitle="内退明细信息" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview9': true, 'pcm-ydntmx-edit-view9': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdntmxEditView9Base
 * @extends {EditView9Base}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdntmxEditView9Base extends EditView9Base {

    /**
     * 实体服务对象
     *
     * @type {PcmYdntmxService}
     * @memberof PcmYdntmxEditView9Base
     */
	 ...
	 * @memberof PcmYdntmxEditView9Base
	 */
	public viewtag: string = 'd5bc5dbf5ec9e9da8f2f80b549e8bbf6';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydntmx.views.editview9.caption',
        srfTitle: 'entities.pcmydntmx.views.editview9.title',
        srfSubTitle: 'entities.pcmydntmx.views.editview9.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem1_openeditview_click(params: any = {}, tag?: any, $event?: any) {
        ...
        curUIService.PcmYdntmx_OpenEditView(datas,contextJO, paramJO,  $event, xData,this,"PcmYdntmx");
    }
...
<style lang='less'>
@import './pcm-ydntmx-edit-view9.less';
</style>