<template>
  <app-layout viewName="pcmxygzzsqmpickupview" viewTitle="试用期员工转正申请数据多项选择视图" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'dempickupview': true, 'pcm-xygzzsq-mpickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmXygzzsqMPickupViewBase
 * @extends {MPickupViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmXygzzsqMPickupViewBase extends MPickupViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmXygzzsqService}
     * @memberof PcmXygzzsqMPickupViewBase
     */
	 ...
	 * @memberof PcmXygzzsqMPickupViewBase
	 */
	public viewtag: string = '35d3d0f6de3bee6c0a7ccbf87612141e';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmxygzzsq.views.mpickupview.caption',
        srfTitle: 'entities.pcmxygzzsq.views.mpickupview.title',
        srfSubTitle: 'entities.pcmxygzzsq.views.mpickupview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {any[]}
     * @memberof PcmXygzzsqMPickupView
     */
        ...
        Object.values(this.containerModel).forEach((model: any) => {
            ...
            if(model.datas.length>0){
                model.datas.forEach((data:any,index:any)=>{
                    Object.assign(data,{srfmajortext: data['pcmxygzzsqname']});
                })
            }
...
<style lang='less'>
@import './pcm-xygzzsq-mpickup-view.less';
</style>