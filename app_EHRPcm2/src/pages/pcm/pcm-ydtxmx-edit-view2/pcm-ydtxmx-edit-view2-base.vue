<template>
  <app-layout viewName="pcmydtxmxeditview2" viewTitle="异动病休明细编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview2': true, 'pcm-ydtxmx-edit-view2': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdtxmxEditView2Base
 * @extends {EditView2Base}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdtxmxEditView2Base extends EditView2Base {
	 ...
	 * @memberof PcmYdtxmxEditView2Base
	 */
	public viewtag: string = '60392ec1e472b8f85da89b34faada1f6';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydtxmx.views.editview2.caption',
        srfTitle: 'entities.pcmydtxmx.views.editview2.title',
        srfSubTitle: 'entities.pcmydtxmx.views.editview2.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pcm-ydtxmx-edit-view2.less';
</style>