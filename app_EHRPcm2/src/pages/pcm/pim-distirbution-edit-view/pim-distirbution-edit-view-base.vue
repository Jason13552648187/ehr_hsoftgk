<template>
  <app-layout viewName="pimdistirbutioneditview" viewTitle="分配信息编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pim-distirbution-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PimDistirbutionEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PimDistirbutionEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimDistirbutionService}
     * @memberof PimDistirbutionEditViewBase
     */
	 ...
	 * @memberof PimDistirbutionEditViewBase
	 */
	public viewtag: string = '9c3d3ccdf9f018e612cfd0c6969832f1';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimdistirbution.views.editview.caption',
        srfTitle: 'entities.pimdistirbution.views.editview.title',
        srfSubTitle: 'entities.pimdistirbution.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PimDistirbutionEditView
     */
...
<style lang='less'>
@import './pim-distirbution-edit-view.less';
</style>