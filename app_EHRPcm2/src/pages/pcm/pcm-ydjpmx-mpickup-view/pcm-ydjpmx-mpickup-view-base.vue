<template>
  <app-layout viewName="pcmydjpmxmpickupview" viewTitle="异动解聘明细数据多项选择视图" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'dempickupview': true, 'pcm-ydjpmx-mpickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdjpmxMPickupViewBase
 * @extends {MPickupViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdjpmxMPickupViewBase extends MPickupViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdjpmxService}
     * @memberof PcmYdjpmxMPickupViewBase
     */
	 ...
	 * @memberof PcmYdjpmxMPickupViewBase
	 */
	public viewtag: string = '46c527e5e4f0aec93ddec88f8e014f43';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydjpmx.views.mpickupview.caption',
        srfTitle: 'entities.pcmydjpmx.views.mpickupview.title',
        srfSubTitle: 'entities.pcmydjpmx.views.mpickupview.subtitle',
        dataInfo: ''
    }
        ...
        Object.values(this.containerModel).forEach((model: any) => {
            ...
            if(model.datas.length>0){
                model.datas.forEach((data:any,index:any)=>{
                    Object.assign(data,{srfmajortext: data['pcmydjpmxname']});
                })
            }
...
<style lang='less'>
@import './pcm-ydjpmx-mpickup-view.less';
</style>