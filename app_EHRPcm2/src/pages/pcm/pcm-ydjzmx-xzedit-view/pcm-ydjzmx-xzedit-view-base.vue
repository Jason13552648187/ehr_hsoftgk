<template>
  <app-layout viewName="pcmydjzmxxzeditview" viewTitle="新增兼职" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcm-ydjzmx-xzedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYdjzmxXZEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYdjzmxXZEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmYdjzmxService}
     * @memberof PcmYdjzmxXZEditViewBase
     */
	 ...
	 * @memberof PcmYdjzmxXZEditViewBase
	 */
	public viewtag: string = 'e6bbb2fdf41c855fb2471658e7706248';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmydjzmx.views.xzeditview.caption',
        srfTitle: 'entities.pcmydjzmx.views.xzeditview.title',
        srfSubTitle: 'entities.pcmydjzmx.views.xzeditview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pcm-ydjzmx-xzedit-view.less';
</style>