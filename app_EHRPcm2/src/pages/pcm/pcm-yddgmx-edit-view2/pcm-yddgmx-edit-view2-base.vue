<template>
  <app-layout viewName="pcmyddgmxeditview2" viewTitle="异动待岗明细编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview2': true, 'pcm-yddgmx-edit-view2': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmYddgmxEditView2Base
 * @extends {EditView2Base}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmYddgmxEditView2Base extends EditView2Base {

    /**
     * 实体服务对象
     *
     * @type {PcmYddgmxService}
     * @memberof PcmYddgmxEditView2Base
     */
	 ...
	 * @memberof PcmYddgmxEditView2Base
	 */
	public viewtag: string = 'f6454b5a7c7467c1f6bce56b0e13e3ad';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmyddgmx.views.editview2.caption',
        srfTitle: 'entities.pcmyddgmx.views.editview2.title',
        srfSubTitle: 'entities.pcmyddgmx.views.editview2.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pcm-yddgmx-edit-view2.less';
</style>