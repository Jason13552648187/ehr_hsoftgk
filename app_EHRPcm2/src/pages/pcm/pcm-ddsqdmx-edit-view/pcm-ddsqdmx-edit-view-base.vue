<template>
  <app-layout viewName="pcmddsqdmxeditview" viewTitle="调动申请明细" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcm-ddsqdmx-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PcmDdsqdmxEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PcmDdsqdmxEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmDdsqdmxService}
     * @memberof PcmDdsqdmxEditViewBase
     */
	 ...
	 * @memberof PcmDdsqdmxEditViewBase
	 */
	public viewtag: string = 'd754cb941b0de239e7e88c9c8bbfc1d0';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmddsqdmx.views.editview.caption',
        srfTitle: 'entities.pcmddsqdmx.views.editview.title',
        srfSubTitle: 'entities.pcmddsqdmx.views.editview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pcm-ddsqdmx-edit-view.less';
</style>