<template>
  <app-layout viewName="socrulemain2editview" viewTitle="社保规则编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'soc-rule-main2-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class SocRuleMain2EditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SocRuleMain2EditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {SocRuleService}
     * @memberof SocRuleMain2EditViewBase
     */
	 ...
	 * @memberof SocRuleMain2EditViewBase
	 */
	public viewtag: string = 'bcb4830aa7bbc34a074b36fc48f8f0b6';
     ...
     */
    public model: any = {
        srfCaption: 'entities.socrule.views.main2editview.caption',
        srfTitle: 'entities.socrule.views.main2editview.title',
        srfSubTitle: 'entities.socrule.views.main2editview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"SocRule");
    }
...
<style lang='less'>
@import './soc-rule-main2-edit-view.less';
</style>