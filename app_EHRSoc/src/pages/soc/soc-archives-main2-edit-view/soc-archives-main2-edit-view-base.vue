<template>
  <app-layout viewName="socarchivesmain2editview" viewTitle="社保档案编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'soc-archives-main2-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class SocArchivesMain2EditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class SocArchivesMain2EditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {SocArchivesService}
     * @memberof SocArchivesMain2EditViewBase
     */
	 ...
	 * @memberof SocArchivesMain2EditViewBase
	 */
	public viewtag: string = 'bc7184f7d9cd35c81ab755bd2ff2e729';
     ...
     */
    public model: any = {
        srfCaption: 'entities.socarchives.views.main2editview.caption',
        srfTitle: 'entities.socarchives.views.main2editview.title',
        srfSubTitle: 'entities.socarchives.views.main2editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof SocArchivesMain2EditView
     */
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"SocArchives");
    }
...
<style lang='less'>
@import './soc-archives-main2-edit-view.less';
</style>