    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('ordervalue')">
                <el-table-column show-overflow-tooltip :prop="'ordervalue'" :label="$t('entities.socarchivesdetail.main_grid.columns.ordervalue')" :width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.socarchivesdetail.main_grid.columns.ordervalue')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('soctypename')">
                <el-table-column show-overflow-tooltip :prop="'soctypename'" :label="$t('entities.socarchivesdetail.main_grid.columns.soctypename')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.socarchivesdetail.main_grid.columns.soctypename')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.soctypename}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('highnum')">
                <el-table-column show-overflow-tooltip :prop="'highnum'" :label="$t('entities.socarchivesdetail.main_grid.columns.highnum')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.socarchivesdetail.main_grid.columns.highnum')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.highnum}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('lownum')">
                <el-table-column show-overflow-tooltip :prop="'lownum'" :label="$t('entities.socarchivesdetail.main_grid.columns.lownum')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.socarchivesdetail.main_grid.columns.lownum')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.lownum}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('companynum')">
                <el-table-column show-overflow-tooltip :prop="'companynum'" :label="$t('entities.socarchivesdetail.main_grid.columns.companynum')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.socarchivesdetail.main_grid.columns.companynum')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('personnum')">
                <el-table-column show-overflow-tooltip :prop="'personnum'" :label="$t('entities.socarchivesdetail.main_grid.columns.personnum')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.socarchivesdetail.main_grid.columns.personnum')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
            ...
            <template v-if="getColumnState('companyrate')">
                <el-table-column show-overflow-tooltip :prop="'companyrate'" :label="$t('entities.socarchivesdetail.main_grid.columns.companyrate')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.socarchivesdetail.main_grid.columns.companyrate')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('personrate')">
                <el-table-column show-overflow-tooltip :prop="'personrate'" :label="$t('entities.socarchivesdetail.main_grid.columns.personrate')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.socarchivesdetail.main_grid.columns.personrate')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.personrate}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('companyamount')">
                <el-table-column show-overflow-tooltip :prop="'companyamount'" :label="$t('entities.socarchivesdetail.main_grid.columns.companyamount')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.socarchivesdetail.main_grid.columns.companyamount')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.companyamount}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('personamount')">
                <el-table-column show-overflow-tooltip :prop="'personamount'" :label="$t('entities.socarchivesdetail.main_grid.columns.personamount')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.socarchivesdetail.main_grid.columns.personamount')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.personamount}}</span>
                    </template>
                </el-table-column>
            </template>
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * 实体服务对象
     *
     * @type {SocArchivesDetailService}
     * @memberof MainBase
     */
    public appEntityService: SocArchivesDetailService = new SocArchivesDetailService({ $store: this.$store });
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'ordervalue',
            label: '排序号',
            langtag: 'entities.socarchivesdetail.main_grid.columns.ordervalue',
            show: true,
            util: 'PX'
        },
        {
            name: 'soctypename',
            label: '保险类型',
            langtag: 'entities.socarchivesdetail.main_grid.columns.soctypename',
            show: true,
            util: 'PX'
        },
        {
            name: 'highnum',
            label: '最高基数',
            langtag: 'entities.socarchivesdetail.main_grid.columns.highnum',
            show: true,
            util: 'PX'
        },
        {
            name: 'lownum',
            label: '最低基数',
            langtag: 'entities.socarchivesdetail.main_grid.columns.lownum',
            show: true,
            util: 'PX'
        },
        {
            name: 'companynum',
            label: '企业基数',
            langtag: 'entities.socarchivesdetail.main_grid.columns.companynum',
            show: true,
            util: 'PX'
        },
        {
            name: 'personnum',
            label: '个人基数',
            langtag: 'entities.socarchivesdetail.main_grid.columns.personnum',
            show: true,
            util: 'PX'
        },
        {
            name: 'companyrate',
            label: '企业比例',
            langtag: 'entities.socarchivesdetail.main_grid.columns.companyrate',
            show: true,
            util: 'PX'
        },
        {
            name: 'personrate',
            label: '个人比例',
            langtag: 'entities.socarchivesdetail.main_grid.columns.personrate',
            show: true,
            util: 'PX'
        },
        {
            name: 'companyamount',
            label: '企业固定额',
            langtag: 'entities.socarchivesdetail.main_grid.columns.companyamount',
            show: true,
            util: 'PX'
        },
        {
            name: 'personamount',
            label: '个人固定额',
            langtag: 'entities.socarchivesdetail.main_grid.columns.personamount',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public rules: any = {
        ...
        srfkey: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '社保档案明细标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '社保档案明细标识 值不能为空', trigger: 'blur' },
        ],
    }
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'SocArchivesDetailGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'SocArchivesDetailGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        _datas.forEach((record: any, index: number) => {
            let srfmajortext = record.socarchivesdetailname;
            if (index < 5) {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ socarchivesdetail: _keys }),Object.assign({ socarchivesdetail: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.socarchivesdetail,$event.socarchivesdetail);
        });
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('socarchivesdetail_main_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('socarchivesdetail_main_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'SocArchivesDetailGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'SocArchivesDetailGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.socarchivesdetail){
                            Object.assign(this.context,{socarchivesdetail:item.socarchivesdetail});
                        }
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'SocArchivesDetailGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
    ...
    public getRowClassName(args:{row: any,rowIndex: number}){
        let isSelected = this.selections.some((item:any)=>{
            return Object.is(item.socarchivesdetail,args.row.socarchivesdetail);
        });
