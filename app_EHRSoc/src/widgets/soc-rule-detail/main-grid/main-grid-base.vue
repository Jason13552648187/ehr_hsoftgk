        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <app-picker  
              ...
              @formitemvaluechange="($event)=>{onGridItemValueChange(row,$event,$index)}">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='soctypename' editorType="PICKER" :value="row.soctypename"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('highnum')">
              ...
              @change="($event)=>{gridEditItemChange(row, column.property, $event, $index)}">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='highnum' editorType="TEXTBOX" :value="row.highnum"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('lownum')">
              ...
              @change="($event)=>{gridEditItemChange(row, column.property, $event, $index)}">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='lownum' editorType="TEXTBOX" :value="row.lownum"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            ...
            <template v-if="getColumnState('companyrate')">
              ...
              @change="($event)=>{gridEditItemChange(row, column.property, $event, $index)}">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='companyrate' editorType="TEXTBOX" :value="row.companyrate"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('personrate')">
              ...
              @change="($event)=>{gridEditItemChange(row, column.property, $event, $index)}">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='personrate' editorType="TEXTBOX" :value="row.personrate"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('companyamount')">
              ...
              @change="($event)=>{gridEditItemChange(row, column.property, $event, $index)}">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='companyamount' editorType="TEXTBOX" :value="row.companyamount"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('personamount')">
              ...
              @change="($event)=>{gridEditItemChange(row, column.property, $event, $index)}">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='personamount' editorType="TEXTBOX" :value="row.personamount"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
    ...
    */
    ...
    public allColumns: any[] = [
        ...
        },
        {
            name: 'soctypename',
            label: '保险类型',
            langtag: 'entities.socruledetail.main_grid.columns.soctypename',
            show: true,
            util: 'PX'
        },
        {
            name: 'highnum',
            label: '最高基数',
            langtag: 'entities.socruledetail.main_grid.columns.highnum',
            show: true,
            util: 'PX'
        },
        {
            name: 'lownum',
            label: '最低基数',
            langtag: 'entities.socruledetail.main_grid.columns.lownum',
            show: true,
            util: 'PX'
        },
        {
        ...
        },
        {
            name: 'companyrate',
            label: '企业比例',
            langtag: 'entities.socruledetail.main_grid.columns.companyrate',
            show: true,
            util: 'PX'
        },
        {
            name: 'personrate',
            label: '个人比例',
            langtag: 'entities.socruledetail.main_grid.columns.personrate',
            show: true,
            util: 'PX'
        },
        {
            name: 'companyamount',
            label: '企业固定额',
            langtag: 'entities.socruledetail.main_grid.columns.companyamount',
            show: true,
            util: 'PX'
        },
        {
            name: 'personamount',
            label: '个人固定额',
            langtag: 'entities.socruledetail.main_grid.columns.personamount',
            show: true,
            util: 'PX'
        },
        {
            name: 'memo',
            label: '备注',
            langtag: 'entities.socruledetail.main_grid.columns.memo',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public getGridRowModel(){
        return {
          soctypeid: new FormItemModel(),
          personrate: new FormItemModel(),
          memo: new FormItemModel(),
          highnum: new FormItemModel(),
          personamount: new FormItemModel(),
          companyrate: new FormItemModel(),
          soctypename: new FormItemModel(),
          personnum: new FormItemModel(),
          companynum: new FormItemModel(),
          srfkey: new FormItemModel(),
          companyamount: new FormItemModel(),
          lownum: new FormItemModel(),
        }
    }
    ...
    public rules: any = {
        ...
        personrate: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '个人比例 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '个人比例 值不能为空', trigger: 'blur' },
        ],
        memo: [
        ...
        highnum: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '最高基数 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '最高基数 值不能为空', trigger: 'blur' },
        ],
        personamount: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '个人固定额 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '个人固定额 值不能为空', trigger: 'blur' },
        ],
        companyrate: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '企业比例 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '企业比例 值不能为空', trigger: 'blur' },
        ],
        soctypename: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '保险类型 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '保险类型 值不能为空', trigger: 'blur' },
        ],
        personnum: [
        ...
        companynum: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '企业基数 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '企业基数 值不能为空', trigger: 'blur' },
        ],
        srfkey: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '社保规则明细标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '社保规则明细标识 值不能为空', trigger: 'blur' },
        ],
        companyamount: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '企业固定额 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '企业固定额 值不能为空', trigger: 'blur' },
        ],
        lownum: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '最低基数 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '最低基数 值不能为空', trigger: 'blur' },
        ],
    }
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'SocRuleDetailGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'SocRuleDetailGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        _datas.forEach((record: any, index: number) => {
            let srfmajortext = record.socruledetailname;
            if (index < 5) {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ socruledetail: _keys }),Object.assign({ socruledetail: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.socruledetail,$event.socruledetail);
        });
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('socruledetail_main_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('socruledetail_main_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'SocRuleDetailGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'SocRuleDetailGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.socruledetail){
                            Object.assign(this.context,{socruledetail:item.socruledetail});
                        }
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'SocRuleDetailGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
    ...
    public getRowClassName(args:{row: any,rowIndex: number}){
        let isSelected = this.selections.some((item:any)=>{
            return Object.is(item.socruledetail,args.row.socruledetail);
        });
