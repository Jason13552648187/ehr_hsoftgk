<template>
  <app-layout viewName="trmlgbcosteditview" viewTitle="老干部活动管理" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'trmlgbcostedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class TRMLGBCOSTEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class TRMLGBCOSTEditViewBase extends EditViewBase {
	 ...
	 * @memberof TRMLGBCOSTEditViewBase
	 */
	public viewtag: string = '298ba053da5a29b926cee19df42b03cc';
     ...
     */
    public model: any = {
        srfCaption: 'entities.trmlgbcost.views.editview.caption',
        srfTitle: 'entities.trmlgbcost.views.editview.title',
        srfSubTitle: 'entities.trmlgbcost.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'trmlgbcost',
            majorPSDEField: 'trmlgbcostname',
            isLoadDefault: true,
        });
    }
...
<style lang='less'>
@import './trmlgbcostedit-view.less';
</style>