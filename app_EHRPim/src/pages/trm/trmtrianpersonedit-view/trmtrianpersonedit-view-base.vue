<template>
  <app-layout viewName="trmtrianpersoneditview" viewTitle="培训人员编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'trmtrianpersonedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class TRMTRIANPERSONEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class TRMTRIANPERSONEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {TrmTrainPersonService}
     * @memberof TRMTRIANPERSONEditViewBase
     */
	 ...
	 * @memberof TRMTRIANPERSONEditViewBase
	 */
	public viewtag: string = '4eaa3108dd715038d585d60f4bbce8fe';
     ...
     *
     * @type {*}
     * @memberof TRMTRIANPERSONEditView
     */
...
<style lang='less'>
@import './trmtrianpersonedit-view.less';
</style>