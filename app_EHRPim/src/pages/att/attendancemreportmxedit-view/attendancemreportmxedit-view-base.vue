<template>
  <app-layout viewName="attendancemreportmxeditview" viewTitle="考勤月报明细" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'attendancemreportmxedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
export default class ATTENDANCEMREPORTMXEditViewBase extends EditViewBase {
	 ...
	 * @memberof ATTENDANCEMREPORTMXEditViewBase
	 */
	public viewtag: string = '19e3a27c4763e3bf10b6c641848c2b4d';
...
<style lang='less'>
@import './attendancemreportmxedit-view.less';
</style>