<template>
  <app-layout viewName="pimtitlecatalogueeditview" viewTitle="职称目录管理编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimtitlecatalogueedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMTITLECATALOGUEEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMTITLECATALOGUEEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimTitleCatalogueService}
     * @memberof PIMTITLECATALOGUEEditViewBase
     */
	 ...
	 * @memberof PIMTITLECATALOGUEEditViewBase
	 */
	public viewtag: string = 'a4e8b102553ecf95abf3f99f49571393';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimtitlecatalogue.views.editview.caption',
        srfTitle: 'entities.pimtitlecatalogue.views.editview.title',
        srfSubTitle: 'entities.pimtitlecatalogue.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMTITLECATALOGUEEditView
     */
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"PimTitleCatalogue");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"PimTitleCatalogue");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PimTitleCatalogue");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PimTitleCatalogue");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"PimTitleCatalogue");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"PimTitleCatalogue");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"PimTitleCatalogue");
    }
...
<style lang='less'>
@import './pimtitlecatalogueedit-view.less';
</style>