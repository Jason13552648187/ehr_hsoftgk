<template>
  <app-layout viewName="archivalcataloguepickupview" viewTitle="档案目录数据选择视图" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'depickupview': true, 'archivalcataloguepickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ARCHIVALCATALOGUEPickupViewBase
 * @extends {PickupViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ARCHIVALCATALOGUEPickupViewBase extends PickupViewBase {
	 ...
	 * @memberof ARCHIVALCATALOGUEPickupViewBase
	 */
	public viewtag: string = '3a969b534843e4ebed7136d772f2f2bd';
...
<style lang='less'>
@import './archivalcataloguepickup-view.less';
</style>