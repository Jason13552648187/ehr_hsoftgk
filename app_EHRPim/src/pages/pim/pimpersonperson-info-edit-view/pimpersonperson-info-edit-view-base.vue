<template>
  <app-layout viewName="pimpersonpersoninfoeditview" viewTitle="员工信息" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimpersonperson-info-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMPERSONPersonInfoEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMPERSONPersonInfoEditViewBase extends EditViewBase {
	 ...
	 * @memberof PIMPERSONPersonInfoEditViewBase
	 */
	public viewtag: string = '1804046b3715d3dcecec6303aa0ddc25';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimperson.views.personinfoeditview.caption',
        srfTitle: 'entities.pimperson.views.personinfoeditview.title',
        srfSubTitle: 'entities.pimperson.views.personinfoeditview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMPERSONPersonInfoEditView
     */
...
<style lang='less'>
@import './pimpersonperson-info-edit-view.less';
</style>