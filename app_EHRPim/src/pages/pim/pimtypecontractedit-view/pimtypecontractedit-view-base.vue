<template>
  <app-layout viewName="pimtypecontracteditview" viewTitle="合同类型编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimtypecontractedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMTYPECONTRACTEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMTYPECONTRACTEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimTypeContractService}
     * @memberof PIMTYPECONTRACTEditViewBase
     */
	 ...
	 * @memberof PIMTYPECONTRACTEditViewBase
	 */
	public viewtag: string = 'e8db54a4b997adaeebdb886851e17369';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimtypecontract.views.editview.caption',
        srfTitle: 'entities.pimtypecontract.views.editview.title',
        srfSubTitle: 'entities.pimtypecontract.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMTYPECONTRACTEditView
     */
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'pimtypecontract',
            majorPSDEField: 'pimtypecontractname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"PimTypeContract");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"PimTypeContract");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PimTypeContract");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PimTypeContract");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"PimTypeContract");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"PimTypeContract");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"PimTypeContract");
    }
...
<style lang='less'>
@import './pimtypecontractedit-view.less';
</style>