<template>
  <app-layout viewName="pimarchiveschangeeditview" viewTitle="档案归档地变更记录编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimarchiveschangeedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMARCHIVESCHANGEEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMARCHIVESCHANGEEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimArchivesChangeService}
     * @memberof PIMARCHIVESCHANGEEditViewBase
     */
	 ...
	 * @memberof PIMARCHIVESCHANGEEditViewBase
	 */
	public viewtag: string = 'b75c19668934a942420d205ebc7bf4e2';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimarchiveschange.views.editview.caption',
        srfTitle: 'entities.pimarchiveschange.views.editview.title',
        srfSubTitle: 'entities.pimarchiveschange.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMARCHIVESCHANGEEditView
     */
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"PimArchivesChange");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"PimArchivesChange");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PimArchivesChange");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PimArchivesChange");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"PimArchivesChange");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"PimArchivesChange");
    }
...
<style lang='less'>
@import './pimarchiveschangeedit-view.less';
</style>