<template>
  <app-layout viewName="pimfaminfoeditview" viewTitle="家庭情况编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimfaminfoedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMFAMINFOEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMFAMINFOEditViewBase extends EditViewBase {
	 ...
	 * @memberof PIMFAMINFOEditViewBase
	 */
	public viewtag: string = '796f7a60de318a972fb9c335f4ca446f';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimfaminfo.views.editview.caption',
        srfTitle: 'entities.pimfaminfo.views.editview.title',
        srfSubTitle: 'entities.pimfaminfo.views.editview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pimfaminfoedit-view.less';
</style>