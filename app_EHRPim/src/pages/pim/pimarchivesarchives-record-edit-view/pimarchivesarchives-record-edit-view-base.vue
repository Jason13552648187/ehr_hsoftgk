<template>
  <app-layout viewName="pimarchivesarchivesrecordeditview" viewTitle="调档记录编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimarchivesarchives-record-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMARCHIVESArchivesRecordEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMARCHIVESArchivesRecordEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimArchivesService}
     * @memberof PIMARCHIVESArchivesRecordEditViewBase
     */
	 ...
	 * @memberof PIMARCHIVESArchivesRecordEditViewBase
	 */
	public viewtag: string = '2bd345f6f0035c6eb43bd5e74c4f8348';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimarchives.views.archivesrecordeditview.caption',
        srfTitle: 'entities.pimarchives.views.archivesrecordeditview.title',
        srfSubTitle: 'entities.pimarchives.views.archivesrecordeditview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMARCHIVESArchivesRecordEditView
     */
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Exit(datas, contextJO,paramJO,  $event, xData,this,"PimArchives");
    }
...
<style lang='less'>
@import './pimarchivesarchives-record-edit-view.less';
</style>