<template>
  <app-layout viewName="pimsearchfieldseteditview" viewTitle="组合查询条件设置编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pim-search-field-set-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PimSearchFieldSetEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PimSearchFieldSetEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimSearchFieldSetService}
     * @memberof PimSearchFieldSetEditViewBase
     */
	 ...
	 * @memberof PimSearchFieldSetEditViewBase
	 */
	public viewtag: string = 'f5a70415a5b8015463b1c213e1a1c282';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimsearchfieldset.views.editview.caption',
        srfTitle: 'entities.pimsearchfieldset.views.editview.title',
        srfSubTitle: 'entities.pimsearchfieldset.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PimSearchFieldSetEditView
     */
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'pimsearchfieldset',
            majorPSDEField: 'pimsearchfieldsetname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"PimSearchFieldSet");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"PimSearchFieldSet");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PimSearchFieldSet");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PimSearchFieldSet");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"PimSearchFieldSet");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"PimSearchFieldSet");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"PimSearchFieldSet");
    }
...
<style lang='less'>
@import './pim-search-field-set-edit-view.less';
</style>