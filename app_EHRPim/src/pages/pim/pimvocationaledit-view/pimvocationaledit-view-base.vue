<template>
  <app-layout viewName="pimvocationaleditview" viewTitle="证书信息编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimvocationaledit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMVOCATIONALEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMVOCATIONALEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimVocationalService}
     * @memberof PIMVOCATIONALEditViewBase
     */
	 ...
	 * @memberof PIMVOCATIONALEditViewBase
	 */
	public viewtag: string = '5f0a67fb9bd2214c95a0042b00a85057';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimvocational.views.editview.caption',
        srfTitle: 'entities.pimvocational.views.editview.title',
        srfSubTitle: 'entities.pimvocational.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMVOCATIONALEditView
     */
...
<style lang='less'>
@import './pimvocationaledit-view.less';
</style>