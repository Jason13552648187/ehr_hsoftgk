<template>
  <app-layout viewName="pimmajorsetypeeditview" viewTitle="专业序列类型编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimmajorsetypeedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMMAJORSETYPEEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMMAJORSETYPEEditViewBase extends EditViewBase {
	 ...
	 * @memberof PIMMAJORSETYPEEditViewBase
	 */
	public viewtag: string = '275b635e5e3dc5c88ddeb708e374cade';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimmajorsetype.views.editview.caption',
        srfTitle: 'entities.pimmajorsetype.views.editview.title',
        srfSubTitle: 'entities.pimmajorsetype.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMMAJORSETYPEEditView
     */
...
<style lang='less'>
@import './pimmajorsetypeedit-view.less';
</style>