<template>
  <app-layout viewName="pimexitandentryygcgjxjeditview" viewTitle="出（国）境基本信息" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimexitandentryygcgjxjedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMEXITANDENTRYYGCGJXJEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMEXITANDENTRYYGCGJXJEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimExitandentryService}
     * @memberof PIMEXITANDENTRYYGCGJXJEditViewBase
     */
	 ...
	 * @memberof PIMEXITANDENTRYYGCGJXJEditViewBase
	 */
	public viewtag: string = 'c5ffcee9c740d6d420ec6159d25df1aa';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimexitandentry.views.ygcgjxjeditview.caption',
        srfTitle: 'entities.pimexitandentry.views.ygcgjxjeditview.title',
        srfSubTitle: 'entities.pimexitandentry.views.ygcgjxjeditview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMEXITANDENTRYYGCGJXJEditView
     */
...
<style lang='less'>
@import './pimexitandentryygcgjxjedit-view.less';
</style>