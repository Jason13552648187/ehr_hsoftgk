<template>
  <app-layout viewName="archivesmanageeditview" viewTitle="档案管理编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'archivesmanageedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ARCHIVESMANAGEEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ARCHIVESMANAGEEditViewBase extends EditViewBase {
	 ...
	 * @memberof ARCHIVESMANAGEEditViewBase
	 */
	public viewtag: string = '36475364691f756687f5aaa4d32cb964';
     ...
     *
     * @type {*}
     * @memberof ARCHIVESMANAGEEditView
     */
...
<style lang='less'>
@import './archivesmanageedit-view.less';
</style>