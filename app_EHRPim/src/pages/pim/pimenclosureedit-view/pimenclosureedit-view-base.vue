<template>
  <app-layout viewName="pimenclosureeditview" viewTitle="附件信息编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimenclosureedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMENCLOSUREEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMENCLOSUREEditViewBase extends EditViewBase {
	 ...
	 * @memberof PIMENCLOSUREEditViewBase
	 */
	public viewtag: string = '9c228a0fb01db04e9eddf0ca4275ce2e';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimenclosure.views.editview.caption',
        srfTitle: 'entities.pimenclosure.views.editview.title',
        srfSubTitle: 'entities.pimenclosure.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'pimenclosure',
            majorPSDEField: 'pimenclosurename',
            isLoadDefault: true,
        });
    }
...
<style lang='less'>
@import './pimenclosureedit-view.less';
</style>