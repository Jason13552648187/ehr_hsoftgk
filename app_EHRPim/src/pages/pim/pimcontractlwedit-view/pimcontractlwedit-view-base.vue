<template>
  <app-layout viewName="pimcontractlweditview" viewTitle="合同信息编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimcontractlwedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMCONTRACTLWEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMCONTRACTLWEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimContractService}
     * @memberof PIMCONTRACTLWEditViewBase
     */
	 ...
	 * @memberof PIMCONTRACTLWEditViewBase
	 */
	public viewtag: string = '65b74d530e2f3a2a3bbb960ba56683d7';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimcontract.views.lweditview.caption',
        srfTitle: 'entities.pimcontract.views.lweditview.title',
        srfSubTitle: 'entities.pimcontract.views.lweditview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMCONTRACTLWEditView
     */
...
<style lang='less'>
@import './pimcontractlwedit-view.less';
</style>