<template>
  <app-layout viewName="pimvocationalwsseditview" viewTitle="证书信息编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimvocationalwssedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMVOCATIONALWSSEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMVOCATIONALWSSEditViewBase extends EditViewBase {
	 ...
	 * @memberof PIMVOCATIONALWSSEditViewBase
	 */
	public viewtag: string = '5ad2ef33c8d1adbb1c9353df20c1d7e9';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimvocational.views.wsseditview.caption',
        srfTitle: 'entities.pimvocational.views.wsseditview.title',
        srfSubTitle: 'entities.pimvocational.views.wsseditview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMVOCATIONALWSSEditView
     */
...
<style lang='less'>
@import './pimvocationalwssedit-view.less';
</style>