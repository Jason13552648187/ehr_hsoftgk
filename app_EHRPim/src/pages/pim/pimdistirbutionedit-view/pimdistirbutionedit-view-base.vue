<template>
  <app-layout viewName="pimdistirbutioneditview" viewTitle="分配信息编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimdistirbutionedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
export default class PIMDISTIRBUTIONEditViewBase extends EditViewBase {
	 ...
	 * @memberof PIMDISTIRBUTIONEditViewBase
	 */
	public viewtag: string = '9def4871869e56f3eda70c8b29fcc463';
...
<style lang='less'>
@import './pimdistirbutionedit-view.less';
</style>