<template>
  <app-layout viewName="pimrewardpunishmenteditview" viewTitle="奖励惩罚编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimrewardpunishmentedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMREWARDPUNISHMENTEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMREWARDPUNISHMENTEditViewBase extends EditViewBase {
	 ...
	 * @memberof PIMREWARDPUNISHMENTEditViewBase
	 */
	public viewtag: string = '9ddb200191f860b35f61162eb6ad3a20';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimrewardpunishment.views.editview.caption',
        srfTitle: 'entities.pimrewardpunishment.views.editview.title',
        srfSubTitle: 'entities.pimrewardpunishment.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMREWARDPUNISHMENTEditView
     */
...
<style lang='less'>
@import './pimrewardpunishmentedit-view.less';
</style>