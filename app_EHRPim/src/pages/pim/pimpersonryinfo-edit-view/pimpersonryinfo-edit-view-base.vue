<template>
  <app-layout viewName="pimpersonryinfoeditview" viewTitle="人员信息编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimpersonryinfo-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMPERSONRYInfoEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMPERSONRYInfoEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimPersonService}
     * @memberof PIMPERSONRYInfoEditViewBase
     */
	 ...
	 * @memberof PIMPERSONRYInfoEditViewBase
	 */
	public viewtag: string = 'c05753c87731f02b862491ae2d4fc908';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimperson.views.ryinfoeditview.caption',
        srfTitle: 'entities.pimperson.views.ryinfoeditview.title',
        srfSubTitle: 'entities.pimperson.views.ryinfoeditview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMPERSONRYInfoEditView
     */
...
<style lang='less'>
@import './pimpersonryinfo-edit-view.less';
</style>