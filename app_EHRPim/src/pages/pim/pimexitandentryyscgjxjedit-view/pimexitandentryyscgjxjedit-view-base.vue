<template>
  <app-layout viewName="pimexitandentryyscgjxjeditview" viewTitle="出（国）境基本信息" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimexitandentryyscgjxjedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMEXITANDENTRYYSCGJXJEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMEXITANDENTRYYSCGJXJEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimExitandentryService}
     * @memberof PIMEXITANDENTRYYSCGJXJEditViewBase
     */
	 ...
	 * @memberof PIMEXITANDENTRYYSCGJXJEditViewBase
	 */
	public viewtag: string = '873a148fca4068110c452146a61ed51c';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimexitandentry.views.yscgjxjeditview.caption',
        srfTitle: 'entities.pimexitandentry.views.yscgjxjeditview.title',
        srfSubTitle: 'entities.pimexitandentry.views.yscgjxjeditview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMEXITANDENTRYYSCGJXJEditView
     */
...
<style lang='less'>
@import './pimexitandentryyscgjxjedit-view.less';
</style>