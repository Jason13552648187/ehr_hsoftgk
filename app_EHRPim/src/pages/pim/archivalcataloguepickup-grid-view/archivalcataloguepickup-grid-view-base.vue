 ...
 *
 * @export
 * @class ARCHIVALCATALOGUEPickupGridViewBase
 * @extends {PickupViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ARCHIVALCATALOGUEPickupGridViewBase extends PickupViewBase {
	 ...
	 * @memberof ARCHIVALCATALOGUEPickupGridViewBase
	 */
	public viewtag: string = '0ff4bcadeab507d5531d6310b69e05e0';
...
<style lang='less'>
@import './archivalcataloguepickup-grid-view.less';
</style>