<template>
  <app-layout viewName="pimpatenteditview" viewTitle="专利信息编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimpatentedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMPATENTEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMPATENTEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimPatentService}
     * @memberof PIMPATENTEditViewBase
     */
	 ...
	 * @memberof PIMPATENTEditViewBase
	 */
	public viewtag: string = '347141f7ddbcdfde987bd9c9284f982a';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimpatent.views.editview.caption',
        srfTitle: 'entities.pimpatent.views.editview.title',
        srfSubTitle: 'entities.pimpatent.views.editview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pimpatentedit-view.less';
</style>