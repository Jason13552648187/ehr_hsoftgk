<template>
  <app-layout viewName="pimarmycadreseditview" viewTitle="军转干部编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimarmycadresedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMARMYCADRESEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMARMYCADRESEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimArmycadresService}
     * @memberof PIMARMYCADRESEditViewBase
     */
	 ...
	 * @memberof PIMARMYCADRESEditViewBase
	 */
	public viewtag: string = '5bd15b1edbb0dcaf3571002db07c19d5';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimarmycadres.views.editview.caption',
        srfTitle: 'entities.pimarmycadres.views.editview.title',
        srfSubTitle: 'entities.pimarmycadres.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMARMYCADRESEditView
     */
...
<style lang='less'>
@import './pimarmycadresedit-view.less';
</style>