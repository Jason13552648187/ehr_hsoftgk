<template>
  <app-layout viewName="pimexpaccounteditview" viewTitle="费用台账编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimexpaccountedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMEXPACCOUNTEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMEXPACCOUNTEditViewBase extends EditViewBase {
	 ...
	 * @memberof PIMEXPACCOUNTEditViewBase
	 */
	public viewtag: string = '0d9de3e10529046318626669a630433f';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimexpaccount.views.editview.caption',
        srfTitle: 'entities.pimexpaccount.views.editview.title',
        srfSubTitle: 'entities.pimexpaccount.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMEXPACCOUNTEditView
     */
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'pimexpaccount',
            majorPSDEField: 'pimexpaccountname',
            isLoadDefault: true,
        });
    }
...
<style lang='less'>
@import './pimexpaccountedit-view.less';
</style>