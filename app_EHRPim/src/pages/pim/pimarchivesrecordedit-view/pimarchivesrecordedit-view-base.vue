<template>
  <app-layout viewName="pimarchivesrecordeditview" viewTitle="档案目录缺失记录编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimarchivesrecordedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMARCHIVESRECORDEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMARCHIVESRECORDEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimArchivesRecordService}
     * @memberof PIMARCHIVESRECORDEditViewBase
     */
	 ...
	 * @memberof PIMARCHIVESRECORDEditViewBase
	 */
	public viewtag: string = '3a28b973d4738f0945428cce75c4e059';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimarchivesrecord.views.editview.caption',
        srfTitle: 'entities.pimarchivesrecord.views.editview.title',
        srfSubTitle: 'entities.pimarchivesrecord.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMARCHIVESRECORDEditView
     */
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'pimarchivesrecord',
            majorPSDEField: 'pimarchivesrecordname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"PimArchivesRecord");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"PimArchivesRecord");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PimArchivesRecord");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PimArchivesRecord");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"PimArchivesRecord");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"PimArchivesRecord");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"PimArchivesRecord");
    }
...
<style lang='less'>
@import './pimarchivesrecordedit-view.less';
</style>