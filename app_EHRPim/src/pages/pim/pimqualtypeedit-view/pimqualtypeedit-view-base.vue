<template>
  <app-layout viewName="pimqualtypeeditview" viewTitle="岗位（技能）证书编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimqualtypeedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMQUALTYPEEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMQUALTYPEEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimQualTypeService}
     * @memberof PIMQUALTYPEEditViewBase
     */
	 ...
	 * @memberof PIMQUALTYPEEditViewBase
	 */
	public viewtag: string = 'e22aa356608b9bc9452dc1264c887bee';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimqualtype.views.editview.caption',
        srfTitle: 'entities.pimqualtype.views.editview.title',
        srfSubTitle: 'entities.pimqualtype.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'pimqualtype',
            majorPSDEField: 'pimqualtypename',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"PimQualType");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"PimQualType");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PimQualType");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PimQualType");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"PimQualType");
    }
...
<style lang='less'>
@import './pimqualtypeedit-view.less';
</style>