<template>
  <app-layout viewName="pimcontracttypeeditview" viewTitle="合同类型编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimcontracttypeedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMCONTRACTTYPEEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMCONTRACTTYPEEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimContractTypeService}
     * @memberof PIMCONTRACTTYPEEditViewBase
     */
	 ...
	 * @memberof PIMCONTRACTTYPEEditViewBase
	 */
	public viewtag: string = '4d6fd810f234bfac9e4b95a531122148';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimcontracttype.views.editview.caption',
        srfTitle: 'entities.pimcontracttype.views.editview.title',
        srfSubTitle: 'entities.pimcontracttype.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMCONTRACTTYPEEditView
     */
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'pimcontracttype',
            majorPSDEField: 'pimcontracttypename',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"PimContractType");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"PimContractType");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PimContractType");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PimContractType");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"PimContractType");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"PimContractType");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"PimContractType");
    }
...
<style lang='less'>
@import './pimcontracttypeedit-view.less';
</style>