<template>
  <app-layout viewName="pimgwtypempickupview" viewTitle="岗位类型" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'dempickupview': true, 'pimgwtypempickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMGWTYPEMPickupViewBase
 * @extends {MPickupViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMGWTYPEMPickupViewBase extends MPickupViewBase {
	 ...
	 * @memberof PIMGWTYPEMPickupViewBase
	 */
	public viewtag: string = '202329c082bd388ad69e64e9dae9e1ee';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimgwtype.views.mpickupview.caption',
        srfTitle: 'entities.pimgwtype.views.mpickupview.title',
        srfSubTitle: 'entities.pimgwtype.views.mpickupview.subtitle',
        dataInfo: ''
    }
        ...
        Object.values(this.containerModel).forEach((model: any) => {
            ...
            if(model.datas.length>0){
                model.datas.forEach((data:any,index:any)=>{
                    Object.assign(data,{srfmajortext: data['pimgwtypename']});
                })
            }
...
<style lang='less'>
@import './pimgwtypempickup-view.less';
</style>