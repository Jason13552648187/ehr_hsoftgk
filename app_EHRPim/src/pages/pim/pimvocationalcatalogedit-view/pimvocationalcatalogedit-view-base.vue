<template>
  <app-layout viewName="pimvocationalcatalogeditview" viewTitle="职（执）业资格目录管理编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimvocationalcatalogedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMVOCATIONALCATALOGEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMVOCATIONALCATALOGEditViewBase extends EditViewBase {
	 ...
	 * @memberof PIMVOCATIONALCATALOGEditViewBase
	 */
	public viewtag: string = '8b7bb8559ea51e3cb1f72c99bc6681d7';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimvocationalcatalog.views.editview.caption',
        srfTitle: 'entities.pimvocationalcatalog.views.editview.title',
        srfSubTitle: 'entities.pimvocationalcatalog.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMVOCATIONALCATALOGEditView
     */
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'pimvocationalcatalog',
            majorPSDEField: 'pimvocationalcatalogname',
            isLoadDefault: true,
        });
    }
...
<style lang='less'>
@import './pimvocationalcatalogedit-view.less';
</style>