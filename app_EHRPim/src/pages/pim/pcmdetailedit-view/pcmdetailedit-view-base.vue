<template>
  <app-layout viewName="pcmdetaileditview" viewTitle="人员明细表编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcmdetailedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PCMDETAILEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMDETAILEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmDetailService}
     * @memberof PCMDETAILEditViewBase
     */
	 ...
	 * @memberof PCMDETAILEditViewBase
	 */
	public viewtag: string = '424f6764a55b3e5cf0a9e3f14bba8497';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmdetail.views.editview.caption',
        srfTitle: 'entities.pcmdetail.views.editview.title',
        srfSubTitle: 'entities.pcmdetail.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"PcmDetail");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"PcmDetail");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PcmDetail");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PcmDetail");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"PcmDetail");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"PcmDetail");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"PcmDetail");
    }
...
<style lang='less'>
@import './pcmdetailedit-view.less';
</style>