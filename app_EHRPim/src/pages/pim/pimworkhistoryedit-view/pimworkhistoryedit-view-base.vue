<template>
  <app-layout viewName="pimworkhistoryeditview" viewTitle="工作履历编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimworkhistoryedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMWORKHISTORYEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMWORKHISTORYEditViewBase extends EditViewBase {
	 ...
	 * @memberof PIMWORKHISTORYEditViewBase
	 */
	public viewtag: string = 'face08be9bcc54a8c02a259269d44e5f';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimworkhistory.views.editview.caption',
        srfTitle: 'entities.pimworkhistory.views.editview.title',
        srfSubTitle: 'entities.pimworkhistory.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMWORKHISTORYEditView
     */
...
<style lang='less'>
@import './pimworkhistoryedit-view.less';
</style>