<template>
  <app-layout viewName="pimsearchmodaleditview" viewTitle="组合查询模版编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pim-search-modal-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PimSearchModalEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PimSearchModalEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimSearchModalService}
     * @memberof PimSearchModalEditViewBase
     */
	 ...
	 * @memberof PimSearchModalEditViewBase
	 */
	public viewtag: string = '427e6dbbaea5115695a81822d525517c';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimsearchmodal.views.editview.caption',
        srfTitle: 'entities.pimsearchmodal.views.editview.title',
        srfSubTitle: 'entities.pimsearchmodal.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PimSearchModalEditView
     */
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'pimsearchmodal',
            majorPSDEField: 'pimsearchmodalname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"PimSearchModal");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"PimSearchModal");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PimSearchModal");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PimSearchModal");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"PimSearchModal");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"PimSearchModal");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"PimSearchModal");
    }
...
<style lang='less'>
@import './pim-search-modal-edit-view.less';
</style>