<template>
  <app-layout viewName="pimarchiveseditview" viewTitle="档案信息编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimarchivesedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMARCHIVESEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMARCHIVESEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimArchivesService}
     * @memberof PIMARCHIVESEditViewBase
     */
	 ...
	 * @memberof PIMARCHIVESEditViewBase
	 */
	public viewtag: string = '6d0ccb404f6bbdea4aebbda249e975ed';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimarchives.views.editview.caption',
        srfTitle: 'entities.pimarchives.views.editview.title',
        srfSubTitle: 'entities.pimarchives.views.editview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pimarchivesedit-view.less';
</style>