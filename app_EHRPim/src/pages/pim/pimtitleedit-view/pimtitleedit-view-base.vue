<template>
  <app-layout viewName="pimtitleeditview" viewTitle="职称信息编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimtitleedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMTITLEEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMTITLEEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimTitleService}
     * @memberof PIMTITLEEditViewBase
     */
	 ...
	 * @memberof PIMTITLEEditViewBase
	 */
	public viewtag: string = 'b55357d4e36ad334e8f4f4174f796d27';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimtitle.views.editview.caption',
        srfTitle: 'entities.pimtitle.views.editview.title',
        srfSubTitle: 'entities.pimtitle.views.editview.subtitle',
        dataInfo: ''
    }
