 ...
 *
 * @export
 * @class PIMLABOURCAMPANYPickupGridViewBase
 * @extends {PickupViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMLABOURCAMPANYPickupGridViewBase extends PickupViewBase {
	 ...
	 * @memberof PIMLABOURCAMPANYPickupGridViewBase
	 */
	public viewtag: string = '33511b7e64bcbd3289c425f2ac61ce95';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimlabourcampany.views.pickupgridview.caption',
        srfTitle: 'entities.pimlabourcampany.views.pickupgridview.title',
        srfSubTitle: 'entities.pimlabourcampany.views.pickupgridview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pimlabourcampanypickup-grid-view.less';
</style>