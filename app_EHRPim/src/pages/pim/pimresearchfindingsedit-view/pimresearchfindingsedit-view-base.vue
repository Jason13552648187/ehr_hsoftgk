<template>
  <app-layout viewName="pimresearchfindingseditview" viewTitle="科研成果编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimresearchfindingsedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMRESEARCHFINDINGSEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMRESEARCHFINDINGSEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimResearchFindingsService}
     * @memberof PIMRESEARCHFINDINGSEditViewBase
     */
	 ...
	 * @memberof PIMRESEARCHFINDINGSEditViewBase
	 */
	public viewtag: string = 'b2d8bf186815cb39915a2856f121724d';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimresearchfindings.views.editview.caption',
        srfTitle: 'entities.pimresearchfindings.views.editview.title',
        srfSubTitle: 'entities.pimresearchfindings.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMRESEARCHFINDINGSEditView
     */
...
<style lang='less'>
@import './pimresearchfindingsedit-view.less';
</style>