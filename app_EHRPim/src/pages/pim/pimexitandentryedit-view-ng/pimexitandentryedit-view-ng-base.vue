<template>
  <app-layout viewName="pimexitandentryeditview_ng" viewTitle="出（国）境基本信息" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimexitandentryedit-view-ng': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMEXITANDENTRYEditView_NGBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMEXITANDENTRYEditView_NGBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimExitandentryService}
     * @memberof PIMEXITANDENTRYEditView_NGBase
     */
	 ...
	 * @memberof PIMEXITANDENTRYEditView_NGBase
	 */
	public viewtag: string = 'eb782be65606634b8d2dbd29b6c6c97a';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimexitandentry.views.editview_ng.caption',
        srfTitle: 'entities.pimexitandentry.views.editview_ng.title',
        srfSubTitle: 'entities.pimexitandentry.views.editview_ng.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMEXITANDENTRYEditView_NG
     */
...
<style lang='less'>
@import './pimexitandentryedit-view-ng.less';
</style>