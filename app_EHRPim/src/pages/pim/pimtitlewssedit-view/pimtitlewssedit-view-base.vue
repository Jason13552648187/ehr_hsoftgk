<template>
  <app-layout viewName="pimtitlewsseditview" viewTitle="职称信息编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimtitlewssedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMTITLEWSSEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMTITLEWSSEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimTitleService}
     * @memberof PIMTITLEWSSEditViewBase
     */
	 ...
	 * @memberof PIMTITLEWSSEditViewBase
	 */
	public viewtag: string = '17a7ba15f517554f027aa805191ae63f';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimtitle.views.wsseditview.caption',
        srfTitle: 'entities.pimtitle.views.wsseditview.title',
        srfSubTitle: 'entities.pimtitle.views.wsseditview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"PimTitle");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PimTitle");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"PimTitle");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"PimTitle");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"PimTitle");
    }
...
<style lang='less'>
@import './pimtitlewssedit-view.less';
</style>