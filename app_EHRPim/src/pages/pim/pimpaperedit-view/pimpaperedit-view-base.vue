<template>
  <app-layout viewName="pimpapereditview" viewTitle="论文信息编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimpaperedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMPAPEREditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMPAPEREditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimPaperService}
     * @memberof PIMPAPEREditViewBase
     */
	 ...
	 * @memberof PIMPAPEREditViewBase
	 */
	public viewtag: string = 'cfe4f5afb6a17974025709324fd1aec9';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimpaper.views.editview.caption',
        srfTitle: 'entities.pimpaper.views.editview.title',
        srfSubTitle: 'entities.pimpaper.views.editview.subtitle',
        dataInfo: ''
    }
