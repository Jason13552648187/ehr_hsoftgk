<template>
  <app-layout viewName="archivescentereditview" viewTitle="档案室管理编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'archivescenteredit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ARCHIVESCENTEREditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ARCHIVESCENTEREditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimArchivesCenterService}
     * @memberof ARCHIVESCENTEREditViewBase
     */
	 ...
	 * @memberof ARCHIVESCENTEREditViewBase
	 */
	public viewtag: string = 'a2501af050813eae54209d97cbe16f1f';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimarchivescenter.views.editview.caption',
        srfTitle: 'entities.pimarchivescenter.views.editview.title',
        srfSubTitle: 'entities.pimarchivescenter.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof ARCHIVESCENTEREditView
     */
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"PimArchivesCenter");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"PimArchivesCenter");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PimArchivesCenter");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PimArchivesCenter");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"PimArchivesCenter");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"PimArchivesCenter");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"PimArchivesCenter");
    }
...
<style lang='less'>
@import './archivescenteredit-view.less';
</style>