<template>
  <app-layout viewName="pimlabourcampanyeditview" viewTitle="劳务派遣公司编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimlabourcampanyedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMLABOURCAMPANYEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMLABOURCAMPANYEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimLabourcampanyService}
     * @memberof PIMLABOURCAMPANYEditViewBase
     */
	 ...
	 * @memberof PIMLABOURCAMPANYEditViewBase
	 */
	public viewtag: string = '8f5bf5cb0d09fca031d70be078d42621';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimlabourcampany.views.editview.caption',
        srfTitle: 'entities.pimlabourcampany.views.editview.title',
        srfSubTitle: 'entities.pimlabourcampany.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMLABOURCAMPANYEditView
     */
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'pimlabourcampany',
            majorPSDEField: 'pimlabourcampanyname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"PimLabourcampany");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"PimLabourcampany");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PimLabourcampany");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PimLabourcampany");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"PimLabourcampany");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"PimLabourcampany");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"PimLabourcampany");
    }
...
<style lang='less'>
@import './pimlabourcampanyedit-view.less';
</style>