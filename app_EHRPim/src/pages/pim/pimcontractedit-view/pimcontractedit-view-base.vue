<template>
  <app-layout viewName="pimcontracteditview" viewTitle="合同信息编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimcontractedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMCONTRACTEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMCONTRACTEditViewBase extends EditViewBase {
	 ...
	 * @memberof PIMCONTRACTEditViewBase
	 */
	public viewtag: string = 'a957fe4f2b902f476f50342656f65d19';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimcontract.views.editview.caption',
        srfTitle: 'entities.pimcontract.views.editview.title',
        srfSubTitle: 'entities.pimcontract.views.editview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pimcontractedit-view.less';
</style>