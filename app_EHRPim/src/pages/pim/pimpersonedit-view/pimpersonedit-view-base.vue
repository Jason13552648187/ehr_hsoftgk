<template>
  <app-layout viewName="pimpersoneditview" viewTitle="人员首页编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimpersonedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMPERSONEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMPERSONEditViewBase extends EditViewBase {
	 ...
	 * @memberof PIMPERSONEditViewBase
	 */
	public viewtag: string = '8fd92f189c89011b779240791ddce0b6';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimperson.views.editview.caption',
        srfTitle: 'entities.pimperson.views.editview.title',
        srfSubTitle: 'entities.pimperson.views.editview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pimpersonedit-view.less';
</style>