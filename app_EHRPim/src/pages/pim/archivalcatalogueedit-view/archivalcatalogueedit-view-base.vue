<template>
  <app-layout viewName="archivalcatalogueeditview" viewTitle="档案类别编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'archivalcatalogueedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ARCHIVALCATALOGUEEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ARCHIVALCATALOGUEEditViewBase extends EditViewBase {
	 ...
	 * @memberof ARCHIVALCATALOGUEEditViewBase
	 */
	public viewtag: string = '08c1c77ca3cea710c6744dfce3699e61';
     ...
     *
     * @type {*}
     * @memberof ARCHIVALCATALOGUEEditView
     */
...
<style lang='less'>
@import './archivalcatalogueedit-view.less';
</style>