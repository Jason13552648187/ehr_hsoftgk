<template>
  <app-layout viewName="pimlanguageabilityeditview" viewTitle="语言能力编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimlanguageabilityedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMLANGUAGEABILITYEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMLANGUAGEABILITYEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimLanguageAbilityService}
     * @memberof PIMLANGUAGEABILITYEditViewBase
     */
	 ...
	 * @memberof PIMLANGUAGEABILITYEditViewBase
	 */
	public viewtag: string = 'b8db05015388b6e80064e32729a09ea4';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimlanguageability.views.editview.caption',
        srfTitle: 'entities.pimlanguageability.views.editview.title',
        srfSubTitle: 'entities.pimlanguageability.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMLANGUAGEABILITYEditView
     */
...
<style lang='less'>
@import './pimlanguageabilityedit-view.less';
</style>