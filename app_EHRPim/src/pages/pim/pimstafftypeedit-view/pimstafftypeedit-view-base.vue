<template>
  <app-layout viewName="pimstafftypeeditview" viewTitle="员工类型编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimstafftypeedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMSTAFFTYPEEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMSTAFFTYPEEditViewBase extends EditViewBase {
	 ...
	 * @memberof PIMSTAFFTYPEEditViewBase
	 */
	public viewtag: string = '003c49714be39f21f9a26d87a41095c0';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimstafftype.views.editview.caption',
        srfTitle: 'entities.pimstafftype.views.editview.title',
        srfSubTitle: 'entities.pimstafftype.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'pimstafftype',
            majorPSDEField: 'pimstafftypename',
            isLoadDefault: true,
        });
    }
...
<style lang='less'>
@import './pimstafftypeedit-view.less';
</style>