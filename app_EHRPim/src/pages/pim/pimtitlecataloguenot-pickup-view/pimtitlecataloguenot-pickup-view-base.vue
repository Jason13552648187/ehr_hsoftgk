<template>
  <app-layout viewName="pimtitlecataloguenotpickupview" viewTitle="职称目录管理数据选择视图" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'depickupview': true, 'pimtitlecataloguenot-pickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMTITLECATALOGUENotPickupViewBase
 * @extends {PickupViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMTITLECATALOGUENotPickupViewBase extends PickupViewBase {
	 ...
	 * @memberof PIMTITLECATALOGUENotPickupViewBase
	 */
	public viewtag: string = 'd49fd7fa079e107b7f31f415b4cc8537';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimtitlecatalogue.views.notpickupview.caption',
        srfTitle: 'entities.pimtitlecatalogue.views.notpickupview.title',
        srfSubTitle: 'entities.pimtitlecatalogue.views.notpickupview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pimtitlecataloguenot-pickup-view.less';
</style>