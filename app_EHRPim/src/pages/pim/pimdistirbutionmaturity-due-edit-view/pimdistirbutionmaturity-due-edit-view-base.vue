<template>
  <app-layout viewName="pimdistirbutionmaturitydueeditview" viewTitle="借调到期编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimdistirbutionmaturity-due-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
export default class PIMDISTIRBUTIONMaturityDueEditViewBase extends EditViewBase {
	 ...
	 * @memberof PIMDISTIRBUTIONMaturityDueEditViewBase
	 */
	public viewtag: string = '6f4b078d3c031443a68b74847d25fd07';
...
<style lang='less'>
@import './pimdistirbutionmaturity-due-edit-view.less';
</style>