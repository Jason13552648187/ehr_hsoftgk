<template>
  <app-layout viewName="pimpersonquickeditview" viewTitle="人员信息编辑视图" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimpersonquick-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMPERSONQuickEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMPERSONQuickEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimPersonService}
     * @memberof PIMPERSONQuickEditViewBase
     */
	 ...
	 * @memberof PIMPERSONQuickEditViewBase
	 */
	public viewtag: string = '989e8d6cf1e2313c8bec03672ce0f7f9';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimperson.views.quickeditview.caption',
        srfTitle: 'entities.pimperson.views.quickeditview.title',
        srfSubTitle: 'entities.pimperson.views.quickeditview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMPERSONQuickEditView
     */
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Exit(datas, contextJO,paramJO,  $event, xData,this,"PimPerson");
    }
...
<style lang='less'>
@import './pimpersonquick-edit-view.less';
</style>