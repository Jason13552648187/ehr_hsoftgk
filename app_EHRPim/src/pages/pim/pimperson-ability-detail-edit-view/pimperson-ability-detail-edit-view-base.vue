<template>
  <app-layout viewName="pimpersonabilitydetaileditview" viewTitle="员工能力明细编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimperson-ability-detail-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMPersonAbilityDetailEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMPersonAbilityDetailEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimPersonAbilityDetailService}
     * @memberof PIMPersonAbilityDetailEditViewBase
     */
	 ...
	 * @memberof PIMPersonAbilityDetailEditViewBase
	 */
	public viewtag: string = '229dc8a499c851813e30fbb07e10be8a';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimpersonabilitydetail.views.editview.caption',
        srfTitle: 'entities.pimpersonabilitydetail.views.editview.title',
        srfSubTitle: 'entities.pimpersonabilitydetail.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMPersonAbilityDetailEditView
     */
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'pimpersonabilitydetail',
            majorPSDEField: 'pimpersonabilitydetailname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"PimPersonAbilityDetail");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"PimPersonAbilityDetail");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PimPersonAbilityDetail");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PimPersonAbilityDetail");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"PimPersonAbilityDetail");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"PimPersonAbilityDetail");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"PimPersonAbilityDetail");
    }
...
<style lang='less'>
@import './pimperson-ability-detail-edit-view.less';
</style>