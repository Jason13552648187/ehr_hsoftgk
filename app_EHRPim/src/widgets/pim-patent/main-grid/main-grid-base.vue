    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('zlh')">
                <el-table-column show-overflow-tooltip :prop="'zlh'" :label="$t('entities.pimpatent.main_grid.columns.zlh')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimpatent.main_grid.columns.zlh')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('pimpatentname')">
                <el-table-column show-overflow-tooltip :prop="'pimpatentname'" :label="$t('entities.pimpatent.main_grid.columns.pimpatentname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimpatent.main_grid.columns.pimpatentname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
            ...
            <template v-if="getColumnState('zlhqsj')">
                <el-table-column show-overflow-tooltip :prop="'zlhqsj'" :label="$t('entities.pimpatent.main_grid.columns.zlhqsj')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimpatent.main_grid.columns.zlhqsj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
            ...
            <template v-if="getColumnState('zlpzgb')">
                <el-table-column show-overflow-tooltip :prop="'zlpzgb'" :label="$t('entities.pimpatent.main_grid.columns.zlpzgb')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimpatent.main_grid.columns.zlpzgb')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
            ...
            <template v-if="getColumnState('enclolure')">
                <el-table-column show-overflow-tooltip :prop="'enclolure'" :label="$t('entities.pimpatent.main_grid.columns.enclolure')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimpatent.main_grid.columns.enclolure')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
              ...
              style="overflow: auto;">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='enclolure' editorType="FILEUPLOADER" :value="row.enclolure"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'zlh',
            label: '专利号(*)',
            langtag: 'entities.pimpatent.main_grid.columns.zlh',
            show: true,
            util: 'PX'
        },
        {
            name: 'pimpatentname',
            label: '专利名称(*)',
            langtag: 'entities.pimpatent.main_grid.columns.pimpatentname',
            show: true,
            util: 'PX'
        },
        {
            name: 'zlhqsj',
            label: '专利获取时间(*)',
            langtag: 'entities.pimpatent.main_grid.columns.zlhqsj',
            show: true,
            util: 'PX'
        },
        {
            name: 'zlpzgb',
            label: '专利批准国别(*)',
            langtag: 'entities.pimpatent.main_grid.columns.zlpzgb',
            show: true,
            util: 'PX'
        },
        {
            name: 'enclolure',
            label: '附件',
            langtag: 'entities.pimpatent.main_grid.columns.enclolure',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PIMPATENTPATENTGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PIMPATENTPATENTGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('pimpatent_main_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('pimpatent_main_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMPATENTPATENTGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMPATENTPATENTGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.pimpatent){
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PIMPATENTPATENTGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
