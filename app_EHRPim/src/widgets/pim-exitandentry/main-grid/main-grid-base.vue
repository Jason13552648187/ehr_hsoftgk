        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
                ...
                <el-table-column show-overflow-tooltip :prop="'ygbh'" :label="$t('entities.pimexitandentry.main_grid.columns.ygbh')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimexitandentry.main_grid.columns.ygbh')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('pimpersonname')">
                <el-table-column show-overflow-tooltip :prop="'pimpersonname'" :label="$t('entities.pimexitandentry.main_grid.columns.pimpersonname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimexitandentry.main_grid.columns.pimpersonname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('zzdzs')">
                <el-table-column show-overflow-tooltip :prop="'zzdzs'" :label="$t('entities.pimexitandentry.main_grid.columns.zzdzs')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimexitandentry.main_grid.columns.zzdzs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.zzdzs}}</span>
            ...
            <template v-if="getColumnState('rank')">
                <el-table-column show-overflow-tooltip :prop="'rank'" :label="$t('entities.pimexitandentry.main_grid.columns.rank')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimexitandentry.main_grid.columns.rank')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('qwfhgj')">
                <el-table-column show-overflow-tooltip :prop="'qwfhgj'" :label="$t('entities.pimexitandentry.main_grid.columns.qwfhgj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimexitandentry.main_grid.columns.qwfhgj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('cjsj')">
                <el-table-column show-overflow-tooltip :prop="'cjsj'" :label="$t('entities.pimexitandentry.main_grid.columns.cjsj')" :width="180"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimexitandentry.main_grid.columns.cjsj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('rjsj')">
                <el-table-column show-overflow-tooltip :prop="'rjsj'" :label="$t('entities.pimexitandentry.main_grid.columns.rjsj')" :width="180"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimexitandentry.main_grid.columns.rjsj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('lx')">
                <el-table-column show-overflow-tooltip :prop="'lx'" :label="$t('entities.pimexitandentry.main_grid.columns.lx')" :width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimexitandentry.main_grid.columns.lx')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.lx" tag='EhrCodeList0126' codelistType='STATIC' ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('sy')">
                <el-table-column show-overflow-tooltip :prop="'sy'" :label="$t('entities.pimexitandentry.main_grid.columns.sy')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimexitandentry.main_grid.columns.sy')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.sy}}</span>
            ...
            <template v-if="getColumnState('workflowstate')">
                <el-table-column show-overflow-tooltip :prop="'workflowstate'" :label="$t('entities.pimexitandentry.main_grid.columns.workflowstate')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimexitandentry.main_grid.columns.workflowstate')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.workflowstate" tag='EhrCodeList0106' codelistType='STATIC' ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'ygbh',
            label: '员工编号',
            langtag: 'entities.pimexitandentry.main_grid.columns.ygbh',
            show: true,
            util: 'px'
        },
        {
            name: 'pimpersonname',
            label: '员工姓名',
            langtag: 'entities.pimexitandentry.main_grid.columns.pimpersonname',
            show: true,
            util: 'px'
        },
        {
            name: 'zzdzs',
            label: '组织',
            langtag: 'entities.pimexitandentry.main_grid.columns.zzdzs',
            show: true,
            util: 'px'
        },
        {
            name: 'rank',
            label: '职级',
            langtag: 'entities.pimexitandentry.main_grid.columns.rank',
            show: true,
            util: 'PX'
        },
        {
            name: 'qwfhgj',
            label: '目的国家/地区',
            langtag: 'entities.pimexitandentry.main_grid.columns.qwfhgj',
            show: true,
            util: 'px'
        },
        {
            name: 'cjsj',
            label: '出（国）境时间',
            langtag: 'entities.pimexitandentry.main_grid.columns.cjsj',
            show: true,
            util: 'PX'
        },
        {
            name: 'rjsj',
            label: '入（国）境时间',
            langtag: 'entities.pimexitandentry.main_grid.columns.rjsj',
            show: true,
            util: 'PX'
        },
        {
            name: 'lx',
            label: '类型',
            langtag: 'entities.pimexitandentry.main_grid.columns.lx',
            show: true,
            util: 'PX'
        },
        {
    ...
    public getGridRowModel(){
        return {
          ...
          cjsj: new FormItemModel(),
          rjsj: new FormItemModel(),
    ...
    public rules: any = {
        ...
        cjsj: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '出（国）境时间 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '出（国）境时间 值不能为空', trigger: 'blur' },
        ],
        rjsj: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '入（国）境时间 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '入（国）境时间 值不能为空', trigger: 'blur' },
        ],
        srfkey: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '出入境管理标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '出入境管理标识 值不能为空', trigger: 'blur' },
        ],
    }
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PIMEXITANDENTRYYGCGJGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PIMEXITANDENTRYYGCGJGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        _datas.forEach((record: any, index: number) => {
            let srfmajortext = record.pimexitandentryname;
            if (index < 5) {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pimexitandentry: _keys }),Object.assign({ pimexitandentry: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.pimexitandentry,$event.pimexitandentry);
        });
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('pimexitandentry_main_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('pimexitandentry_main_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMEXITANDENTRYYGCGJGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMEXITANDENTRYYGCGJGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.pimexitandentry){
                            Object.assign(this.context,{pimexitandentry:item.pimexitandentry});
                        }
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PIMEXITANDENTRYYGCGJGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
