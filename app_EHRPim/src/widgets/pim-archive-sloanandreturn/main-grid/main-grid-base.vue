        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('jyr')">
                <el-table-column show-overflow-tooltip :prop="'jyr'" :label="$t('entities.pimarchivesloanandreturn.main_grid.columns.jyr')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimarchivesloanandreturn.main_grid.columns.jyr')}}
                      </span>
                    </template>
              ...
              @change="($event)=>{gridEditItemChange(row, column.property, $event, $index)}">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='jyr' editorType="TEXTBOX" :value="row.jyr"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('jyqssj')">
                <el-table-column show-overflow-tooltip :prop="'jyqssj'" :label="$t('entities.pimarchivesloanandreturn.main_grid.columns.jyqssj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimarchivesloanandreturn.main_grid.columns.jyqssj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='jyqssj' editorType="DATEPICKER" :value="row.jyqssj"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('ghrq')">
                <el-table-column show-overflow-tooltip :prop="'ghrq'" :label="$t('entities.pimarchivesloanandreturn.main_grid.columns.ghrq')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimarchivesloanandreturn.main_grid.columns.ghrq')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='ghrq' editorType="DATEPICKER" :value="row.ghrq"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('pimpersonname3')">
                <el-table-column show-overflow-tooltip :prop="'pimpersonname3'" :label="$t('entities.pimarchivesloanandreturn.main_grid.columns.pimpersonname3')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimarchivesloanandreturn.main_grid.columns.pimpersonname3')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
            ...
            { pathName: 'editview2', parameterName: 'editview2' }
                                ...
                                <app-span name='pimpersonname3' editorType="PICKER" :value="row.pimpersonname3"></app-span>
                              </app-column-link>
                        </template>
                    </template>
                </el-table-column>
            ...
            <template v-if="getColumnState('spdate')">
                <el-table-column show-overflow-tooltip :prop="'spdate'" :label="$t('entities.pimarchivesloanandreturn.main_grid.columns.spdate')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimarchivesloanandreturn.main_grid.columns.spdate')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='spdate' editorType="DATEPICKER" :value="row.spdate"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('jyyy')">
                <el-table-column show-overflow-tooltip :prop="'jyyy'" :label="$t('entities.pimarchivesloanandreturn.main_grid.columns.jyyy')" :min-width="300"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimarchivesloanandreturn.main_grid.columns.jyyy')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
              ...
              @change="($event)=>{gridEditItemChange(row, column.property, $event, $index)}">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='jyyy' editorType="TEXTBOX" :value="row.jyyy"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('zt')">
                <el-table-column show-overflow-tooltip :prop="'zt'" :label="$t('entities.pimarchivesloanandreturn.main_grid.columns.zt')" :width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimarchivesloanandreturn.main_grid.columns.zt')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
             ...
             <dropdown-list 
              ...
              @change="($event)=>{gridEditItemChange(row, column.property, $event, $index)}">
                        ...
                        <template v-if="!actualIsOpenEdit">
            <codelist :value="row.zt" tag='EhrCodeList0149' codelistType='STATIC' renderMode="STR" valueSeparator=";" textSeparator="、" ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof MainBase
     */
    public appEntityService: PimArchiveSloanandreturnService = new PimArchiveSloanandreturnService({ $store: this.$store });
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'jyr',
            label: '借阅人',
            langtag: 'entities.pimarchivesloanandreturn.main_grid.columns.jyr',
            show: true,
            util: 'PX'
        },
        {
            name: 'jyqssj',
            label: '借阅时间',
            langtag: 'entities.pimarchivesloanandreturn.main_grid.columns.jyqssj',
            show: true,
            util: 'PX'
        },
        {
            name: 'ghrq',
            label: '归还时间',
            langtag: 'entities.pimarchivesloanandreturn.main_grid.columns.ghrq',
            show: true,
            util: 'PX'
        },
        {
            name: 'pimpersonname3',
            label: '审批人',
            langtag: 'entities.pimarchivesloanandreturn.main_grid.columns.pimpersonname3',
            show: true,
            util: 'PX'
        },
        {
            name: 'spdate',
            label: '审批时间',
            langtag: 'entities.pimarchivesloanandreturn.main_grid.columns.spdate',
            show: true,
            util: 'PX'
        },
        {
            name: 'jyyy',
            label: '借阅原因',
            langtag: 'entities.pimarchivesloanandreturn.main_grid.columns.jyyy',
            show: true,
            util: 'STAR'
        },
        {
            name: 'zt',
            label: '状态',
            langtag: 'entities.pimarchivesloanandreturn.main_grid.columns.zt',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public getGridRowModel(){
        return {
          ghrq: new FormItemModel(),
          jyr: new FormItemModel(),
          pimpersonid3: new FormItemModel(),
          pimarchivesid: new FormItemModel(),
          jyqssj: new FormItemModel(),
          zt: new FormItemModel(),
          spperson: new FormItemModel(),
          spdate: new FormItemModel(),
          jyyy: new FormItemModel(),
          pimpersonname3: new FormItemModel(),
    ...
    public rules: any = {
        ghrq: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '归还时间 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '归还时间 值不能为空', trigger: 'blur' },
        ],
        jyr: [
             { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '借阅人 值不能为空', trigger: 'change' },
            { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '借阅人 值不能为空', trigger: 'blur' },
        ],
        pimpersonid3: [
        ...
        jyqssj: [
             { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '借阅时间 值不能为空', trigger: 'change' },
            { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '借阅时间 值不能为空', trigger: 'blur' },
        ],
        zt: [
             { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '状态 值不能为空', trigger: 'change' },
            { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '状态 值不能为空', trigger: 'blur' },
        ],
        spperson: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '审批同意人 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '审批同意人 值不能为空', trigger: 'blur' },
        ],
        spdate: [
             { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '审批时间 值不能为空', trigger: 'change' },
            { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '审批时间 值不能为空', trigger: 'blur' },
        ],
        jyyy: [
             { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '借阅原因 值不能为空', trigger: 'change' },
            { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '借阅原因 值不能为空', trigger: 'blur' },
        ],
        pimpersonname3: [
             { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '审批人 值不能为空', trigger: 'change' },
            { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '审批人 值不能为空', trigger: 'blur' },
        ],
        srfkey: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '档案借阅及归还记录标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '档案借阅及归还记录标识 值不能为空', trigger: 'blur' },
        ],
    }
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PIMARCHIVESLOANANDRETURNGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PIMARCHIVESLOANANDRETURNGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        _datas.forEach((record: any, index: number) => {
            let srfmajortext = record.pimarchivesloanandreturnname;
            if (index < 5) {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pimarchivesloanandreturn: _keys }),Object.assign({ pimarchivesloanandreturn: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.pimarchivesloanandreturn,$event.pimarchivesloanandreturn);
        });
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('pimarchivesloanandreturn_main_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('pimarchivesloanandreturn_main_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMARCHIVESLOANANDRETURNGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMARCHIVESLOANANDRETURNGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.pimarchivesloanandreturn){
                            Object.assign(this.context,{pimarchivesloanandreturn:item.pimarchivesloanandreturn});
                        }
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PIMARCHIVESLOANANDRETURNGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
    ...
    public gridEditItemChange(row: any, property: string, value: any, rowIndex: number){
        ...
        if(Object.is(property, 'ghrq')){
            const details: string[] = ['zt'];
            this.updateGridEditItem('UpdateState', row, details, true);
        }
        if(Object.is(property, 'jyqssj')){
            const details: string[] = ['zt'];
            this.updateGridEditItem('UpdateState', row, details, true);
        }
    }
    ...
    public getRowClassName(args:{row: any,rowIndex: number}){
        let isSelected = this.selections.some((item:any)=>{
            return Object.is(item.pimarchivesloanandreturn,args.row.pimarchivesloanandreturn);
        });
    ...
    public createDefault(row: any){                    
        if (row.hasOwnProperty('pimarchivesid')) {
            row['pimarchivesid'] = this.viewparams['srfparentkey'];
        }
    }
}
</script>
