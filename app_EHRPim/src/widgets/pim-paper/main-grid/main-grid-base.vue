        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
                ...
                <el-table-column show-overflow-tooltip :prop="'pimpapername'" :label="$t('entities.pimpaper.main_grid.columns.pimpapername')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimpaper.main_grid.columns.pimpapername')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('cbs')">
                <el-table-column show-overflow-tooltip :prop="'cbs'" :label="$t('entities.pimpaper.main_grid.columns.cbs')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimpaper.main_grid.columns.cbs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
            ...
            <template v-if="getColumnState('kwmc')">
                <el-table-column show-overflow-tooltip :prop="'kwmc'" :label="$t('entities.pimpaper.main_grid.columns.kwmc')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimpaper.main_grid.columns.kwmc')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
            ...
            <template v-if="getColumnState('kwqs')">
                <el-table-column show-overflow-tooltip :prop="'kwqs'" :label="$t('entities.pimpaper.main_grid.columns.kwqs')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimpaper.main_grid.columns.kwqs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
            ...
            <template v-if="getColumnState('fbsj')">
                <el-table-column show-overflow-tooltip :prop="'fbsj'" :label="$t('entities.pimpaper.main_grid.columns.fbsj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimpaper.main_grid.columns.fbsj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
            ...
            <template v-if="getColumnState('grzlwzzzdpm')">
                <el-table-column show-overflow-tooltip :prop="'grzlwzzzdpm'" :label="$t('entities.pimpaper.main_grid.columns.grzlwzzzdpm')" :width="220"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimpaper.main_grid.columns.grzlwzzzdpm')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
            ...
            <template v-if="getColumnState('fj')">
                <el-table-column show-overflow-tooltip :prop="'fj'" :label="$t('entities.pimpaper.main_grid.columns.fj')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimpaper.main_grid.columns.fj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'pimpapername',
            label: '论文名称(*)',
            langtag: 'entities.pimpaper.main_grid.columns.pimpapername',
            show: true,
            util: 'PX'
        },
        {
            name: 'cbs',
            label: '出版社(*)',
            langtag: 'entities.pimpaper.main_grid.columns.cbs',
            show: true,
            util: 'PX'
        },
        {
            name: 'kwmc',
            label: '刊物名称(*)',
            langtag: 'entities.pimpaper.main_grid.columns.kwmc',
            show: true,
            util: 'PX'
        },
        {
            name: 'kwqs',
            label: '刊物期数',
            langtag: 'entities.pimpaper.main_grid.columns.kwqs',
            show: true,
            util: 'PX'
        },
        {
            name: 'fbsj',
            label: '发表时间(*)',
            langtag: 'entities.pimpaper.main_grid.columns.fbsj',
            show: true,
            util: 'PX'
        },
        {
            name: 'grzlwzzzdpm',
            label: '个人在论文著作中的排名',
            langtag: 'entities.pimpaper.main_grid.columns.grzlwzzzdpm',
            show: true,
            util: 'PX'
        },
        {
            name: 'fj',
            label: '附件',
            langtag: 'entities.pimpaper.main_grid.columns.fj',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PIMPAPERPAPERGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PIMPAPERPAPERGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('pimpaper_main_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('pimpaper_main_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMPAPERPAPERGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMPAPERPAPERGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.pimpaper){
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PIMPAPERPAPERGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
