...
import OrgTitleBarService from './org-title-bar-chart-service';
...
export default class OrgTitleBarBase extends Vue implements ControlInterface {
    ...
    */
     ...
     * @public
     * @type {boolean}
     * @memberof Db_sysportlet5_chartBase
     */
    ...
    public  seriesModel:any = {
        orgtitlebar:new ChartBarSeries({
    name:'orgtitlebar',
    
    
    categorField:'professor_type',
    categorCodeList:{type:'DYNAMIC',tag:'EhrCodeList0024',emptycode:'empty',emptytext:'未定义'},
    ...
    seriesMap:{},
    dataSetFields:[
    {name:"professor_type",codelist:{type:"DYNAMIC",tag:"EhrCodeList0024",emptycode:'empty',emptytext:'未定义'},isGroupField:true,groupMode:"CODELIST"},
    ...
    ecObject:{
        label:{show:true,position:"top",formatter: '{b}: {@countnum}人'},
        itemStyle:{normal:{color:(params:any)=>{let colorList=["#6741ff","#00ffa4","#43b2ff","#fea675"];return colorList[params.dataIndex];}}},
    },
    seriesTemp:{
        type:'bar',
    },
    ...
    public chartUserParams:any ={
        xAxis:[{gridIndex: 0,position: "bottom",type: "category",name: "",axisTick: {show: false,},axisLabel:{show: false,}}],
        color:['#886fec','#0404f6', '#8BC34A', '#25fad3', '#91c7ae','#749f83',  '#ca8622', '#bda29a','#6e7074', '#546570', '#c4ccd3'],
        yAxis:{show:false}
    };
...
<style lang='less'>
@import './org-title-bar-chart.less';
</style>