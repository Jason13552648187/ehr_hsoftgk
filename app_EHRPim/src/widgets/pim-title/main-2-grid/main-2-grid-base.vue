    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('ygbh')">
                <el-table-column show-overflow-tooltip :prop="'ygbh'" :label="$t('entities.pimtitle.main_2_grid.columns.ygbh')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimtitle.main_2_grid.columns.ygbh')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('pimpersonname')">
                <el-table-column show-overflow-tooltip :prop="'pimpersonname'" :label="$t('entities.pimtitle.main_2_grid.columns.pimpersonname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimtitle.main_2_grid.columns.pimpersonname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            { pathName: 'editview2', parameterName: 'editview2' }
                                ...
                                <app-span name='pimpersonname' editorType="PICKER" :value="row.pimpersonname"></app-span>
                              </app-column-link>
                        </template>
                    </template>
                </el-table-column>
            ...
            <template v-if="getColumnState('ygzt')">
                <el-table-column show-overflow-tooltip :prop="'ygzt'" :label="$t('entities.pimtitle.main_2_grid.columns.ygzt')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimtitle.main_2_grid.columns.ygzt')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.ygzt" tag='EhrCodeList0014' codelistType='DYNAMIC' ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('ormorgname')">
                <el-table-column show-overflow-tooltip :prop="'ormorgname'" :label="$t('entities.pimtitle.main_2_grid.columns.ormorgname')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimtitle.main_2_grid.columns.ormorgname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('pimtitlecataloguename')">
                <el-table-column show-overflow-tooltip :prop="'pimtitlecataloguename'" :label="$t('entities.pimtitle.main_2_grid.columns.pimtitlecataloguename')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimtitle.main_2_grid.columns.pimtitlecataloguename')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            ]}" valueitem="pimtitlecatalogueid">
                                <app-span name='pimtitlecataloguename' editorType="PICKER" :value="row.pimtitlecataloguename"></app-span>
                              </app-column-link>
                        </template>
                    </template>
                </el-table-column>
            ...
            <template v-if="getColumnState('zchqrq')">
                <el-table-column show-overflow-tooltip :prop="'zchqrq'" :label="$t('entities.pimtitle.main_2_grid.columns.zchqrq')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimtitle.main_2_grid.columns.zchqrq')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('zcbh')">
                <el-table-column show-overflow-tooltip :prop="'zcbh'" :label="$t('entities.pimtitle.main_2_grid.columns.zcbh')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimtitle.main_2_grid.columns.zcbh')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('majorengaged')">
                <el-table-column show-overflow-tooltip :prop="'majorengaged'" :label="$t('entities.pimtitle.main_2_grid.columns.majorengaged')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimtitle.main_2_grid.columns.majorengaged')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('zcdj')">
                <el-table-column show-overflow-tooltip :prop="'zcdj'" :label="$t('entities.pimtitle.main_2_grid.columns.zcdj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimtitle.main_2_grid.columns.zcdj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.zcdj" tag='EhrCodeList0024' codelistType='DYNAMIC' ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('duration')">
                <el-table-column show-overflow-tooltip :prop="'duration'" :label="$t('entities.pimtitle.main_2_grid.columns.duration')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimtitle.main_2_grid.columns.duration')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('employtime')">
                <el-table-column show-overflow-tooltip :prop="'employtime'" :label="$t('entities.pimtitle.main_2_grid.columns.employtime')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimtitle.main_2_grid.columns.employtime')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <app-format-data format="YYYY-MM-DD" :data="row.employtime"></app-format-data>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('lssuingagency')">
                <el-table-column show-overflow-tooltip :prop="'lssuingagency'" :label="$t('entities.pimtitle.main_2_grid.columns.lssuingagency')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimtitle.main_2_grid.columns.lssuingagency')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('reviewbody')">
                <el-table-column show-overflow-tooltip :prop="'reviewbody'" :label="$t('entities.pimtitle.main_2_grid.columns.reviewbody')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimtitle.main_2_grid.columns.reviewbody')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('sfzgzc')">
                <el-table-column show-overflow-tooltip :prop="'sfzgzc'" :label="$t('entities.pimtitle.main_2_grid.columns.sfzgzc')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimtitle.main_2_grid.columns.sfzgzc')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.sfzgzc" tag='EhrCodeList0401' codelistType='STATIC' renderMode="STR" valueSeparator=";" textSeparator="、" ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
...
export default class Main_2Base extends Vue implements ControlInterface {
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'ygbh',
            label: '员工编号',
            langtag: 'entities.pimtitle.main_2_grid.columns.ygbh',
            show: true,
            util: 'px'
        },
        {
            name: 'pimpersonname',
            label: '员工姓名',
            langtag: 'entities.pimtitle.main_2_grid.columns.pimpersonname',
            show: true,
            util: 'PX'
        },
        {
            name: 'ygzt',
            label: '员工状态',
            langtag: 'entities.pimtitle.main_2_grid.columns.ygzt',
            show: true,
            util: 'PX'
        },
        {
            name: 'ormorgname',
            label: '组织',
            langtag: 'entities.pimtitle.main_2_grid.columns.ormorgname',
            show: true,
            util: 'PX'
        },
        {
            ...
            label: '职称名称',
            langtag: 'entities.pimtitle.main_2_grid.columns.pimtitlecataloguename',
            show: true,
            util: 'PX'
        },
        {
            name: 'zchqrq',
            label: '职称获取日期',
            langtag: 'entities.pimtitle.main_2_grid.columns.zchqrq',
            show: true,
            util: 'PX'
        },
        {
            name: 'zcbh',
            label: '证书编号',
            langtag: 'entities.pimtitle.main_2_grid.columns.zcbh',
            show: true,
            util: 'PX'
        },
        {
            name: 'majorengaged',
            label: '专业类别',
            langtag: 'entities.pimtitle.main_2_grid.columns.majorengaged',
            show: true,
            util: 'PX'
        },
        {
            name: 'zcdj',
            label: '职称等级',
            langtag: 'entities.pimtitle.main_2_grid.columns.zcdj',
            show: true,
            util: 'PX'
        },
        {
            name: 'duration',
            label: '职称获取月数',
            langtag: 'entities.pimtitle.main_2_grid.columns.duration',
            show: true,
            util: 'px'
        },
        {
            name: 'employtime',
            label: '职称聘用时间',
            langtag: 'entities.pimtitle.main_2_grid.columns.employtime',
            show: true,
            util: 'px'
        },
        {
            name: 'lssuingagency',
            label: '签发机构',
            langtag: 'entities.pimtitle.main_2_grid.columns.lssuingagency',
            show: true,
            util: 'px'
        },
        {
            name: 'reviewbody',
            label: '评审单位',
            langtag: 'entities.pimtitle.main_2_grid.columns.reviewbody',
            show: true,
            util: 'PX'
        },
        {
            name: 'sfzgzc',
            label: '是否最高职称',
            langtag: 'entities.pimtitle.main_2_grid.columns.sfzgzc',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public getGridRowModel(){
        return {
          zcdj: new FormItemModel(),
          pimtitlecatalogueid: new FormItemModel(),
          zcbh: new FormItemModel(),
          pimpersonid: new FormItemModel(),
          pimtitlecataloguename: new FormItemModel(),
          majorengaged: new FormItemModel(),
          zchqrq: new FormItemModel(),
          srfkey: new FormItemModel(),
          pimpersonname: new FormItemModel(),
          reviewbody: new FormItemModel(),
        }
    }
    ...
    public rules: any = {
        zcdj: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '职称等级 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '职称等级 值不能为空', trigger: 'blur' },
        ],
        pimtitlecatalogueid: [
        ...
        zcbh: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '证书编号 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '证书编号 值不能为空', trigger: 'blur' },
        ],
        pimpersonid: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '值不能为空', trigger: 'blur' },
        ],
        pimtitlecataloguename: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '职称名称 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '职称名称 值不能为空', trigger: 'blur' },
        ],
        majorengaged: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '专业类别 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '专业类别 值不能为空', trigger: 'blur' },
        ],
        zchqrq: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '职称获取日期 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '职称获取日期 值不能为空', trigger: 'blur' },
        ],
        srfkey: [
        ...
        pimpersonname: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '员工姓名 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '员工姓名 值不能为空', trigger: 'blur' },
        ],
        reviewbody: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '评审单位 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '评审单位 值不能为空', trigger: 'blur' },
        ],
    }
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PIMTITLEGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PIMTITLEGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pimtitle: _keys }),Object.assign({ pimtitle: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.pimtitle,$event.pimtitle);
        });
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('pimtitle_main_2_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('pimtitle_main_2_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMTITLEGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMTITLEGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.pimtitle){
                            Object.assign(this.context,{pimtitle:item.pimtitle});
                        }
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PIMTITLEGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
