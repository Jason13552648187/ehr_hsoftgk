        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
                ...
                <el-table-column show-overflow-tooltip :prop="'ygbh'" :label="$t('entities.pimcontract.stopremindgrid_grid.columns.ygbh')" :width="115"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontract.stopremindgrid_grid.columns.ygbh')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('pimpersonname')">
                <el-table-column show-overflow-tooltip :prop="'pimpersonname'" :label="$t('entities.pimcontract.stopremindgrid_grid.columns.pimpersonname')" :width="115"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontract.stopremindgrid_grid.columns.pimpersonname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('zzdzs')">
                <el-table-column show-overflow-tooltip :prop="'zzdzs'" :label="$t('entities.pimcontract.stopremindgrid_grid.columns.zzdzs')" :width="135"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontract.stopremindgrid_grid.columns.zzdzs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.zzdzs}}</span>
            ...
            <template v-if="getColumnState('ygzt')">
                <el-table-column show-overflow-tooltip :prop="'ygzt'" :label="$t('entities.pimcontract.stopremindgrid_grid.columns.ygzt')" :width="110"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontract.stopremindgrid_grid.columns.ygzt')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('dbdwsj')">
                <el-table-column show-overflow-tooltip :prop="'dbdwsj'" :label="$t('entities.pimcontract.stopremindgrid_grid.columns.dbdwsj')" :width="135"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontract.stopremindgrid_grid.columns.dbdwsj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('htbh')">
                <el-table-column show-overflow-tooltip :prop="'htbh'" :label="$t('entities.pimcontract.stopremindgrid_grid.columns.htbh')" :width="110"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontract.stopremindgrid_grid.columns.htbh')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.htbh}}</span>
            ...
            <template v-if="getColumnState('signingunit')">
                <el-table-column show-overflow-tooltip :prop="'signingunit'" :label="$t('entities.pimcontract.stopremindgrid_grid.columns.signingunit')" :width="135"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontract.stopremindgrid_grid.columns.signingunit')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('htlx')">
                <el-table-column show-overflow-tooltip :prop="'htlx'" :label="$t('entities.pimcontract.stopremindgrid_grid.columns.htlx')" :width="110"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontract.stopremindgrid_grid.columns.htlx')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('contracttype')">
                <el-table-column show-overflow-tooltip :prop="'contracttype'" :label="$t('entities.pimcontract.stopremindgrid_grid.columns.contracttype')" :width="110"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontract.stopremindgrid_grid.columns.contracttype')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('qsrq')">
                <el-table-column show-overflow-tooltip :prop="'qsrq'" :label="$t('entities.pimcontract.stopremindgrid_grid.columns.qsrq')" :width="110"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontract.stopremindgrid_grid.columns.qsrq')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('jsrq')">
                <el-table-column show-overflow-tooltip :prop="'jsrq'" :label="$t('entities.pimcontract.stopremindgrid_grid.columns.jsrq')" :width="110"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontract.stopremindgrid_grid.columns.jsrq')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('uagridcolumn1')">
                <el-table-column :column-key="'uagridcolumn1'" :label="$t('entities.pimcontract.stopremindgrid_grid.columns.uagridcolumn1')" :width="100"  :align="'right'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontract.stopremindgrid_grid.columns.uagridcolumn1')}}
                      </span>
                    </template>
...
export default class StopRemindGridBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof StopRemindGridBase
     */
    ...
    */
    ...
    public allColumns: any[] = [
        ...
        },
        {
            name: 'pimpersonname',
            label: '员工姓名',
            langtag: 'entities.pimcontract.stopremindgrid_grid.columns.pimpersonname',
            show: true,
            util: 'PX'
        },
        {
            name: 'zzdzs',
            label: '员工所属单位',
            langtag: 'entities.pimcontract.stopremindgrid_grid.columns.zzdzs',
            show: true,
            util: 'px'
        },
        {
            name: 'ygzt',
            label: '员工状态',
            langtag: 'entities.pimcontract.stopremindgrid_grid.columns.ygzt',
            show: true,
            util: 'px'
        },
        {
            name: 'dbdwsj',
            label: '到本单位时间',
            langtag: 'entities.pimcontract.stopremindgrid_grid.columns.dbdwsj',
            show: true,
            util: 'PX'
        },
        {
            name: 'htbh',
            label: '合同编号',
            langtag: 'entities.pimcontract.stopremindgrid_grid.columns.htbh',
            show: true,
            util: 'px'
        },
        {
            name: 'signingunit',
            label: '合同签订单位',
            langtag: 'entities.pimcontract.stopremindgrid_grid.columns.signingunit',
            show: true,
            util: 'PX'
        },
        {
            name: 'htlx',
            label: '合同类别',
            langtag: 'entities.pimcontract.stopremindgrid_grid.columns.htlx',
            show: true,
            util: 'px'
        },
        {
            name: 'contracttype',
            label: '合同类型',
            langtag: 'entities.pimcontract.stopremindgrid_grid.columns.contracttype',
            show: true,
            util: 'PX'
        },
        {
            name: 'qsrq',
            label: '起始日期',
            langtag: 'entities.pimcontract.stopremindgrid_grid.columns.qsrq',
            show: true,
            util: 'PX'
        },
        {
            name: 'jsrq',
            label: '结束日期',
            langtag: 'entities.pimcontract.stopremindgrid_grid.columns.jsrq',
            show: true,
            util: 'PX'
        },
        {
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMCONTRACTStopRemindGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMCONTRACTStopRemindGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.pimcontract){
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PIMCONTRACTStopRemindGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
...
<style lang='less'>
@import './stop-remind-grid-grid.less';
</style>