    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('ygbh')">
                <el-table-column show-overflow-tooltip :prop="'ygbh'" :label="$t('entities.pimcontract.main_grid.columns.ygbh')" :width="115"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontract.main_grid.columns.ygbh')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('pimpersonname')">
                <el-table-column show-overflow-tooltip :prop="'pimpersonname'" :label="$t('entities.pimcontract.main_grid.columns.pimpersonname')" :width="115"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontract.main_grid.columns.pimpersonname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('personorgname')">
                <el-table-column show-overflow-tooltip :prop="'personorgname'" :label="$t('entities.pimcontract.main_grid.columns.personorgname')" :width="135"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontract.main_grid.columns.personorgname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.personorgname}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('ygzt')">
                <el-table-column show-overflow-tooltip :prop="'ygzt'" :label="$t('entities.pimcontract.main_grid.columns.ygzt')" :width="110"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontract.main_grid.columns.ygzt')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('dbdwsj')">
                <el-table-column show-overflow-tooltip :prop="'dbdwsj'" :label="$t('entities.pimcontract.main_grid.columns.dbdwsj')" :width="135"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontract.main_grid.columns.dbdwsj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('htbh')">
                <el-table-column show-overflow-tooltip :prop="'htbh'" :label="$t('entities.pimcontract.main_grid.columns.htbh')" :width="110"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontract.main_grid.columns.htbh')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('signingunit')">
                <el-table-column show-overflow-tooltip :prop="'signingunit'" :label="$t('entities.pimcontract.main_grid.columns.signingunit')" :width="135"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontract.main_grid.columns.signingunit')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('htlx')">
                <el-table-column show-overflow-tooltip :prop="'htlx'" :label="$t('entities.pimcontract.main_grid.columns.htlx')" :width="110"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontract.main_grid.columns.htlx')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.htlx" tag='EhrCodeList0084' codelistType='DYNAMIC' renderMode="STR" valueSeparator=";" textSeparator="、" ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('contracttype')">
                <el-table-column show-overflow-tooltip :prop="'contracttype'" :label="$t('entities.pimcontract.main_grid.columns.contracttype')" :width="110"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontract.main_grid.columns.contracttype')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.contracttype" tag='EhrCodeList0107' codelistType='DYNAMIC' ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('qsrq')">
                <el-table-column show-overflow-tooltip :prop="'qsrq'" :label="$t('entities.pimcontract.main_grid.columns.qsrq')" :width="110"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontract.main_grid.columns.qsrq')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('jsrq')">
                <el-table-column show-overflow-tooltip :prop="'jsrq'" :label="$t('entities.pimcontract.main_grid.columns.jsrq')" :width="110"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontract.main_grid.columns.jsrq')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('htzt')">
                <el-table-column show-overflow-tooltip :prop="'htzt'" :label="$t('entities.pimcontract.main_grid.columns.htzt')" :width="110"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontract.main_grid.columns.htzt')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.htzt" tag='EhrCodeList0030' codelistType='STATIC' renderMode="STR" valueSeparator=";" textSeparator="、" ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('htsyts')">
                <el-table-column show-overflow-tooltip :prop="'htsyts'" :label="$t('entities.pimcontract.main_grid.columns.htsyts')" :width="135"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontract.main_grid.columns.htsyts')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('sydqsj')">
                <el-table-column show-overflow-tooltip :prop="'sydqsj'" :label="$t('entities.pimcontract.main_grid.columns.sydqsj')" :width="135"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontract.main_grid.columns.sydqsj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'ygbh',
            label: '员工编号',
            langtag: 'entities.pimcontract.main_grid.columns.ygbh',
            show: true,
            util: 'px'
        },
        {
            name: 'pimpersonname',
            label: '员工姓名',
            langtag: 'entities.pimcontract.main_grid.columns.pimpersonname',
            show: true,
            util: 'px'
        },
        {
            name: 'personorgname',
            label: '员工所属单位',
            langtag: 'entities.pimcontract.main_grid.columns.personorgname',
            show: true,
            util: 'PX'
        },
        {
            name: 'ygzt',
            label: '员工状态',
            langtag: 'entities.pimcontract.main_grid.columns.ygzt',
            show: true,
            util: 'px'
        },
        {
            name: 'dbdwsj',
            label: '到本单位时间',
            langtag: 'entities.pimcontract.main_grid.columns.dbdwsj',
            show: true,
            util: 'PX'
        },
        {
            name: 'htbh',
            label: '合同编号',
            langtag: 'entities.pimcontract.main_grid.columns.htbh',
            show: true,
            util: 'PX'
        },
        {
            name: 'signingunit',
            label: '合同签订单位',
            langtag: 'entities.pimcontract.main_grid.columns.signingunit',
            show: true,
            util: 'PX'
        },
        {
            name: 'htlx',
            label: '合同类别',
            langtag: 'entities.pimcontract.main_grid.columns.htlx',
            show: true,
            util: 'PX'
        },
        {
            name: 'contracttype',
            label: '合同类型',
            langtag: 'entities.pimcontract.main_grid.columns.contracttype',
            show: true,
            util: 'PX'
        },
        {
            name: 'qsrq',
            label: '起始日期',
            langtag: 'entities.pimcontract.main_grid.columns.qsrq',
            show: true,
            util: 'PX'
        },
        {
            name: 'jsrq',
            label: '结束日期',
            langtag: 'entities.pimcontract.main_grid.columns.jsrq',
            show: true,
            util: 'PX'
        },
        {
            name: 'htzt',
            label: '合同状态',
            langtag: 'entities.pimcontract.main_grid.columns.htzt',
            show: true,
            util: 'PX'
        },
        {
            name: 'htsyts',
            label: '合同剩余天数',
            langtag: 'entities.pimcontract.main_grid.columns.htsyts',
            show: true,
            util: 'PX'
        },
        {
            name: 'sydqsj',
            label: '试用到期时间',
            langtag: 'entities.pimcontract.main_grid.columns.sydqsj',
            show: true,
            util: 'px'
        },
    ]
    ...
    public getGridRowModel(){
        return {
          ...
          htzt: new FormItemModel(),
          pimpersonid: new FormItemModel(),
          qsrq: new FormItemModel(),
          htlx: new FormItemModel(),
          jsrq: new FormItemModel(),
          srfkey: new FormItemModel(),
          htbh: new FormItemModel(),
        }
    }
    ...
    public rules: any = {
        contracttype: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '合同类型 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '合同类型 值不能为空', trigger: 'blur' },
        ],
        htzt: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '合同状态 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '合同状态 值不能为空', trigger: 'blur' },
        ],
        pimpersonid: [
        ...
        qsrq: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '起始日期 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '起始日期 值不能为空', trigger: 'blur' },
        ],
        htlx: [
        ...
        htbh: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '合同编号 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '合同编号 值不能为空', trigger: 'blur' },
        ],
    }
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PIMCONTRACTGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PIMCONTRACTGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pimcontract: _keys }),Object.assign({ pimcontract: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('pimcontract_main_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('pimcontract_main_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMCONTRACTGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMCONTRACTGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.pimcontract){
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PIMCONTRACTGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
