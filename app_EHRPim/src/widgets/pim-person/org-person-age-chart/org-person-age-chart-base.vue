...
import OrgPersonAgeService from './org-person-age-chart-service';
...
export default class OrgPersonAgeBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof OrgPersonAgeBase
     */
    ...
    */
    ...
    public  seriesModel:any = {
        orgpersonagefunnel:new ChartFunnelSeries({
    name:'orgpersonagefunnel',
    ...
    seriesMap:{},
    dataSetFields:[
    {name:"agetype",codelist:{type:"STATIC",tag:"EhrCodeList0056",emptycode:'empty',emptytext:'未定义'},isGroupField:true,groupMode:"CODELIST"},
    ...
    ecObject:{
        label:{position: "right",formatter:'{b} {@countnum}人'},
        right:'30%',
        width:'70%',
        labelLine:{length: 40},
        left:10,
    ...
    public chartUserParams:any ={
        color:['#6642ff','#00ffab','#FFAE7A','#4076E1','#42B3FF','#85B3FF','#A1FFFF']
    };
...
<style lang='less'>
@import './org-person-age-chart.less';
</style>