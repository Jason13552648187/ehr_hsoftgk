...
import PimPortalView_dbService from './pim-portal-view-db-dashboard-service';
...
export default class PimPortalView_dbBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof PimPortalView_dbBase
     */
...
<style lang='less'>
@import './pim-portal-view-db-dashboard.less';
</style>