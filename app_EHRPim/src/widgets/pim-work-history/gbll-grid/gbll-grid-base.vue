        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
                ...
                <el-table-column show-overflow-tooltip :prop="'rzkssj'" :label="$t('entities.pimworkhistory.gbll_grid.columns.rzkssj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimworkhistory.gbll_grid.columns.rzkssj')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('rzjssj')">
                <el-table-column show-overflow-tooltip :prop="'rzjssj'" :label="$t('entities.pimworkhistory.gbll_grid.columns.rzjssj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimworkhistory.gbll_grid.columns.rzjssj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('ormorgname')">
                <el-table-column show-overflow-tooltip :prop="'ormorgname'" :label="$t('entities.pimworkhistory.gbll_grid.columns.ormorgname')" :width="250"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimworkhistory.gbll_grid.columns.ormorgname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('ormorgsectorname')">
                <el-table-column show-overflow-tooltip :prop="'ormorgsectorname'" :label="$t('entities.pimworkhistory.gbll_grid.columns.ormorgsectorname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimworkhistory.gbll_grid.columns.ormorgsectorname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('ormdutyname')">
                <el-table-column show-overflow-tooltip :prop="'ormdutyname'" :label="$t('entities.pimworkhistory.gbll_grid.columns.ormdutyname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimworkhistory.gbll_grid.columns.ormdutyname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('ormpostname')">
                <el-table-column show-overflow-tooltip :prop="'ormpostname'" :label="$t('entities.pimworkhistory.gbll_grid.columns.ormpostname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimworkhistory.gbll_grid.columns.ormpostname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('ormrankname')">
                <el-table-column show-overflow-tooltip :prop="'ormrankname'" :label="$t('entities.pimworkhistory.gbll_grid.columns.ormrankname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimworkhistory.gbll_grid.columns.ormrankname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
...
import GBLLService from './gbll-grid-service';
...
export default class GBLLBase extends Vue implements ControlInterface {
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'rzkssj',
            label: '任职开始时间(*)',
            langtag: 'entities.pimworkhistory.gbll_grid.columns.rzkssj',
            show: true,
            util: 'PX'
        },
        {
            name: 'rzjssj',
            label: '任职结束时间',
            langtag: 'entities.pimworkhistory.gbll_grid.columns.rzjssj',
            show: true,
            util: 'px'
        },
        {
            name: 'ormorgname',
            label: '工作单位(*)',
            langtag: 'entities.pimworkhistory.gbll_grid.columns.ormorgname',
            show: true,
            util: 'PX'
        },
        {
            ...
            label: '部门(*)',
            langtag: 'entities.pimworkhistory.gbll_grid.columns.ormorgsectorname',
            show: true,
            util: 'px'
        },
        {
            name: 'ormdutyname',
            label: '职务(*)',
            langtag: 'entities.pimworkhistory.gbll_grid.columns.ormdutyname',
            show: true,
            util: 'px'
        },
        {
            name: 'ormpostname',
            label: '岗位(*)',
            langtag: 'entities.pimworkhistory.gbll_grid.columns.ormpostname',
            show: true,
            util: 'px'
        },
        {
            name: 'ormrankname',
            label: '职级',
            langtag: 'entities.pimworkhistory.gbll_grid.columns.ormrankname',
            show: true,
            util: 'px'
        },
    ]
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMWORKHISTORYGBLLGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMWORKHISTORYGBLLGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PIMWORKHISTORYGBLLGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
