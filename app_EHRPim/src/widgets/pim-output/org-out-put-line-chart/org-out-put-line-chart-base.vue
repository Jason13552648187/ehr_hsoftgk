...
import OrgOutPutLineService from './org-out-put-line-chart-service';
...
export default class OrgOutPutLineBase extends Vue implements ControlInterface {
    ...
    */
    ...
    public  seriesModel:any = {
        orgoutputline:new ChartLineSeries({
    name:'orgoutputline',
    
    
    categorField:'outdate',
    ...
    seriesMap:{},
    dataSetFields:[
    {name:"outdate",codelist:null,isGroupField:true,groupMode:"MONTH"},
    {name:"outnum",codelist:null,isGroupField:false,groupMode:""}
    ],
    ecxObject:{
        label:{
            show: true,
...
<style lang='less'>
@import './org-out-put-line-chart.less';
</style>