        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
                ...
                <el-table-column show-overflow-tooltip :prop="'dabh'" :label="$t('entities.pimarchives.main_2_grid.columns.dabh')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimarchives.main_2_grid.columns.dabh')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('ormorgname3')">
                <el-table-column show-overflow-tooltip :prop="'ormorgname3'" :label="$t('entities.pimarchives.main_2_grid.columns.ormorgname3')" :width="250"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimarchives.main_2_grid.columns.ormorgname3')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('dabgd')">
                <el-table-column show-overflow-tooltip :prop="'dabgd'" :label="$t('entities.pimarchives.main_2_grid.columns.dabgd')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimarchives.main_2_grid.columns.dabgd')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('archivescentername')">
                <el-table-column show-overflow-tooltip :prop="'archivescentername'" :label="$t('entities.pimarchives.main_2_grid.columns.archivescentername')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimarchives.main_2_grid.columns.archivescentername')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('education')">
                <el-table-column show-overflow-tooltip :prop="'education'" :label="$t('entities.pimarchives.main_2_grid.columns.education')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimarchives.main_2_grid.columns.education')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.education" tag='EhrCodeList0117' codelistType='DYNAMIC' renderMode="STR" valueSeparator=";" textSeparator="、" ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('dateofbirth')">
                <el-table-column show-overflow-tooltip :prop="'dateofbirth'" :label="$t('entities.pimarchives.main_2_grid.columns.dateofbirth')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimarchives.main_2_grid.columns.dateofbirth')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('joinpartydate')">
                <el-table-column show-overflow-tooltip :prop="'joinpartydate'" :label="$t('entities.pimarchives.main_2_grid.columns.joinpartydate')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimarchives.main_2_grid.columns.joinpartydate')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('startworkdatae')">
                <el-table-column show-overflow-tooltip :prop="'startworkdatae'" :label="$t('entities.pimarchives.main_2_grid.columns.startworkdatae')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimarchives.main_2_grid.columns.startworkdatae')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('dastate')">
                <el-table-column show-overflow-tooltip :prop="'dastate'" :label="$t('entities.pimarchives.main_2_grid.columns.dastate')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimarchives.main_2_grid.columns.dastate')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'dabh',
            label: '档案编号',
            langtag: 'entities.pimarchives.main_2_grid.columns.dabh',
            show: true,
            util: 'PX'
        },
        {
            name: 'ormorgname3',
            label: '管理单位',
            langtag: 'entities.pimarchives.main_2_grid.columns.ormorgname3',
            show: true,
            util: 'PX'
        },
        {
            name: 'dabgd',
            label: '档案保管地',
            langtag: 'entities.pimarchives.main_2_grid.columns.dabgd',
            show: true,
            util: 'PX'
        },
        {
            ...
            label: '档案室',
            langtag: 'entities.pimarchives.main_2_grid.columns.archivescentername',
            show: true,
            util: 'px'
        },
        {
            name: 'education',
            label: '档案学历',
            langtag: 'entities.pimarchives.main_2_grid.columns.education',
            show: true,
            util: 'px'
        },
        {
            name: 'dateofbirth',
            label: '档案出生日期',
            langtag: 'entities.pimarchives.main_2_grid.columns.dateofbirth',
            show: true,
            util: 'px'
        },
        {
            name: 'joinpartydate',
            label: '档案入党时间',
            langtag: 'entities.pimarchives.main_2_grid.columns.joinpartydate',
            show: true,
            util: 'px'
        },
        {
            name: 'startworkdatae',
            label: '档案参加工作时间',
            langtag: 'entities.pimarchives.main_2_grid.columns.startworkdatae',
            show: true,
            util: 'px'
        },
        {
            name: 'dastate',
            label: '档案状态',
            langtag: 'entities.pimarchives.main_2_grid.columns.dastate',
            show: true,
            util: 'px'
        },
    ]
    ...
    public getGridRowModel(){
        return {
          ...
          dabh: new FormItemModel(),
          srfkey: new FormItemModel(),
          dabgd: new FormItemModel(),
        }
    }
    ...
    public rules: any = {
        pimpersonid: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '员工 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '员工 值不能为空', trigger: 'blur' },
        ],
        dabh: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '档案编号 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '档案编号 值不能为空', trigger: 'blur' },
        ],
        srfkey: [
        ...
        dabgd: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '档案保管地 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '档案保管地 值不能为空', trigger: 'blur' },
        ],
    }
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PIMARCHIVESPimDangaGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PIMARCHIVESPimDangaGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('pimarchives_main_2_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('pimarchives_main_2_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMARCHIVESPimDangaGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMARCHIVESPimDangaGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.pimarchives){
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PIMARCHIVESPimDangaGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
