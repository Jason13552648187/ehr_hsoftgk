    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('dabh')">
                <el-table-column show-overflow-tooltip :prop="'dabh'" :label="$t('entities.pimarchives.main_grid.columns.dabh')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimarchives.main_grid.columns.dabh')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('glzzdzs')">
                <el-table-column show-overflow-tooltip :prop="'glzzdzs'" :label="$t('entities.pimarchives.main_grid.columns.glzzdzs')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimarchives.main_grid.columns.glzzdzs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('dabgd')">
                <el-table-column show-overflow-tooltip :prop="'dabgd'" :label="$t('entities.pimarchives.main_grid.columns.dabgd')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimarchives.main_grid.columns.dabgd')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.dabgd}}</span>
            ...
            <template v-if="getColumnState('archivescentername')">
                <el-table-column show-overflow-tooltip :prop="'archivescentername'" :label="$t('entities.pimarchives.main_grid.columns.archivescentername')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimarchives.main_grid.columns.archivescentername')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <app-column-link deKeyField='pimarchivescenter' :context="JSON.parse(JSON.stringify(context))" :viewparams="JSON.parse(JSON.stringify(viewparams))" :data="row" :linkview="{viewname: 'archivescenterredirect-view', height: 0,width: 0,title: $t('entities.pimarchivescenter.views.redirectview.title'),placement: '', isRedirectView: true,deResParameters: [
            ]
            ,parameters: [
            { pathName: 'pimarchivescenters', parameterName: 'pimarchivescenter' },
            { pathName: 'redirectview', parameterName: 'redirectview' }
            ]}" valueitem="archivescenterid">
            ...
            <template v-if="getColumnState('dastate')">
                <el-table-column show-overflow-tooltip :prop="'dastate'" :label="$t('entities.pimarchives.main_grid.columns.dastate')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimarchives.main_grid.columns.dastate')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.dastate" tag='EhrCodeList0057' codelistType='STATIC' renderMode="STR" valueSeparator=";" textSeparator="、" ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('ygbh')">
                <el-table-column show-overflow-tooltip :prop="'ygbh'" :label="$t('entities.pimarchives.main_grid.columns.ygbh')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimarchives.main_grid.columns.ygbh')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.ygbh}}</span>
            ...
            <template v-if="getColumnState('pimpersonname')">
                <el-table-column show-overflow-tooltip :prop="'pimpersonname'" :label="$t('entities.pimarchives.main_grid.columns.pimpersonname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimarchives.main_grid.columns.pimpersonname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('ygzt')">
                <el-table-column show-overflow-tooltip :prop="'ygzt'" :label="$t('entities.pimarchives.main_grid.columns.ygzt')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimarchives.main_grid.columns.ygzt')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('sszzdzs')">
                <el-table-column show-overflow-tooltip :prop="'sszzdzs'" :label="$t('entities.pimarchives.main_grid.columns.sszzdzs')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimarchives.main_grid.columns.sszzdzs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('duration')">
                <el-table-column show-overflow-tooltip :prop="'duration'" :label="$t('entities.pimarchives.main_grid.columns.duration')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimarchives.main_grid.columns.duration')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('zt')">
                <el-table-column show-overflow-tooltip :prop="'zt'" :label="$t('entities.pimarchives.main_grid.columns.zt')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimarchives.main_grid.columns.zt')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof MainBase
     */
    public minorSortPSDEF: string = 'dadrrq';
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'dabh',
            label: '档案编号',
            langtag: 'entities.pimarchives.main_grid.columns.dabh',
            show: true,
            util: 'px'
        },
        {
            name: 'glzzdzs',
            label: '管理单位',
            langtag: 'entities.pimarchives.main_grid.columns.glzzdzs',
            show: true,
            util: 'px'
        },
        {
            name: 'dabgd',
            label: '档案保管地',
            langtag: 'entities.pimarchives.main_grid.columns.dabgd',
            show: true,
            util: 'px'
        },
        {
            ...
            label: '档案室',
            langtag: 'entities.pimarchives.main_grid.columns.archivescentername',
            show: true,
            util: 'px'
        },
        {
            name: 'dastate',
            label: '档案状态',
            langtag: 'entities.pimarchives.main_grid.columns.dastate',
            show: true,
            util: 'px'
        },
        {
            name: 'ygbh',
            label: '员工编号',
            langtag: 'entities.pimarchives.main_grid.columns.ygbh',
            show: true,
            util: 'px'
        },
        {
            name: 'pimpersonname',
            label: '员工姓名',
            langtag: 'entities.pimarchives.main_grid.columns.pimpersonname',
            show: true,
            util: 'PX'
        },
        {
            name: 'ygzt',
            label: '员工状态',
            langtag: 'entities.pimarchives.main_grid.columns.ygzt',
            show: true,
            util: 'px'
        },
        {
            name: 'sszzdzs',
            label: '所属单位',
            langtag: 'entities.pimarchives.main_grid.columns.sszzdzs',
            show: true,
            util: 'px'
        },
        {
            name: 'duration',
            label: '档案未转出月数',
            langtag: 'entities.pimarchives.main_grid.columns.duration',
            show: true,
            util: 'PX'
        },
        {
            name: 'zt',
            label: '档案借阅状态',
            langtag: 'entities.pimarchives.main_grid.columns.zt',
            show: true,
            util: 'px'
        },
    ]
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PIMARCHIVESGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PIMARCHIVESGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pimarchives: _keys }),Object.assign({ pimarchives: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.pimarchives,$event.pimarchives);
        });
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('pimarchives_main_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('pimarchives_main_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMARCHIVESGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMARCHIVESGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.pimarchives){
                            Object.assign(this.context,{pimarchives:item.pimarchives});
                        }
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PIMARCHIVESGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
