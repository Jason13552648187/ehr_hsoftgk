        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
                ...
                <el-table-column show-overflow-tooltip :prop="'xl'" :label="$t('entities.pimeducation.main_2_grid.columns.xl')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimeducation.main_2_grid.columns.xl')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('qssj')">
                <el-table-column show-overflow-tooltip :prop="'qssj'" :label="$t('entities.pimeducation.main_2_grid.columns.qssj')" :width="130"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimeducation.main_2_grid.columns.qssj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('jssj')">
                <el-table-column show-overflow-tooltip :prop="'jssj'" :label="$t('entities.pimeducation.main_2_grid.columns.jssj')" :width="130"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimeducation.main_2_grid.columns.jssj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('byyx')">
                <el-table-column show-overflow-tooltip :prop="'byyx'" :label="$t('entities.pimeducation.main_2_grid.columns.byyx')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimeducation.main_2_grid.columns.byyx')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('xkml')">
                <el-table-column show-overflow-tooltip :prop="'xkml'" :label="$t('entities.pimeducation.main_2_grid.columns.xkml')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimeducation.main_2_grid.columns.xkml')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('sxzy')">
                <el-table-column show-overflow-tooltip :prop="'sxzy'" :label="$t('entities.pimeducation.main_2_grid.columns.sxzy')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimeducation.main_2_grid.columns.sxzy')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('xllx')">
                <el-table-column show-overflow-tooltip :prop="'xllx'" :label="$t('entities.pimeducation.main_2_grid.columns.xllx')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimeducation.main_2_grid.columns.xllx')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('xxxz')">
                <el-table-column show-overflow-tooltip :prop="'xxxz'" :label="$t('entities.pimeducation.main_2_grid.columns.xxxz')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimeducation.main_2_grid.columns.xxxz')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('sfdyxl')">
                <el-table-column show-overflow-tooltip :prop="'sfdyxl'" :label="$t('entities.pimeducation.main_2_grid.columns.sfdyxl')" :width="160"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimeducation.main_2_grid.columns.sfdyxl')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('sfzgxl')">
                <el-table-column show-overflow-tooltip :prop="'sfzgxl'" :label="$t('entities.pimeducation.main_2_grid.columns.sfzgxl')" :width="160"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimeducation.main_2_grid.columns.sfzgxl')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
...
export default class Main_2Base extends Vue implements ControlInterface {
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'xl',
            label: '学历',
            langtag: 'entities.pimeducation.main_2_grid.columns.xl',
            show: true,
            util: 'PX'
        },
        {
            name: 'qssj',
            label: '入学时间',
            langtag: 'entities.pimeducation.main_2_grid.columns.qssj',
            show: true,
            util: 'PX'
        },
        {
            name: 'jssj',
            label: '毕业时间',
            langtag: 'entities.pimeducation.main_2_grid.columns.jssj',
            show: true,
            util: 'PX'
        },
        {
            name: 'byyx',
            label: '毕业院校',
            langtag: 'entities.pimeducation.main_2_grid.columns.byyx',
            show: true,
            util: 'PX'
        },
        {
            name: 'xkml',
            label: '一级学科',
            langtag: 'entities.pimeducation.main_2_grid.columns.xkml',
            show: true,
            util: 'PX'
        },
        {
            name: 'sxzy',
            label: '所学专业',
            langtag: 'entities.pimeducation.main_2_grid.columns.sxzy',
            show: true,
            util: 'PX'
        },
        {
            name: 'xllx',
            label: '学习形式',
            langtag: 'entities.pimeducation.main_2_grid.columns.xllx',
            show: true,
            util: 'PX'
        },
        {
            name: 'xxxz',
            label: '学校性质',
            langtag: 'entities.pimeducation.main_2_grid.columns.xxxz',
            show: true,
            util: 'PX'
        },
        {
            name: 'sfdyxl',
            label: '是否第一学历',
            langtag: 'entities.pimeducation.main_2_grid.columns.sfdyxl',
            show: true,
            util: 'PX'
        },
        {
            name: 'sfzgxl',
            label: '是否最高学历',
            langtag: 'entities.pimeducation.main_2_grid.columns.sfzgxl',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PIMEDUCATIONZDXLGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PIMEDUCATIONZDXLGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('pimeducation_main_2_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('pimeducation_main_2_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMEDUCATIONZDXLGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMEDUCATIONZDXLGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PIMEDUCATIONZDXLGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
