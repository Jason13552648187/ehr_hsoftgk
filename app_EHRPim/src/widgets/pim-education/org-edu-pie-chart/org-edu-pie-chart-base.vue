...
export default class OrgEduPieBase extends Vue implements ControlInterface {
    ...
    */
    ...
    public  seriesModel:any = {
        pie:new ChartPieSeries({
    name:'pie',
    
    
    categorField:'highestdegree',
    categorCodeList:{type:'STATIC',tag:'EhrCodeList0236',emptycode:'empty',emptytext:'未定义'},
    ...
    seriesMap:{},
    dataSetFields:[
    {name:"highestdegree",codelist:{type:"STATIC",tag:"EhrCodeList0236",emptycode:'empty',emptytext:'未定义'},isGroupField:true,groupMode:"CODELIST"},
    ...
    public chartUserParams:any ={
        tooltip:{ formatter:'{a}<br />{b}:{d}'},
        legend:{ show:true,left:'5%',top:'35%',orient:'vertical'},
