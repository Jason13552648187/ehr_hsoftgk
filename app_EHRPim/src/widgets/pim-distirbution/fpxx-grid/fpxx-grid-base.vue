        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
                ...
                <el-table-column show-overflow-tooltip :prop="'fplx'" :label="$t('entities.pimdistirbution.fpxx_grid.columns.fplx')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.fpxx_grid.columns.fplx')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('cfplx')">
                <el-table-column show-overflow-tooltip :prop="'cfplx'" :label="$t('entities.pimdistirbution.fpxx_grid.columns.cfplx')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.fpxx_grid.columns.cfplx')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('zzdzs')">
                <el-table-column show-overflow-tooltip :prop="'zzdzs'" :label="$t('entities.pimdistirbution.fpxx_grid.columns.zzdzs')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.fpxx_grid.columns.zzdzs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.zzdzs}}</span>
            ...
            <template v-if="getColumnState('shortname')">
                <el-table-column show-overflow-tooltip :prop="'shortname'" :label="$t('entities.pimdistirbution.fpxx_grid.columns.shortname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.fpxx_grid.columns.shortname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('ormdutyname')">
                <el-table-column show-overflow-tooltip :prop="'ormdutyname'" :label="$t('entities.pimdistirbution.fpxx_grid.columns.ormdutyname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.fpxx_grid.columns.ormdutyname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('ormpostname')">
                <el-table-column show-overflow-tooltip :prop="'ormpostname'" :label="$t('entities.pimdistirbution.fpxx_grid.columns.ormpostname')" :width="180"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.fpxx_grid.columns.ormpostname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('rzkssj')">
                <el-table-column show-overflow-tooltip :prop="'rzkssj'" :label="$t('entities.pimdistirbution.fpxx_grid.columns.rzkssj')" :width="180"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.fpxx_grid.columns.rzkssj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('rzjssj')">
                <el-table-column show-overflow-tooltip :prop="'rzjssj'" :label="$t('entities.pimdistirbution.fpxx_grid.columns.rzjssj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.fpxx_grid.columns.rzjssj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
...
import FPXXService from './fpxx-grid-service';
...
export default class FPXXBase extends Vue implements ControlInterface {
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'fplx',
            label: '分配',
            langtag: 'entities.pimdistirbution.fpxx_grid.columns.fplx',
            show: true,
            util: 'PX'
        },
        {
            name: 'cfplx',
            label: '类型',
            langtag: 'entities.pimdistirbution.fpxx_grid.columns.cfplx',
            show: true,
            util: 'PX'
        },
        {
            name: 'zzdzs',
            label: '组织',
            langtag: 'entities.pimdistirbution.fpxx_grid.columns.zzdzs',
            show: true,
            util: 'PX'
        },
        {
            name: 'shortname',
            label: '部门',
            langtag: 'entities.pimdistirbution.fpxx_grid.columns.shortname',
            show: true,
            util: 'PX'
        },
        {
            name: 'ormdutyname',
            label: '职务',
            langtag: 'entities.pimdistirbution.fpxx_grid.columns.ormdutyname',
            show: true,
            util: 'PX'
        },
        {
            name: 'ormpostname',
            label: '岗位',
            langtag: 'entities.pimdistirbution.fpxx_grid.columns.ormpostname',
            show: true,
            util: 'PX'
        },
        {
            name: 'rzkssj',
            label: '任职开始时间',
            langtag: 'entities.pimdistirbution.fpxx_grid.columns.rzkssj',
            show: true,
            util: 'PX'
        },
        {
            name: 'rzjssj',
            label: '任职结束时间',
            langtag: 'entities.pimdistirbution.fpxx_grid.columns.rzjssj',
            show: true,
            util: 'PX'
        },
    ]
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMDISTIRBUTIONYGFenPeiGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMDISTIRBUTIONYGFenPeiGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PIMDISTIRBUTIONYGFenPeiGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
