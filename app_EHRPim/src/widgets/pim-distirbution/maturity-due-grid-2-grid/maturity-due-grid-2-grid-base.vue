        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
                ...
                <el-table-column show-overflow-tooltip :prop="'ygbh'" :label="$t('entities.pimdistirbution.maturityduegrid_2_grid.columns.ygbh')" :width="130"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.maturityduegrid_2_grid.columns.ygbh')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('pimpersonname')">
                <el-table-column show-overflow-tooltip :prop="'pimpersonname'" :label="$t('entities.pimdistirbution.maturityduegrid_2_grid.columns.pimpersonname')" :width="130"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.maturityduegrid_2_grid.columns.pimpersonname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('yzzzzdzs')">
                <el-table-column show-overflow-tooltip :prop="'yzzzzdzs'" :label="$t('entities.pimdistirbution.maturityduegrid_2_grid.columns.yzzzzdzs')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.maturityduegrid_2_grid.columns.yzzzzdzs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('ybmshortname')">
                <el-table-column show-overflow-tooltip :prop="'ybmshortname'" :label="$t('entities.pimdistirbution.maturityduegrid_2_grid.columns.ybmshortname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.maturityduegrid_2_grid.columns.ybmshortname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('yzw')">
                <el-table-column show-overflow-tooltip :prop="'yzw'" :label="$t('entities.pimdistirbution.maturityduegrid_2_grid.columns.yzw')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.maturityduegrid_2_grid.columns.yzw')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('ygw')">
                <el-table-column show-overflow-tooltip :prop="'ygw'" :label="$t('entities.pimdistirbution.maturityduegrid_2_grid.columns.ygw')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.maturityduegrid_2_grid.columns.ygw')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('zzdzs')">
                <el-table-column show-overflow-tooltip :prop="'zzdzs'" :label="$t('entities.pimdistirbution.maturityduegrid_2_grid.columns.zzdzs')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.maturityduegrid_2_grid.columns.zzdzs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.zzdzs}}</span>
            ...
            <template v-if="getColumnState('shortname')">
                <el-table-column show-overflow-tooltip :prop="'shortname'" :label="$t('entities.pimdistirbution.maturityduegrid_2_grid.columns.shortname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.maturityduegrid_2_grid.columns.shortname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('ormdutyname')">
                <el-table-column show-overflow-tooltip :prop="'ormdutyname'" :label="$t('entities.pimdistirbution.maturityduegrid_2_grid.columns.ormdutyname')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.maturityduegrid_2_grid.columns.ormdutyname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('ormpostname')">
                <el-table-column show-overflow-tooltip :prop="'ormpostname'" :label="$t('entities.pimdistirbution.maturityduegrid_2_grid.columns.ormpostname')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.maturityduegrid_2_grid.columns.ormpostname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('jdzt')">
                <el-table-column show-overflow-tooltip :prop="'jdzt'" :label="$t('entities.pimdistirbution.maturityduegrid_2_grid.columns.jdzt')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.maturityduegrid_2_grid.columns.jdzt')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.jdzt}}</span>
            ...
            <template v-if="getColumnState('rzkssj')">
                <el-table-column show-overflow-tooltip :prop="'rzkssj'" :label="$t('entities.pimdistirbution.maturityduegrid_2_grid.columns.rzkssj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.maturityduegrid_2_grid.columns.rzkssj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('rzjssj')">
                <el-table-column show-overflow-tooltip :prop="'rzjssj'" :label="$t('entities.pimdistirbution.maturityduegrid_2_grid.columns.rzjssj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.maturityduegrid_2_grid.columns.rzjssj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
...
import MaturityDueGrid_2Service from './maturity-due-grid-2-grid-service';
...
export default class MaturityDueGrid_2Base extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof MaturityDueGrid_2Base
     */
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'ygbh',
            label: '员工编号',
            langtag: 'entities.pimdistirbution.maturityduegrid_2_grid.columns.ygbh',
            show: true,
            util: 'PX'
        },
        {
            name: 'pimpersonname',
            label: '员工姓名',
            langtag: 'entities.pimdistirbution.maturityduegrid_2_grid.columns.pimpersonname',
            show: true,
            util: 'PX'
        },
        {
            name: 'yzzzzdzs',
            label: '原组织',
            langtag: 'entities.pimdistirbution.maturityduegrid_2_grid.columns.yzzzzdzs',
            show: true,
            util: 'px'
        },
        {
            name: 'ybmshortname',
            label: '原部门',
            langtag: 'entities.pimdistirbution.maturityduegrid_2_grid.columns.ybmshortname',
            show: true,
            util: 'px'
        },
        {
            name: 'yzw',
            label: '原职务',
            langtag: 'entities.pimdistirbution.maturityduegrid_2_grid.columns.yzw',
            show: true,
            util: 'PX'
        },
        {
            name: 'ygw',
            label: '原岗位',
            langtag: 'entities.pimdistirbution.maturityduegrid_2_grid.columns.ygw',
            show: true,
            util: 'PX'
        },
        {
            name: 'zzdzs',
            label: '新组织',
            langtag: 'entities.pimdistirbution.maturityduegrid_2_grid.columns.zzdzs',
            show: true,
            util: 'PX'
        },
        {
            name: 'shortname',
            label: '新部门',
            langtag: 'entities.pimdistirbution.maturityduegrid_2_grid.columns.shortname',
            show: true,
            util: 'PX'
        },
        {
            name: 'ormdutyname',
            label: '新职务',
            langtag: 'entities.pimdistirbution.maturityduegrid_2_grid.columns.ormdutyname',
            show: true,
            util: 'PX'
        },
        {
            name: 'ormpostname',
            label: '新岗位',
            langtag: 'entities.pimdistirbution.maturityduegrid_2_grid.columns.ormpostname',
            show: true,
            util: 'PX'
        },
        {
            name: 'jdzt',
            label: '借调状态',
            langtag: 'entities.pimdistirbution.maturityduegrid_2_grid.columns.jdzt',
            show: true,
            util: 'px'
        },
        {
            name: 'rzkssj',
            label: '借调开始时间',
            langtag: 'entities.pimdistirbution.maturityduegrid_2_grid.columns.rzkssj',
            show: true,
            util: 'PX'
        },
        {
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PimDistirbutionJDRYHMCGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
...
<style lang='less'>
@import './maturity-due-grid-2-grid.less';
</style>