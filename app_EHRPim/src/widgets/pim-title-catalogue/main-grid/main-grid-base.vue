        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
                ...
                <el-table-column show-overflow-tooltip :prop="'pxh'" :label="$t('entities.pimtitlecatalogue.main_grid.columns.pxh')" :width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimtitlecatalogue.main_grid.columns.pxh')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('dh')">
                <el-table-column show-overflow-tooltip :prop="'dh'" :label="$t('entities.pimtitlecatalogue.main_grid.columns.dh')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimtitlecatalogue.main_grid.columns.dh')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
            ...
            <template v-if="getColumnState('pimtitlecataloguename')">
                <el-table-column show-overflow-tooltip :prop="'pimtitlecataloguename'" :label="$t('entities.pimtitlecatalogue.main_grid.columns.pimtitlecataloguename')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimtitlecatalogue.main_grid.columns.pimtitlecataloguename')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
            ...
            <template v-if="getColumnState('pimtitlecataloguename2')">
                <el-table-column show-overflow-tooltip :prop="'pimtitlecataloguename2'" :label="$t('entities.pimtitlecatalogue.main_grid.columns.pimtitlecataloguename2')" :width="250"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimtitlecatalogue.main_grid.columns.pimtitlecataloguename2')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
            ...
            <app-picker 
              ...
              deKeyField='pimtitlecatalogue'
              :service="service"
              :acParams="{ serviceName: 'PimTitleCatalogueService', interfaceName: 'FetchIsRootDQ'}"
              valueitem='pimtitlecatalogueid2' 
              :value="row[column.property]" 
              editortype="" 
              :pickupView="{ viewname: 'pimtitlecataloguepickup-view', title: $t('entities.pimtitlecatalogue.views.pickupview.title'), deResParameters: [], parameters: [{ pathName: 'pimtitlecatalogues', parameterName: 'pimtitlecatalogue' }, { pathName: 'pickupview', parameterName: 'pickupview' } ], placement:'' }"
              style=""  
            ...
            <template v-if="getColumnState('zclc')">
                <el-table-column show-overflow-tooltip :prop="'zclc'" :label="$t('entities.pimtitlecatalogue.main_grid.columns.zclc')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimtitlecatalogue.main_grid.columns.zclc')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
             ...
             <dropdown-list 
              ...
              @change="($event)=>{gridEditItemChange(row, column.property, $event, $index)}">
                        ...
                        <template v-if="!actualIsOpenEdit">
            <codelist :value="row.zclc" tag='EhrCodeList0047' codelistType='DYNAMIC' ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof MainBase
     */
    public appEntityService: PimTitleCatalogueService = new PimTitleCatalogueService({ $store: this.$store });
     ...
     * @memberof MainBase
     */
    public minorSortPSDEF: string = 'pxh';
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'pxh',
            label: '排序号',
            langtag: 'entities.pimtitlecatalogue.main_grid.columns.pxh',
            show: true,
            util: 'PX'
        },
        {
            name: 'dh',
            label: '职称代码',
            langtag: 'entities.pimtitlecatalogue.main_grid.columns.dh',
            show: true,
            util: 'PX'
        },
        {
            ...
            label: '职称目录名称',
            langtag: 'entities.pimtitlecatalogue.main_grid.columns.pimtitlecataloguename',
            show: true,
            util: 'PX'
        },
        {
            name: 'pimtitlecataloguename2',
            label: '职称目录类型',
            langtag: 'entities.pimtitlecatalogue.main_grid.columns.pimtitlecataloguename2',
            show: true,
            util: 'PX'
        },
        {
            name: 'zclc',
            label: '职称类型',
            langtag: 'entities.pimtitlecatalogue.main_grid.columns.zclc',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public getGridRowModel(){
        return {
          pimtitlecataloguename2: new FormItemModel(),
          pimtitlecatalogueid2: new FormItemModel(),
          dh: new FormItemModel(),
          pimtitlecataloguename: new FormItemModel(),
          zclc: new FormItemModel(),
          pxh: new FormItemModel(),
     ...
     */
    public rules: any = {
        pimtitlecataloguename2: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '职称目录类型 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '职称目录类型 值不能为空', trigger: 'blur' },
        ],
        pimtitlecatalogueid2: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '职称标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '职称标识 值不能为空', trigger: 'blur' },
        ],
        dh: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '职称代码 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '职称代码 值不能为空', trigger: 'blur' },
        ],
        pimtitlecataloguename: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '职称目录名称 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '职称目录名称 值不能为空', trigger: 'blur' },
        ],
        zclc: [
             { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '职称类型 值不能为空', trigger: 'change' },
            { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '职称类型 值不能为空', trigger: 'blur' },
        ],
        pxh: [
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PIMTITLECATALOGUEGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PIMTITLECATALOGUEGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        _datas.forEach((record: any, index: number) => {
            let srfmajortext = record.pimtitlecataloguename;
            if (index < 5) {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pimtitlecatalogue: _keys }),Object.assign({ pimtitlecatalogue: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.pimtitlecatalogue,$event.pimtitlecatalogue);
        });
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('pimtitlecatalogue_main_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('pimtitlecatalogue_main_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMTITLECATALOGUEGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMTITLECATALOGUEGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.pimtitlecatalogue){
                            Object.assign(this.context,{pimtitlecatalogue:item.pimtitlecatalogue});
                        }
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PIMTITLECATALOGUEGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
    ...
    public getRowClassName(args:{row: any,rowIndex: number}){
        let isSelected = this.selections.some((item:any)=>{
            return Object.is(item.pimtitlecatalogue,args.row.pimtitlecatalogue);
        });
    ...
    public getCellClassName(args:{row: any, column: any, rowIndex: number, columnIndex:number}){
        let hasRowEdit:any = {
          'pxh':true,
          'dh':true,
          'pimtitlecataloguename':true,
          'pimtitlecataloguename2':true,
          'zclc':true,
        }
