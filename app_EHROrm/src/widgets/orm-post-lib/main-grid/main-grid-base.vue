...
<div class='grid' style="height:100%;">
    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('ormpostlibname')">
                <el-table-column show-overflow-tooltip :prop="'ormpostlibname'" :label="$t('entities.ormpostlib.main_grid.columns.ormpostlibname')" :width="180"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.ormpostlib.main_grid.columns.ormpostlibname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
                                <app-span name='ormpostlibname' editorType="TEXTBOX" :value="row.ormpostlibname"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('gwtype')">
                <el-table-column show-overflow-tooltip :prop="'gwtype'" :label="$t('entities.ormpostlib.main_grid.columns.gwtype')" :width="160"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.ormpostlib.main_grid.columns.gwtype')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.gwtype" tag='EhrCodeList0140' codelistType='DYNAMIC' ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('gwflag')">
                <el-table-column show-overflow-tooltip :prop="'gwflag'" :label="$t('entities.ormpostlib.main_grid.columns.gwflag')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.ormpostlib.main_grid.columns.gwflag')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.gwflag" tag='EhrCodeList0073' codelistType='STATIC' ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('sugexcyear')">
                <el-table-column show-overflow-tooltip :prop="'sugexcyear'" :label="$t('entities.ormpostlib.main_grid.columns.sugexcyear')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.ormpostlib.main_grid.columns.sugexcyear')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
                                <app-span name='sugexcyear' editorType="TEXTBOX" :value="row.sugexcyear"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('mustexcyear')">
                <el-table-column show-overflow-tooltip :prop="'mustexcyear'" :label="$t('entities.ormpostlib.main_grid.columns.mustexcyear')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.ormpostlib.main_grid.columns.mustexcyear')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
                                <app-span name='mustexcyear' editorType="TEXTBOX" :value="row.mustexcyear"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('isconfidential')">
                <el-table-column show-overflow-tooltip :prop="'isconfidential'" :label="$t('entities.ormpostlib.main_grid.columns.isconfidential')" :width="140"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.ormpostlib.main_grid.columns.isconfidential')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.isconfidential" tag='EhrCodeList0097' codelistType='STATIC' ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('postnature')">
                <el-table-column show-overflow-tooltip :prop="'postnature'" :label="$t('entities.ormpostlib.main_grid.columns.postnature')" :width="130"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.ormpostlib.main_grid.columns.postnature')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.postnature" tag='EhrCodeList0190' codelistType='STATIC' ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('jobdesc')">
                <el-table-column show-overflow-tooltip :prop="'jobdesc'" :label="$t('entities.ormpostlib.main_grid.columns.jobdesc')" :min-width="300"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.ormpostlib.main_grid.columns.jobdesc')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
                                <app-span name='jobdesc' editorType="TEXTBOX" :value="row.jobdesc"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof MainBase
     */
    public appEntityService: OrmPostLibService = new OrmPostLibService({ $store: this.$store });
     ...
     * @memberof MainBase
     */
    public minorSortPSDEF: string = 'createdate';
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'ormpostlibname',
            label: '岗位名称',
            langtag: 'entities.ormpostlib.main_grid.columns.ormpostlibname',
            show: true,
            util: 'PX'
        },
        {
            name: 'gwtype',
            label: '岗位类型',
            langtag: 'entities.ormpostlib.main_grid.columns.gwtype',
            show: true,
            util: 'PX'
        },
        {
            name: 'gwflag',
            label: '岗位标签',
            langtag: 'entities.ormpostlib.main_grid.columns.gwflag',
            show: true,
            util: 'PX'
        },
        {
            name: 'sugexcyear',
            label: '建议交流年限',
            langtag: 'entities.ormpostlib.main_grid.columns.sugexcyear',
            show: true,
            util: 'PX'
        },
        {
            name: 'mustexcyear',
            label: '必须交流年限',
            langtag: 'entities.ormpostlib.main_grid.columns.mustexcyear',
            show: true,
            util: 'PX'
        },
        {
            name: 'isconfidential',
            label: '是否保密岗',
            langtag: 'entities.ormpostlib.main_grid.columns.isconfidential',
            show: true,
            util: 'PX'
        },
        {
            name: 'postnature',
            label: '岗位性质',
            langtag: 'entities.ormpostlib.main_grid.columns.postnature',
            show: true,
            util: 'PX'
        },
        {
            name: 'jobdesc',
            label: '岗位职责说明',
            langtag: 'entities.ormpostlib.main_grid.columns.jobdesc',
            show: true,
            util: 'STAR'
        },
    ]
    ...
    public getGridRowModel(){
        return {
          jobdesc: new FormItemModel(),
          ormpostlibname: new FormItemModel(),
          sugexcyear: new FormItemModel(),
          gwtype: new FormItemModel(),
          postnature: new FormItemModel(),
          gwflag: new FormItemModel(),
          isconfidential: new FormItemModel(),
          srfkey: new FormItemModel(),
          mustexcyear: new FormItemModel(),
        }
    }
    ...
    public rules: any = {
        jobdesc: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '岗位职责说明 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '岗位职责说明 值不能为空', trigger: 'blur' },
        ],
        ormpostlibname: [
             { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '岗位名称 值不能为空', trigger: 'change' },
            { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '岗位名称 值不能为空', trigger: 'blur' },
        ],
        sugexcyear: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '建议交流年限 值不能为空', trigger: 'change' },
        ...
        gwtype: [
             { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '岗位类型 值不能为空', trigger: 'change' },
            { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '岗位类型 值不能为空', trigger: 'blur' },
        ],
        postnature: [
        ...
        gwflag: [
             { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '岗位标签 值不能为空', trigger: 'change' },
            { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '岗位标签 值不能为空', trigger: 'blur' },
        ],
        isconfidential: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '是否保密岗 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '是否保密岗 值不能为空', trigger: 'blur' },
        ],
        srfkey: [
        ...
        mustexcyear: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '必须交流年限 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '必须交流年限 值不能为空', trigger: 'blur' },
        ],
    }
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'ORMPostLibPickupGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'ORMPostLibPickupGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        _datas.forEach((record: any, index: number) => {
            let srfmajortext = record.ormpostlibname;
            if (index < 5) {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ ormpostlib: _keys }),Object.assign({ ormpostlib: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.ormpostlib,$event.ormpostlib);
        });
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('ormpostlib_main_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('ormpostlib_main_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'ORMPostLibPickupGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'ORMPostLibPickupGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.ormpostlib){
                            Object.assign(this.context,{ormpostlib:item.ormpostlib});
                        }
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'ORMPostLibPickupGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
    ...
    public getRowClassName(args:{row: any,rowIndex: number}){
        let isSelected = this.selections.some((item:any)=>{
            return Object.is(item.ormpostlib,args.row.ormpostlib);
        });
    ...
    public createDefault(row: any){                    
        if (row.hasOwnProperty('isconfidential')) {
            row['isconfidential'] = '0';
        }
    }
}
</script>
