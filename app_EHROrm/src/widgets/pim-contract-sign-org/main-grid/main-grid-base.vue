    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('ormorgname')">
                <el-table-column show-overflow-tooltip :prop="'ormorgname'" :label="$t('entities.pimcontractsignorg.main_grid.columns.ormorgname')" :width="400"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontractsignorg.main_grid.columns.ormorgname')}}
                      </span>
                    </template>
            ...
            <app-picker 
              ...
              editortype="" 
              :pickupView="{ viewname: 'ormorgpickup-view', title: $t('entities.ormorg.views.pickupview.title'), deResParameters: [], parameters: [{ pathName: 'ormorgs', parameterName: 'ormorg' }, { pathName: 'pickupview', parameterName: 'pickupview' } ], placement:'' }"
              style=""  
            ...
            <template v-if="getColumnState('ormsignorgname')">
                <el-table-column show-overflow-tooltip :prop="'ormsignorgname'" :label="$t('entities.pimcontractsignorg.main_grid.columns.ormsignorgname')" :width="400"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontractsignorg.main_grid.columns.ormsignorgname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
            ...
            <app-picker 
              ...
              :value="row[column.property]" 
              editortype="" 
              :pickupView="{ viewname: 'orm-sign-org-pickup-view', title: $t('entities.ormsignorg.views.pickupview.title'), deResParameters: [], parameters: [{ pathName: 'ormsignorgs', parameterName: 'ormsignorg' }, { pathName: 'pickupview', parameterName: 'pickupview' } ], placement:'' }"
              style=""  
              @formitemvaluechange="($event)=>{onGridItemValueChange(row,$event,$index)}">
            </app-picker>
                        ...
                        <template v-if="!actualIsOpenEdit">
                              <app-column-link deKeyField='ormsignorg' :context="JSON.parse(JSON.stringify(context))" :viewparams="JSON.parse(JSON.stringify(viewparams))" :data="row" :linkview="{viewname: 'orm-sign-org-redirect-view', height: 0,width: 0,title: $t('entities.ormsignorg.views.redirectview.title'),placement: '', isRedirectView: true,deResParameters: [
            ]
            ,parameters: [
            { pathName: 'ormsignorgs', parameterName: 'ormsignorg' },
            { pathName: 'redirectview', parameterName: 'redirectview' }
            ]}" valueitem="ormsignorgid">
                                <app-span name='ormsignorgname' editorType="PICKER" :value="row.ormsignorgname"></app-span>
                              </app-column-link>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('isdefaultsignorg')">
                <el-table-column show-overflow-tooltip :prop="'isdefaultsignorg'" :label="$t('entities.pimcontractsignorg.main_grid.columns.isdefaultsignorg')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontractsignorg.main_grid.columns.isdefaultsignorg')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof MainBase
     */
    public appEntityService: PimContractSignOrgService = new PimContractSignOrgService({ $store: this.$store });
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'ormorgname',
            label: '管理单位名称',
            langtag: 'entities.pimcontractsignorg.main_grid.columns.ormorgname',
            show: true,
            util: 'PX'
        },
        {
            name: 'ormsignorgname',
            label: '法人主体名称',
            langtag: 'entities.pimcontractsignorg.main_grid.columns.ormsignorgname',
            show: true,
            util: 'PX'
        },
        {
            ...
            label: '默认签约主体',
            langtag: 'entities.pimcontractsignorg.main_grid.columns.isdefaultsignorg',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public getGridRowModel(){
        return {
          ...
          ormsignorgname: new FormItemModel(),
          ormsignorgid: new FormItemModel(),
          isdefaultsignorg: new FormItemModel(),
    ...
    public rules: any = {
        ormorgid: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '管理单位标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '管理单位标识 值不能为空', trigger: 'blur' },
        ],
        ormsignorgname: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '法人主体名称 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '法人主体名称 值不能为空', trigger: 'blur' },
        ],
        ormsignorgid: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '法人主体标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '法人主体标识 值不能为空', trigger: 'blur' },
        ],
        isdefaultsignorg: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '默认签约主体 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '默认签约主体 值不能为空', trigger: 'blur' },
        ],
        srfkey: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '签约主体单位标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '签约主体单位标识 值不能为空', trigger: 'blur' },
        ],
        ormorgname: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '管理单位名称 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '管理单位名称 值不能为空', trigger: 'blur' },
        ],
    }
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'ContractSignORGGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'ContractSignORGGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        _datas.forEach((record: any, index: number) => {
            let srfmajortext = record.contractsignorgname;
            if (index < 5) {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pimcontractsignorg: _keys }),Object.assign({ pimcontractsignorg: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.contractsignorg,$event.contractsignorg);
        });
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('contractsignorg_main_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('contractsignorg_main_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'ContractSignORGGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'ContractSignORGGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.pimcontractsignorg){
                            Object.assign(this.context,{pimcontractsignorg:item.pimcontractsignorg});
                        }
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'ContractSignORGGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
    ...
    public getRowClassName(args:{row: any,rowIndex: number}){
        let isSelected = this.selections.some((item:any)=>{
            return Object.is(item.pimcontractsignorg,args.row.pimcontractsignorg);
        });
