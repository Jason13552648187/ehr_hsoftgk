<template>
  <app-layout viewName="ormdepestmaneditview" viewTitle="部门编制管理编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'ormdep-est-man-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ORMDepEstManEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ORMDepEstManEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {OrmDepEstManService}
     * @memberof ORMDepEstManEditViewBase
     */
	 ...
	 * @memberof ORMDepEstManEditViewBase
	 */
	public viewtag: string = 'f589e5b5d0c563d96f2c0582e7700d4a';
     ...
     */
    public model: any = {
        srfCaption: 'entities.ormdepestman.views.editview.caption',
        srfTitle: 'entities.ormdepestman.views.editview.title',
        srfSubTitle: 'entities.ormdepestman.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'ormdepestman',
            majorPSDEField: 'ormdepestmanname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"OrmDepEstMan");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"OrmDepEstMan");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"OrmDepEstMan");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"OrmDepEstMan");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"OrmDepEstMan");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"OrmDepEstMan");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"OrmDepEstMan");
    }
...
<style lang='less'>
@import './ormdep-est-man-edit-view.less';
</style>