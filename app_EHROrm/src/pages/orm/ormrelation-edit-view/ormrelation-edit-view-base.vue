<template>
  <app-layout viewName="ormrelationeditview" viewTitle="组织管理关系表编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'ormrelation-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ORMRelationEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ORMRelationEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {OrmRelationService}
     * @memberof ORMRelationEditViewBase
     */
	 ...
	 * @memberof ORMRelationEditViewBase
	 */
	public viewtag: string = 'c402adcb2fbab932e05fbda1cbe9e5fd';
     ...
     */
    public model: any = {
        srfCaption: 'entities.ormrelation.views.editview.caption',
        srfTitle: 'entities.ormrelation.views.editview.title',
        srfSubTitle: 'entities.ormrelation.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'ormrelation',
            majorPSDEField: 'ormorgrelationname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"OrmRelation");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"OrmRelation");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"OrmRelation");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"OrmRelation");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"OrmRelation");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"OrmRelation");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"OrmRelation");
    }
...
<style lang='less'>
@import './ormrelation-edit-view.less';
</style>