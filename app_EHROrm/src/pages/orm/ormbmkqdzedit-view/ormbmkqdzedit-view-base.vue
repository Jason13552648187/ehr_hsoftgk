...
export default class ORMBMKQDZEditViewBase extends EditViewBase {
	 ...
	 * @memberof ORMBMKQDZEditViewBase
	 */
	public viewtag: string = '1204f602861ee84407a280392ef01ad3';
     ...
     */
    public model: any = {
        srfCaption: 'entities.ormbmkqdz.views.editview.caption',
        srfTitle: 'entities.ormbmkqdz.views.editview.title',
        srfSubTitle: 'entities.ormbmkqdz.views.editview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './ormbmkqdzedit-view.less';
</style>