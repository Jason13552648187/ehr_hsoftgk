<template>
  <app-layout viewName="ormeditioneditview" viewTitle="版本对照表编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'ormeditionedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ORMEDITIONEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ORMEDITIONEditViewBase extends EditViewBase {
	 ...
	 * @memberof ORMEDITIONEditViewBase
	 */
	public viewtag: string = 'd008fe2ad1da3e0f5c0b47a989edd018';
     ...
     */
    public model: any = {
        srfCaption: 'entities.ormedition.views.editview.caption',
        srfTitle: 'entities.ormedition.views.editview.title',
        srfSubTitle: 'entities.ormedition.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'ormedition',
            majorPSDEField: 'ormeditionname',
            isLoadDefault: true,
        });
    }
...
<style lang='less'>
@import './ormeditionedit-view.less';
</style>