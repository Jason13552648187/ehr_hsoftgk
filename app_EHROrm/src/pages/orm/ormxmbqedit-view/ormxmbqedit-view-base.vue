<template>
  <app-layout viewName="ormxmbqeditview" viewTitle="项目标签编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'ormxmbqedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ORMXMBQEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ORMXMBQEditViewBase extends EditViewBase {
	 ...
	 * @memberof ORMXMBQEditViewBase
	 */
	public viewtag: string = '00167068a07a6fd8bf6af7d42bcdb7fe';
     ...
     */
    public model: any = {
        srfCaption: 'entities.ormxmbq.views.editview.caption',
        srfTitle: 'entities.ormxmbq.views.editview.title',
        srfSubTitle: 'entities.ormxmbq.views.editview.subtitle',
        dataInfo: ''
    }
