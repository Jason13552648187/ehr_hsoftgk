<template>
  <app-layout viewName="ormorgdzeditview" viewTitle="组织地址维护编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'ormorgdzedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ORMORGDZEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ORMORGDZEditViewBase extends EditViewBase {
	 ...
	 * @memberof ORMORGDZEditViewBase
	 */
	public viewtag: string = '7da4fb21031e6fe44577c63910d52141';
     ...
     */
    public model: any = {
        srfCaption: 'entities.ormorgdz.views.editview.caption',
        srfTitle: 'entities.ormorgdz.views.editview.title',
        srfSubTitle: 'entities.ormorgdz.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'ormorgdz',
            majorPSDEField: 'ormorgdzname',
            isLoadDefault: true,
        });
    }
