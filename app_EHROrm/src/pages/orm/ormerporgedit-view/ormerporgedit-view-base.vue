<template>
  <app-layout viewName="ormerporgeditview" viewTitle="ERP组织中间表编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'ormerporgedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ORMERPORGEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ORMERPORGEditViewBase extends EditViewBase {
	 ...
	 * @memberof ORMERPORGEditViewBase
	 */
	public viewtag: string = '5219c3c559df32121480588a0bfa42c9';
     ...
     */
    public model: any = {
        srfCaption: 'entities.ormerporg.views.editview.caption',
        srfTitle: 'entities.ormerporg.views.editview.title',
        srfSubTitle: 'entities.ormerporg.views.editview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './ormerporgedit-view.less';
</style>