<template>
  <app-layout viewName="ormdutyeditview" viewTitle="职务设置" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'ormdutyedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ORMDUTYEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ORMDUTYEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {OrmDutyService}
     * @memberof ORMDUTYEditViewBase
     */
	 ...
	 * @memberof ORMDUTYEditViewBase
	 */
	public viewtag: string = 'e97d29e46761b8948b09515a6e37dbce';
     ...
     */
    public model: any = {
        srfCaption: 'entities.ormduty.views.editview.caption',
        srfTitle: 'entities.ormduty.views.editview.title',
        srfSubTitle: 'entities.ormduty.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"OrmDuty");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"OrmDuty");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Exit(datas, contextJO,paramJO,  $event, xData,this,"OrmDuty");
    }
