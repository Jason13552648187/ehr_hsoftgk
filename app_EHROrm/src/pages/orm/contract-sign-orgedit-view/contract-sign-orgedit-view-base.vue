<template>
  <app-layout viewName="contractsignorgeditview" viewTitle="法人主体设置编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'contract-sign-orgedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ContractSignORGEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ContractSignORGEditViewBase extends EditViewBase {
	 ...
	 * @memberof ContractSignORGEditViewBase
	 */
	public viewtag: string = '79fe5c0c8ff6e616e9a945a44e224844';
     ...
     *
     * @type {*}
     * @memberof ContractSignORGEditView
     */
...
<style lang='less'>
@import './contract-sign-orgedit-view.less';
</style>