<template>
  <app-layout viewName="ormqybzwheditview" viewTitle="区域标准维护编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'ormqybzwhedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ORMQYBZWHEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ORMQYBZWHEditViewBase extends EditViewBase {
	 ...
	 * @memberof ORMQYBZWHEditViewBase
	 */
	public viewtag: string = 'bbe5d21a65d912e9b17acac2ecd276fb';
     ...
     */
    public model: any = {
        srfCaption: 'entities.ormqybzwh.views.editview.caption',
        srfTitle: 'entities.ormqybzwh.views.editview.title',
        srfSubTitle: 'entities.ormqybzwh.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'ormqybzwh',
            majorPSDEField: 'ormqybzwhname',
            isLoadDefault: true,
        });
    }
...
<style lang='less'>
@import './ormqybzwhedit-view.less';
</style>