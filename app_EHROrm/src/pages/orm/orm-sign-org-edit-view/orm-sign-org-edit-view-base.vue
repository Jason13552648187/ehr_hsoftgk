<template>
  <app-layout viewName="ormsignorgeditview" viewTitle="法人主体编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'orm-sign-org-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class OrmSignOrgEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class OrmSignOrgEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {OrmSignOrgService}
     * @memberof OrmSignOrgEditViewBase
     */
	 ...
	 * @memberof OrmSignOrgEditViewBase
	 */
	public viewtag: string = '917714c6b3de7ed13424d76ca50070e2';
     ...
     */
    public model: any = {
        srfCaption: 'entities.ormsignorg.views.editview.caption',
        srfTitle: 'entities.ormsignorg.views.editview.title',
        srfSubTitle: 'entities.ormsignorg.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"OrmSignOrg");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"OrmSignOrg");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"OrmSignOrg");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"OrmSignOrg");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"OrmSignOrg");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"OrmSignOrg");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"OrmSignOrg");
    }
...
<style lang='less'>
@import './orm-sign-org-edit-view.less';
</style>