<template>
  <app-layout viewName="ormorginfoeditview" viewTitle="组织管理" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'ormorginfo-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
import OrmOrgInfoService from '@/service/orm-org-info/orm-org-info-service';
 ...
 *
 * @export
 * @class ORMORGInfoEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ORMORGInfoEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {OrmOrgInfoService}
     * @memberof ORMORGInfoEditViewBase
     */
    public appEntityService: OrmOrgInfoService = new OrmOrgInfoService;
	 ...
	 * @memberof ORMORGInfoEditViewBase
	 */
	public viewtag: string = '9851f29e3a4f62727ef164d964f3c2fd';
     ...
     */
    public model: any = {
        srfCaption: 'entities.ormorginfo.views.editview.caption',
        srfTitle: 'entities.ormorginfo.views.editview.title',
        srfSubTitle: 'entities.ormorginfo.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'ormorginfo',
            majorPSDEField: 'ormorginfoname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"OrmOrgInfo");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"OrmOrgInfo");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"OrmOrgInfo");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"OrmOrgInfo");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"OrmOrgInfo");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"OrmOrgInfo");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"OrmOrgInfo");
    }
...
<style lang='less'>
@import './ormorginfo-edit-view.less';
</style>