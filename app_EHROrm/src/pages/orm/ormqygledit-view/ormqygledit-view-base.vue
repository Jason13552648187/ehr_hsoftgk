<template>
  <app-layout viewName="ormqygleditview" viewTitle="区域补贴" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'ormqygledit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class ORMQYGLEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class ORMQYGLEditViewBase extends EditViewBase {
	 ...
	 * @memberof ORMQYGLEditViewBase
	 */
	public viewtag: string = 'bb8f8363ee628eff78879d048e31d92c';
     ...
     */
    public model: any = {
        srfCaption: 'entities.ormqygl.views.editview.caption',
        srfTitle: 'entities.ormqygl.views.editview.title',
        srfSubTitle: 'entities.ormqygl.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'ormqygl',
            majorPSDEField: 'ormqyglname',
            isLoadDefault: true,
        });
    }
