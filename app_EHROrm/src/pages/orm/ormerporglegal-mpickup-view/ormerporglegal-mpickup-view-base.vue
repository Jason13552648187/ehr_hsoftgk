<template>
  <app-layout viewName="ormerporglegalmpickupview" viewTitle="管理单位" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'dempickupview': true, 'ormerporglegal-mpickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
export default class ORMERPORGLegalMPickupViewBase extends MPickupViewBase {
	 ...
	 * @memberof ORMERPORGLegalMPickupViewBase
	 */
	public viewtag: string = 'a9e8848adebb1372086602b973419f50';
...
<style lang='less'>
@import './ormerporglegal-mpickup-view.less';
</style>