        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
                ...
                <el-table-column show-overflow-tooltip :prop="'htbh'" :label="$t('entities.pimcontract.main_3_grid.columns.htbh')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontract.main_3_grid.columns.htbh')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('htlx')">
                <el-table-column show-overflow-tooltip :prop="'htlx'" :label="$t('entities.pimcontract.main_3_grid.columns.htlx')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontract.main_3_grid.columns.htlx')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('contracttype')">
                <el-table-column show-overflow-tooltip :prop="'contracttype'" :label="$t('entities.pimcontract.main_3_grid.columns.contracttype')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontract.main_3_grid.columns.contracttype')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('qsrq')">
                <el-table-column show-overflow-tooltip :prop="'qsrq'" :label="$t('entities.pimcontract.main_3_grid.columns.qsrq')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontract.main_3_grid.columns.qsrq')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('jsrq')">
                <el-table-column show-overflow-tooltip :prop="'jsrq'" :label="$t('entities.pimcontract.main_3_grid.columns.jsrq')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontract.main_3_grid.columns.jsrq')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('htzt')">
                <el-table-column show-overflow-tooltip :prop="'htzt'" :label="$t('entities.pimcontract.main_3_grid.columns.htzt')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontract.main_3_grid.columns.htzt')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('sydqsj')">
                <el-table-column show-overflow-tooltip :prop="'sydqsj'" :label="$t('entities.pimcontract.main_3_grid.columns.sydqsj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimcontract.main_3_grid.columns.sydqsj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
...
export default class Main_3Base extends Vue implements ControlInterface {
     ...
     * @memberof Main_3Base
     */
    public minorSortPSDEF: string = 'jsrq';
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'htbh',
            label: '合同编号',
            langtag: 'entities.pimcontract.main_3_grid.columns.htbh',
            show: true,
            util: 'PX'
        },
        {
            name: 'htlx',
            label: '合同类别',
            langtag: 'entities.pimcontract.main_3_grid.columns.htlx',
            show: true,
            util: 'PX'
        },
        {
            name: 'contracttype',
            label: '合同类型',
            langtag: 'entities.pimcontract.main_3_grid.columns.contracttype',
            show: true,
            util: 'PX'
        },
        {
            name: 'qsrq',
            label: '起始日期',
            langtag: 'entities.pimcontract.main_3_grid.columns.qsrq',
            show: true,
            util: 'PX'
        },
        {
            name: 'jsrq',
            label: '结束日期',
            langtag: 'entities.pimcontract.main_3_grid.columns.jsrq',
            show: true,
            util: 'PX'
        },
        {
            name: 'htzt',
            label: '合同状态',
            langtag: 'entities.pimcontract.main_3_grid.columns.htzt',
            show: true,
            util: 'PX'
        },
        {
            name: 'sydqsj',
            label: '试用到期时间',
            langtag: 'entities.pimcontract.main_3_grid.columns.sydqsj',
            show: true,
            util: 'px'
        },
    ]
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PIMCONTRACTGRContractGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PIMCONTRACTGRContractGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('pimcontract_main_3_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('pimcontract_main_3_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMCONTRACTGRContractGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMCONTRACTGRContractGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.pimcontract){
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PIMCONTRACTGRContractGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
