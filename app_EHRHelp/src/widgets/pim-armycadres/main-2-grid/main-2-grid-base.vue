        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
                ...
                <el-table-column show-overflow-tooltip :prop="'trooptype'" :label="$t('entities.pimarmycadres.main_2_grid.columns.trooptype')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimarmycadres.main_2_grid.columns.trooptype')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('leveltype')">
                <el-table-column show-overflow-tooltip :prop="'leveltype'" :label="$t('entities.pimarmycadres.main_2_grid.columns.leveltype')" :width="250"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimarmycadres.main_2_grid.columns.leveltype')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('fssj')">
                <el-table-column show-overflow-tooltip :prop="'fssj'" :label="$t('entities.pimarmycadres.main_2_grid.columns.fssj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimarmycadres.main_2_grid.columns.fssj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('fj')">
                <el-table-column show-overflow-tooltip :prop="'fj'" :label="$t('entities.pimarmycadres.main_2_grid.columns.fj')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimarmycadres.main_2_grid.columns.fj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
...
export default class Main_2Base extends Vue implements ControlInterface {
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'trooptype',
            label: '类型(*)',
            langtag: 'entities.pimarmycadres.main_2_grid.columns.trooptype',
            show: true,
            util: 'PX'
        },
        {
            name: 'leveltype',
            label: '级别(*)',
            langtag: 'entities.pimarmycadres.main_2_grid.columns.leveltype',
            show: true,
            util: 'PX'
        },
        {
            name: 'fssj',
            label: '发生时间(*)',
            langtag: 'entities.pimarmycadres.main_2_grid.columns.fssj',
            show: true,
            util: 'PX'
        },
        {
            name: 'fj',
            label: '附件',
            langtag: 'entities.pimarmycadres.main_2_grid.columns.fj',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PIMARMYCADRESGRARMYGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PIMARMYCADRESGRARMYGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('pimarmycadres_main_2_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('pimarmycadres_main_2_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMARMYCADRESGRARMYGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMARMYCADRESGRARMYGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PIMARMYCADRESGRARMYGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
