        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
                ...
                <el-table-column show-overflow-tooltip :prop="'ygbh'" :label="$t('entities.pimexitandentry.ygzz_grid.columns.ygbh')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimexitandentry.ygzz_grid.columns.ygbh')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('pimpersonname')">
                <el-table-column show-overflow-tooltip :prop="'pimpersonname'" :label="$t('entities.pimexitandentry.ygzz_grid.columns.pimpersonname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimexitandentry.ygzz_grid.columns.pimpersonname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('ormorgname')">
                <el-table-column show-overflow-tooltip :prop="'ormorgname'" :label="$t('entities.pimexitandentry.ygzz_grid.columns.ormorgname')" :width="250"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimexitandentry.ygzz_grid.columns.ormorgname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('rank')">
                <el-table-column show-overflow-tooltip :prop="'rank'" :label="$t('entities.pimexitandentry.ygzz_grid.columns.rank')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimexitandentry.ygzz_grid.columns.rank')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('qwfhgj')">
                <el-table-column show-overflow-tooltip :prop="'qwfhgj'" :label="$t('entities.pimexitandentry.ygzz_grid.columns.qwfhgj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimexitandentry.ygzz_grid.columns.qwfhgj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('cjsj')">
                <el-table-column show-overflow-tooltip :prop="'cjsj'" :label="$t('entities.pimexitandentry.ygzz_grid.columns.cjsj')" :width="180"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimexitandentry.ygzz_grid.columns.cjsj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('rjsj')">
                <el-table-column show-overflow-tooltip :prop="'rjsj'" :label="$t('entities.pimexitandentry.ygzz_grid.columns.rjsj')" :width="180"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimexitandentry.ygzz_grid.columns.rjsj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('lx')">
                <el-table-column show-overflow-tooltip :prop="'lx'" :label="$t('entities.pimexitandentry.ygzz_grid.columns.lx')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimexitandentry.ygzz_grid.columns.lx')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('sy')">
                <el-table-column show-overflow-tooltip :prop="'sy'" :label="$t('entities.pimexitandentry.ygzz_grid.columns.sy')" :min-width="1"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimexitandentry.ygzz_grid.columns.sy')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.sy}}</span>
            ...
            <template v-if="getColumnState('workflowstate')">
                <el-table-column show-overflow-tooltip :prop="'workflowstate'" :label="$t('entities.pimexitandentry.ygzz_grid.columns.workflowstate')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimexitandentry.ygzz_grid.columns.workflowstate')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('updatedate')">
                <el-table-column show-overflow-tooltip :prop="'updatedate'" :label="$t('entities.pimexitandentry.ygzz_grid.columns.updatedate')" :width="180"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimexitandentry.ygzz_grid.columns.updatedate')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
...
export default class YGZZBase extends Vue implements ControlInterface {
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'ygbh',
            label: '员工编号',
            langtag: 'entities.pimexitandentry.ygzz_grid.columns.ygbh',
            show: true,
            util: 'px'
        },
        {
            name: 'pimpersonname',
            label: '员工姓名',
            langtag: 'entities.pimexitandentry.ygzz_grid.columns.pimpersonname',
            show: true,
            util: 'px'
        },
        {
            name: 'ormorgname',
            label: '组织',
            langtag: 'entities.pimexitandentry.ygzz_grid.columns.ormorgname',
            show: true,
            util: 'PX'
        },
        {
            name: 'rank',
            label: '职级',
            langtag: 'entities.pimexitandentry.ygzz_grid.columns.rank',
            show: true,
            util: 'px'
        },
        {
            name: 'qwfhgj',
            label: '目的国家/地区',
            langtag: 'entities.pimexitandentry.ygzz_grid.columns.qwfhgj',
            show: true,
            util: 'px'
        },
        {
            name: 'cjsj',
            label: '出（国）境时间',
            langtag: 'entities.pimexitandentry.ygzz_grid.columns.cjsj',
            show: true,
            util: 'PX'
        },
        {
            name: 'rjsj',
            label: '入（国）境时间',
            langtag: 'entities.pimexitandentry.ygzz_grid.columns.rjsj',
            show: true,
            util: 'PX'
        },
        {
            name: 'lx',
            label: '类型',
            langtag: 'entities.pimexitandentry.ygzz_grid.columns.lx',
            show: true,
            util: 'PX'
        },
        {
            name: 'sy',
            label: '事由',
            langtag: 'entities.pimexitandentry.ygzz_grid.columns.sy',
            show: true,
            util: 'STAR'
        },
        {
            name: 'workflowstate',
            label: '流程状态',
            langtag: 'entities.pimexitandentry.ygzz_grid.columns.workflowstate',
            show: true,
            util: 'px'
        },
        {
            name: 'updatedate',
            label: '更新时间',
            langtag: 'entities.pimexitandentry.ygzz_grid.columns.updatedate',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PIMEXITANDENTRYYGZZGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PIMEXITANDENTRYYGZZGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMEXITANDENTRYYGZZGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMEXITANDENTRYYGZZGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
