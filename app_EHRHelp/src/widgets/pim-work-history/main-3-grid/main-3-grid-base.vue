    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('rzkssj')">
                <el-table-column show-overflow-tooltip :prop="'rzkssj'" :label="$t('entities.pimworkhistory.main_3_grid.columns.rzkssj')" :width="130"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimworkhistory.main_3_grid.columns.rzkssj')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('rzjssj')">
                <el-table-column show-overflow-tooltip :prop="'rzjssj'" :label="$t('entities.pimworkhistory.main_3_grid.columns.rzjssj')" :width="130"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimworkhistory.main_3_grid.columns.rzjssj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
            ...
            <template v-if="getColumnState('ormorgname')">
                <el-table-column show-overflow-tooltip :prop="'ormorgname'" :label="$t('entities.pimworkhistory.main_3_grid.columns.ormorgname')" :width="250"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimworkhistory.main_3_grid.columns.ormorgname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
              ...
              @change="($event)=>{gridEditItemChange(row, column.property, $event, $index)}">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='ormorgname' editorType="TEXTBOX" :value="row.ormorgname"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('ormorgsectorname')">
                <el-table-column show-overflow-tooltip :prop="'ormorgsectorname'" :label="$t('entities.pimworkhistory.main_3_grid.columns.ormorgsectorname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimworkhistory.main_3_grid.columns.ormorgsectorname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
              ...
              @change="($event)=>{gridEditItemChange(row, column.property, $event, $index)}">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='ormorgsectorname' editorType="TEXTBOX" :value="row.ormorgsectorname"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('ormdutyname')">
                <el-table-column show-overflow-tooltip :prop="'ormdutyname'" :label="$t('entities.pimworkhistory.main_3_grid.columns.ormdutyname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimworkhistory.main_3_grid.columns.ormdutyname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
            ...
            <template v-if="getColumnState('ormpostname')">
                <el-table-column show-overflow-tooltip :prop="'ormpostname'" :label="$t('entities.pimworkhistory.main_3_grid.columns.ormpostname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimworkhistory.main_3_grid.columns.ormpostname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
            ...
            <template v-if="getColumnState('cfplx')">
                <el-table-column show-overflow-tooltip :prop="'cfplx'" :label="$t('entities.pimworkhistory.main_3_grid.columns.cfplx')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimworkhistory.main_3_grid.columns.cfplx')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
             ...
             <dropdown-list 
              ...
              @change="($event)=>{gridEditItemChange(row, column.property, $event, $index)}">
                        ...
                        <template v-if="!actualIsOpenEdit">
            <codelist :value="row.cfplx" tag='EhrCodeList0237' codelistType='DYNAMIC' ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('experience')">
                <el-table-column show-overflow-tooltip :prop="'experience'" :label="$t('entities.pimworkhistory.main_3_grid.columns.experience')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimworkhistory.main_3_grid.columns.experience')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
             ...
             <dropdown-list 
              ...
              @change="($event)=>{gridEditItemChange(row, column.property, $event, $index)}">
                        ...
                        <template v-if="!actualIsOpenEdit">
            <codelist :value="row.experience" tag='EhrCodeList0401' codelistType='STATIC' renderMode="STR" valueSeparator=";" textSeparator="、" ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('jlspzt')">
                <el-table-column show-overflow-tooltip :prop="'jlspzt'" :label="$t('entities.pimworkhistory.main_3_grid.columns.jlspzt')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimworkhistory.main_3_grid.columns.jlspzt')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.jlspzt" tag='EhrCodeList0138' codelistType='STATIC' renderMode="STR" valueSeparator=";" textSeparator="、" ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
...
import Main_3Service from './main-3-grid-service';
...
export default class Main_3Base extends Vue implements ControlInterface {
     ...
     * @memberof Main_3Base
     */
    public service: Main_3Service = new Main_3Service({ $store: this.$store });
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'rzkssj',
            label: '任职开始时间',
            langtag: 'entities.pimworkhistory.main_3_grid.columns.rzkssj',
            show: true,
            util: 'PX'
        },
        {
            name: 'rzjssj',
            label: '任职结束时间',
            langtag: 'entities.pimworkhistory.main_3_grid.columns.rzjssj',
            show: true,
            util: 'PX'
        },
        {
            name: 'ormorgname',
            label: '工作单位',
            langtag: 'entities.pimworkhistory.main_3_grid.columns.ormorgname',
            show: true,
            util: 'PX'
        },
        {
            ...
            label: '部门',
            langtag: 'entities.pimworkhistory.main_3_grid.columns.ormorgsectorname',
            show: true,
            util: 'PX'
        },
        {
            name: 'ormdutyname',
            label: '职务',
            langtag: 'entities.pimworkhistory.main_3_grid.columns.ormdutyname',
            show: true,
            util: 'PX'
        },
        {
            name: 'ormpostname',
            label: '岗位',
            langtag: 'entities.pimworkhistory.main_3_grid.columns.ormpostname',
            show: true,
            util: 'PX'
        },
        {
            name: 'cfplx',
            label: '兼职借调类型',
            langtag: 'entities.pimworkhistory.main_3_grid.columns.cfplx',
            show: true,
            util: 'PX'
        },
        {
            name: 'experience',
            label: '是否主要经历',
            langtag: 'entities.pimworkhistory.main_3_grid.columns.experience',
            show: true,
            util: 'PX'
        },
        {
            name: 'jlspzt',
            label: '审批状态',
            langtag: 'entities.pimworkhistory.main_3_grid.columns.jlspzt',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public getGridRowModel(){
        return {
          ...
          rzkssj: new FormItemModel(),
          pimpersonid: new FormItemModel(),
          cfplx: new FormItemModel(),
          experience: new FormItemModel(),
          rzjssj: new FormItemModel(),
          srfkey: new FormItemModel(),
          ormdutyname: new FormItemModel(),
    ...
    public rules: any = {
        ormpostname: [
             { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '岗位 值不能为空', trigger: 'change' },
            { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '岗位 值不能为空', trigger: 'blur' },
        ],
        rzkssj: [
             { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '任职开始时间 值不能为空', trigger: 'change' },
            { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '任职开始时间 值不能为空', trigger: 'blur' },
        ],
        pimpersonid: [
        ...
        cfplx: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '兼职借调类型 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '兼职借调类型 值不能为空', trigger: 'blur' },
        ],
        experience: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '是否主要经历 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '是否主要经历 值不能为空', trigger: 'blur' },
        ],
        rzjssj: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '任职结束时间 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '任职结束时间 值不能为空', trigger: 'blur' },
        ],
        srfkey: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '工作履历标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '工作履历标识 值不能为空', trigger: 'blur' },
        ],
        ormdutyname: [
             { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '职务 值不能为空', trigger: 'change' },
            { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '职务 值不能为空', trigger: 'blur' },
        ],
        jlss: [
        ...
        ormorgsectorname: [
             { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '部门 值不能为空', trigger: 'change' },
            { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '部门 值不能为空', trigger: 'blur' },
        ],
        ormorgname: [
             { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '工作单位 值不能为空', trigger: 'change' },
            { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '工作单位 值不能为空', trigger: 'blur' },
        ],
    }
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PIMWORKHISTORYGRPimWorkGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PIMWORKHISTORYGRPimWorkGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        _datas.forEach((record: any, index: number) => {
            let srfmajortext = record.pimworkhistoryname;
            if (index < 5) {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pimworkhistory: _keys }),Object.assign({ pimworkhistory: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.pimworkhistory,$event.pimworkhistory);
        });
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('pimworkhistory_main_3_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('pimworkhistory_main_3_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMWORKHISTORYGRPimWorkGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMWORKHISTORYGRPimWorkGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.pimworkhistory){
                            Object.assign(this.context,{pimworkhistory:item.pimworkhistory});
                        }
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PIMWORKHISTORYGRPimWorkGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
    ...
    public createDefault(row: any){                    
        ...
        if (row.hasOwnProperty('experience')) {
            row['experience'] = 0;
        }
