    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('fplx')">
                <el-table-column show-overflow-tooltip :prop="'fplx'" :label="$t('entities.pimdistirbution.main_grid.columns.fplx')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.main_grid.columns.fplx')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.fplx" tag='EhrCodeList0205' codelistType='DYNAMIC' ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('cfplx')">
                <el-table-column show-overflow-tooltip :prop="'cfplx'" :label="$t('entities.pimdistirbution.main_grid.columns.cfplx')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.main_grid.columns.cfplx')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('zzdzs')">
                <el-table-column show-overflow-tooltip :prop="'zzdzs'" :label="$t('entities.pimdistirbution.main_grid.columns.zzdzs')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.main_grid.columns.zzdzs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.zzdzs}}</span>
            ...
            <template v-if="getColumnState('shortname')">
                <el-table-column show-overflow-tooltip :prop="'shortname'" :label="$t('entities.pimdistirbution.main_grid.columns.shortname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.main_grid.columns.shortname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('ormdutyname')">
                <el-table-column show-overflow-tooltip :prop="'ormdutyname'" :label="$t('entities.pimdistirbution.main_grid.columns.ormdutyname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.main_grid.columns.ormdutyname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('ormpostname')">
                <el-table-column show-overflow-tooltip :prop="'ormpostname'" :label="$t('entities.pimdistirbution.main_grid.columns.ormpostname')" :width="180"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.main_grid.columns.ormpostname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('rzkssj')">
                <el-table-column show-overflow-tooltip :prop="'rzkssj'" :label="$t('entities.pimdistirbution.main_grid.columns.rzkssj')" :width="180"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.main_grid.columns.rzkssj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('rzjssj')">
                <el-table-column show-overflow-tooltip :prop="'rzjssj'" :label="$t('entities.pimdistirbution.main_grid.columns.rzjssj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimdistirbution.main_grid.columns.rzjssj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'fplx',
            label: '分配',
            langtag: 'entities.pimdistirbution.main_grid.columns.fplx',
            show: true,
            util: 'PX'
        },
        {
            name: 'cfplx',
            label: '类型',
            langtag: 'entities.pimdistirbution.main_grid.columns.cfplx',
            show: true,
            util: 'px'
        },
        {
            name: 'zzdzs',
            label: '组织',
            langtag: 'entities.pimdistirbution.main_grid.columns.zzdzs',
            show: true,
            util: 'px'
        },
        {
            name: 'shortname',
            label: '部门',
            langtag: 'entities.pimdistirbution.main_grid.columns.shortname',
            show: true,
            util: 'px'
        },
        {
            name: 'ormdutyname',
            label: '职务',
            langtag: 'entities.pimdistirbution.main_grid.columns.ormdutyname',
            show: true,
            util: 'PX'
        },
        {
            name: 'ormpostname',
            label: '岗位',
            langtag: 'entities.pimdistirbution.main_grid.columns.ormpostname',
            show: true,
            util: 'PX'
        },
        {
            name: 'rzkssj',
            label: '任职开始时间',
            langtag: 'entities.pimdistirbution.main_grid.columns.rzkssj',
            show: true,
            util: 'PX'
        },
        {
            name: 'rzjssj',
            label: '任职结束时间',
            langtag: 'entities.pimdistirbution.main_grid.columns.rzjssj',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public rules: any = {
        ...
        rzkssj: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '任职开始时间 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '任职开始时间 值不能为空', trigger: 'blur' },
        ],
        ormpostname: [
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PimDistirbutionGRPImFenpGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PimDistirbutionGRPImFenpGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('pimdistirbution_main_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('pimdistirbution_main_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PimDistirbutionGRPImFenpGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PimDistirbutionGRPImFenpGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PimDistirbutionGRPImFenpGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
