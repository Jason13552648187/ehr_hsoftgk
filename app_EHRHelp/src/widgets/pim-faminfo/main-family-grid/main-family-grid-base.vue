    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('ybrgx')">
                <el-table-column show-overflow-tooltip :prop="'ybrgx'" :label="$t('entities.pimfaminfo.main_family_grid.columns.ybrgx')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimfaminfo.main_family_grid.columns.ybrgx')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.ybrgx" tag='EhrCodeList0043' codelistType='DYNAMIC' ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('pimfaminfoname')">
                <el-table-column show-overflow-tooltip :prop="'pimfaminfoname'" :label="$t('entities.pimfaminfo.main_family_grid.columns.pimfaminfoname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimfaminfo.main_family_grid.columns.pimfaminfoname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('xb')">
                <el-table-column show-overflow-tooltip :prop="'xb'" :label="$t('entities.pimfaminfo.main_family_grid.columns.xb')" :width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimfaminfo.main_family_grid.columns.xb')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.xb" tag='EhrCodeList0072' codelistType='DYNAMIC' ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('nl')">
                <el-table-column show-overflow-tooltip :prop="'nl'" :label="$t('entities.pimfaminfo.main_family_grid.columns.nl')" :width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimfaminfo.main_family_grid.columns.nl')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.nl}}</span>
            ...
            <template v-if="getColumnState('gzdw')">
                <el-table-column show-overflow-tooltip :prop="'gzdw'" :label="$t('entities.pimfaminfo.main_family_grid.columns.gzdw')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimfaminfo.main_family_grid.columns.gzdw')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.gzdw}}</span>
            ...
            <template v-if="getColumnState('zw')">
                <el-table-column show-overflow-tooltip :prop="'zw'" :label="$t('entities.pimfaminfo.main_family_grid.columns.zw')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimfaminfo.main_family_grid.columns.zw')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.zw}}</span>
            ...
            <template v-if="getColumnState('zzmm')">
                <el-table-column show-overflow-tooltip :prop="'zzmm'" :label="$t('entities.pimfaminfo.main_family_grid.columns.zzmm')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimfaminfo.main_family_grid.columns.zzmm')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.zzmm" tag='EhrCodeList0029' codelistType='DYNAMIC' ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('zjh')">
                <el-table-column show-overflow-tooltip :prop="'zjh'" :label="$t('entities.pimfaminfo.main_family_grid.columns.zjh')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimfaminfo.main_family_grid.columns.zjh')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.zjh}}</span>
            ...
            <template v-if="getColumnState('csrq')">
                <el-table-column show-overflow-tooltip :prop="'csrq'" :label="$t('entities.pimfaminfo.main_family_grid.columns.csrq')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimfaminfo.main_family_grid.columns.csrq')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('sfjjllr')">
                <el-table-column show-overflow-tooltip :prop="'sfjjllr'" :label="$t('entities.pimfaminfo.main_family_grid.columns.sfjjllr')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimfaminfo.main_family_grid.columns.sfjjllr')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.sfjjllr" tag='EhrCodeList0097' codelistType='STATIC' ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('jlspzt')">
                <el-table-column show-overflow-tooltip :prop="'jlspzt'" :label="$t('entities.pimfaminfo.main_family_grid.columns.jlspzt')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimfaminfo.main_family_grid.columns.jlspzt')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
...
import Main_FamilyService from './main-family-grid-service';
...
export default class Main_FamilyBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof Main_FamilyBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {Main_FamilyService}
     * @memberof Main_FamilyBase
     */
    public service: Main_FamilyService = new Main_FamilyService({ $store: this.$store });
     ...
     * @memberof Main_FamilyBase
     */
    public minorSortPSDEF: string = 'csrq';
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'ybrgx',
            label: '与本人关系',
            langtag: 'entities.pimfaminfo.main_family_grid.columns.ybrgx',
            show: true,
            util: 'px'
        },
        {
            name: 'pimfaminfoname',
            label: '姓名',
            langtag: 'entities.pimfaminfo.main_family_grid.columns.pimfaminfoname',
            show: true,
            util: 'px'
        },
        {
            name: 'xb',
            label: '性别',
            langtag: 'entities.pimfaminfo.main_family_grid.columns.xb',
            show: true,
            util: 'PX'
        },
        {
            name: 'nl',
            label: '年龄',
            langtag: 'entities.pimfaminfo.main_family_grid.columns.nl',
            show: true,
            util: 'PX'
        },
        {
            name: 'gzdw',
            label: '工作单位',
            langtag: 'entities.pimfaminfo.main_family_grid.columns.gzdw',
            show: true,
            util: 'px'
        },
        {
            name: 'zw',
            label: '职务',
            langtag: 'entities.pimfaminfo.main_family_grid.columns.zw',
            show: true,
            util: 'px'
        },
        {
            name: 'zzmm',
            label: '政治面貌',
            langtag: 'entities.pimfaminfo.main_family_grid.columns.zzmm',
            show: true,
            util: 'px'
        },
        {
            name: 'zjh',
            label: '证件号',
            langtag: 'entities.pimfaminfo.main_family_grid.columns.zjh',
            show: true,
            util: 'PX'
        },
        {
            name: 'csrq',
            label: '出生日期',
            langtag: 'entities.pimfaminfo.main_family_grid.columns.csrq',
            show: true,
            util: 'px'
        },
        {
            name: 'sfjjllr',
            label: '是否紧急联络人',
            langtag: 'entities.pimfaminfo.main_family_grid.columns.sfjjllr',
            show: true,
            util: 'PX'
        },
        {
            name: 'jlspzt',
            label: '审批状态',
            langtag: 'entities.pimfaminfo.main_family_grid.columns.jlspzt',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PIMFAMINFOGRPimfimGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PIMFAMINFOGRPimfimGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        _datas.forEach((record: any, index: number) => {
            let srfmajortext = record.pimfaminfoname;
            if (index < 5) {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pimfaminfo: _keys }),Object.assign({ pimfaminfo: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.pimfaminfo,$event.pimfaminfo);
        });
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('pimfaminfo_main_family_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('pimfaminfo_main_family_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMFAMINFOGRPimfimGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMFAMINFOGRPimfimGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.pimfaminfo){
                            Object.assign(this.context,{pimfaminfo:item.pimfaminfo});
                        }
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PIMFAMINFOGRPimfimGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
