        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('pimpapername')">
                <el-table-column show-overflow-tooltip :prop="'pimpapername'" :label="$t('entities.pimpaper.main_2_grid.columns.pimpapername')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimpaper.main_2_grid.columns.pimpapername')}}
                      </span>
                    </template>
              ...
              @change="($event)=>{gridEditItemChange(row, column.property, $event, $index)}">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='pimpapername' editorType="TEXTBOX" :value="row.pimpapername"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('cbs')">
                <el-table-column show-overflow-tooltip :prop="'cbs'" :label="$t('entities.pimpaper.main_2_grid.columns.cbs')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimpaper.main_2_grid.columns.cbs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
              ...
              @change="($event)=>{gridEditItemChange(row, column.property, $event, $index)}">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='cbs' editorType="TEXTBOX" :value="row.cbs"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('kwmc')">
                <el-table-column show-overflow-tooltip :prop="'kwmc'" :label="$t('entities.pimpaper.main_2_grid.columns.kwmc')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimpaper.main_2_grid.columns.kwmc')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
              ...
              @change="($event)=>{gridEditItemChange(row, column.property, $event, $index)}">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='kwmc' editorType="TEXTBOX" :value="row.kwmc"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('kwqs')">
                <el-table-column show-overflow-tooltip :prop="'kwqs'" :label="$t('entities.pimpaper.main_2_grid.columns.kwqs')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimpaper.main_2_grid.columns.kwqs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
              ...
              @change="($event)=>{gridEditItemChange(row, column.property, $event, $index)}">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='kwqs' editorType="TEXTBOX" :value="row.kwqs"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('fbsj')">
                <el-table-column show-overflow-tooltip :prop="'fbsj'" :label="$t('entities.pimpaper.main_2_grid.columns.fbsj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimpaper.main_2_grid.columns.fbsj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='fbsj' editorType="DATEPICKER" :value="row.fbsj"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('grzlwzzzdpm')">
                <el-table-column show-overflow-tooltip :prop="'grzlwzzzdpm'" :label="$t('entities.pimpaper.main_2_grid.columns.grzlwzzzdpm')" :width="220"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimpaper.main_2_grid.columns.grzlwzzzdpm')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
              ...
              @change="($event)=>{gridEditItemChange(row, column.property, $event, $index)}">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='grzlwzzzdpm' editorType="TEXTBOX" :value="row.grzlwzzzdpm"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('fj')">
                <el-table-column show-overflow-tooltip :prop="'fj'" :label="$t('entities.pimpaper.main_2_grid.columns.fj')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimpaper.main_2_grid.columns.fj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
            ...
            <template v-if="getColumnState('jlspzt')">
                <el-table-column show-overflow-tooltip :prop="'jlspzt'" :label="$t('entities.pimpaper.main_2_grid.columns.jlspzt')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimpaper.main_2_grid.columns.jlspzt')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
...
export default class Main_2Base extends Vue implements ControlInterface {
     ...
     * @memberof Main_2Base
     */
    public appEntityService: PimPaperService = new PimPaperService({ $store: this.$store });
     ...
     * @memberof Main_2Base
     */
    public minorSortPSDEF: string = 'fbsj';
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'pimpapername',
            label: '论文名称(*)',
            langtag: 'entities.pimpaper.main_2_grid.columns.pimpapername',
            show: true,
            util: 'PX'
        },
        {
            name: 'cbs',
            label: '出版社(*)',
            langtag: 'entities.pimpaper.main_2_grid.columns.cbs',
            show: true,
            util: 'PX'
        },
        {
            name: 'kwmc',
            label: '刊物名称(*)',
            langtag: 'entities.pimpaper.main_2_grid.columns.kwmc',
            show: true,
            util: 'PX'
        },
        {
            name: 'kwqs',
            label: '刊物期数',
            langtag: 'entities.pimpaper.main_2_grid.columns.kwqs',
            show: true,
            util: 'PX'
        },
        {
            name: 'fbsj',
            label: '发表时间(*)',
            langtag: 'entities.pimpaper.main_2_grid.columns.fbsj',
            show: true,
            util: 'PX'
        },
        {
            name: 'grzlwzzzdpm',
            label: '个人在论文著作中的排名',
            langtag: 'entities.pimpaper.main_2_grid.columns.grzlwzzzdpm',
            show: true,
            util: 'PX'
        },
        {
            name: 'fj',
            label: '附件',
            langtag: 'entities.pimpaper.main_2_grid.columns.fj',
            show: true,
            util: 'PX'
        },
        {
            name: 'jlspzt',
            label: '审批状态',
            langtag: 'entities.pimpaper.main_2_grid.columns.jlspzt',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public getGridRowModel(){
        return {
          grzlwzzzdpm: new FormItemModel(),
          fj: new FormItemModel(),
          kwmc: new FormItemModel(),
          cbs: new FormItemModel(),
          pimpersonid: new FormItemModel(),
          kwqs: new FormItemModel(),
          pimpapername: new FormItemModel(),
          srfkey: new FormItemModel(),
          jlss: new FormItemModel(),
          fbsj: new FormItemModel(),
        }
    }
    ...
    public rules: any = {
        grzlwzzzdpm: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '个人在论文著作中的排名 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '个人在论文著作中的排名 值不能为空', trigger: 'blur' },
        ],
        fj: [
        ...
        kwmc: [
             { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '刊物名称(*) 值不能为空', trigger: 'change' },
            { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '刊物名称(*) 值不能为空', trigger: 'blur' },
        ],
        cbs: [
             { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '出版社(*) 值不能为空', trigger: 'change' },
            { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '出版社(*) 值不能为空', trigger: 'blur' },
        ],
        pimpersonid: [
        ...
        kwqs: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '刊物期数 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '刊物期数 值不能为空', trigger: 'blur' },
        ],
        pimpapername: [
             { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '论文名称(*) 值不能为空', trigger: 'change' },
            { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '论文名称(*) 值不能为空', trigger: 'blur' },
        ],
        srfkey: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '论文信息标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '论文信息标识 值不能为空', trigger: 'blur' },
        ],
        jlss: [
        ...
        fbsj: [
             { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '发表时间(*) 值不能为空', trigger: 'change' },
            { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '发表时间(*) 值不能为空', trigger: 'blur' },
        ],
    }
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PIMPAPERGrPAPERGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PIMPAPERGrPAPERGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        _datas.forEach((record: any, index: number) => {
            let srfmajortext = record.pimpapername;
            if (index < 5) {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pimpaper: _keys }),Object.assign({ pimpaper: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.pimpaper,$event.pimpaper);
        });
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('pimpaper_main_2_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('pimpaper_main_2_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMPAPERGrPAPERGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMPAPERGrPAPERGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.pimpaper){
                            Object.assign(this.context,{pimpaper:item.pimpaper});
                        }
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PIMPAPERGrPAPERGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
