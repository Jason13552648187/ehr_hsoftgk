    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('pimtitlecataloguename')">
                <el-table-column show-overflow-tooltip :prop="'pimtitlecataloguename'" :label="$t('entities.pimtitle.main_title_grid.columns.pimtitlecataloguename')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimtitle.main_title_grid.columns.pimtitlecataloguename')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('zcbh')">
                <el-table-column show-overflow-tooltip :prop="'zcbh'" :label="$t('entities.pimtitle.main_title_grid.columns.zcbh')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimtitle.main_title_grid.columns.zcbh')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('zcdj')">
                <el-table-column show-overflow-tooltip :prop="'zcdj'" :label="$t('entities.pimtitle.main_title_grid.columns.zcdj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimtitle.main_title_grid.columns.zcdj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('majorengaged')">
                <el-table-column show-overflow-tooltip :prop="'majorengaged'" :label="$t('entities.pimtitle.main_title_grid.columns.majorengaged')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimtitle.main_title_grid.columns.majorengaged')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.majorengaged}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('zchqrq')">
                <el-table-column show-overflow-tooltip :prop="'zchqrq'" :label="$t('entities.pimtitle.main_title_grid.columns.zchqrq')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimtitle.main_title_grid.columns.zchqrq')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('reviewbody')">
                <el-table-column show-overflow-tooltip :prop="'reviewbody'" :label="$t('entities.pimtitle.main_title_grid.columns.reviewbody')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimtitle.main_title_grid.columns.reviewbody')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.reviewbody}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('lssuingagency')">
                <el-table-column show-overflow-tooltip :prop="'lssuingagency'" :label="$t('entities.pimtitle.main_title_grid.columns.lssuingagency')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimtitle.main_title_grid.columns.lssuingagency')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('employtime')">
                <el-table-column show-overflow-tooltip :prop="'employtime'" :label="$t('entities.pimtitle.main_title_grid.columns.employtime')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimtitle.main_title_grid.columns.employtime')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('sfzgzc')">
                <el-table-column show-overflow-tooltip :prop="'sfzgzc'" :label="$t('entities.pimtitle.main_title_grid.columns.sfzgzc')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimtitle.main_title_grid.columns.sfzgzc')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('jlspzt')">
                <el-table-column show-overflow-tooltip :prop="'jlspzt'" :label="$t('entities.pimtitle.main_title_grid.columns.jlspzt')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimtitle.main_title_grid.columns.jlspzt')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
...
import Main_TitleService from './main-title-grid-service';
...
export default class Main_TitleBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof Main_TitleBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {Main_TitleService}
     * @memberof Main_TitleBase
     */
    public service: Main_TitleService = new Main_TitleService({ $store: this.$store });
     ...
     * @memberof Main_TitleBase
     */
    public minorSortPSDEF: string = 'zchqrq';
    ...
    */
    ...
    public allColumns: any[] = [
        {
            ...
            label: '职称名称',
            langtag: 'entities.pimtitle.main_title_grid.columns.pimtitlecataloguename',
            show: true,
            util: 'PX'
        },
        {
            name: 'zcbh',
            label: '证书编号',
            langtag: 'entities.pimtitle.main_title_grid.columns.zcbh',
            show: true,
            util: 'PX'
        },
        {
            name: 'zcdj',
            label: '职称等级',
            langtag: 'entities.pimtitle.main_title_grid.columns.zcdj',
            show: true,
            util: 'PX'
        },
        {
            name: 'majorengaged',
            label: '专业类别',
            langtag: 'entities.pimtitle.main_title_grid.columns.majorengaged',
            show: true,
            util: 'px'
        },
        {
            name: 'zchqrq',
            label: '职称获取日期',
            langtag: 'entities.pimtitle.main_title_grid.columns.zchqrq',
            show: true,
            util: 'PX'
        },
        {
            name: 'reviewbody',
            label: '评审单位',
            langtag: 'entities.pimtitle.main_title_grid.columns.reviewbody',
            show: true,
            util: 'px'
        },
        {
            name: 'lssuingagency',
            label: '签发机构',
            langtag: 'entities.pimtitle.main_title_grid.columns.lssuingagency',
            show: true,
            util: 'px'
        },
        {
            name: 'employtime',
            label: '职称聘用时间',
            langtag: 'entities.pimtitle.main_title_grid.columns.employtime',
            show: true,
            util: 'px'
        },
        {
            name: 'sfzgzc',
            label: '是否最高职称',
            langtag: 'entities.pimtitle.main_title_grid.columns.sfzgzc',
            show: true,
            util: 'PX'
        },
        {
            name: 'jlspzt',
            label: '审批状态',
            langtag: 'entities.pimtitle.main_title_grid.columns.jlspzt',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public rules: any = {
        ...
        sfzgzc: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '是否最高职称 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '是否最高职称 值不能为空', trigger: 'blur' },
        ],
        zchqrq: [
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PIMTITLEGRPimZhicGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PIMTITLEGRPimZhicGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('pimtitle_main_title_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('pimtitle_main_title_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMTITLEGRPimZhicGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMTITLEGRPimZhicGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.pimtitle){
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PIMTITLEGRPimZhicGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
