...
<div class='grid' style="height:100%;">
    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('zlh')">
                <el-table-column show-overflow-tooltip :prop="'zlh'" :label="$t('entities.pimpatent.main_2_grid.columns.zlh')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimpatent.main_2_grid.columns.zlh')}}
                      </span>
                    </template>
              ...
              @change="($event)=>{gridEditItemChange(row, column.property, $event, $index)}">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='zlh' editorType="TEXTBOX" :value="row.zlh"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('pimpatentname')">
                <el-table-column show-overflow-tooltip :prop="'pimpatentname'" :label="$t('entities.pimpatent.main_2_grid.columns.pimpatentname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimpatent.main_2_grid.columns.pimpatentname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
              ...
              @change="($event)=>{gridEditItemChange(row, column.property, $event, $index)}">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='pimpatentname' editorType="TEXTBOX" :value="row.pimpatentname"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('zlhqsj')">
                <el-table-column show-overflow-tooltip :prop="'zlhqsj'" :label="$t('entities.pimpatent.main_2_grid.columns.zlhqsj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimpatent.main_2_grid.columns.zlhqsj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='zlhqsj' editorType="DATEPICKER" :value="row.zlhqsj"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('zlpzgb')">
                <el-table-column show-overflow-tooltip :prop="'zlpzgb'" :label="$t('entities.pimpatent.main_2_grid.columns.zlpzgb')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimpatent.main_2_grid.columns.zlpzgb')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
              ...
              @change="($event)=>{gridEditItemChange(row, column.property, $event, $index)}">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='zlpzgb' editorType="TEXTBOX" :value="row.zlpzgb"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('enclolure')">
                <el-table-column show-overflow-tooltip :prop="'enclolure'" :label="$t('entities.pimpatent.main_2_grid.columns.enclolure')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimpatent.main_2_grid.columns.enclolure')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
              ...
              @change="($event)=>{gridEditItemChange(row, column.property, $event, $index)}">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='enclolure' editorType="TEXTBOX" :value="row.enclolure"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('jlspzt')">
                <el-table-column show-overflow-tooltip :prop="'jlspzt'" :label="$t('entities.pimpatent.main_2_grid.columns.jlspzt')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pimpatent.main_2_grid.columns.jlspzt')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
...
export default class Main_2Base extends Vue implements ControlInterface {
     ...
     * @memberof Main_2Base
     */
    public minorSortPSDEF: string = 'zlhqsj';
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'zlh',
            label: '专利号(*)',
            langtag: 'entities.pimpatent.main_2_grid.columns.zlh',
            show: true,
            util: 'PX'
        },
        {
            name: 'pimpatentname',
            label: '专利名称(*)',
            langtag: 'entities.pimpatent.main_2_grid.columns.pimpatentname',
            show: true,
            util: 'PX'
        },
        {
            name: 'zlhqsj',
            label: '专利获取时间(*)',
            langtag: 'entities.pimpatent.main_2_grid.columns.zlhqsj',
            show: true,
            util: 'PX'
        },
        {
            name: 'zlpzgb',
            label: '专利批准国别(*)',
            langtag: 'entities.pimpatent.main_2_grid.columns.zlpzgb',
            show: true,
            util: 'PX'
        },
        {
            name: 'enclolure',
            label: '附件',
            langtag: 'entities.pimpatent.main_2_grid.columns.enclolure',
            show: true,
            util: 'PX'
        },
        {
            name: 'jlspzt',
            label: '审批状态',
            langtag: 'entities.pimpatent.main_2_grid.columns.jlspzt',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public getGridRowModel(){
        return {
          zlhqsj: new FormItemModel(),
          zlh: new FormItemModel(),
          pimpatentname: new FormItemModel(),
          pimpersonid: new FormItemModel(),
          zlpzgb: new FormItemModel(),
          srfkey: new FormItemModel(),
          enclolure: new FormItemModel(),
    ...
    public rules: any = {
        zlhqsj: [
             { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '专利获取时间(*) 值不能为空', trigger: 'change' },
            { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '专利获取时间(*) 值不能为空', trigger: 'blur' },
        ],
        zlh: [
             { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '专利号(*) 值不能为空', trigger: 'change' },
            { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '专利号(*) 值不能为空', trigger: 'blur' },
        ],
        pimpatentname: [
             { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '专利名称(*) 值不能为空', trigger: 'change' },
            { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '专利名称(*) 值不能为空', trigger: 'blur' },
        ],
        pimpersonid: [
        ...
        zlpzgb: [
             { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '专利批准国别(*) 值不能为空', trigger: 'change' },
            { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '专利批准国别(*) 值不能为空', trigger: 'blur' },
        ],
        srfkey: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '专利信息编码 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '专利信息编码 值不能为空', trigger: 'blur' },
        ],
        enclolure: [
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PIMPATENTGRPATENTGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PIMPATENTGRPATENTGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        _datas.forEach((record: any, index: number) => {
            let srfmajortext = record.pimpatentname;
            if (index < 5) {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pimpatent: _keys }),Object.assign({ pimpatent: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.pimpatent,$event.pimpatent);
        });
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('pimpatent_main_2_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('pimpatent_main_2_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMPATENTGRPATENTGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PIMPATENTGRPATENTGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.pimpatent){
                            Object.assign(this.context,{pimpatent:item.pimpatent});
                        }
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PIMPATENTGRPATENTGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
    ...
    public getRowClassName(args:{row: any,rowIndex: number}){
        let isSelected = this.selections.some((item:any)=>{
            return Object.is(item.pimpatent,args.row.pimpatent);
        });
