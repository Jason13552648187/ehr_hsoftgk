<template>
  <app-layout viewName="questionsyh_checkeditview" viewTitle="用户查看表单" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'questionsyh-check-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class QUESTIONSYH_CheckEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class QUESTIONSYH_CheckEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimQuestionsService}
     * @memberof QUESTIONSYH_CheckEditViewBase
     */
	 ...
	 * @memberof QUESTIONSYH_CheckEditViewBase
	 */
	public viewtag: string = '22927e3e256fe74ec2bccb549b0d6071';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimquestions.views.yh_checkeditview.caption',
        srfTitle: 'entities.pimquestions.views.yh_checkeditview.title',
        srfSubTitle: 'entities.pimquestions.views.yh_checkeditview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof QUESTIONSYH_CheckEditView
     */
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"PimQuestions");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"PimQuestions");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PimQuestions");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PimQuestions");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"PimQuestions");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"PimQuestions");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"PimQuestions");
    }
...
<style lang='less'>
@import './questionsyh-check-edit-view.less';
</style>