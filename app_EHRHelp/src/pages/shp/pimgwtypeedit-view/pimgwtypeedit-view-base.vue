<template>
  <app-layout viewName="pimgwtypeeditview" viewTitle="岗位类型对照表编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimgwtypeedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMGWTYPEEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMGWTYPEEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimGwTypeService}
     * @memberof PIMGWTYPEEditViewBase
     */
	 ...
	 * @memberof PIMGWTYPEEditViewBase
	 */
	public viewtag: string = '827abc9cb1813e8df244c902de18d8b9';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimgwtype.views.editview.caption',
        srfTitle: 'entities.pimgwtype.views.editview.title',
        srfSubTitle: 'entities.pimgwtype.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"PimGwType");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"PimGwType");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PimGwType");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PimGwType");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"PimGwType");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"PimGwType");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"PimGwType");
    }
...
<style lang='less'>
@import './pimgwtypeedit-view.less';
</style>