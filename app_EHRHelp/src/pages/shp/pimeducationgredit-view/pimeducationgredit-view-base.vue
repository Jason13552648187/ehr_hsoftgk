<template>
  <app-layout viewName="pimeducationgreditview" viewTitle="教育信息编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimeducationgredit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMEDUCATIONGREditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMEDUCATIONGREditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimEducationService}
     * @memberof PIMEDUCATIONGREditViewBase
     */
	 ...
	 * @memberof PIMEDUCATIONGREditViewBase
	 */
	public viewtag: string = 'a35d53d794e229e9012b26dac5268034';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimeducation.views.greditview.caption',
        srfTitle: 'entities.pimeducation.views.greditview.title',
        srfSubTitle: 'entities.pimeducation.views.greditview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMEDUCATIONGREditView
     */
...
<style lang='less'>
@import './pimeducationgredit-view.less';
</style>