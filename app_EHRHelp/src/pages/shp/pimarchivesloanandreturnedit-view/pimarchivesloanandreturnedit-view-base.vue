<template>
  <app-layout viewName="pimarchivesloanandreturneditview" viewTitle="档案借阅及归还记录编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimarchivesloanandreturnedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMARCHIVESLOANANDRETURNEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMARCHIVESLOANANDRETURNEditViewBase extends EditViewBase {
	 ...
	 * @memberof PIMARCHIVESLOANANDRETURNEditViewBase
	 */
	public viewtag: string = 'f66418edcffccccde4209412dab02987';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimarchivesloanandreturn.views.editview.caption',
        srfTitle: 'entities.pimarchivesloanandreturn.views.editview.title',
        srfSubTitle: 'entities.pimarchivesloanandreturn.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMARCHIVESLOANANDRETURNEditView
     */
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'pimarchivesloanandreturn',
            majorPSDEField: 'pimarchivesloanandreturnname',
            isLoadDefault: true,
        });
    }
...
<style lang='less'>
@import './pimarchivesloanandreturnedit-view.less';
</style>