<template>
  <app-layout viewName="pimworkhistorygreditview" viewTitle="工作履历编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimworkhistorygredit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMWORKHISTORYGREditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMWORKHISTORYGREditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimWorkHistoryService}
     * @memberof PIMWORKHISTORYGREditViewBase
     */
	 ...
	 * @memberof PIMWORKHISTORYGREditViewBase
	 */
	public viewtag: string = 'dd6b082a3d33315bc205b86369ded6f4';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimworkhistory.views.greditview.caption',
        srfTitle: 'entities.pimworkhistory.views.greditview.title',
        srfSubTitle: 'entities.pimworkhistory.views.greditview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMWORKHISTORYGREditView
     */
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'pimworkhistory',
            majorPSDEField: 'pimworkhistoryname',
            isLoadDefault: true,
        });
    }
...
<style lang='less'>
@import './pimworkhistorygredit-view.less';
</style>