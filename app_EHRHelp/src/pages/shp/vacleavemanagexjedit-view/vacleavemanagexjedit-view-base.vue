<template>
  <app-layout viewName="vacleavemanagexjeditview" viewTitle="销假" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'vacleavemanagexjedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class VACLEAVEMANAGEXJEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class VACLEAVEMANAGEXJEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {VacLeaveManageService}
     * @memberof VACLEAVEMANAGEXJEditViewBase
     */
	 ...
	 * @memberof VACLEAVEMANAGEXJEditViewBase
	 */
	public viewtag: string = '2be99c3cf13e616ace5bb131ef4652f5';
     ...
     */
    public model: any = {
        srfCaption: 'entities.vacleavemanage.views.xjeditview.caption',
        srfTitle: 'entities.vacleavemanage.views.xjeditview.title',
        srfSubTitle: 'entities.vacleavemanage.views.xjeditview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof VACLEAVEMANAGEXJEditView
     */
...
<style lang='less'>
@import './vacleavemanagexjedit-view.less';
</style>