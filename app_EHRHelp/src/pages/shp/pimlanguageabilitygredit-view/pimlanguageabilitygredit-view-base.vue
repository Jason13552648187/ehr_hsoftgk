<template>
  <app-layout viewName="pimlanguageabilitygreditview" viewTitle="语言能力编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimlanguageabilitygredit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMLANGUAGEABILITYGREditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMLANGUAGEABILITYGREditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimLanguageAbilityService}
     * @memberof PIMLANGUAGEABILITYGREditViewBase
     */
	 ...
	 * @memberof PIMLANGUAGEABILITYGREditViewBase
	 */
	public viewtag: string = 'dfbabc9f4c755d80386a1c5b6c67f907';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimlanguageability.views.greditview.caption',
        srfTitle: 'entities.pimlanguageability.views.greditview.title',
        srfSubTitle: 'entities.pimlanguageability.views.greditview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMLANGUAGEABILITYGREditView
     */
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'pimlanguageability',
            majorPSDEField: 'pimlanguageabilityname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"PimLanguageAbility");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"PimLanguageAbility");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PimLanguageAbility");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PimLanguageAbility");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"PimLanguageAbility");
    }
...
<style lang='less'>
@import './pimlanguageabilitygredit-view.less';
</style>