<template>
  <app-layout viewName="pimarmycadresgreditview" viewTitle="军转干部编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimarmycadresgredit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMARMYCADRESGREditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMARMYCADRESGREditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimArmycadresService}
     * @memberof PIMARMYCADRESGREditViewBase
     */
	 ...
	 * @memberof PIMARMYCADRESGREditViewBase
	 */
	public viewtag: string = '57be995a9006a6533352630814a8be63';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimarmycadres.views.greditview.caption',
        srfTitle: 'entities.pimarmycadres.views.greditview.title',
        srfSubTitle: 'entities.pimarmycadres.views.greditview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMARMYCADRESGREditView
     */
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'pimarmycadres',
            majorPSDEField: 'pimarmycadresname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"PimArmycadres");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"PimArmycadres");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PimArmycadres");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PimArmycadres");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"PimArmycadres");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"PimArmycadres");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"PimArmycadres");
    }
...
<style lang='less'>
@import './pimarmycadresgredit-view.less';
</style>