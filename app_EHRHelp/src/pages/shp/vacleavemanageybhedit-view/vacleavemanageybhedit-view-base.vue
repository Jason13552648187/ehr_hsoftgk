<template>
  <app-layout viewName="vacleavemanageybheditview" viewTitle="请假管理" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'vacleavemanageybhedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class VACLEAVEMANAGEYBHEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class VACLEAVEMANAGEYBHEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {VacLeaveManageService}
     * @memberof VACLEAVEMANAGEYBHEditViewBase
     */
	 ...
	 * @memberof VACLEAVEMANAGEYBHEditViewBase
	 */
	public viewtag: string = '8dac134de81ebe22b4c2f462c8c6eb3e';
     ...
     */
    public model: any = {
        srfCaption: 'entities.vacleavemanage.views.ybheditview.caption',
        srfTitle: 'entities.vacleavemanage.views.ybheditview.title',
        srfSubTitle: 'entities.vacleavemanage.views.ybheditview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof VACLEAVEMANAGEYBHEditView
     */
...
<style lang='less'>
@import './vacleavemanageybhedit-view.less';
</style>