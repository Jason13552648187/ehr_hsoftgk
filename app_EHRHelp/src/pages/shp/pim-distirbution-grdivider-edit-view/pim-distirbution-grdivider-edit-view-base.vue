<template>
  <app-layout viewName="pimdistirbutiongrdividereditview" viewTitle="分配信息编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pim-distirbution-grdivider-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PimDistirbutionGRDividerEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PimDistirbutionGRDividerEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimDistirbutionService}
     * @memberof PimDistirbutionGRDividerEditViewBase
     */
	 ...
	 * @memberof PimDistirbutionGRDividerEditViewBase
	 */
	public viewtag: string = '6afa61d020d536cac86d31e8276b6e36';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimdistirbution.views.grdividereditview.caption',
        srfTitle: 'entities.pimdistirbution.views.grdividereditview.title',
        srfSubTitle: 'entities.pimdistirbution.views.grdividereditview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PimDistirbutionGRDividerEditView
     */
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"PimDistirbution");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"PimDistirbution");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PimDistirbution");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PimDistirbution");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"PimDistirbution");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"PimDistirbution");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"PimDistirbution");
    }
...
<style lang='less'>
@import './pim-distirbution-grdivider-edit-view.less';
</style>