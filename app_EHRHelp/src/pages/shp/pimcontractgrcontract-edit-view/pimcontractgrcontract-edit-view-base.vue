<template>
  <app-layout viewName="pimcontractgrcontracteditview" viewTitle="合同信息编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimcontractgrcontract-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMCONTRACTGRContractEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMCONTRACTGRContractEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimContractService}
     * @memberof PIMCONTRACTGRContractEditViewBase
     */
	 ...
	 * @memberof PIMCONTRACTGRContractEditViewBase
	 */
	public viewtag: string = 'aa1d98345f845c6bae1d129cd4de751b';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimcontract.views.grcontracteditview.caption',
        srfTitle: 'entities.pimcontract.views.grcontracteditview.title',
        srfSubTitle: 'entities.pimcontract.views.grcontracteditview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMCONTRACTGRContractEditView
     */
...
<style lang='less'>
@import './pimcontractgrcontract-edit-view.less';
</style>