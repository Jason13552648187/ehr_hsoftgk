<template>
  <app-layout viewName="pimresearchfindingsgreditview" viewTitle="科研成果编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pimresearchfindingsgredit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PIMRESEARCHFINDINGSGREditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PIMRESEARCHFINDINGSGREditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimResearchFindingsService}
     * @memberof PIMRESEARCHFINDINGSGREditViewBase
     */
	 ...
	 * @memberof PIMRESEARCHFINDINGSGREditViewBase
	 */
	public viewtag: string = '1fa2e31993185c35bc914a39ede37e1b';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimresearchfindings.views.greditview.caption',
        srfTitle: 'entities.pimresearchfindings.views.greditview.title',
        srfSubTitle: 'entities.pimresearchfindings.views.greditview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PIMRESEARCHFINDINGSGREditView
     */
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'pimresearchfindings',
            majorPSDEField: 'pimresearchfindingsname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"PimResearchFindings");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"PimResearchFindings");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PimResearchFindings");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PimResearchFindings");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"PimResearchFindings");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"PimResearchFindings");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"PimResearchFindings");
    }
...
<style lang='less'>
@import './pimresearchfindingsgredit-view.less';
</style>