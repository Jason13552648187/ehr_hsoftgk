...
import OrgBarService from './org-bar-chart-service';
...
export default class OrgBarBase extends Vue implements ControlInterface {
    ...
    */
    ...
    ecObject:{
        label:{formatter:'{@countnum}人',position:'right' },
        barWidth:10,
        encode:{x: ['countnum'], y: ['orgid'] },
    },
    seriesTemp:{
        type:'bar',
    },
