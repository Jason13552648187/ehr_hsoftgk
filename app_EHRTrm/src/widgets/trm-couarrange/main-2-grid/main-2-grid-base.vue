    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('trmtrainplantermname')">
                <el-table-column show-overflow-tooltip :prop="'trmtrainplantermname'" :label="$t('entities.trmcouarrange.main_2_grid.columns.trmtrainplantermname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmcouarrange.main_2_grid.columns.trmtrainplantermname')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('trmtraincoursename')">
                <el-table-column show-overflow-tooltip :prop="'trmtraincoursename'" :label="$t('entities.trmcouarrange.main_2_grid.columns.trmtraincoursename')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmcouarrange.main_2_grid.columns.trmtraincoursename')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('trmtrainaddressname')">
                <el-table-column show-overflow-tooltip :prop="'trmtrainaddressname'" :label="$t('entities.trmcouarrange.main_2_grid.columns.trmtrainaddressname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmcouarrange.main_2_grid.columns.trmtrainaddressname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('skkssj')">
                <el-table-column show-overflow-tooltip :prop="'skkssj'" :label="$t('entities.trmcouarrange.main_2_grid.columns.skkssj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmcouarrange.main_2_grid.columns.skkssj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('skjssj')">
                <el-table-column show-overflow-tooltip :prop="'skjssj'" :label="$t('entities.trmcouarrange.main_2_grid.columns.skjssj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmcouarrange.main_2_grid.columns.skjssj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('pj')">
                <el-table-column show-overflow-tooltip :prop="'pj'" :label="$t('entities.trmcouarrange.main_2_grid.columns.pj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmcouarrange.main_2_grid.columns.pj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.pj}}</span>
...
export default class Main_2Base extends Vue implements ControlInterface {
    ...
    */
    ...
    public allColumns: any[] = [
        {
            ...
            label: '班级',
            langtag: 'entities.trmcouarrange.main_2_grid.columns.trmtrainplantermname',
            show: true,
            util: 'px'
        },
        {
            ...
            label: '课程',
            langtag: 'entities.trmcouarrange.main_2_grid.columns.trmtraincoursename',
            show: true,
            util: 'px'
        },
        {
            ...
            label: '培训场地',
            langtag: 'entities.trmcouarrange.main_2_grid.columns.trmtrainaddressname',
            show: true,
            util: 'px'
        },
        {
            name: 'skkssj',
            label: '培训开始时间',
            langtag: 'entities.trmcouarrange.main_2_grid.columns.skkssj',
            show: true,
            util: 'PX'
        },
        {
            name: 'skjssj',
            label: '培训结束时间',
            langtag: 'entities.trmcouarrange.main_2_grid.columns.skjssj',
            show: true,
            util: 'PX'
        },
        {
            name: 'pj',
            label: '评价',
            langtag: 'entities.trmcouarrange.main_2_grid.columns.pj',
            show: true,
            util: 'px'
        },
    ]
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'TrmCouarrangePXJGGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'TrmCouarrangePXJGGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('trmcouarrange_main_2_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('trmcouarrange_main_2_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'TrmCouarrangePXJGGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'TrmCouarrangePXJGGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'TrmCouarrangePXJGGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
