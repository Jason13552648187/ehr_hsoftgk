...
<div class='grid' style="height:100%;">
    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('trmtrainaddressname')">
                <el-table-column show-overflow-tooltip :prop="'trmtrainaddressname'" :label="$t('entities.trmtrainaddress.main_grid.columns.trmtrainaddressname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtrainaddress.main_grid.columns.trmtrainaddressname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.trmtrainaddressname}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('sf')">
                <el-table-column show-overflow-tooltip :prop="'sf'" :label="$t('entities.trmtrainaddress.main_grid.columns.sf')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtrainaddress.main_grid.columns.sf')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.sf" tag='EhrCodeList0186' codelistType='STATIC' renderMode="STR" valueSeparator=";" textSeparator="、" ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('s')">
                <el-table-column show-overflow-tooltip :prop="'s'" :label="$t('entities.trmtrainaddress.main_grid.columns.s')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtrainaddress.main_grid.columns.s')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.s}}</span>
            ...
            <template v-if="getColumnState('lxr')">
                <el-table-column show-overflow-tooltip :prop="'lxr'" :label="$t('entities.trmtrainaddress.main_grid.columns.lxr')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtrainaddress.main_grid.columns.lxr')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.lxr}}</span>
            ...
            <template v-if="getColumnState('dz')">
                <el-table-column show-overflow-tooltip :prop="'dz'" :label="$t('entities.trmtrainaddress.main_grid.columns.dz')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtrainaddress.main_grid.columns.dz')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.dz}}</span>
            ...
            <template v-if="getColumnState('lxdh')">
                <el-table-column show-overflow-tooltip :prop="'lxdh'" :label="$t('entities.trmtrainaddress.main_grid.columns.lxdh')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtrainaddress.main_grid.columns.lxdh')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.lxdh}}</span>
            ...
            <template v-if="getColumnState('xj')">
                <el-table-column show-overflow-tooltip :prop="'xj'" :label="$t('entities.trmtrainaddress.main_grid.columns.xj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtrainaddress.main_grid.columns.xj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.xj}}</span>
            ...
            <template v-if="getColumnState('xz')">
                <el-table-column show-overflow-tooltip :prop="'xz'" :label="$t('entities.trmtrainaddress.main_grid.columns.xz')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtrainaddress.main_grid.columns.xz')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.xz" tag='EhrCodeList0130' codelistType='DYNAMIC' renderMode="STR" valueSeparator=";" textSeparator="、" ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('hjzk')">
                <el-table-column show-overflow-tooltip :prop="'hjzk'" :label="$t('entities.trmtrainaddress.main_grid.columns.hjzk')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtrainaddress.main_grid.columns.hjzk')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.hjzk" tag='EhrCodeList0161' codelistType='STATIC' renderMode="STR" valueSeparator=";" textSeparator="、" ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('shortname')">
                <el-table-column show-overflow-tooltip :prop="'shortname'" :label="$t('entities.trmtrainaddress.main_grid.columns.shortname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtrainaddress.main_grid.columns.shortname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    */
    ...
    public allColumns: any[] = [
        {
            ...
            label: '场地名称',
            langtag: 'entities.trmtrainaddress.main_grid.columns.trmtrainaddressname',
            show: true,
            util: 'PX'
        },
        {
            name: 'sf',
            label: '省份',
            langtag: 'entities.trmtrainaddress.main_grid.columns.sf',
            show: true,
            util: 'px'
        },
        {
            name: 's',
            label: '市',
            langtag: 'entities.trmtrainaddress.main_grid.columns.s',
            show: true,
            util: 'px'
        },
        {
            name: 'lxr',
            label: '联系人',
            langtag: 'entities.trmtrainaddress.main_grid.columns.lxr',
            show: true,
            util: 'px'
        },
        {
            name: 'dz',
            label: '地址',
            langtag: 'entities.trmtrainaddress.main_grid.columns.dz',
            show: true,
            util: 'px'
        },
        {
            name: 'lxdh',
            label: '联系电话',
            langtag: 'entities.trmtrainaddress.main_grid.columns.lxdh',
            show: true,
            util: 'px'
        },
        {
            name: 'xj',
            label: '星级',
            langtag: 'entities.trmtrainaddress.main_grid.columns.xj',
            show: true,
            util: 'px'
        },
        {
            name: 'xz',
            label: '性质',
            langtag: 'entities.trmtrainaddress.main_grid.columns.xz',
            show: true,
            util: 'px'
        },
        {
            name: 'hjzk',
            label: '环境状况',
            langtag: 'entities.trmtrainaddress.main_grid.columns.hjzk',
            show: true,
            util: 'px'
        },
        {
            name: 'shortname',
            label: '所属单位',
            langtag: 'entities.trmtrainaddress.main_grid.columns.shortname',
            show: true,
            util: 'px'
        },
    ]
    ...
    public rules: any = {
        srfkey: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '培训地点标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '培训地点标识 值不能为空', trigger: 'blur' },
        ],
    }
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'TrmTrainAddressPickupGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'TrmTrainAddressPickupGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        _datas.forEach((record: any, index: number) => {
            let srfmajortext = record.trmtrainaddressname;
            if (index < 5) {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ trmtrainaddress: _keys }),Object.assign({ trmtrainaddress: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.trmtrainaddress,$event.trmtrainaddress);
        });
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('trmtrainaddress_main_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('trmtrainaddress_main_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'TrmTrainAddressPickupGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'TrmTrainAddressPickupGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.trmtrainaddress){
                            Object.assign(this.context,{trmtrainaddress:item.trmtrainaddress});
                        }
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'TrmTrainAddressPickupGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
    ...
    public getRowClassName(args:{row: any,rowIndex: number}){
        let isSelected = this.selections.some((item:any)=>{
            return Object.is(item.trmtrainaddress,args.row.trmtrainaddress);
        });
