        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('trmdemdeftionname')">
                <el-table-column show-overflow-tooltip :prop="'trmdemdeftionname'" :label="$t('entities.trmdemdeftion.main_grid.columns.trmdemdeftionname')" :width="200"  :align="'left'" :sortable="'custom'">
                    ...
                    <template v-slot="{row,column,$index}">
                        <span>{{row.trmdemdeftionname}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('pxmk')">
                <el-table-column show-overflow-tooltip :prop="'pxmk'" :label="$t('entities.trmdemdeftion.main_grid.columns.pxmk')" :width="220"  :align="'left'" :sortable="'custom'">
                    ...
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.pxmk" tag='EhrCodeList0171' codelistType='STATIC' ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('xqfl')">
                <el-table-column show-overflow-tooltip :prop="'xqfl'" :label="$t('entities.trmdemdeftion.main_grid.columns.xqfl')" :width="140"  :align="'left'" :sortable="'custom'">
                    ...
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.xqfl" tag='EhrCodeList0154' codelistType='STATIC' renderMode="STR" valueSeparator=";" textSeparator="、" ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            ...
            <template v-if="getColumnState('pxkssj')">
                <el-table-column show-overflow-tooltip :prop="'pxkssj'" :label="$t('entities.trmdemdeftion.main_grid.columns.pxkssj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmdemdeftion.main_grid.columns.pxkssj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <app-format-data format="YYYY-MM-DD" :data="row.pxkssj"></app-format-data>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('pxjssj')">
                <el-table-column show-overflow-tooltip :prop="'pxjssj'" :label="$t('entities.trmdemdeftion.main_grid.columns.pxjssj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmdemdeftion.main_grid.columns.pxjssj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <app-format-data format="YYYY-MM-DD" :data="row.pxjssj"></app-format-data>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('pxdd')">
                <el-table-column show-overflow-tooltip :prop="'pxdd'" :label="$t('entities.trmdemdeftion.main_grid.columns.pxdd')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmdemdeftion.main_grid.columns.pxdd')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.pxdd}}</span>
            ...
            <template v-if="getColumnState('pxrs')">
                <el-table-column show-overflow-tooltip :prop="'pxrs'" :label="$t('entities.trmdemdeftion.main_grid.columns.pxrs')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmdemdeftion.main_grid.columns.pxrs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.pxrs}}</span>
            ...
            <template v-if="getColumnState('bmjzsj')">
                <el-table-column show-overflow-tooltip :prop="'bmjzsj'" :label="$t('entities.trmdemdeftion.main_grid.columns.bmjzsj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmdemdeftion.main_grid.columns.bmjzsj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <app-format-data format="YYYY-MM-DD" :data="row.bmjzsj"></app-format-data>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('ormorgname')">
                <el-table-column show-overflow-tooltip :prop="'ormorgname'" :label="$t('entities.trmdemdeftion.main_grid.columns.ormorgname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmdemdeftion.main_grid.columns.ormorgname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
    ...
    */
    ...
    public allColumns: any[] = [
        ...
        },
        {
            name: 'pxmk',
            label: '培训模块',
            langtag: 'entities.trmdemdeftion.main_grid.columns.pxmk',
            show: true,
            util: 'PX'
        },
        {
            name: 'xqfl',
            label: '需求分类',
            langtag: 'entities.trmdemdeftion.main_grid.columns.xqfl',
            show: true,
            util: 'px'
        },
        {
        ...
        },
        {
            name: 'pxzynr',
            label: '培训主要内容',
            langtag: 'entities.trmdemdeftion.main_grid.columns.pxzynr',
            show: true,
            util: 'px'
        },
        {
            name: 'pxkssj',
            label: '培训开始时间',
            langtag: 'entities.trmdemdeftion.main_grid.columns.pxkssj',
            show: true,
            util: 'px'
        },
        {
            name: 'pxjssj',
            label: '培训结束时间',
            langtag: 'entities.trmdemdeftion.main_grid.columns.pxjssj',
            show: true,
            util: 'px'
        },
        {
            name: 'pxdd',
            label: '培训地点',
            langtag: 'entities.trmdemdeftion.main_grid.columns.pxdd',
            show: true,
            util: 'px'
        },
        {
            name: 'pxrs',
            label: '培训人数',
            langtag: 'entities.trmdemdeftion.main_grid.columns.pxrs',
            show: true,
            util: 'px'
        },
        {
            name: 'bmjzsj',
            label: '报名截止时间',
            langtag: 'entities.trmdemdeftion.main_grid.columns.bmjzsj',
            show: true,
            util: 'px'
        },
        {
            name: 'ormorgname',
            label: '单位',
            langtag: 'entities.trmdemdeftion.main_grid.columns.ormorgname',
            show: true,
            util: 'px'
        },
    ]
    ...
    public rules: any = {
        srfkey: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '需求调查定义标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '需求调查定义标识 值不能为空', trigger: 'blur' },
        ],
    }
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'TrmDemdeftionTBGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'TrmDemdeftionTBGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        _datas.forEach((record: any, index: number) => {
            let srfmajortext = record.trmdemdeftionname;
            if (index < 5) {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ trmdemdeftion: _keys }),Object.assign({ trmdemdeftion: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.trmdemdeftion,$event.trmdemdeftion);
        });
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('trmdemdeftion_main_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('trmdemdeftion_main_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'TrmDemdeftionTBGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'TrmDemdeftionTBGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.trmdemdeftion){
                            Object.assign(this.context,{trmdemdeftion:item.trmdemdeftion});
                        }
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'TrmDemdeftionTBGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
    ...
    public getRowClassName(args:{row: any,rowIndex: number}){
        let isSelected = this.selections.some((item:any)=>{
            return Object.is(item.trmdemdeftion,args.row.trmdemdeftion);
        });
