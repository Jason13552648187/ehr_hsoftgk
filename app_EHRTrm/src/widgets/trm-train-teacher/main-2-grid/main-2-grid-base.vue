    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('pimpersonname')">
                <el-table-column show-overflow-tooltip :prop="'pimpersonname'" :label="$t('entities.trmtrainteacher.main_2_grid.columns.pimpersonname')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtrainteacher.main_2_grid.columns.pimpersonname')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('dj')">
                <el-table-column show-overflow-tooltip :prop="'dj'" :label="$t('entities.trmtrainteacher.main_2_grid.columns.dj')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtrainteacher.main_2_grid.columns.dj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.dj" tag='EhrCodeList0032' codelistType='STATIC' renderMode="STR" valueSeparator=";" textSeparator="、" ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('jslx')">
                <el-table-column show-overflow-tooltip :prop="'jslx'" :label="$t('entities.trmtrainteacher.main_2_grid.columns.jslx')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtrainteacher.main_2_grid.columns.jslx')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.jslx" tag='EhrCodeList0111' codelistType='STATIC' ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('xb')">
                <el-table-column show-overflow-tooltip :prop="'xb'" :label="$t('entities.trmtrainteacher.main_2_grid.columns.xb')" :width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtrainteacher.main_2_grid.columns.xb')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('nl')">
                <el-table-column show-overflow-tooltip :prop="'nl'" :label="$t('entities.trmtrainteacher.main_2_grid.columns.nl')" :width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtrainteacher.main_2_grid.columns.nl')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.nl}}</span>
            ...
            <template v-if="getColumnState('lxdh')">
                <el-table-column show-overflow-tooltip :prop="'lxdh'" :label="$t('entities.trmtrainteacher.main_2_grid.columns.lxdh')" :width="140"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtrainteacher.main_2_grid.columns.lxdh')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.lxdh}}</span>
            ...
            <template v-if="getColumnState('zjkssj')">
                <el-table-column show-overflow-tooltip :prop="'zjkssj'" :label="$t('entities.trmtrainteacher.main_2_grid.columns.zjkssj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtrainteacher.main_2_grid.columns.zjkssj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <app-format-data format="YYYY-MM-DD" :data="row.zjkssj"></app-format-data>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('zzdzs')">
                <el-table-column show-overflow-tooltip :prop="'zzdzs'" :label="$t('entities.trmtrainteacher.main_2_grid.columns.zzdzs')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtrainteacher.main_2_grid.columns.zzdzs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.zzdzs}}</span>
            ...
            <template v-if="getColumnState('sfgx')">
                <el-table-column show-overflow-tooltip :prop="'sfgx'" :label="$t('entities.trmtrainteacher.main_2_grid.columns.sfgx')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtrainteacher.main_2_grid.columns.sfgx')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.sfgx" tag='EhrCodeList0401' codelistType='STATIC' renderMode="STR" valueSeparator=";" textSeparator="、" ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
...
import TrmTrainTeacherService from '@/service/trm-train-teacher/trm-train-teacher-service';
...
export default class Main_2Base extends Vue implements ControlInterface {
     ...
     * 实体服务对象
     *
     * @type {TrmTrainTeacherService}
     * @memberof Main_2Base
     */
    public appEntityService: TrmTrainTeacherService = new TrmTrainTeacherService({ $store: this.$store });
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'pimpersonname',
            label: '姓名',
            langtag: 'entities.trmtrainteacher.main_2_grid.columns.pimpersonname',
            show: true,
            util: 'PX'
        },
        {
            name: 'dj',
            label: '等级',
            langtag: 'entities.trmtrainteacher.main_2_grid.columns.dj',
            show: true,
            util: 'px'
        },
        {
            name: 'jslx',
            label: '讲师类型',
            langtag: 'entities.trmtrainteacher.main_2_grid.columns.jslx',
            show: true,
            util: 'px'
        },
        {
            name: 'xb',
            label: '性别',
            langtag: 'entities.trmtrainteacher.main_2_grid.columns.xb',
            show: true,
            util: 'px'
        },
        {
            name: 'nl',
            label: '年龄',
            langtag: 'entities.trmtrainteacher.main_2_grid.columns.nl',
            show: true,
            util: 'px'
        },
        {
            name: 'lxdh',
            label: '联系电话',
            langtag: 'entities.trmtrainteacher.main_2_grid.columns.lxdh',
            show: true,
            util: 'px'
        },
        {
            name: 'zjkssj',
            label: '执教开始时间',
            langtag: 'entities.trmtrainteacher.main_2_grid.columns.zjkssj',
            show: true,
            util: 'px'
        },
        {
            name: 'zzdzs',
            label: '所属单位',
            langtag: 'entities.trmtrainteacher.main_2_grid.columns.zzdzs',
            show: true,
            util: 'px'
        },
        {
            name: 'sfgx',
            label: '是否共享',
            langtag: 'entities.trmtrainteacher.main_2_grid.columns.sfgx',
            show: true,
            util: 'px'
        },
    ]
    ...
    public rules: any = {
        srfkey: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '培训教师标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '培训教师标识 值不能为空', trigger: 'blur' },
        ],
    }
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'TrmTrainTeacherWBGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'TrmTrainTeacherWBGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        _datas.forEach((record: any, index: number) => {
            let srfmajortext = record.trmtrainteachername;
            if (index < 5) {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ trmtrainteacher: _keys }),Object.assign({ trmtrainteacher: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.trmtrainteacher,$event.trmtrainteacher);
        });
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('trmtrainteacher_main_2_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('trmtrainteacher_main_2_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'TrmTrainTeacherWBGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'TrmTrainTeacherWBGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.trmtrainteacher){
                            Object.assign(this.context,{trmtrainteacher:item.trmtrainteacher});
                        }
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'TrmTrainTeacherWBGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
    ...
    public getRowClassName(args:{row: any,rowIndex: number}){
        let isSelected = this.selections.some((item:any)=>{
            return Object.is(item.trmtrainteacher,args.row.trmtrainteacher);
        });
