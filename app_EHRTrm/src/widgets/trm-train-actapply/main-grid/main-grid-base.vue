...
<div class='grid' style="height:100%;">
    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('pxhdbm')">
                <el-table-column show-overflow-tooltip :prop="'pxhdbm'" :label="$t('entities.trmtrainactapply.main_grid.columns.pxhdbm')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtrainactapply.main_grid.columns.pxhdbm')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.pxhdbm}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('trmtrainactapplyname')">
                <el-table-column show-overflow-tooltip :prop="'trmtrainactapplyname'" :label="$t('entities.trmtrainactapply.main_grid.columns.trmtrainactapplyname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtrainactapply.main_grid.columns.trmtrainactapplyname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('ormorgsectorname')">
                <el-table-column show-overflow-tooltip :prop="'ormorgsectorname'" :label="$t('entities.trmtrainactapply.main_grid.columns.ormorgsectorname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtrainactapply.main_grid.columns.ormorgsectorname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('pxnr')">
                <el-table-column show-overflow-tooltip :prop="'pxnr'" :label="$t('entities.trmtrainactapply.main_grid.columns.pxnr')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtrainactapply.main_grid.columns.pxnr')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.pxnr}}</span>
            ...
            <template v-if="getColumnState('pxmb')">
                <el-table-column show-overflow-tooltip :prop="'pxmb'" :label="$t('entities.trmtrainactapply.main_grid.columns.pxmb')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtrainactapply.main_grid.columns.pxmb')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.pxmb}}</span>
            ...
            <template v-if="getColumnState('pxlb')">
                <el-table-column show-overflow-tooltip :prop="'pxlb'" :label="$t('entities.trmtrainactapply.main_grid.columns.pxlb')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtrainactapply.main_grid.columns.pxlb')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.pxlb}}</span>
            ...
            <template v-if="getColumnState('pxfs')">
                <el-table-column show-overflow-tooltip :prop="'pxfs'" :label="$t('entities.trmtrainactapply.main_grid.columns.pxfs')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtrainactapply.main_grid.columns.pxfs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.pxfs}}</span>
            ...
            <template v-if="getColumnState('jhpxrs')">
                <el-table-column show-overflow-tooltip :prop="'jhpxrs'" :label="$t('entities.trmtrainactapply.main_grid.columns.jhpxrs')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtrainactapply.main_grid.columns.jhpxrs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.jhpxrs}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('sjpxrs')">
                <el-table-column show-overflow-tooltip :prop="'sjpxrs'" :label="$t('entities.trmtrainactapply.main_grid.columns.sjpxrs')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtrainactapply.main_grid.columns.sjpxrs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.sjpxrs}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('pxnd')">
                <el-table-column show-overflow-tooltip :prop="'pxnd'" :label="$t('entities.trmtrainactapply.main_grid.columns.pxnd')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtrainactapply.main_grid.columns.pxnd')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.pxnd" tag='EhrCodeList0115' codelistType='STATIC' renderMode="STR" valueSeparator=";" textSeparator="、" ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('pxjd')">
                <el-table-column show-overflow-tooltip :prop="'pxjd'" :label="$t('entities.trmtrainactapply.main_grid.columns.pxjd')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtrainactapply.main_grid.columns.pxjd')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.pxjd" tag='CodeList83' codelistType='STATIC' ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('pxyf')">
                <el-table-column show-overflow-tooltip :prop="'pxyf'" :label="$t('entities.trmtrainactapply.main_grid.columns.pxyf')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtrainactapply.main_grid.columns.pxyf')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.pxyf" tag='CodeList82' codelistType='STATIC' renderMode="STR" valueSeparator=";" textSeparator="、" ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'pxhdbm',
            label: '培训活动编码',
            langtag: 'entities.trmtrainactapply.main_grid.columns.pxhdbm',
            show: true,
            util: 'px'
        },
        {
            ...
            label: '培训活动名称',
            langtag: 'entities.trmtrainactapply.main_grid.columns.trmtrainactapplyname',
            show: true,
            util: 'PX'
        },
        {
            ...
            label: '培训部门',
            langtag: 'entities.trmtrainactapply.main_grid.columns.ormorgsectorname',
            show: true,
            util: 'PX'
        },
        {
            name: 'pxnr',
            label: '培训内容',
            langtag: 'entities.trmtrainactapply.main_grid.columns.pxnr',
            show: true,
            util: 'px'
        },
        {
            name: 'pxmb',
            label: '培训目标',
            langtag: 'entities.trmtrainactapply.main_grid.columns.pxmb',
            show: true,
            util: 'px'
        },
        {
            name: 'pxlb',
            label: '培训类别',
            langtag: 'entities.trmtrainactapply.main_grid.columns.pxlb',
            show: true,
            util: 'px'
        },
        {
            name: 'pxfs',
            label: '培训方式',
            langtag: 'entities.trmtrainactapply.main_grid.columns.pxfs',
            show: true,
            util: 'px'
        },
        {
            name: 'jhpxrs',
            label: '计划培训人数',
            langtag: 'entities.trmtrainactapply.main_grid.columns.jhpxrs',
            show: true,
            util: 'px'
        },
        {
            name: 'sjpxrs',
            label: '实际培训人数',
            langtag: 'entities.trmtrainactapply.main_grid.columns.sjpxrs',
            show: true,
            util: 'px'
        },
        {
            name: 'pxnd',
            label: '培训年度',
            langtag: 'entities.trmtrainactapply.main_grid.columns.pxnd',
            show: true,
            util: 'px'
        },
        {
            name: 'pxjd',
            label: '培训季度',
            langtag: 'entities.trmtrainactapply.main_grid.columns.pxjd',
            show: true,
            util: 'px'
        },
        {
            name: 'pxyf',
            label: '培训月份',
            langtag: 'entities.trmtrainactapply.main_grid.columns.pxyf',
            show: true,
            util: 'px'
        },
    ]
    ...
    public rules: any = {
        srfkey: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '培训活动申请标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '培训活动申请标识 值不能为空', trigger: 'blur' },
        ],
    }
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'TrmTrainActapplyPickupGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'TrmTrainActapplyPickupGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        _datas.forEach((record: any, index: number) => {
            let srfmajortext = record.trmtrainactapplyname;
            if (index < 5) {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ trmtrainactapply: _keys }),Object.assign({ trmtrainactapply: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.trmtrainactapply,$event.trmtrainactapply);
        });
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('trmtrainactapply_main_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('trmtrainactapply_main_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'TrmTrainActapplyPickupGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'TrmTrainActapplyPickupGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.trmtrainactapply){
                            Object.assign(this.context,{trmtrainactapply:item.trmtrainactapply});
                        }
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'TrmTrainActapplyPickupGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
    ...
    public getRowClassName(args:{row: any,rowIndex: number}){
        let isSelected = this.selections.some((item:any)=>{
            return Object.is(item.trmtrainactapply,args.row.trmtrainactapply);
        });
