    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('trmtraincoursename')">
                <el-table-column show-overflow-tooltip :prop="'trmtraincoursename'" :label="$t('entities.trmtraincourse.main_grid.columns.trmtraincoursename')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtraincourse.main_grid.columns.trmtraincoursename')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('trmcoursesystemname')">
                <el-table-column show-overflow-tooltip :prop="'trmcoursesystemname'" :label="$t('entities.trmtraincourse.main_grid.columns.trmcoursesystemname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtraincourse.main_grid.columns.trmcoursesystemname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.trmcoursesystemname}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('jb')">
                <el-table-column show-overflow-tooltip :prop="'jb'" :label="$t('entities.trmtraincourse.main_grid.columns.jb')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtraincourse.main_grid.columns.jb')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.jb}}</span>
            ...
            <template v-if="getColumnState('bb')">
                <el-table-column show-overflow-tooltip :prop="'bb'" :label="$t('entities.trmtraincourse.main_grid.columns.bb')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtraincourse.main_grid.columns.bb')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.bb}}</span>
            ...
            <template v-if="getColumnState('kcxs')">
                <el-table-column show-overflow-tooltip :prop="'kcxs'" :label="$t('entities.trmtraincourse.main_grid.columns.kcxs')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtraincourse.main_grid.columns.kcxs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                            <app-format-data dataType="FLOAT" precision="0" :data="row.kcxs"></app-format-data>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('nr')">
                <el-table-column show-overflow-tooltip :prop="'nr'" :label="$t('entities.trmtraincourse.main_grid.columns.nr')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtraincourse.main_grid.columns.nr')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.nr}}</span>
            ...
            <template v-if="getColumnState('pxmb')">
                <el-table-column show-overflow-tooltip :prop="'pxmb'" :label="$t('entities.trmtraincourse.main_grid.columns.pxmb')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtraincourse.main_grid.columns.pxmb')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.pxmb}}</span>
            ...
            <template v-if="getColumnState('sfgx')">
                <el-table-column show-overflow-tooltip :prop="'sfgx'" :label="$t('entities.trmtraincourse.main_grid.columns.sfgx')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmtraincourse.main_grid.columns.sfgx')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    */
    ...
    public allColumns: any[] = [
        {
            ...
            label: '课程名称',
            langtag: 'entities.trmtraincourse.main_grid.columns.trmtraincoursename',
            show: true,
            util: 'PX'
        },
        {
            ...
            label: '培训模块',
            langtag: 'entities.trmtraincourse.main_grid.columns.trmcoursesystemname',
            show: true,
            util: 'px'
        },
        {
            name: 'jb',
            label: '级别',
            langtag: 'entities.trmtraincourse.main_grid.columns.jb',
            show: true,
            util: 'px'
        },
        {
            name: 'bb',
            label: '版本',
            langtag: 'entities.trmtraincourse.main_grid.columns.bb',
            show: true,
            util: 'px'
        },
        {
            name: 'kcxs',
            label: '累积学时',
            langtag: 'entities.trmtraincourse.main_grid.columns.kcxs',
            show: true,
            util: 'PX'
        },
        {
            name: 'nr',
            label: '培训内容',
            langtag: 'entities.trmtraincourse.main_grid.columns.nr',
            show: true,
            util: 'px'
        },
        {
            name: 'pxmb',
            label: '培训目标',
            langtag: 'entities.trmtraincourse.main_grid.columns.pxmb',
            show: true,
            util: 'px'
        },
        {
            name: 'sfgx',
            label: '是否共享',
            langtag: 'entities.trmtraincourse.main_grid.columns.sfgx',
            show: true,
            util: 'px'
        },
    ]
    ...
    public rules: any = {
        srfkey: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '培训课程标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '培训课程标识 值不能为空', trigger: 'blur' },
        ],
    }
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'TrmTrainCourseGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'TrmTrainCourseGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        _datas.forEach((record: any, index: number) => {
            let srfmajortext = record.trmtraincoursename;
            if (index < 5) {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ trmtraincourse: _keys }),Object.assign({ trmtraincourse: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.trmtraincourse,$event.trmtraincourse);
        });
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('trmtraincourse_main_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('trmtraincourse_main_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'TrmTrainCourseGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'TrmTrainCourseGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.trmtraincourse){
                            Object.assign(this.context,{trmtraincourse:item.trmtraincourse});
                        }
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'TrmTrainCourseGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
    ...
    public getRowClassName(args:{row: any,rowIndex: number}){
        let isSelected = this.selections.some((item:any)=>{
            return Object.is(item.trmtraincourse,args.row.trmtraincourse);
        });
