    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('pxkssj')">
                <el-table-column show-overflow-tooltip :prop="'pxkssj'" :label="$t('entities.trmteachertrain.main_grid.columns.pxkssj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmteachertrain.main_grid.columns.pxkssj')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('pxjssj')">
                <el-table-column show-overflow-tooltip :prop="'pxjssj'" :label="$t('entities.trmteachertrain.main_grid.columns.pxjssj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmteachertrain.main_grid.columns.pxjssj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('trmtrainplantermname')">
                <el-table-column show-overflow-tooltip :prop="'trmtrainplantermname'" :label="$t('entities.trmteachertrain.main_grid.columns.trmtrainplantermname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmteachertrain.main_grid.columns.trmtrainplantermname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('trmtraincoursename')">
                <el-table-column show-overflow-tooltip :prop="'trmtraincoursename'" :label="$t('entities.trmteachertrain.main_grid.columns.trmtraincoursename')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmteachertrain.main_grid.columns.trmtraincoursename')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('pxsc')">
                <el-table-column show-overflow-tooltip :prop="'pxsc'" :label="$t('entities.trmteachertrain.main_grid.columns.pxsc')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmteachertrain.main_grid.columns.pxsc')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.pxsc}}</span>
            ...
            <template v-if="getColumnState('trmtrainaddressname')">
                <el-table-column show-overflow-tooltip :prop="'trmtrainaddressname'" :label="$t('entities.trmteachertrain.main_grid.columns.trmtrainaddressname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmteachertrain.main_grid.columns.trmtrainaddressname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('jf')">
                <el-table-column show-overflow-tooltip :prop="'jf'" :label="$t('entities.trmteachertrain.main_grid.columns.jf')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmteachertrain.main_grid.columns.jf')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                            <app-format-data dataType="FLOAT" precision="0" :data="row.jf"></app-format-data>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('pj')">
                <el-table-column show-overflow-tooltip :prop="'pj'" :label="$t('entities.trmteachertrain.main_grid.columns.pj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.trmteachertrain.main_grid.columns.pj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.pj}}</span>
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'pxkssj',
            label: '授课开始时间',
            langtag: 'entities.trmteachertrain.main_grid.columns.pxkssj',
            show: true,
            util: 'px'
        },
        {
            name: 'pxjssj',
            label: '授课结束时间',
            langtag: 'entities.trmteachertrain.main_grid.columns.pxjssj',
            show: true,
            util: 'px'
        },
        {
            ...
            label: '授课班级',
            langtag: 'entities.trmteachertrain.main_grid.columns.trmtrainplantermname',
            show: true,
            util: 'px'
        },
        {
            ...
            label: '授课课程',
            langtag: 'entities.trmteachertrain.main_grid.columns.trmtraincoursename',
            show: true,
            util: 'px'
        },
        {
            name: 'pxsc',
            label: '授课时长',
            langtag: 'entities.trmteachertrain.main_grid.columns.pxsc',
            show: true,
            util: 'px'
        },
        {
            ...
            label: '授课地点',
            langtag: 'entities.trmteachertrain.main_grid.columns.trmtrainaddressname',
            show: true,
            util: 'px'
        },
        {
            name: 'jf',
            label: '积分',
            langtag: 'entities.trmteachertrain.main_grid.columns.jf',
            show: true,
            util: 'px'
        },
        {
            name: 'pj',
            label: '评价',
            langtag: 'entities.trmteachertrain.main_grid.columns.pj',
            show: true,
            util: 'px'
        },
    ]
    ...
    public rules: any = {
        srfkey: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '讲师授课记录标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '讲师授课记录标识 值不能为空', trigger: 'blur' },
        ],
    }
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'TrmTeacherTrainGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'TrmTeacherTrainGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        _datas.forEach((record: any, index: number) => {
            let srfmajortext = record.trmteachertrainname;
            if (index < 5) {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ trmteachertrain: _keys }),Object.assign({ trmteachertrain: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.trmteachertrain,$event.trmteachertrain);
        });
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('trmteachertrain_main_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('trmteachertrain_main_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'TrmTeacherTrainGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'TrmTeacherTrainGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.trmteachertrain){
                            Object.assign(this.context,{trmteachertrain:item.trmteachertrain});
                        }
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'TrmTeacherTrainGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
    ...
    public getRowClassName(args:{row: any,rowIndex: number}){
        let isSelected = this.selections.some((item:any)=>{
            return Object.is(item.trmteachertrain,args.row.trmteachertrain);
        });
