<template>
  <app-layout viewName="trmteachertraineditview" viewTitle="讲师授课记录编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'trm-teacher-train-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class TrmTeacherTrainEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class TrmTeacherTrainEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {TrmTeacherTrainService}
     * @memberof TrmTeacherTrainEditViewBase
     */
    public appEntityService: TrmTeacherTrainService = new TrmTeacherTrainService;
	 ...
	 * @memberof TrmTeacherTrainEditViewBase
	 */
	public viewtag: string = '7baa86a07ab62567f156a016800616ac';
     ...
     */
    public model: any = {
        srfCaption: 'entities.trmteachertrain.views.editview.caption',
        srfTitle: 'entities.trmteachertrain.views.editview.title',
        srfSubTitle: 'entities.trmteachertrain.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof TrmTeacherTrainEditView
     */
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'trmteachertrain',
            majorPSDEField: 'trmteachertrainname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"TrmTeacherTrain");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"TrmTeacherTrain");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"TrmTeacherTrain");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"TrmTeacherTrain");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"TrmTeacherTrain");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"TrmTeacherTrain");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"TrmTeacherTrain");
    }
...
<style lang='less'>
@import './trm-teacher-train-edit-view.less';
</style>