<template>
  <app-layout viewName="trmcoursesystemmpickupview" viewTitle="课程体系数据多项选择视图" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'dempickupview': true, 'trm-course-system-mpickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class TrmCourseSystemMPickupViewBase
 * @extends {MPickupViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class TrmCourseSystemMPickupViewBase extends MPickupViewBase {

    /**
     * 实体服务对象
     *
     * @type {TrmCourseSystemService}
     * @memberof TrmCourseSystemMPickupViewBase
     */
	 ...
	 * @memberof TrmCourseSystemMPickupViewBase
	 */
	public viewtag: string = 'e034c6c5752a1ed214cf88a568d623fa';
     ...
     */
    public model: any = {
        srfCaption: 'entities.trmcoursesystem.views.mpickupview.caption',
        srfTitle: 'entities.trmcoursesystem.views.mpickupview.title',
        srfSubTitle: 'entities.trmcoursesystem.views.mpickupview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {any[]}
     * @memberof TrmCourseSystemMPickupView
     */
        ...
        Object.values(this.containerModel).forEach((model: any) => {
            ...
            if(model.datas.length>0){
                model.datas.forEach((data:any,index:any)=>{
                    Object.assign(data,{srfmajortext: data['trmcoursesystemname']});
                })
            }
...
<style lang='less'>
@import './trm-course-system-mpickup-view.less';
</style>