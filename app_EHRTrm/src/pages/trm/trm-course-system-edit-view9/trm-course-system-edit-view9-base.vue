<template>
  <app-layout viewName="trmcoursesystemeditview9" viewTitle="培训模块" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview9': true, 'trm-course-system-edit-view9': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
import TrmCourseSystemUIService from '@/uiservice/trm-course-system/trm-course-system-ui-service';

/**
 * 培训模块基类
 *
 * @export
 * @class TrmCourseSystemEditView9Base
 * @extends {EditView9Base}
 */
@Component({})
@VueLifeCycleProcessing
export default class TrmCourseSystemEditView9Base extends EditView9Base {

    /**
     * 实体服务对象
     *
     * @type {TrmCourseSystemService}
     * @memberof TrmCourseSystemEditView9Base
     */
	 ...
	 * @memberof TrmCourseSystemEditView9Base
	 */
	public viewtag: string = '878c6aa215b91f624102716b96aa8a7d';
     ...
     */
    public model: any = {
        srfCaption: 'entities.trmcoursesystem.views.editview9.caption',
        srfTitle: 'entities.trmcoursesystem.views.editview9.title',
        srfSubTitle: 'entities.trmcoursesystem.views.editview9.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof TrmCourseSystemEditView9
     */
    ...
    public toolbar_tbitem1_openeditview_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        const curUIService:TrmCourseSystemUIService  = new TrmCourseSystemUIService();
        curUIService.TrmCourseSystem_OpenEditView(datas,contextJO, paramJO,  $event, xData,this,"TrmCourseSystem");
    }
...
<style lang='less'>
@import './trm-course-system-edit-view9.less';
</style>