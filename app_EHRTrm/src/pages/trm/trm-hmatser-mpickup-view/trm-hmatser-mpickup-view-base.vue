<template>
  <app-layout viewName="trmhmatsermpickupview" viewTitle="班主任数据多项选择视图" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'dempickupview': true, 'trm-hmatser-mpickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class TrmHmatserMPickupViewBase
 * @extends {MPickupViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class TrmHmatserMPickupViewBase extends MPickupViewBase {
	 ...
	 * @memberof TrmHmatserMPickupViewBase
	 */
	public viewtag: string = 'e0da8d83313b44899a3f9dde3b909571';
     ...
     */
    public model: any = {
        srfCaption: 'entities.trmhmatser.views.mpickupview.caption',
        srfTitle: 'entities.trmhmatser.views.mpickupview.title',
        srfSubTitle: 'entities.trmhmatser.views.mpickupview.subtitle',
        dataInfo: ''
    }
        ...
        Object.values(this.containerModel).forEach((model: any) => {
            ...
            if(model.datas.length>0){
                model.datas.forEach((data:any,index:any)=>{
                    Object.assign(data,{srfmajortext: data['trmhmatsername']});
                })
            }
...
<style lang='less'>
@import './trm-hmatser-mpickup-view.less';
</style>