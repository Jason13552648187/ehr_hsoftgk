...
export default class TrmDemdeftionPickupViewBase extends PickupViewBase {
	 ...
	 * @memberof TrmDemdeftionPickupViewBase
	 */
	public viewtag: string = '36ab48e3ff0b61d2c676d8b76dfca9d5';
     ...
     */
    public model: any = {
        srfCaption: 'entities.trmdemdeftion.views.pickupview.caption',
        srfTitle: 'entities.trmdemdeftion.views.pickupview.title',
        srfSubTitle: 'entities.trmdemdeftion.views.pickupview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './trm-demdeftion-pickup-view.less';
</style>