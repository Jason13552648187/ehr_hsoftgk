<template>
  <app-layout viewName="trmhmatsereditview" viewTitle="班主任编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'trm-hmatser-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class TrmHmatserEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class TrmHmatserEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {TrmHmatserService}
     * @memberof TrmHmatserEditViewBase
     */
    public appEntityService: TrmHmatserService = new TrmHmatserService;
	 ...
	 * @memberof TrmHmatserEditViewBase
	 */
	public viewtag: string = '5f5d8eb214a4b5f0007d6b3c7cfd62c7';
     ...
     */
    public model: any = {
        srfCaption: 'entities.trmhmatser.views.editview.caption',
        srfTitle: 'entities.trmhmatser.views.editview.title',
        srfSubTitle: 'entities.trmhmatser.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'trmhmatser',
            majorPSDEField: 'trmhmatsername',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"TrmHmatser");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"TrmHmatser");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"TrmHmatser");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"TrmHmatser");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"TrmHmatser");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"TrmHmatser");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"TrmHmatser");
    }
...
<style lang='less'>
@import './trm-hmatser-edit-view.less';
</style>