<template>
  <app-layout viewName="trmtrainaddressmpickupview" viewTitle="培训地点数据多项选择视图" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'dempickupview': true, 'trm-train-address-mpickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class TrmTrainAddressMPickupViewBase
 * @extends {MPickupViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class TrmTrainAddressMPickupViewBase extends MPickupViewBase {

    /**
     * 实体服务对象
     *
     * @type {TrmTrainAddressService}
     * @memberof TrmTrainAddressMPickupViewBase
     */
	 ...
	 * @memberof TrmTrainAddressMPickupViewBase
	 */
	public viewtag: string = 'b932b6f17be101715d4183be2f9e3ba6';
     ...
     */
    public model: any = {
        srfCaption: 'entities.trmtrainaddress.views.mpickupview.caption',
        srfTitle: 'entities.trmtrainaddress.views.mpickupview.title',
        srfSubTitle: 'entities.trmtrainaddress.views.mpickupview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {any[]}
     * @memberof TrmTrainAddressMPickupView
     */
        ...
        Object.values(this.containerModel).forEach((model: any) => {
            ...
            if(model.datas.length>0){
                model.datas.forEach((data:any,index:any)=>{
                    Object.assign(data,{srfmajortext: data['trmtrainaddressname']});
                })
            }
...
<style lang='less'>
@import './trm-train-address-mpickup-view.less';
</style>