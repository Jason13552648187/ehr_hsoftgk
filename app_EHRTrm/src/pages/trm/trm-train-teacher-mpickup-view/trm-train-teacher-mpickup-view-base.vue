<template>
  <app-layout viewName="trmtrainteachermpickupview" viewTitle="培训教师数据多项选择视图" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'dempickupview': true, 'trm-train-teacher-mpickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class TrmTrainTeacherMPickupViewBase
 * @extends {MPickupViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class TrmTrainTeacherMPickupViewBase extends MPickupViewBase {

    /**
     * 实体服务对象
     *
     * @type {TrmTrainTeacherService}
     * @memberof TrmTrainTeacherMPickupViewBase
     */
	 ...
	 * @memberof TrmTrainTeacherMPickupViewBase
	 */
	public viewtag: string = '277a884d8a8623a9f90077ad885b6d0c';
     ...
     */
    public model: any = {
        srfCaption: 'entities.trmtrainteacher.views.mpickupview.caption',
        srfTitle: 'entities.trmtrainteacher.views.mpickupview.title',
        srfSubTitle: 'entities.trmtrainteacher.views.mpickupview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {any[]}
     * @memberof TrmTrainTeacherMPickupView
     */
        ...
        Object.values(this.containerModel).forEach((model: any) => {
            ...
            if(model.datas.length>0){
                model.datas.forEach((data:any,index:any)=>{
                    Object.assign(data,{srfmajortext: data['trmtrainteachername']});
                })
            }
...
<style lang='less'>
@import './trm-train-teacher-mpickup-view.less';
</style>