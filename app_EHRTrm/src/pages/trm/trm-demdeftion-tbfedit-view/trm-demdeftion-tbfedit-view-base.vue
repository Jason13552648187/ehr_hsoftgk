<template>
  <app-layout viewName="trmdemdeftiontbfeditview" viewTitle="培训需求填报明细" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'trm-demdeftion-tbfedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class TrmDemdeftionTBFEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class TrmDemdeftionTBFEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {TrmDemdeftionService}
     * @memberof TrmDemdeftionTBFEditViewBase
     */
    public appEntityService: TrmDemdeftionService = new TrmDemdeftionService;
	 ...
	 * @memberof TrmDemdeftionTBFEditViewBase
	 */
	public viewtag: string = '1f036d542e902abffd5a936897c22562';
     ...
     */
    public model: any = {
        srfCaption: 'entities.trmdemdeftion.views.tbfeditview.caption',
        srfTitle: 'entities.trmdemdeftion.views.tbfeditview.title',
        srfSubTitle: 'entities.trmdemdeftion.views.tbfeditview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof TrmDemdeftionTBFEditView
     */
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"TrmDemdeftion");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"TrmDemdeftion");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"TrmDemdeftion");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"TrmDemdeftion");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"TrmDemdeftion");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"TrmDemdeftion");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"TrmDemdeftion");
    }
...
<style lang='less'>
@import './trm-demdeftion-tbfedit-view.less';
</style>