<template>
  <app-layout viewName="trmdeparteditview" viewTitle="需求通知" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'trm-depart-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class TrmDepartEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class TrmDepartEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {TrmDepartService}
     * @memberof TrmDepartEditViewBase
     */
	 ...
	 * @memberof TrmDepartEditViewBase
	 */
	public viewtag: string = '886c4bcfa01e0ddccae03a6d05de3443';
     ...
     */
    public model: any = {
        srfCaption: 'entities.trmdepart.views.editview.caption',
        srfTitle: 'entities.trmdepart.views.editview.title',
        srfSubTitle: 'entities.trmdepart.views.editview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './trm-depart-edit-view.less';
</style>