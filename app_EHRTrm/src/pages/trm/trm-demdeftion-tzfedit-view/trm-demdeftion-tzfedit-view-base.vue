...
export default class TrmDemdeftionTZFEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {TrmDemdeftionService}
     * @memberof TrmDemdeftionTZFEditViewBase
     */
	 ...
	 * @memberof TrmDemdeftionTZFEditViewBase
	 */
	public viewtag: string = 'e0151a24626d40ca84af6810b41bdd53';
     ...
     */
    public model: any = {
        srfCaption: 'entities.trmdemdeftion.views.tzfeditview.caption',
        srfTitle: 'entities.trmdemdeftion.views.tzfeditview.title',
        srfSubTitle: 'entities.trmdemdeftion.views.tzfeditview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof TrmDemdeftionTZFEditView
     */
...
<style lang='less'>
@import './trm-demdeftion-tzfedit-view.less';
</style>