<template>
  <app-layout viewName="trmtrainpersoneditview" viewTitle="培训人员编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'trm-train-person-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class TrmTrainPersonEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class TrmTrainPersonEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {TrmTrainPersonService}
     * @memberof TrmTrainPersonEditViewBase
     */
	 ...
	 * @memberof TrmTrainPersonEditViewBase
	 */
	public viewtag: string = '1fbe5d102b5d0982c2f4d0cdb3947b60';
     ...
     */
    public model: any = {
        srfCaption: 'entities.trmtrainperson.views.editview.caption',
        srfTitle: 'entities.trmtrainperson.views.editview.title',
        srfSubTitle: 'entities.trmtrainperson.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof TrmTrainPersonEditView
     */
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"TrmTrainPerson");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"TrmTrainPerson");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"TrmTrainPerson");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"TrmTrainPerson");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"TrmTrainPerson");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"TrmTrainPerson");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"TrmTrainPerson");
    }
...
<style lang='less'>
@import './trm-train-person-edit-view.less';
</style>