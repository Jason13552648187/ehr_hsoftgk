<template>
  <app-layout viewName="attendancerecordeditview" viewTitle="考勤记录编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'att-endance-record-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class AttEndanceRecordEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class AttEndanceRecordEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {AttEndanceRecordService}
     * @memberof AttEndanceRecordEditViewBase
     */
    public appEntityService: AttEndanceRecordService = new AttEndanceRecordService;
	 ...
	 * @memberof AttEndanceRecordEditViewBase
	 */
	public viewtag: string = '3e14b1a02b1fc2d309850243aa162a92';
     ...
     */
    public model: any = {
        srfCaption: 'entities.attendancerecord.views.editview.caption',
        srfTitle: 'entities.attendancerecord.views.editview.title',
        srfSubTitle: 'entities.attendancerecord.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof AttEndanceRecordEditView
     */
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'attendancerecord',
            majorPSDEField: 'attendancerecordname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"AttEndanceRecord");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"AttEndanceRecord");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"AttEndanceRecord");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"AttEndanceRecord");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"AttEndanceRecord");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"AttEndanceRecord");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"AttEndanceRecord");
    }
...
<style lang='less'>
@import './att-endance-record-edit-view.less';
</style>