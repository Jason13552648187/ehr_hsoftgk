<template>
  <app-layout viewName="ormorgeditview" viewTitle="组织信息" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'orm-org-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
export default class OrmOrgEditViewBase extends EditViewBase {
	 ...
	 * @memberof OrmOrgEditViewBase
	 */
	public viewtag: string = '807df9111b4aa66645b149cbebbf33bc';
