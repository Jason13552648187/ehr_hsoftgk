<template>
  <app-layout viewName="ormorgsectormpickupview" viewTitle="部门管理数据多项选择视图" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'dempickupview': true, 'orm-orgsector-mpickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
export default class OrmOrgsectorMPickupViewBase extends MPickupViewBase {
	 ...
	 * @memberof OrmOrgsectorMPickupViewBase
	 */
	public viewtag: string = 'c41d2861ba450b7fcd675bcd0ba8e46f';
...
<style lang='less'>
@import './orm-orgsector-mpickup-view.less';
</style>