<template>
  <app-layout viewName="pcmworkresumeeditview" viewTitle="工作履历" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcmworkresumeedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PCMWORKRESUMEEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMWORKRESUMEEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmWorkResumeService}
     * @memberof PCMWORKRESUMEEditViewBase
     */
	 ...
	 * @memberof PCMWORKRESUMEEditViewBase
	 */
	public viewtag: string = 'eca902f7ff75f15ff107b7f7c49f13ab';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmworkresume.views.editview.caption',
        srfTitle: 'entities.pcmworkresume.views.editview.title',
        srfSubTitle: 'entities.pcmworkresume.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PCMWORKRESUMEEditView
     */
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"PcmWorkResume");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"PcmWorkResume");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PcmWorkResume");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PcmWorkResume");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"PcmWorkResume");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"PcmWorkResume");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"PcmWorkResume");
    }
...
<style lang='less'>
@import './pcmworkresumeedit-view.less';
</style>