<template>
  <app-layout viewName="pcmcertofregeditview" viewTitle="注册证书编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcmcertofregedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PCMCERTOFREGEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMCERTOFREGEditViewBase extends EditViewBase {
	 ...
	 * @memberof PCMCERTOFREGEditViewBase
	 */
	public viewtag: string = '61ab26467e764252135370d1e6451aed';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmcertofreg.views.editview.caption',
        srfTitle: 'entities.pcmcertofreg.views.editview.title',
        srfSubTitle: 'entities.pcmcertofreg.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'pcmcertofreg',
            majorPSDEField: 'pcmcertofregname',
            isLoadDefault: true,
        });
    }
...
<style lang='less'>
@import './pcmcertofregedit-view.less';
</style>