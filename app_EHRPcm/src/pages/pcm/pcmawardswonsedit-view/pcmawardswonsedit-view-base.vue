<template>
  <app-layout viewName="pcmawardswonseditview" viewTitle="获奖情况" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcmawardswonsedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PCMAWARDSWONSEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMAWARDSWONSEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmAwardsWonsService}
     * @memberof PCMAWARDSWONSEditViewBase
     */
	 ...
	 * @memberof PCMAWARDSWONSEditViewBase
	 */
	public viewtag: string = 'd29ed45e3397bfcda1f4763b9b3e8686';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmawardswons.views.editview.caption',
        srfTitle: 'entities.pcmawardswons.views.editview.title',
        srfSubTitle: 'entities.pcmawardswons.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PCMAWARDSWONSEditView
     */
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'pcmawardswons',
            majorPSDEField: 'pcmawardswonsname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"PcmAwardsWons");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"PcmAwardsWons");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PcmAwardsWons");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PcmAwardsWons");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"PcmAwardsWons");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"PcmAwardsWons");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"PcmAwardsWons");
    }
...
<style lang='less'>
@import './pcmawardswonsedit-view.less';
</style>