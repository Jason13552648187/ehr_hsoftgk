<template>
  <app-layout viewName="pcmprofileypzxx_lreditview" viewTitle="应聘者信息" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcmprofileypzxx-lredit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PCMPROFILEYPZXX_LREditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMPROFILEYPZXX_LREditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmProfileService}
     * @memberof PCMPROFILEYPZXX_LREditViewBase
     */
	 ...
	 * @memberof PCMPROFILEYPZXX_LREditViewBase
	 */
	public viewtag: string = '992ecee21f22b4daf3ecaf7ad516c1e3';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmprofile.views.ypzxx_lreditview.caption',
        srfTitle: 'entities.pcmprofile.views.ypzxx_lreditview.title',
        srfSubTitle: 'entities.pcmprofile.views.ypzxx_lreditview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PCMPROFILEYPZXX_LREditView
     */
...
<style lang='less'>
@import './pcmprofileypzxx-lredit-view.less';
</style>