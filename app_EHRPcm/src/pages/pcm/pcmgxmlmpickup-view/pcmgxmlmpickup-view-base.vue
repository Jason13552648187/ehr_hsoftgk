<template>
  <app-layout viewName="pcmgxmlmpickupview" viewTitle="高校名录数据多项选择视图" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'dempickupview': true, 'pcmgxmlmpickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PCMGXMLMPickupViewBase
 * @extends {MPickupViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMGXMLMPickupViewBase extends MPickupViewBase {
	 ...
	 * @memberof PCMGXMLMPickupViewBase
	 */
	public viewtag: string = 'fd4aa1f72c775c6e42df2c41c6d5f6f6';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmgxml.views.mpickupview.caption',
        srfTitle: 'entities.pcmgxml.views.mpickupview.title',
        srfSubTitle: 'entities.pcmgxml.views.mpickupview.subtitle',
        dataInfo: ''
    }
        ...
        Object.values(this.containerModel).forEach((model: any) => {
            ...
            if(model.datas.length>0){
                model.datas.forEach((data:any,index:any)=>{
                    Object.assign(data,{srfmajortext: data['pcmgxmlname']});
                })
            }
...
<style lang='less'>
@import './pcmgxmlmpickup-view.less';
</style>