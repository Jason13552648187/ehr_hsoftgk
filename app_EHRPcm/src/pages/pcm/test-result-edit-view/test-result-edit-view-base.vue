<template>
  <app-layout viewName="testresulteditview" viewTitle="测评结果摘要信息" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'test-result-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class TestResultEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class TestResultEditViewBase extends EditViewBase {
	 ...
	 * @memberof TestResultEditViewBase
	 */
	public viewtag: string = '642e7abba6964fca1715f07242cc34b1';
...
<style lang='less'>
@import './test-result-edit-view.less';
</style>