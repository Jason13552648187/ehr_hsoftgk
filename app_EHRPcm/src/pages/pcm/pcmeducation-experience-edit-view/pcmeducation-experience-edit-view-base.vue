<template>
  <app-layout viewName="pcmeducationexperienceeditview" viewTitle="教育背景" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcmeducation-experience-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PCMEducationExperienceEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMEducationExperienceEditViewBase extends EditViewBase {
	 ...
	 * @memberof PCMEducationExperienceEditViewBase
	 */
	public viewtag: string = '19cce11f58776909dbd6caa9a9fd3946';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmeducationexperience.views.editview.caption',
        srfTitle: 'entities.pcmeducationexperience.views.editview.title',
        srfSubTitle: 'entities.pcmeducationexperience.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PCMEducationExperienceEditView
     */
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'pcmeducationexperience',
            majorPSDEField: 'pcmeducationexperiencename',
            isLoadDefault: true,
        });
    }
...
<style lang='less'>
@import './pcmeducation-experience-edit-view.less';
</style>