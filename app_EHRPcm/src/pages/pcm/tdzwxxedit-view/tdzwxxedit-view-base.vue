<template>
  <app-layout viewName="tdzwxxeditview" viewTitle="投递职位摘要信息" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'tdzwxxedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class TDZWXXEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class TDZWXXEditViewBase extends EditViewBase {
	 ...
	 * @memberof TDZWXXEditViewBase
	 */
	public viewtag: string = '26f69f4ff507ad80fa6fb9a194aca149';
