<template>
  <app-layout viewName="pcmxkmlmpickupview" viewTitle="学科目录数据多项选择视图" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'dempickupview': true, 'pcmxkmlmpickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PCMXKMLMPickupViewBase
 * @extends {MPickupViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMXKMLMPickupViewBase extends MPickupViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmXkmlService}
     * @memberof PCMXKMLMPickupViewBase
     */
	 ...
	 * @memberof PCMXKMLMPickupViewBase
	 */
	public viewtag: string = 'e8ecbd69de09c2f47066ca1d9eb04d71';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmxkml.views.mpickupview.caption',
        srfTitle: 'entities.pcmxkml.views.mpickupview.title',
        srfSubTitle: 'entities.pcmxkml.views.mpickupview.subtitle',
        dataInfo: ''
    }
        ...
        Object.values(this.containerModel).forEach((model: any) => {
            ...
            if(model.datas.length>0){
                model.datas.forEach((data:any,index:any)=>{
                    Object.assign(data,{srfmajortext: data['pcmxkmlname']});
                })
            }
...
<style lang='less'>
@import './pcmxkmlmpickup-view.less';
</style>