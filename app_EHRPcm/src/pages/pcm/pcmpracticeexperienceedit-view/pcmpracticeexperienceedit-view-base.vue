<template>
  <app-layout viewName="pcmpracticeexperienceeditview" viewTitle="实习经验" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcmpracticeexperienceedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PCMPRACTICEEXPERIENCEEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMPRACTICEEXPERIENCEEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmPracticeExperienceService}
     * @memberof PCMPRACTICEEXPERIENCEEditViewBase
     */
	 ...
	 * @memberof PCMPRACTICEEXPERIENCEEditViewBase
	 */
	public viewtag: string = '47328693892b4aabde90acf085237c98';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmpracticeexperience.views.editview.caption',
        srfTitle: 'entities.pcmpracticeexperience.views.editview.title',
        srfSubTitle: 'entities.pcmpracticeexperience.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PCMPRACTICEEXPERIENCEEditView
     */
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"PcmPracticeExperience");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"PcmPracticeExperience");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PcmPracticeExperience");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PcmPracticeExperience");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"PcmPracticeExperience");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"PcmPracticeExperience");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"PcmPracticeExperience");
    }
...
<style lang='less'>
@import './pcmpracticeexperienceedit-view.less';
</style>