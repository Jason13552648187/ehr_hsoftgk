<template>
  <app-layout viewName="pcmprofilespyyeditview" viewTitle="应聘者审批原因编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcmprofilespyyedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PCMPROFILESPYYEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMPROFILESPYYEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmProfileSpyyService}
     * @memberof PCMPROFILESPYYEditViewBase
     */
	 ...
	 * @memberof PCMPROFILESPYYEditViewBase
	 */
	public viewtag: string = 'e8039e63e4243185036c8869e1baf911';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmprofilespyy.views.editview.caption',
        srfTitle: 'entities.pcmprofilespyy.views.editview.title',
        srfSubTitle: 'entities.pcmprofilespyy.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PCMPROFILESPYYEditView
     */
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'pcmprofilespyy',
            majorPSDEField: 'pcmprofilespyyname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"PcmProfileSpyy");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"PcmProfileSpyy");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PcmProfileSpyy");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PcmProfileSpyy");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"PcmProfileSpyy");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"PcmProfileSpyy");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"PcmProfileSpyy");
    }
...
<style lang='less'>
@import './pcmprofilespyyedit-view.less';
</style>