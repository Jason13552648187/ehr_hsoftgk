<template>
  <app-layout viewName="pcmzpmegleditview" viewTitle="招聘名额管理编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcmzpmegledit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PCMZPMEGLEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMZPMEGLEditViewBase extends EditViewBase {
	 ...
	 * @memberof PCMZPMEGLEditViewBase
	 */
	public viewtag: string = 'b372c9dfc12170a7ab4bc56e4038f4b9';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmzpmegl.views.editview.caption',
        srfTitle: 'entities.pcmzpmegl.views.editview.title',
        srfSubTitle: 'entities.pcmzpmegl.views.editview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pcmzpmegledit-view.less';
</style>