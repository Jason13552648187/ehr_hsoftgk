<template>
  <app-layout viewName="pcmgxmleditview" viewTitle="高校名录编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcmgxmledit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PCMGXMLEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMGXMLEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {PcmGxmlService}
     * @memberof PCMGXMLEditViewBase
     */
	 ...
	 * @memberof PCMGXMLEditViewBase
	 */
	public viewtag: string = 'e8cca29d9578f296af25b69b86bb4a45';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmgxml.views.editview.caption',
        srfTitle: 'entities.pcmgxml.views.editview.title',
        srfSubTitle: 'entities.pcmgxml.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"PcmGxml");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"PcmGxml");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Exit(datas, contextJO,paramJO,  $event, xData,this,"PcmGxml");
    }
