<template>
  <app-layout viewName="pcmschoolofficeeditview" viewTitle="在校职务" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'pcmschoolofficeedit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PCMSCHOOLOFFICEEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PCMSCHOOLOFFICEEditViewBase extends EditViewBase {
	 ...
	 * @memberof PCMSCHOOLOFFICEEditViewBase
	 */
	public viewtag: string = '0e0ec3aacabc80d01e9fd4d788aa8dc5';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pcmschooloffice.views.editview.caption',
        srfTitle: 'entities.pcmschooloffice.views.editview.title',
        srfSubTitle: 'entities.pcmschooloffice.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof PCMSCHOOLOFFICEEditView
     */
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'pcmschooloffice',
            majorPSDEField: 'pcmschoolofficename',
            isLoadDefault: true,
        });
    }
...
<style lang='less'>
@import './pcmschoolofficeedit-view.less';
</style>