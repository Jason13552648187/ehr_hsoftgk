<template>
  <app-layout viewName="ormorgsectorydbmpickupview" viewTitle="部门选择" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'depickupview': true, 'ormorgsectorydbmpickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
...
export default class ORMORGSECTORYDBMPickupViewBase extends PickupViewBase {
	 ...
	 * @memberof ORMORGSECTORYDBMPickupViewBase
	 */
	public viewtag: string = 'fff47154e7d5fc117b240c1141c142f4';
...
<style lang='less'>
@import './ormorgsectorydbmpickup-view.less';
</style>