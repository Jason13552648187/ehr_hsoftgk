...
<div class='grid' style="height:100%;">
    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('practicecompanyname')">
                <el-table-column show-overflow-tooltip :prop="'practicecompanyname'" :label="$t('entities.pcmpracticeexperience.main_grid.columns.practicecompanyname')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmpracticeexperience.main_grid.columns.practicecompanyname')}}
                      </span>
                    </template>
              ...
              @change="($event)=>{gridEditItemChange(row, column.property, $event, $index)}">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='practicecompanyname' editorType="TEXTBOX" :value="row.practicecompanyname"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('sxgw')">
                <el-table-column show-overflow-tooltip :prop="'sxgw'" :label="$t('entities.pcmpracticeexperience.main_grid.columns.sxgw')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmpracticeexperience.main_grid.columns.sxgw')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
              ...
              @change="($event)=>{gridEditItemChange(row, column.property, $event, $index)}">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='sxgw' editorType="TEXTBOX" :value="row.sxgw"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('starttime')">
                <el-table-column show-overflow-tooltip :prop="'starttime'" :label="$t('entities.pcmpracticeexperience.main_grid.columns.starttime')" :width="180"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmpracticeexperience.main_grid.columns.starttime')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
            ...
            <template v-if="getColumnState('endtime')">
                <el-table-column show-overflow-tooltip :prop="'endtime'" :label="$t('entities.pcmpracticeexperience.main_grid.columns.endtime')" :width="180"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmpracticeexperience.main_grid.columns.endtime')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
            ...
            <template v-if="getColumnState('practicecontent')">
                <el-table-column show-overflow-tooltip :prop="'practicecontent'" :label="$t('entities.pcmpracticeexperience.main_grid.columns.practicecontent')" :min-width="1"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmpracticeexperience.main_grid.columns.practicecontent')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
              ...
              @change="($event)=>{gridEditItemChange(row, column.property, $event, $index)}">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='practicecontent' editorType="TEXTBOX" :value="row.practicecontent"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('sxpj')">
                <el-table-column show-overflow-tooltip :prop="'sxpj'" :label="$t('entities.pcmpracticeexperience.main_grid.columns.sxpj')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmpracticeexperience.main_grid.columns.sxpj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
              ...
              @change="($event)=>{gridEditItemChange(row, column.property, $event, $index)}">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='sxpj' editorType="TEXTBOX" :value="row.sxpj"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof MainBase
     */
    public appEntityService: PcmPracticeExperienceService = new PcmPracticeExperienceService({ $store: this.$store });
     ...
     * @memberof MainBase
     */
    public minorSortPSDEF: string = 'starttime';
    ...
    */
    ...
    public allColumns: any[] = [
        {
            ...
            label: '实习单位（*）',
            langtag: 'entities.pcmpracticeexperience.main_grid.columns.practicecompanyname',
            show: true,
            util: 'PX'
        },
        {
            name: 'sxgw',
            label: '实习岗位',
            langtag: 'entities.pcmpracticeexperience.main_grid.columns.sxgw',
            show: true,
            util: 'PX'
        },
        {
            name: 'starttime',
            label: '开始时间（*）',
            langtag: 'entities.pcmpracticeexperience.main_grid.columns.starttime',
            show: true,
            util: 'PX'
        },
        {
            name: 'endtime',
            label: '结束时间（*）',
            langtag: 'entities.pcmpracticeexperience.main_grid.columns.endtime',
            show: true,
            util: 'PX'
        },
        {
            ...
            label: '实习内容',
            langtag: 'entities.pcmpracticeexperience.main_grid.columns.practicecontent',
            show: true,
            util: 'STAR'
        },
        {
            name: 'sxpj',
            label: '实习评价',
            langtag: 'entities.pcmpracticeexperience.main_grid.columns.sxpj',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public getGridRowModel(){
        return {
          ...
          sxpj: new FormItemModel(),
          starttime: new FormItemModel(),
          practicecompanyname: new FormItemModel(),
          sxgw: new FormItemModel(),
          pcmprofileid: new FormItemModel(),
          practicecontent: new FormItemModel(),
    ...
    public rules: any = {
        ...
        sxpj: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '实习评价 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '实习评价 值不能为空', trigger: 'blur' },
        ],
        starttime: [
        ...
        practicecompanyname: [
             { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '实习单位（*） 值不能为空', trigger: 'change' },
            { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '实习单位（*） 值不能为空', trigger: 'blur' },
        ],
        sxgw: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '实习岗位 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '实习岗位 值不能为空', trigger: 'blur' },
        ],
        pcmprofileid: [
        ...
        practicecontent: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '实习内容 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '实习内容 值不能为空', trigger: 'blur' },
        ],
        srfkey: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '实习经验标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '实习经验标识 值不能为空', trigger: 'blur' },
        ],
    }
    ...
    public async remove(datas: any[]): Promise<any> {
        ...
        _datas.forEach((record: any, index: number) => {
            let srfmajortext = record.pcmpracticeexperiencename;
            if (index < 5) {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pcmpracticeexperience: _keys }),Object.assign({ pcmpracticeexperience: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.pcmpracticeexperience,$event.pcmpracticeexperience);
        });
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('pcmpracticeexperience_main_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('pcmpracticeexperience_main_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    ...
                    if(!this.updateAction){
                        ...
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.pcmpracticeexperience){
                            Object.assign(this.context,{pcmpracticeexperience:item.pcmpracticeexperience});
                        }
    ...
    public getRowClassName(args:{row: any,rowIndex: number}){
        let isSelected = this.selections.some((item:any)=>{
            return Object.is(item.pcmpracticeexperience,args.row.pcmpracticeexperience);
        });
