    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('nd')">
                <el-table-column show-overflow-tooltip :prop="'nd'" :label="$t('entities.pcmzpmegl.main_grid.columns.nd')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmzpmegl.main_grid.columns.nd')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('zzdzs')">
                <el-table-column show-overflow-tooltip :prop="'zzdzs'" :label="$t('entities.pcmzpmegl.main_grid.columns.zzdzs')" :min-width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmzpmegl.main_grid.columns.zzdzs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.zzdzs}}</span>
            ...
            <template v-if="getColumnState('pfcs')">
                <el-table-column show-overflow-tooltip :prop="'pfcs'" :label="$t('entities.pcmzpmegl.main_grid.columns.pfcs')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmzpmegl.main_grid.columns.pfcs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.pfcs}}</span>
            ...
            <template v-if="getColumnState('fpme_xza')">
                <el-table-column show-overflow-tooltip :prop="'fpme_xza'" :label="$t('entities.pcmzpmegl.main_grid.columns.fpme_xza')" :width="180"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmzpmegl.main_grid.columns.fpme_xza')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.fpme_xza}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('fpme_xzb')">
                <el-table-column show-overflow-tooltip :prop="'fpme_xzb'" :label="$t('entities.pcmzpmegl.main_grid.columns.fpme_xzb')" :width="180"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmzpmegl.main_grid.columns.fpme_xzb')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.fpme_xzb}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('fpme_xzxzy')">
                <el-table-column show-overflow-tooltip :prop="'fpme_xzxzy'" :label="$t('entities.pcmzpmegl.main_grid.columns.fpme_xzxzy')" :width="220"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmzpmegl.main_grid.columns.fpme_xzxzy')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.fpme_xzxzy}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('fpme_sza')">
                <el-table-column show-overflow-tooltip :prop="'fpme_sza'" :label="$t('entities.pcmzpmegl.main_grid.columns.fpme_sza')" :width="180"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmzpmegl.main_grid.columns.fpme_sza')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.fpme_sza}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('fpme_szb')">
                <el-table-column show-overflow-tooltip :prop="'fpme_szb'" :label="$t('entities.pcmzpmegl.main_grid.columns.fpme_szb')" :width="180"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmzpmegl.main_grid.columns.fpme_szb')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.fpme_szb}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('fpme_szy')">
                <el-table-column show-overflow-tooltip :prop="'fpme_szy'" :label="$t('entities.pcmzpmegl.main_grid.columns.fpme_szy')" :width="180"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmzpmegl.main_grid.columns.fpme_szy')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.fpme_szy}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('fpme_szjhw')">
                <el-table-column show-overflow-tooltip :prop="'fpme_szjhw'" :label="$t('entities.pcmzpmegl.main_grid.columns.fpme_szjhw')" :width="220"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmzpmegl.main_grid.columns.fpme_szjhw')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.fpme_szjhw}}</span>
                    </template>
                </el-table-column>
            </template>
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof MainBase
     */
    public appEntityService: PcmZpmeglService = new PcmZpmeglService({ $store: this.$store });
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'nd',
            label: '年度',
            langtag: 'entities.pcmzpmegl.main_grid.columns.nd',
            show: true,
            util: 'PX'
        },
        {
            name: 'zzdzs',
            label: '组织',
            langtag: 'entities.pcmzpmegl.main_grid.columns.zzdzs',
            show: true,
            util: 'STAR'
        },
        {
            name: 'pfcs',
            label: '批复次数',
            langtag: 'entities.pcmzpmegl.main_grid.columns.pfcs',
            show: true,
            util: 'PX'
        },
        {
            name: 'fpme_xza',
            label: '分配名额（校招A）',
            langtag: 'entities.pcmzpmegl.main_grid.columns.fpme_xza',
            show: true,
            util: 'PX'
        },
        {
            name: 'fpme_xzb',
            label: '分配名额（校招B）',
            langtag: 'entities.pcmzpmegl.main_grid.columns.fpme_xzb',
            show: true,
            util: 'PX'
        },
        {
            name: 'fpme_xzxzy',
            label: '分配名额（校招小专业）',
            langtag: 'entities.pcmzpmegl.main_grid.columns.fpme_xzxzy',
            show: true,
            util: 'PX'
        },
        {
            name: 'fpme_sza',
            label: '分配名额（社招A）',
            langtag: 'entities.pcmzpmegl.main_grid.columns.fpme_sza',
            show: true,
            util: 'PX'
        },
        {
            name: 'fpme_szb',
            label: '分配名额（社招B）',
            langtag: 'entities.pcmzpmegl.main_grid.columns.fpme_szb',
            show: true,
            util: 'PX'
        },
        {
            name: 'fpme_szy',
            label: '分配名额（社招Y）',
            langtag: 'entities.pcmzpmegl.main_grid.columns.fpme_szy',
            show: true,
            util: 'PX'
        },
        {
            name: 'fpme_szjhw',
            label: '分配名额（社招计划外）',
            langtag: 'entities.pcmzpmegl.main_grid.columns.fpme_szjhw',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public rules: any = {
        srfkey: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '招聘名额管理标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '招聘名额管理标识 值不能为空', trigger: 'blur' },
        ],
    }
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PCMZPMEGLCurNDGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PCMZPMEGLCurNDGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        _datas.forEach((record: any, index: number) => {
            let srfmajortext = record.pcmzpmeglname;
            if (index < 5) {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ pcmzpmegl: _keys }),Object.assign({ pcmzpmegl: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.pcmzpmegl,$event.pcmzpmegl);
        });
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('pcmzpmegl_main_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('pcmzpmegl_main_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PCMZPMEGLCurNDGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PCMZPMEGLCurNDGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.pcmzpmegl){
                            Object.assign(this.context,{pcmzpmegl:item.pcmzpmegl});
                        }
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PCMZPMEGLCurNDGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
    ...
    public getRowClassName(args:{row: any,rowIndex: number}){
        let isSelected = this.selections.some((item:any)=>{
            return Object.is(item.pcmzpmegl,args.row.pcmzpmegl);
        });
