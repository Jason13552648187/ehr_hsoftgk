...
export default class TXLXYGBase extends Vue implements ControlInterface {
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'ygbh',
            label: '员工编号',
            langtag: 'entities.pimperson.txlxyg_grid.columns.ygbh',
            show: true,
            util: 'px'
        },
        {
            name: 'pimpersonname',
            label: '员工姓名',
            langtag: 'entities.pimperson.txlxyg_grid.columns.pimpersonname',
            show: true,
            util: 'px'
        },
        {
            name: 'xb',
            label: '性别',
            langtag: 'entities.pimperson.txlxyg_grid.columns.xb',
            show: true,
            util: 'px'
        },
        {
            name: 'nj',
            label: '年龄',
            langtag: 'entities.pimperson.txlxyg_grid.columns.nj',
            show: true,
            util: 'px'
        },
        {
            name: 'postaladdress',
            label: '通讯地址',
            langtag: 'entities.pimperson.txlxyg_grid.columns.postaladdress',
            show: true,
            util: 'px'
        },
        {
            name: 'retiplace',
            label: '退休地',
            langtag: 'entities.pimperson.txlxyg_grid.columns.retiplace',
            show: true,
            util: 'px'
        },
        {
            name: 'jtlxr',
            label: '家庭联系人',
            langtag: 'entities.pimperson.txlxyg_grid.columns.jtlxr',
            show: true,
            util: 'px'
        },
        {
            name: 'jtlxrdh',
            label: '家庭联系人电话',
            langtag: 'entities.pimperson.txlxyg_grid.columns.jtlxrdh',
            show: true,
            util: 'PX'
        },
        {
            name: 'zzdzs',
            label: '组织',
            langtag: 'entities.pimperson.txlxyg_grid.columns.zzdzs',
            show: true,
            util: 'px'
        },
        {
            ...
            label: '部门',
            langtag: 'entities.pimperson.txlxyg_grid.columns.ormorgsectorname',
            show: true,
            util: 'PX'
        },
        {
            name: 'rank',
            label: '职级',
            langtag: 'entities.pimperson.txlxyg_grid.columns.rank',
            show: true,
            util: 'px'
        },
        {
            name: 'zw',
            label: '退休前职务',
            langtag: 'entities.pimperson.txlxyg_grid.columns.zw',
            show: true,
            util: 'PX'
        },
        {
            name: 'gw',
            label: '退休前岗位',
            langtag: 'entities.pimperson.txlxyg_grid.columns.gw',
            show: true,
            util: 'PX'
        },
        {
            name: 'txdq',
            label: '退休时间',
            langtag: 'entities.pimperson.txlxyg_grid.columns.txdq',
            show: true,
            util: 'px'
        },
        {
            name: 'sjtxrq',
            label: '实际退休时间',
            langtag: 'entities.pimperson.txlxyg_grid.columns.sjtxrq',
            show: true,
            util: 'px'
        },
        {
            name: 'lxdh',
            label: '手机号码',
            langtag: 'entities.pimperson.txlxyg_grid.columns.lxdh',
            show: true,
            util: 'px'
        },
        {
            name: 'spdylje',
            label: '审批的养老金额',
            langtag: 'entities.pimperson.txlxyg_grid.columns.spdylje',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PIMPERSONTXRYPickupGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PIMPERSONTXRYPickupGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'PIMPERSONTXRYPickupGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
