    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('zzdzs')">
                <el-table-column show-overflow-tooltip :prop="'zzdzs'" :label="$t('entities.pcmprofile.ypzxx_lr_grid.columns.zzdzs')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmprofile.ypzxx_lr_grid.columns.zzdzs')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('pcmprofilename')">
                <el-table-column show-overflow-tooltip :prop="'pcmprofilename'" :label="$t('entities.pcmprofile.ypzxx_lr_grid.columns.pcmprofilename')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmprofile.ypzxx_lr_grid.columns.pcmprofilename')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('rzqd')">
                <el-table-column show-overflow-tooltip :prop="'rzqd'" :label="$t('entities.pcmprofile.ypzxx_lr_grid.columns.rzqd')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmprofile.ypzxx_lr_grid.columns.rzqd')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('xznf')">
                <el-table-column show-overflow-tooltip :prop="'xznf'" :label="$t('entities.pcmprofile.ypzxx_lr_grid.columns.xznf')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmprofile.ypzxx_lr_grid.columns.xznf')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('yglx')">
                <el-table-column show-overflow-tooltip :prop="'yglx'" :label="$t('entities.pcmprofile.ypzxx_lr_grid.columns.yglx')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmprofile.ypzxx_lr_grid.columns.yglx')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('educationlevel')">
                <el-table-column show-overflow-tooltip :prop="'educationlevel'" :label="$t('entities.pcmprofile.ypzxx_lr_grid.columns.educationlevel')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmprofile.ypzxx_lr_grid.columns.educationlevel')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('r_lastschool')">
                <el-table-column show-overflow-tooltip :prop="'r_lastschool'" :label="$t('entities.pcmprofile.ypzxx_lr_grid.columns.r_lastschool')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmprofile.ypzxx_lr_grid.columns.r_lastschool')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('xkml')">
                <el-table-column show-overflow-tooltip :prop="'xkml'" :label="$t('entities.pcmprofile.ypzxx_lr_grid.columns.xkml')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmprofile.ypzxx_lr_grid.columns.xkml')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('r_lastdiscipline')">
                <el-table-column show-overflow-tooltip :prop="'r_lastdiscipline'" :label="$t('entities.pcmprofile.ypzxx_lr_grid.columns.r_lastdiscipline')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmprofile.ypzxx_lr_grid.columns.r_lastdiscipline')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('xxxz')">
                <el-table-column show-overflow-tooltip :prop="'xxxz'" :label="$t('entities.pcmprofile.ypzxx_lr_grid.columns.xxxz')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmprofile.ypzxx_lr_grid.columns.xxxz')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('yydjmc')">
                <el-table-column show-overflow-tooltip :prop="'yydjmc'" :label="$t('entities.pcmprofile.ypzxx_lr_grid.columns.yydjmc')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmprofile.ypzxx_lr_grid.columns.yydjmc')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('certificatetype')">
                <el-table-column show-overflow-tooltip :prop="'certificatetype'" :label="$t('entities.pcmprofile.ypzxx_lr_grid.columns.certificatetype')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmprofile.ypzxx_lr_grid.columns.certificatetype')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('certificatenumber')">
                <el-table-column show-overflow-tooltip :prop="'certificatenumber'" :label="$t('entities.pcmprofile.ypzxx_lr_grid.columns.certificatenumber')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmprofile.ypzxx_lr_grid.columns.certificatenumber')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('gender')">
                <el-table-column show-overflow-tooltip :prop="'gender'" :label="$t('entities.pcmprofile.ypzxx_lr_grid.columns.gender')" :width="90"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmprofile.ypzxx_lr_grid.columns.gender')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('mobile')">
                <el-table-column show-overflow-tooltip :prop="'mobile'" :label="$t('entities.pcmprofile.ypzxx_lr_grid.columns.mobile')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmprofile.ypzxx_lr_grid.columns.mobile')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('email')">
                <el-table-column show-overflow-tooltip :prop="'email'" :label="$t('entities.pcmprofile.ypzxx_lr_grid.columns.email')" :width="180"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmprofile.ypzxx_lr_grid.columns.email')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.email}}</span>
            ...
            <template v-if="getColumnState('profiletype')">
                <el-table-column show-overflow-tooltip :prop="'profiletype'" :label="$t('entities.pcmprofile.ypzxx_lr_grid.columns.profiletype')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmprofile.ypzxx_lr_grid.columns.profiletype')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('ztyy')">
                <el-table-column show-overflow-tooltip :prop="'ztyy'" :label="$t('entities.pcmprofile.ypzxx_lr_grid.columns.ztyy')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.pcmprofile.ypzxx_lr_grid.columns.ztyy')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.ztyy}}</span>
...
export default class YPZXX_LRBase extends Vue implements ControlInterface {
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'zzdzs',
            label: '组织名称',
            langtag: 'entities.pcmprofile.ypzxx_lr_grid.columns.zzdzs',
            show: true,
            util: 'PX'
        },
        {
            name: 'pcmprofilename',
            label: '姓名',
            langtag: 'entities.pcmprofile.ypzxx_lr_grid.columns.pcmprofilename',
            show: true,
            util: 'PX'
        },
        {
            name: 'rzqd',
            label: '入职渠道',
            langtag: 'entities.pcmprofile.ypzxx_lr_grid.columns.rzqd',
            show: true,
            util: 'PX'
        },
        {
            name: 'xznf',
            label: '招聘年份',
            langtag: 'entities.pcmprofile.ypzxx_lr_grid.columns.xznf',
            show: true,
            util: 'px'
        },
        {
            name: 'yglx',
            label: '申报类型',
            langtag: 'entities.pcmprofile.ypzxx_lr_grid.columns.yglx',
            show: true,
            util: 'PX'
        },
        {
            name: 'educationlevel',
            label: '最高学历',
            langtag: 'entities.pcmprofile.ypzxx_lr_grid.columns.educationlevel',
            show: true,
            util: 'px'
        },
        {
            name: 'r_lastschool',
            label: '毕业学校',
            langtag: 'entities.pcmprofile.ypzxx_lr_grid.columns.r_lastschool',
            show: true,
            util: 'px'
        },
        {
            name: 'xkml',
            label: '一级学科',
            langtag: 'entities.pcmprofile.ypzxx_lr_grid.columns.xkml',
            show: true,
            util: 'PX'
        },
        {
            ...
            label: '专业名称',
            langtag: 'entities.pcmprofile.ypzxx_lr_grid.columns.r_lastdiscipline',
            show: true,
            util: 'px'
        },
        {
            name: 'xxxz',
            label: '学校性质',
            langtag: 'entities.pcmprofile.ypzxx_lr_grid.columns.xxxz',
            show: true,
            util: 'px'
        },
        {
            name: 'yydjmc',
            label: '语言等级名称',
            langtag: 'entities.pcmprofile.ypzxx_lr_grid.columns.yydjmc',
            show: true,
            util: 'px'
        },
        {
        ...
        },
        {
            ...
            label: '证件号码',
            langtag: 'entities.pcmprofile.ypzxx_lr_grid.columns.certificatenumber',
            show: true,
            util: 'PX'
        },
        {
            name: 'gender',
            label: '性别',
            langtag: 'entities.pcmprofile.ypzxx_lr_grid.columns.gender',
            show: true,
            util: 'PX'
        },
        {
            name: 'mobile',
            label: '手机号',
            langtag: 'entities.pcmprofile.ypzxx_lr_grid.columns.mobile',
            show: true,
            util: 'px'
        },
        {
            name: 'email',
            label: '邮箱',
            langtag: 'entities.pcmprofile.ypzxx_lr_grid.columns.email',
            show: true,
            util: 'PX'
        },
        {
            name: 'profiletype',
            label: '应聘者状态',
            langtag: 'entities.pcmprofile.ypzxx_lr_grid.columns.profiletype',
            show: true,
            util: 'px'
        },
        {
            name: 'ztyy',
            label: '状态原因',
            langtag: 'entities.pcmprofile.ypzxx_lr_grid.columns.ztyy',
            show: true,
            util: 'px'
        },
    ]
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'PCMPROFILEYPZXX_LRGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'PCMPROFILEYPZXX_LRGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'PCMPROFILEYPZXX_LRGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'PCMPROFILEYPZXX_LRGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.pcmprofile){
