package cn.ibizlab.ehr.ehrpcm2;
...
@EnableZuulProxy
@ComponentScan(basePackages = {"cn.ibizlab.ehr.ehrpcm2","cn.ibizlab.ehr.util"})
...
public class EHRPcm2Application extends WebMvcConfigurerAdapter{
    ...
    public static void main(String[] args) {
        SpringApplication.run(EHRPcm2Application.class,args);
    }
