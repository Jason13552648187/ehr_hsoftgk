    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('ygbh')">
                <el-table-column show-overflow-tooltip :prop="'ygbh'" :label="$t('entities.vacsynjcx.main_grid.columns.ygbh')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.vacsynjcx.main_grid.columns.ygbh')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('pimpersonname')">
                <el-table-column show-overflow-tooltip :prop="'pimpersonname'" :label="$t('entities.vacsynjcx.main_grid.columns.pimpersonname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.vacsynjcx.main_grid.columns.pimpersonname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('nd')">
                <el-table-column show-overflow-tooltip :prop="'nd'" :label="$t('entities.vacsynjcx.main_grid.columns.nd')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.vacsynjcx.main_grid.columns.nd')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('gly')">
                <el-table-column show-overflow-tooltip :prop="'gly'" :label="$t('entities.vacsynjcx.main_grid.columns.gly')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.vacsynjcx.main_grid.columns.gly')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.gly}}</span>
            ...
            <template v-if="getColumnState('zz')">
                <el-table-column show-overflow-tooltip :prop="'zz'" :label="$t('entities.vacsynjcx.main_grid.columns.zz')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.vacsynjcx.main_grid.columns.zz')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.zz}}</span>
            ...
            <template v-if="getColumnState('bm')">
                <el-table-column show-overflow-tooltip :prop="'bm'" :label="$t('entities.vacsynjcx.main_grid.columns.bm')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.vacsynjcx.main_grid.columns.bm')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.bm}}</span>
            ...
            <template v-if="getColumnState('sjbnts')">
                <el-table-column show-overflow-tooltip :prop="'sjbnts'" :label="$t('entities.vacsynjcx.main_grid.columns.sjbnts')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.vacsynjcx.main_grid.columns.sjbnts')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                            <app-format-data dataType="FLOAT" precision="0" :data="row.sjbnts"></app-format-data>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('bnts')">
                <el-table-column show-overflow-tooltip :prop="'bnts'" :label="$t('entities.vacsynjcx.main_grid.columns.bnts')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.vacsynjcx.main_grid.columns.bnts')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                            <app-format-data dataType="FLOAT" precision="0" :data="row.bnts"></app-format-data>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('yynj')">
                <el-table-column show-overflow-tooltip :prop="'yynj'" :label="$t('entities.vacsynjcx.main_grid.columns.yynj')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.vacsynjcx.main_grid.columns.yynj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                            <app-format-data dataType="FLOAT" precision="0" :data="row.yynj"></app-format-data>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('synjts')">
                <el-table-column show-overflow-tooltip :prop="'synjts'" :label="$t('entities.vacsynjcx.main_grid.columns.synjts')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.vacsynjcx.main_grid.columns.synjts')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                            <app-format-data dataType="FLOAT" precision="0" :data="row.synjts"></app-format-data>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('ksyxsj')">
                <el-table-column show-overflow-tooltip :prop="'ksyxsj'" :label="$t('entities.vacsynjcx.main_grid.columns.ksyxsj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.vacsynjcx.main_grid.columns.ksyxsj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <app-format-data format="YYYY-MM-DD" :data="row.ksyxsj"></app-format-data>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('jsyxsj')">
                <el-table-column show-overflow-tooltip :prop="'jsyxsj'" :label="$t('entities.vacsynjcx.main_grid.columns.jsyxsj')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.vacsynjcx.main_grid.columns.jsyxsj')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <app-format-data format="YYYY-MM-DD" :data="row.jsyxsj"></app-format-data>
                    </template>
                </el-table-column>
            </template>
...
import VacSynjcxService from '@/service/vac-synjcx/vac-synjcx-service';
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * 实体服务对象
     *
     * @type {VacSynjcxService}
     * @memberof MainBase
     */
    public appEntityService: VacSynjcxService = new VacSynjcxService({ $store: this.$store });
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'ygbh',
            label: '员工编号',
            langtag: 'entities.vacsynjcx.main_grid.columns.ygbh',
            show: true,
            util: 'px'
        },
        {
            name: 'pimpersonname',
            label: '员工姓名',
            langtag: 'entities.vacsynjcx.main_grid.columns.pimpersonname',
            show: true,
            util: 'px'
        },
        {
            name: 'nd',
            label: '年度',
            langtag: 'entities.vacsynjcx.main_grid.columns.nd',
            show: true,
            util: 'PX'
        },
        {
            name: 'gly',
            label: '工龄（年）',
            langtag: 'entities.vacsynjcx.main_grid.columns.gly',
            show: true,
            util: 'PX'
        },
        {
            name: 'zz',
            label: '组织名称',
            langtag: 'entities.vacsynjcx.main_grid.columns.zz',
            show: true,
            util: 'px'
        },
        {
            name: 'bm',
            label: '部门名称',
            langtag: 'entities.vacsynjcx.main_grid.columns.bm',
            show: true,
            util: 'PX'
        },
        {
            name: 'sjbnts',
            label: '实休天数',
            langtag: 'entities.vacsynjcx.main_grid.columns.sjbnts',
            show: true,
            util: 'PX'
        },
        {
            name: 'bnts',
            label: '应休天数',
            langtag: 'entities.vacsynjcx.main_grid.columns.bnts',
            show: true,
            util: 'PX'
        },
        {
            name: 'yynj',
            label: '已用天数',
            langtag: 'entities.vacsynjcx.main_grid.columns.yynj',
            show: true,
            util: 'PX'
        },
        {
            name: 'synjts',
            label: '剩余天数',
            langtag: 'entities.vacsynjcx.main_grid.columns.synjts',
            show: true,
            util: 'PX'
        },
        {
            name: 'ksyxsj',
            label: '开始有效时间',
            langtag: 'entities.vacsynjcx.main_grid.columns.ksyxsj',
            show: true,
            util: 'px'
        },
        {
            name: 'jsyxsj',
            label: '结束有效时间',
            langtag: 'entities.vacsynjcx.main_grid.columns.jsyxsj',
            show: true,
            util: 'px'
        },
    ]
    ...
    public rules: any = {
        srfkey: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '年休假查询标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '年休假查询标识 值不能为空', trigger: 'blur' },
        ],
    }
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'VacSynjcxGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'VacSynjcxGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        _datas.forEach((record: any, index: number) => {
            let srfmajortext = record.vacsynjcxname;
            if (index < 5) {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ vacsynjcx: _keys }),Object.assign({ vacsynjcx: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.vacsynjcx,$event.vacsynjcx);
        });
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('vacsynjcx_main_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('vacsynjcx_main_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'VacSynjcxGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'VacSynjcxGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.vacsynjcx){
                            Object.assign(this.context,{vacsynjcx:item.vacsynjcx});
                        }
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'VacSynjcxGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
    ...
    public getRowClassName(args:{row: any,rowIndex: number}){
        let isSelected = this.selections.some((item:any)=>{
            return Object.is(item.vacsynjcx,args.row.vacsynjcx);
        });
