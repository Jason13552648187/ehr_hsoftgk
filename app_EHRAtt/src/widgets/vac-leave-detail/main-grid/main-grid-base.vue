    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('pimpersonname')">
                <el-table-column show-overflow-tooltip :prop="'pimpersonname'" :label="$t('entities.vacleavedetail.main_grid.columns.pimpersonname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.vacleavedetail.main_grid.columns.pimpersonname')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('qjzl')">
                <el-table-column show-overflow-tooltip :prop="'qjzl'" :label="$t('entities.vacleavedetail.main_grid.columns.qjzl')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.vacleavedetail.main_grid.columns.qjzl')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('jhqjks')">
                <el-table-column show-overflow-tooltip :prop="'jhqjks'" :label="$t('entities.vacleavedetail.main_grid.columns.jhqjks')" :width="180"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.vacleavedetail.main_grid.columns.jhqjks')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('jhqjjs')">
                <el-table-column show-overflow-tooltip :prop="'jhqjjs'" :label="$t('entities.vacleavedetail.main_grid.columns.jhqjjs')" :width="180"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.vacleavedetail.main_grid.columns.jhqjjs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('jhts')">
                <el-table-column show-overflow-tooltip :prop="'jhts'" :label="$t('entities.vacleavedetail.main_grid.columns.jhts')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.vacleavedetail.main_grid.columns.jhts')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('bz')">
                <el-table-column show-overflow-tooltip :prop="'bz'" :label="$t('entities.vacleavedetail.main_grid.columns.bz')" :min-width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.vacleavedetail.main_grid.columns.bz')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.bz}}</span>
            ...
            <template v-if="getColumnState('sjqjks')">
                <el-table-column show-overflow-tooltip :prop="'sjqjks'" :label="$t('entities.vacleavedetail.main_grid.columns.sjqjks')" :width="180"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.vacleavedetail.main_grid.columns.sjqjks')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('sjqjjs')">
                <el-table-column show-overflow-tooltip :prop="'sjqjjs'" :label="$t('entities.vacleavedetail.main_grid.columns.sjqjjs')" :width="180"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.vacleavedetail.main_grid.columns.sjqjjs')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('sjts')">
                <el-table-column show-overflow-tooltip :prop="'sjts'" :label="$t('entities.vacleavedetail.main_grid.columns.sjts')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.vacleavedetail.main_grid.columns.sjts')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof MainBase
     */
    public minorSortPSDEF: string = 'jhkssj';
    ...
    */
    ...
    public allColumns: any[] = [
        ...
        },
        {
            name: 'qjzl',
            label: '请假种类',
            langtag: 'entities.vacleavedetail.main_grid.columns.qjzl',
            show: true,
            util: 'PX'
        },
        {
            name: 'jhqjks',
            label: '计划请假开始',
            langtag: 'entities.vacleavedetail.main_grid.columns.jhqjks',
            show: true,
            util: 'PX'
        },
        {
            name: 'jhqjjs',
            label: '计划请假结束',
            langtag: 'entities.vacleavedetail.main_grid.columns.jhqjjs',
            show: true,
            util: 'PX'
        },
        {
        ...
        },
        {
            name: 'bz',
            label: '备注',
            langtag: 'entities.vacleavedetail.main_grid.columns.bz',
            show: true,
            util: 'STAR'
        },
        {
            name: 'sjqjks',
            label: '实际请假开始',
            langtag: 'entities.vacleavedetail.main_grid.columns.sjqjks',
            show: true,
            util: 'PX'
        },
        {
            name: 'sjqjjs',
            label: '实际请假结束',
            langtag: 'entities.vacleavedetail.main_grid.columns.sjqjjs',
            show: true,
            util: 'PX'
        },
        {
            name: 'sjts',
            label: '实际天数',
            langtag: 'entities.vacleavedetail.main_grid.columns.sjts',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public rules: any = {
        srfkey: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '请销假明细标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '请销假明细标识 值不能为空', trigger: 'blur' },
        ],
    }
    ...
    public async remove(datas: any[]): Promise<any> {
        ...
        _datas.forEach((record: any, index: number) => {
            let srfmajortext = record.vacleavedetailname;
            if (index < 5) {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ vacleavedetail: _keys }),Object.assign({ vacleavedetail: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.vacleavedetail,$event.vacleavedetail);
        });
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('vacleavedetail_main_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('vacleavedetail_main_grid', JSON.stringify(this.allColumns));
    }
                ...
                if(Object.is(item.rowDataState, 'create')){
                    ...
                    if(!this.updateAction){
                        ...
                        if(item.vacleavedetail){
                            Object.assign(this.context,{vacleavedetail:item.vacleavedetail});
                        }
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'VacLeaveDetailGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
    ...
    public getRowClassName(args:{row: any,rowIndex: number}){
        let isSelected = this.selections.some((item:any)=>{
            return Object.is(item.vacleavedetail,args.row.vacleavedetail);
        });
