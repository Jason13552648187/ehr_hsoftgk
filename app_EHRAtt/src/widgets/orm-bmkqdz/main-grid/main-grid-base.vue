    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('ormbmkqdzname')">
                <el-table-column show-overflow-tooltip :prop="'ormbmkqdzname'" :label="$t('entities.ormbmkqdz.main_grid.columns.ormbmkqdzname')" :width="300"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.ormbmkqdz.main_grid.columns.ormbmkqdzname')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('sfmrkqdz')">
                <el-table-column show-overflow-tooltip :prop="'sfmrkqdz'" :label="$t('entities.ormbmkqdz.main_grid.columns.sfmrkqdz')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.ormbmkqdz.main_grid.columns.sfmrkqdz')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            <codelist :value="row.sfmrkqdz" tag='EhrCodeList0097' codelistType='STATIC' ></codelist>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('createman')">
                <el-table-column show-overflow-tooltip :prop="'createman'" :label="$t('entities.ormbmkqdz.main_grid.columns.createman')" :width="130"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.ormbmkqdz.main_grid.columns.createman')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('createdate')">
                <el-table-column show-overflow-tooltip :prop="'createdate'" :label="$t('entities.ormbmkqdz.main_grid.columns.createdate')" :width="140"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.ormbmkqdz.main_grid.columns.createdate')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof MainBase
     */
    public appEntityService: OrmBmkqdzService = new OrmBmkqdzService({ $store: this.$store });
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'ormbmkqdzname',
            label: '部门地址',
            langtag: 'entities.ormbmkqdz.main_grid.columns.ormbmkqdzname',
            show: true,
            util: 'PX'
        },
        {
            name: 'sfmrkqdz',
            label: '默认考勤地址',
            langtag: 'entities.ormbmkqdz.main_grid.columns.sfmrkqdz',
            show: true,
            util: 'PX'
        },
        {
            name: 'createman',
            label: '建立人',
            langtag: 'entities.ormbmkqdz.main_grid.columns.createman',
            show: true,
            util: 'PX'
        },
        {
            name: 'createdate',
            label: '建立时间',
            langtag: 'entities.ormbmkqdz.main_grid.columns.createdate',
            show: true,
            util: 'PX'
        },
    ]
    ...
    public rules: any = {
        ...
        ormorgsectorid: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '部门ID 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '部门ID 值不能为空', trigger: 'blur' },
        ],
        ormorgdzid: [
        ...
        sfmrkqdz: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '默认考勤地址 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '默认考勤地址 值不能为空', trigger: 'blur' },
        ],
        srfkey: [
            ...
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '部门地址维护标识 值不能为空', trigger: 'blur' },
        ],
        ormorgsectorname: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '部门名称 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '部门名称 值不能为空', trigger: 'blur' },
        ],
        ormbmkqdzname: [
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'OrmBmkqdzPickupGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'OrmBmkqdzPickupGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        _datas.forEach((record: any, index: number) => {
            let srfmajortext = record.ormbmkqdzname;
            if (index < 5) {
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.ormbmkqdz,$event.ormbmkqdz);
        });
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('ormbmkqdz_main_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('ormbmkqdz_main_grid', JSON.stringify(this.allColumns));
    }
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: '错误', desc: 'OrmBmkqdzPickupGridView视图表格createAction参数未配置' });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: '错误', desc: 'OrmBmkqdzPickupGridView视图表格updateAction参数未配置' });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.ormbmkqdz){
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'OrmBmkqdzPickupGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
    ...
    public createDefault(row: any){                    
        if (row.hasOwnProperty('sfmrkqdz')) {
            row['sfmrkqdz'] = '1';
        }
    }
}
