<template>
    <split id="kqhztreeexpviewtreeexpbar" class='app-tree-exp-bar' v-model="split" mode="horizontal" @on-move-end="onSplitChange">
        <div slot='left'>
...
import KQHZTreeExpViewtreeexpbarService from './kqhztree-exp-viewtreeexpbar-treeexpbar-service';
...
export default class KQHZTreeExpViewtreeexpbarBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof KQHZTreeExpViewtreeexpbarBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {KQHZTreeExpViewtreeexpbarService}
     * @memberof KQHZTreeExpViewtreeexpbarBase
     */
    public service: KQHZTreeExpViewtreeexpbarService = new KQHZTreeExpViewtreeexpbarService({ $store: this.$store });
     ...
     * vue 声明周期
     *
     * @memberof @memberof KQHZTreeExpViewtreeexpbarBase
     */
    public created() {
        this.afterCreated();
    }
    ...
    */
    public afterMounted(){ 
        if(this.$store.getters.getViewSplit(this.viewUID)){
            ...
            let containerWidth:number = (document.getElementById("kqhztreeexpviewtreeexpbar") as any).offsetWidth;
            if(this.ctrlWidth){
...
<style lang='less'>
@import './kqhztree-exp-viewtreeexpbar-treeexpbar.less';
</style>
