<template>
    <split id="kqybtreeexpviewtreeexpbar" class='app-tree-exp-bar' v-model="split" mode="horizontal" @on-move-end="onSplitChange">
        <div slot='left'>
...
export default class KQYBTreeExpViewtreeexpbarBase extends Vue implements ControlInterface {
     ...
     * vue 声明周期
     *
     * @memberof @memberof KQYBTreeExpViewtreeexpbarBase
     */
    public created() {
        this.afterCreated();
    }
    ...
    */
    public afterMounted(){ 
        if(this.$store.getters.getViewSplit(this.viewUID)){
            ...
            let containerWidth:number = (document.getElementById("kqybtreeexpviewtreeexpbar") as any).offsetWidth;
            if(this.ctrlWidth){
...
<style lang='less'>
@import './kqybtree-exp-viewtreeexpbar-treeexpbar.less';
</style>
