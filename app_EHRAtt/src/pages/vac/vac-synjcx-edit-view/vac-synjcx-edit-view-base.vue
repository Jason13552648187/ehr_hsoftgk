<template>
  <app-layout viewName="vacsynjcxeditview" viewTitle="年休假查询编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'vac-synjcx-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class VacSynjcxEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class VacSynjcxEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {VacSynjcxService}
     * @memberof VacSynjcxEditViewBase
     */
    public appEntityService: VacSynjcxService = new VacSynjcxService;
	 ...
	 * @memberof VacSynjcxEditViewBase
	 */
	public viewtag: string = 'c1fae59437ec480d0ebf1b6b9f506bfa';
     ...
     */
    public model: any = {
        srfCaption: 'entities.vacsynjcx.views.editview.caption',
        srfTitle: 'entities.vacsynjcx.views.editview.title',
        srfSubTitle: 'entities.vacsynjcx.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'vacsynjcx',
            majorPSDEField: 'vacsynjcxname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"VacSynjcx");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"VacSynjcx");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"VacSynjcx");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"VacSynjcx");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"VacSynjcx");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"VacSynjcx");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"VacSynjcx");
    }
...
<style lang='less'>
@import './vac-synjcx-edit-view.less';
</style>