<template>
  <app-layout viewName="vacholidayeditview" viewTitle="节假日/调休上班" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'vac-holiday-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class VacHolidayEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class VacHolidayEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {VacHolidayService}
     * @memberof VacHolidayEditViewBase
     */
	 ...
	 * @memberof VacHolidayEditViewBase
	 */
	public viewtag: string = '43382b00685ac886ac519967af516ee9';
     ...
     */
    public model: any = {
        srfCaption: 'entities.vacholiday.views.editview.caption',
        srfTitle: 'entities.vacholiday.views.editview.title',
        srfSubTitle: 'entities.vacholiday.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_deuiaction5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"VacHoliday");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Exit(datas, contextJO,paramJO,  $event, xData,this,"VacHoliday");
    }
...
<style lang='less'>
@import './vac-holiday-edit-view.less';
</style>