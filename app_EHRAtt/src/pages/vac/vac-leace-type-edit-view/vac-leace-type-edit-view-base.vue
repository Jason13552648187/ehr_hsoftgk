<template>
  <app-layout viewName="vacleacetypeeditview" viewTitle="休假类型管理编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'vac-leace-type-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class VacLeaceTypeEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class VacLeaceTypeEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {VacLeaceTypeService}
     * @memberof VacLeaceTypeEditViewBase
     */
    public appEntityService: VacLeaceTypeService = new VacLeaceTypeService;
	 ...
	 * @memberof VacLeaceTypeEditViewBase
	 */
	public viewtag: string = 'eccc30f0a682850771495604f591627d';
     ...
     */
    public model: any = {
        srfCaption: 'entities.vacleacetype.views.editview.caption',
        srfTitle: 'entities.vacleacetype.views.editview.title',
        srfSubTitle: 'entities.vacleacetype.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"VacLeaceType");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"VacLeaceType");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Exit(datas, contextJO,paramJO,  $event, xData,this,"VacLeaceType");
    }
...
<style lang='less'>
@import './vac-leace-type-edit-view.less';
</style>