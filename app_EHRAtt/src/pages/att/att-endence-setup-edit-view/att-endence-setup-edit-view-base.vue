<template>
  <app-layout viewName="attendencesetupeditview" viewTitle="考勤设置编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'att-endence-setup-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class AttEndenceSetupEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class AttEndenceSetupEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {AttEndenceSetupService}
     * @memberof AttEndenceSetupEditViewBase
     */
	 ...
	 * @memberof AttEndenceSetupEditViewBase
	 */
	public viewtag: string = '1670d8d1ba576d381e759a1968ca96d9';
     ...
     */
    public model: any = {
        srfCaption: 'entities.attendencesetup.views.editview.caption',
        srfTitle: 'entities.attendencesetup.views.editview.title',
        srfSubTitle: 'entities.attendencesetup.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof AttEndenceSetupEditView
     */
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"AttEndenceSetup");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"AttEndenceSetup");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Exit(datas, contextJO,paramJO,  $event, xData,this,"AttEndenceSetup");
    }
...
<style lang='less'>
@import './att-endence-setup-edit-view.less';
</style>