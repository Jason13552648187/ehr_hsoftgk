<template>
  <app-layout viewName="attendancemreporteditview" viewTitle="考勤月报" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'att-endance-mreport-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class AttEndanceMreportEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class AttEndanceMreportEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {AttEndanceMreportService}
     * @memberof AttEndanceMreportEditViewBase
     */
	 ...
	 * @memberof AttEndanceMreportEditViewBase
	 */
	public viewtag: string = '6b3008117fb17fb739d7fa3a19cec37b';
     ...
     */
    public model: any = {
        srfCaption: 'entities.attendancemreport.views.editview.caption',
        srfTitle: 'entities.attendancemreport.views.editview.title',
        srfSubTitle: 'entities.attendancemreport.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof AttEndanceMreportEditView
     */
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"AttEndanceMreport");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"AttEndanceMreport");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"AttEndanceMreport");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"AttEndanceMreport");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"AttEndanceMreport");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"AttEndanceMreport");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"AttEndanceMreport");
    }
...
<style lang='less'>
@import './att-endance-mreport-edit-view.less';
</style>