<template>
  <app-layout viewName="attendancesettingseditview" viewTitle="考勤人员" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'att-endance-settings-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class AttEndanceSettingsEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class AttEndanceSettingsEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {AttEndanceSettingsService}
     * @memberof AttEndanceSettingsEditViewBase
     */
	 ...
	 * @memberof AttEndanceSettingsEditViewBase
	 */
	public viewtag: string = '03511dfb145e54bb23246d7f2b417a36';
     ...
     */
    public model: any = {
        srfCaption: 'entities.attendancesettings.views.editview.caption',
        srfTitle: 'entities.attendancesettings.views.editview.title',
        srfSubTitle: 'entities.attendancesettings.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof AttEndanceSettingsEditView
     */
    ...
    public toolbar_deuiaction5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"AttEndanceSettings");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Exit(datas, contextJO,paramJO,  $event, xData,this,"AttEndanceSettings");
    }
...
<style lang='less'>
@import './att-endance-settings-edit-view.less';
</style>