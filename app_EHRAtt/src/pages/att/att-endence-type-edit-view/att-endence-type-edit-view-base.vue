<template>
  <app-layout viewName="attendencetypeeditview" viewTitle="考勤类型编辑视图" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'att-endence-type-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class AttEndenceTypeEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class AttEndenceTypeEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {AttEndenceTypeService}
     * @memberof AttEndenceTypeEditViewBase
     */
    public appEntityService: AttEndenceTypeService = new AttEndenceTypeService;
	 ...
	 * @memberof AttEndenceTypeEditViewBase
	 */
	public viewtag: string = 'e1887c627c5d3e6b1a34311ecc990535';
     ...
     */
    public model: any = {
        srfCaption: 'entities.attendencetype.views.editview.caption',
        srfTitle: 'entities.attendencetype.views.editview.title',
        srfSubTitle: 'entities.attendencetype.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof AttEndenceTypeEditView
     */
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'attendencetype',
            majorPSDEField: 'attendencetypename',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"AttEndenceType");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"AttEndenceType");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"AttEndenceType");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"AttEndenceType");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"AttEndenceType");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"AttEndenceType");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"AttEndenceType");
    }
...
<style lang='less'>
@import './att-endence-type-edit-view.less';
</style>