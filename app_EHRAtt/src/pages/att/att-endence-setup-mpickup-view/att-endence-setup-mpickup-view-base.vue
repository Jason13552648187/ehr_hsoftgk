<template>
  <app-layout viewName="attendencesetupmpickupview" viewTitle="考勤设置数据多项选择视图" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'dempickupview': true, 'att-endence-setup-mpickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class AttEndenceSetupMPickupViewBase
 * @extends {MPickupViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class AttEndenceSetupMPickupViewBase extends MPickupViewBase {

    /**
     * 实体服务对象
     *
     * @type {AttEndenceSetupService}
     * @memberof AttEndenceSetupMPickupViewBase
     */
	 ...
	 * @memberof AttEndenceSetupMPickupViewBase
	 */
	public viewtag: string = 'fda0fddd972d90b7d9335a0aa20c6cf4';
     ...
     */
    public model: any = {
        srfCaption: 'entities.attendencesetup.views.mpickupview.caption',
        srfTitle: 'entities.attendencesetup.views.mpickupview.title',
        srfSubTitle: 'entities.attendencesetup.views.mpickupview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {any[]}
     * @memberof AttEndenceSetupMPickupView
     */
        ...
        Object.values(this.containerModel).forEach((model: any) => {
            ...
            if(model.datas.length>0){
                model.datas.forEach((data:any,index:any)=>{
                    Object.assign(data,{srfmajortext: data['attendencesetupname']});
                })
            }
...
<style lang='less'>
@import './att-endence-setup-mpickup-view.less';
</style>