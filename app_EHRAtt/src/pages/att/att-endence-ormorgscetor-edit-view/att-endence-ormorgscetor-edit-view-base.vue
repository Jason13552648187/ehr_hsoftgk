<template>
  <app-layout viewName="attendenceormorgscetoreditview" viewTitle="考勤部门编辑视图" :isShowCaptionBar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'att-endence-ormorgscetor-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class AttEndenceOrmorgscetorEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class AttEndenceOrmorgscetorEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {AttEndenceOrmorgscetorService}
     * @memberof AttEndenceOrmorgscetorEditViewBase
     */
    public appEntityService: AttEndenceOrmorgscetorService = new AttEndenceOrmorgscetorService;
	 ...
	 * @memberof AttEndenceOrmorgscetorEditViewBase
	 */
	public viewtag: string = '8dc4b335c6da32e29f4f6f082d4b2020';
     ...
     */
    public model: any = {
        srfCaption: 'entities.attendenceormorgscetor.views.editview.caption',
        srfTitle: 'entities.attendenceormorgscetor.views.editview.title',
        srfSubTitle: 'entities.attendenceormorgscetor.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof AttEndenceOrmorgscetorEditView
     */
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'attendenceormorgscetor',
            majorPSDEField: 'attendenceormorgsectorname',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"AttEndenceOrmorgscetor");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"AttEndenceOrmorgscetor");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"AttEndenceOrmorgscetor");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"AttEndenceOrmorgscetor");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"AttEndenceOrmorgscetor");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"AttEndenceOrmorgscetor");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"AttEndenceOrmorgscetor");
    }
...
<style lang='less'>
@import './att-endence-ormorgscetor-edit-view.less';
</style>