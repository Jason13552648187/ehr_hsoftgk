<template>
  <app-layout viewName="attendancemreportmxeditview" viewTitle="考勤月报明细" :className="{ 'view-container': true, 'default-mode-view': true, 'deeditview': true, 'att-endance-mreportmx-edit-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class AttEndanceMreportmxEditViewBase
 * @extends {EditViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class AttEndanceMreportmxEditViewBase extends EditViewBase {

    /**
     * 实体服务对象
     *
     * @type {AttEndanceMreportmxService}
     * @memberof AttEndanceMreportmxEditViewBase
     */
	 ...
	 * @memberof AttEndanceMreportmxEditViewBase
	 */
	public viewtag: string = 'f524f181dee3fe0d33a8a85505f92cb9';
     ...
     */
    public model: any = {
        srfCaption: 'entities.attendancemreportmx.views.editview.caption',
        srfTitle: 'entities.attendancemreportmx.views.editview.title',
        srfSubTitle: 'entities.attendancemreportmx.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof AttEndanceMreportmxEditView
     */
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            form: this.$refs.form,
            p2k: '0',
            keyPSDEField: 'attendancemreportmx',
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"AttEndanceMreportmx");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"AttEndanceMreportmx");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"AttEndanceMreportmx");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"AttEndanceMreportmx");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"AttEndanceMreportmx");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"AttEndanceMreportmx");
    }
    ...
    public toolbar_tbitem22_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"AttEndanceMreportmx");
    }
...
<style lang='less'>
@import './att-endance-mreportmx-edit-view.less';
</style>