<template>
  <app-layout viewName="attendencesetupkqsztreeexpview" viewTitle="考勤设置树导航视图" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'detreeexpview': true, 'att-endence-setup-kqsztree-exp-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class AttEndenceSetupKQSZTreeExpViewBase
 * @extends {TreeExpViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class AttEndenceSetupKQSZTreeExpViewBase extends TreeExpViewBase {
	 ...
	 * @memberof AttEndenceSetupKQSZTreeExpViewBase
	 */
	public viewtag: string = '8dfb451be615b1dd6bd681453572ee50';
     ...
     */
    public model: any = {
        srfCaption: 'entities.attendencesetup.views.kqsztreeexpview.caption',
        srfTitle: 'entities.attendencesetup.views.kqsztreeexpview.title',
        srfSubTitle: 'entities.attendencesetup.views.kqsztreeexpview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './att-endence-setup-kqsztree-exp-view.less';
</style>