<template>
  <app-layout viewName="pimpersonmpickupview" viewTitle="人员信息数据多项选择视图" :isShowCaptionBar="false" :isShowToolbar="false" :className="{ 'view-container': true, 'default-mode-view': true, 'dempickupview': true, 'pim-person-mpickup-view': true }" layoutMode="VIEW" :isShowUserInfo="isDefaultView()" :openMode="openMode" @close-view="closeView($event)">
 ...
 *
 * @export
 * @class PimPersonMPickupViewBase
 * @extends {MPickupViewBase}
 */
@Component({})
@VueLifeCycleProcessing
export default class PimPersonMPickupViewBase extends MPickupViewBase {

    /**
     * 实体服务对象
     *
     * @type {PimPersonService}
     * @memberof PimPersonMPickupViewBase
     */
	 ...
	 * @memberof PimPersonMPickupViewBase
	 */
	public viewtag: string = '8948a5606031ac246f782f05654883a7';
     ...
     */
    public model: any = {
        srfCaption: 'entities.pimperson.views.mpickupview.caption',
        srfTitle: 'entities.pimperson.views.mpickupview.title',
        srfSubTitle: 'entities.pimperson.views.mpickupview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './pim-person-mpickup-view.less';
</style>